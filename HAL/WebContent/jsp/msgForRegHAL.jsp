...
--><%//}else{
%>	
	<input type="button" name="createVisit" value="Next Registration"	class="buttonBig"
	onclick="submitForm('messageAdt','/hms/hms/registration?method=showRegistrationJspHAL','checkTargetForNo');" />
<%//}
for(UserButtonRights  userButtonRights : userRightsList){
