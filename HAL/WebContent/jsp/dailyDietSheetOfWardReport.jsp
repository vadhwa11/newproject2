...
<div  id="contentHolder">
	...
	<h6>Daily Diet Sheet Of <%=deptName %> </h6>
	
	<div class="Clear"></div>
	 <form name="dailyDietSheetOfWard" target="_blank" method="post" action="">
	<div class="blockFrame">
	  <input type="hidden" name="<%=DEPARTMENT_NAME %>" value="<%=deptName %>">
			...
			<input type="button" name="OK" value="OK" class="button" onClick="submitForm('dailyDietSheetOfWard','diet?method=printDailyDietSheetOfWardReport');" />
