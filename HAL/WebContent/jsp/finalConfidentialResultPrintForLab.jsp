...
<label
	style="font-size: 11px; font-family: arial; padding-left: 30px; width: auto;">Result
</label>
<div class="Clear"></div>
<label
	style="font-size: 11px; font-family: arial; padding-left: 170px; width: auto;">&nbsp;</label>
<label class="value"><%=dgDetail.getResult()%></label>
<div class="Clear"></div>
<label
	style="padding-left: 28px; width: 70px; font-size: 11px; padding-right: 0px;">Remarks
:</label> <% if(dgDetail.getRemarks() != null && !dgDetail.getRemarks().equals("")){ %>
<label class="value" style="padding-left: 10px; width: 140px;"><%=dgDetail.getRemarks()%></label>
<% } else { %> <label class="value"
	style="padding-left: 10px; width: 140px;">-</label> <% } %>
<div class="Clear"></div>
<%}
 	 		testCounter++;
 		  }
...
<label
	style="font-size: 11px; color: #000; font-family: arial; padding-left: 20px; width: 103px; padding-right: 0px; margin-right: 0px; padding-top: 10px;">Date</label>
<label class="value"
	style="width: 120px; margin-left: 0px; padding-left: 0px; padding-top: 10px;">:
<%=resultDate%> </label>
<div class="Clear"></div>
