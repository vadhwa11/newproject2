...
<%
	...
	if (map.get("patientDetailCmdOfficerList") != null) {
		patientDetailCmdOfficerList = (List) map.get("patientDetailCmdOfficerList");
	}
...
<form name="medicalBoardCommandingOfficer" method="post" action="">
<div class="clear"></div>
...
<%
int  counter=0;
if (patientDetailCmdOfficerList != null && patientDetailCmdOfficerList.size() > 0) {
for(MasMedicalExaminationReportOnEntry masexam : patientDetailCmdOfficerList){
%>
...
%>
formName = "medicalBoardCommandingOfficer"
start = 0
...
<label class="valueAutoPriority">Investigation Pending</label>
