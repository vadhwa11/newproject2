...
<h6>Contingent bill-General/Emergency/Hearing aid Investigation
report</h6>
<form name="generalContingentBill" target="_blank" action=""
	method="post">
<div class="Clear"></div>
<div class="blockFrame"><label><span>*</span>From Date</label> <input
	...
	onClick="setdate('<%=currentDate %>',document.generalContingentBill.<%=FROM_DATE%>,event)" />
...
<label><span>*</span>To Date</label> <input type="text" class="calDate"
	...
	src="/hms/jsp/images/cal.gif" width="16" height="16" border="0"
	validate="Pick a date"
	onClick="setdate('<%=currentDate %>',document.generalContingentBill.<%=TO_DATE%>,event)" />

</div>
<div class="Clear"></div>
<div class="bottom"><input type="button" name="OK" value="OK"
	class="button"
	onClick="submitForm('generalContingentBill','mediClaim?method=generateGenerateContingentReport','validateFromToDate');" />
...
function validateFromToDate(){
	...
	obj1 = eval(document.generalContingentBill.fromDate)
	obj2 = eval(document.generalContingentBill.toDate)
