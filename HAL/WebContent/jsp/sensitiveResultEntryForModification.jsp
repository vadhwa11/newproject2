...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	...
	<tr>
		<td><textarea name="result1" id="result1" onkeyup="chk(this,45);"><%= dgResultEntryDetailSenList.get(0).getResult()%></textarea>
		</td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	...
	<tr>
		...
		<%if(dgResultEntryDetailSenList.get(0).getResultOther() != null) { %> <textarea
			name="result2" onkeyup="chk(this,45);"><%=dgResultEntryDetailSenList.get(0).getResultOther() %></textarea>
		<% }else { %> <textarea name="result2" onkeyup="chk(this,45);"></textarea>
		<% } %>
		</td>
	</tr>
</table>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	...
	<tr>
		<td><textarea name="remarks" onkeyup="chk(this,100);"><%=dgResultEntryHeader.getRemarks()%></textarea>
