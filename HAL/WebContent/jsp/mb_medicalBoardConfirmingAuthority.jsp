...
<%
	...
	if (map.get("mbConfirmAuthWaitList") != null) {
		mbConfirmAuthWaitList = (List) map.get("mbConfirmAuthWaitList");
	}
...
<form name="medicalBoardConfirmingAuthority" method="post" action="">
<div class="clear"></div>
...
<%
int  counter=0;
if (mbConfirmAuthWaitList != null && mbConfirmAuthWaitList.size() > 0) {
for(MasMedicalExaminationReportOnEntry masexam : mbConfirmAuthWaitList){
%>
	   ...
	   String ma_status="";
		if(masexam.getVisit().getPriority()!=null){
			if(masexam.getVisit().getPriority()==4){
				...
				ma_status="Rejected By Accepting";
...
%>
formName = "medicalBoardConfirmingAuthority"
start = 0
