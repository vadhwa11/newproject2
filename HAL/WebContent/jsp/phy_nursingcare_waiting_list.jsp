...
<%
    ...
    if(map.get("FromDateId")!=null && map.get("ToDateId")!=null )
	{
...
<div class="Block">
<div class="clear"></div>
<h4>Physiotherapy Waiting List</h4>
<form name="physiotherapy_nursingcare_Waiting_List" method="post" action="">
<input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}">
<div class="paddingTop15">
<label> Employee No.</label><input name="serviceNo" value="" maxlength="30" validate="Service No,metachar,no" type="text" style="width: 107px">
<label>From Date</label>
<input type="text" id="FromDateId" name="FromDateId" class="dateTextSmall" value="<%=fromDate%>" readonly="readonly" style="width: 107px">
<img src="/hms/jsp/images/cal.gif"	width="16" height="16" border="0" validate="Pick a date"
	onclick="setdate('<%=date%>',document.physiotherapy_nursingcare_Waiting_List.FromDateId,event);" />

<label>To Date</label>
<input type="text" id="ToDateId"name="ToDateId" class="dateTextSmall" value="<%=toDate%>" readonly="readonly" style="width: 107px">
<img src="/hms/jsp/images/cal.gif"	width="16" height="16" border="0" validate="Pick a date"	
	onclick="setdate('<%=date%>',document.physiotherapy_nursingcare_Waiting_List.ToDateId,event);" />
</div>
<input type="button" name="search" value="Search" class="button"
onClick="if(datevalidation()){submitForm('physiotherapy_nursingcare_Waiting_List','/hms/hms/opd?method=getPhysiotherapyNursingCareWaitingList');}" />
...
/* 	data_header[8] = new Array;
	...
	formName = "physiotherapy_nursingcare_Waiting_List"
