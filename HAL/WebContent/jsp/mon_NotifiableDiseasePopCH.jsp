...
function check(){
var SDate = document.mon_NotifiableDiseaseCH.<%= FROM_DATE%>.value;
var EDate = document.mon_NotifiableDiseaseCH.<%= TO_DATE %>.value;
...
%>
<form name="mon_NotifiableDiseaseCH" method="post" action="" >
...
<a	href="javascript:setdate('<%=f%>',document.mon_NotifiableDiseaseCH.<%=FROM_DATE%>,true)">
...
<a href="javascript:setdate('<%=t%>',document.mon_NotifiableDiseaseCH.<%=TO_DATE%>,true)">
<img src="/hms/jsp/images/cal.gif" width="16" height="16" border="0" validate="Pick a date" class="calender" /> </a> 
...
{
	submitForm('mon_NotifiableDiseaseCH','/hms/hms/monitoring?method=printNotifiableDiseaseReport');
}
</script>