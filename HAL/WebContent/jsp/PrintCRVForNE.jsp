...
<% 
	...
	System.out.println(map.get("grnNo"));
	System.out.println(map.get("printUrl"));
	System.out.println(map.get("url"));
	System.out.println(map.get("chkJsp"));
...
if(!printUrl.equals("")){
%>
<input type="button" value="Print Crv" class="button" onClick="submitForm('message','<%=printUrl %>');checkTargetForYes();" />
<%} %>
<input type="button" value="Back" class="button" onClick="submitForm('message','<%=url%>');checkTargetForYes();" />
<div class="Clear"></div>
<div class="division"></div>
<div class="Clear"></div>
</form>
