...
<input type="hidden" name="<%=JASPER_FILE_NAME%>" value="Mas_patient_type">
</div>
</form>
</div>
<div class="Clear"></div>
...
<form name="patientType" method="post" action=""><input
	...
	type="hidden" name="<%=POJO_PROPERTY_NAME %>" value="PatientTypeName">
<input type="hidden" name="title" value="PatientType"> <input
...
<div class="Clear"></div>
<div class="Block">
<label>  Patient Type Code <span>*</span></label> <input id="codeId" type="text"
	name="<%= CODE%>" value="" validate="PatientType Code,string,yes"
	 MAXLENGTH="8" / tabindex=1> 
	 <label class="noWidth"> Patient Type
Name<span>*</span></label> <input type="text" name="<%= SEARCH_NAME %>" value=""
	validate="PatientType Name,string,yes" 
	MAXLENGTH="30" / tabindex=1
	onkeypress="return submitenter(this,event,'hospital?method=addPatientType')">
<script>
...
<div class="Clear"></div>
 <input type="button" name="add" id="addbutton"
	...
	onClick="submitForm('patientType','hospital?method=addPatientType');"
	accesskey="a" tabindex=1 /> <input type="button" name="edit"
	id="editbutton" value="Update" class="button"
	onClick="submitForm('patientType','hospital?method=editPatientType')"
	accesskey="u" tabindex=1 /> <input type="button" name="Delete"
	id="deletebutton" value="Activate" class="button"
	onClick="submitForm('patientType','hospital?method=deletePatientType&flag='+this.value)"
...
data_arr[<%= counter%>][3] = "<%= masPatientType.getLastChgBy() %>"
