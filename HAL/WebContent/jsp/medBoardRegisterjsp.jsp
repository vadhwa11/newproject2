...
<%@page import="jkt.hms.masters.business.MasRank"%><link rel="stylesheet" type="text/css" href="/hms/jsp/css/pops.css"
	id="vbulletin_css" />
...
<div class="titleBg"><h2>RECORD OF MEDICAL BOARD REGISTER</h2>
</div>
<div class="Block">
...
<input type="text" name="<%=TO_DATE%>" value="<%=currentDate %>" class="date" MAXLENGTH="30"
	validate="Pick a to date,date,yes" readonly="readonly" class="auto" /> <a
	href="javascript:setdate('<%=currentDate%>',document.dailyDoctorWise.<%=TO_DATE%>,true)">
<img src="/hms/jsp/images/cal.gif" width="16" height="16" border="0"
	validate="Pick a date" class="calender" /> </a>

<label>Service No</label>
<input name="<%=SERVICE_NO %>" type="text" tabindex="1" maxlength="10" class="auto" />
...
<input type="button" name="add" id="addbutton" value="Ok" class="button"
	onClick="submitForm('dailyDoctorWise','medicalExam?method=generatemedBoardRegister','check()','checkTargetForYes');"
