...
<input  type="button"	tabindex="1" align="right" class="button" value="Ok" onClick="submitForm('mon_MedLecturePop','aviationMedicine?method=generateMOLectureSummaryRpt');"	accesskey="a" tabindex=1 />
