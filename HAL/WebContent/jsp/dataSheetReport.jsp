...
<form name="dataSheet" action="" method="post">
<h6>Data Sheet</h6>
<%
...
<font class="boxtitle">Data Sheet</font></div>
...
<input type="button" name="Print"
	onclick="submitForm('dataSheet','/hms/hms/pension?method=printDataSheetReportJsp');"
