...
<table border="0" align="center" cellpadding="0" cellspacing="0" id="grid">
	...
	%>
		...
		<%if(assignedTemplate){ %>
		<input type="checkbox" checked="checked" name="templetId<%=templetCnt%><%=counter%>" id="templetId<%=templetCnt%><%=counter%>" value="<%=masTemplate.getId()%>" disabled="disabled"/>
		<%}else{ %>
		<input type="checkbox"  name="templetId<%=templetCnt%><%=counter%>" id="templetId<%=templetCnt%><%=counter%>" value="<%=masTemplate.getId()%>"  disabled="disabled"/>
		<%} %>
