...
<input type="hidden" name="<%=VISIT_ID %>" id="visitId"
	...
	onclick="submitForm('patientAD','opd?method=printOpdUrologyCaseSheet','checkTargetForYes');" />
<input type="button" name="no" value="No" class="button"
	onclick="submitForm('patientAD','opd?method=updateOPDPatientDetails','checkTargetForNo');" />
</form>
