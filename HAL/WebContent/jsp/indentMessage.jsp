...
if(!printUrl.equals("")){
%>
<input type="button" value="Print Indent" class="button" onClick="submitForm('message','<%=printUrl %>');" />
<input type="button" value="Export To Excel " class="buttonBig" onClick="submitForm('message','stores?method=generateExcelForDepot1');" />
