...
<h2 align="left" class="style1">OPD Ophthalmology Format</h2>
<br />
...
<input type="button" name="OK" value="OK" class="button"
	onClick="submitForm('search','opd?method=printOpdOphthalmology');" /><!-- showOpdOphthalmologyMainCaseSheetReport -->
