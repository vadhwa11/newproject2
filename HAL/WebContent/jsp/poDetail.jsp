...
<input type="button" name="exportExcel" type="submit" class="buttonBig" value="export to excel" onClick="printPoExcel();">
...
function printPo(){
	...
	//alert(document.getElementsByName('parent').value)
...
//alert(document.getElementsByName('parent').value)
submitForm('poDetails','purchaseOrder?method=poModifyJsp&poDetailId='+poId);
}
