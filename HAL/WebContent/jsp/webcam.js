...
window.webcam = {
	...
	swf_url: '/hms/jsp/webcam.swf', // URI to webcam.swf movie (defaults to cwd)
	shutter_url: '/hms/jsp/shutter.mp3', // URI to shutter.mp3 sound
	...
	get_movie: function() {
		...
		if (!this.loaded) return alert("No camera detected");
	...
	set_shutter_sound: function(enabled, url) {
		...
		this.shutter_url = url ? url : '/hms/jsp/shutter.mp3';
	},
