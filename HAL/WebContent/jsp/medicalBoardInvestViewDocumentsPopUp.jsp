...
<input name="" type="button" class="button"
	value="Back" onClick="submitForm('viewDocumentsInvestPopUpMedicalExam','medicalBoard?method=displayFileUploadInvestigation&hinId=<%=hinId%>&hinNo=<%=hin_no%>&invest_id=<%=invest_id%>&masExamId=<%=medExamId%>');" /><%--- onClick="history.back();" />--%>
