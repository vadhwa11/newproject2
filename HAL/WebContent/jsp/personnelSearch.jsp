...
<h6>Personnel Search For Updating Personnel Details</h6>
<div class="Clear"></div>
...
<div class="Clear"></div>
<div class="blockFrame"><label>Personnel Name</label> 
<input type="text" name="personnelName" value="" MAXLENGTH="30" /> 
<label>Pass No. </label> 
<input type="text" name="passNo" value="" MAXLENGTH="30" />
...
<input type="button" name="Search"
	onclick="submitForm('personnelSearch','/hms/hms/pension?method=personnelSearchJsp&jspName=updatePersonnelDetails');"
...
<form name="personnelDetail" method="post" action=""><script
