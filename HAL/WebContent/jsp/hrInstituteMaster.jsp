...
<%@page import="jkt.hms.masters.business.HrMasInstitute"%>
...
<div class="titleBg"><h2>Institute Master</h2></div>
 ...
 <div id="searcharea">
  <div id="searchbar">
			   <form name="search" method="post" action="">
                    ...
                    <input type="button" name="search" value="Search" class="button" onclick="submitForm('search','systemRelatedMaster?method=searchInstituteMaster','checkSearch')" tabindex=1  />
...
<div class="division"></div>
	...
	%> 
                ...
                <!-- <h4><a href="instituteMaster?method=showInstituteMasterJsp">Show All Records</a></h4> -->
                 <h4><a href="javascript:void(0)" onclick="submitForm('ancher','systemRelatedMaster?method=showInstituteMasterJsp');">Show All Records</a></h4>
	<%
			}
		 }
  ...
  <input type="hidden" name="<%= POJO_NAME %>" value = "HrMasInstitute">
  <input type="hidden" name="<%=POJO_PROPERTY_NAME %>" value = "InstituteName">
  <input type="hidden" name="title" value = "Institute">
  <input type="hidden" name="<%=JSP_NAME %>" value = "hrInstituteMaster">
  <input type="hidden" name="pojoPropertyCode" value = "InstituteCode">
		
 		
        <label><span>*</span> Institute Code</label>
	  	<input id="codeId" type="text" name="<%= CODE%>" value="" validate="Institute Code,string,yes" MAXLENGTH="8" tabindex=1 >
  		<label><span>*</span> Institute Name</label>
			<input type="text" name="<%= SEARCH_NAME %>" value="" validate="Institute Name,string,yes" MAXLENGTH="200" tabindex=1 >
			<script>
		...
		<div class="division"></div>
			<div id="edited"></div>
			<input type="button" name="add" id="addbutton" value="Add" class="button" onClick="submitForm('institute','systemRelatedMaster?method=addInstituteMaster');" accesskey="a" tabindex=1/>
		
			<input type="button" name="edit" id="editbutton" value="Update" style="display: none;" class="button" onClick="submitForm('institute','systemRelatedMaster?method=editInstituteMaster')" accesskey="u" tabindex=1 />

			<input type="button" name="Delete" id="deletebutton" value="Activate" style="display: none;" class="button" onClick="submitForm('institute','systemRelatedMaster?method=deleteInstituteMaster&flag='+this.value)" accesskey="d" tabindex=1/>		
