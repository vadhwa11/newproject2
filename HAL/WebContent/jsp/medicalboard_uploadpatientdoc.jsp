...
function jsImport()
{
	...
	}else
	{
       ...
       submitForm('attachHearingDocument','medicalBoard?method=submitUploadDocuments&hinId='+hin_id+'&visitId='+visit_id+'&hinNo='+hin_no+'&filename='+filename+'&folderName='+folderName);
...
function jsViewDocument()
{
	...
	//alert("folderName ===>"+folderName)   
      document.attachHearingDocument.method="post";
      submitForm('attachHearingDocument','medicalBoard?method=viewUploadDocumentsDetails&hinId='+hin_id+'&visitId='+visit_id+'&hinNo='+hin_no+'&folderName='+folderName);
  }
...
<input name="Submit13" type="button" class="button" value="View" onClick="jsViewDocument();"/>
