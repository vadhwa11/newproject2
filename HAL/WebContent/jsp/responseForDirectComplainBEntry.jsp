...
<input type="text" tabindex="1" name="requested_by" value="<%=complain.getRequestBy().getRank().getRankName().concat("  ").concat(complain.getRequestBy().getFirstName()).concat("  ").concat(complain.getRequestBy().getLastName())%>" />
...
<label>Status</label>
<input type="text" tabindex="1" name="status" value="<%=complain.getStatus()!=null?complain.getStatus():""%>" />
...
<%}else{ %>
<textarea name="airHqRemarks" tabindex="1" maxlength="150" onkeyup="chkLength(this,150);" onpaste="return checkOnPaste(this)"	
oninput="return checkMaxLengthMoz(this)"	onKeyDown="return checkMaxLength(this)"></textarea>
<%} %>
</div>
...
<div class="clear paddingTop10"></div>
	...
	<input type="button" name="add" id="addbutton"	value="Update" class="button" onClick="submitForm('complainB','user?method=updateComplainB&compainId=<%=complain.getId() %>');" accesskey="a" tabindex=1 />
