...
%>
<div id="hinDiv"><label>HIN <span>*</span></label> <select name="<%=HIN_NO%>"
	validate="Hin,string,yes">	<!-- onchange="submitProtoAjax('medicalCertificateReport','adt?method=getVisitDates')" -->
	...
	<% 
	     	...
	     	{ 
				...
				%>
	<option value="<%=patient.getHinNo()%>"><%=patient.getHinNo()+"-"+patient.getPFirstName()+" "+(patient.getPMiddleName()!=null?patient.getPMiddleName():"")+" "+(patient.getPLastName()!=null?patient.getPLastName():"")+" ("+patient.getRelation().getRelationName()+")"%>
	</option>
	<% } 
			} 
	     	 else
