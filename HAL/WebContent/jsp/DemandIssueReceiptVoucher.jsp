...
function fillValues(){
    ...
    submitForm('DemanIssueReciptBoucher','stores?method=showDemanIssueReceiptVoucher');
}
--></script>
<div class="titleBg">
<h2>Demand Issue and Receipt Voucher</h2>
</div>
<form name="DemanIssueReciptBoucher" method="post" action="">
<div class="division">
