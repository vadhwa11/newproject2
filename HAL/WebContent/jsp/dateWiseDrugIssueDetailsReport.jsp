...
<div class="titleBg">
<h2>Nomenclature Wise Issued Details</h2>
</div>
...
<div class="clear"></div>
<input type="button" name="OK" value="OK" class="button" onClick="submitForm('cashSheet','ipd?method=showDateWiseDrugIssuedReport');" />
