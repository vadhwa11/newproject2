...
<input type="hidden" name="indentType" value="exist">
<%if(pageNo==1){
...
<input	type="text" name="<%=RequestConstants.INDENT_NO %>"	value="<%=storeIndentM.getIndentNo()%>" readonly="readonly"	 MAXLENGTH="8" />
	...
	<input type="text"	name="<%=RequestConstants.INDENT_DATE%>" readonly="readonly"	value="<%=HMSUtil.changeDateToddMMyyyy(storeIndentM.getIndentDate())%>"	 MAXLENGTH="30" />
...
<div class="clear"></div>
 <label>Life Span</label> 
		...
		<%if(!(storeIndentM.getSelfLife().toString().equalsIgnoreCase("SLA"))){%>
...
<label>Contact No.</label>
<input type="text" name="<%=CONTACT_NUMBER %>" id="conNo" value="<%=contactNo %>" maxlength="12" tabindex="1"/>
	 <label> Code Head</label> 
...
<div id="pagination">
Page No.:
<span class="selected"><%=pageNo + " of "+ totalNumberOfPages %></span>
</div>
<div class="clear"></div>
<div class="cmntable">
