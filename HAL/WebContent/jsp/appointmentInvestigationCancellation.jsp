...
<%    
			 ...
			 %> </script>
<h6>Cancellation for Investigation Appointments</h6>
<div class="Clear"></div>
...
Age:</label> <input type="text" name="<%=AGE %>" value="" MAXLENGTH="2" /> <label>Investigation
...
<label> Investigation No:</label> <input type="text"
	name="<%=APPOINTMENT_NO %>" value="" MAXLENGTH="40" /> <label>Equipment:</label>
...
<table border="0" cellspacing="0" cellpadding="0">
	...
	<tr>
		...
		<td>
		<%if(appInvestigationAppointments.getServiceNo()!=null){ %> <input
			type="text" size="8" id="serviceNo<%=counter %>"
			name="<%=SERVICE_NO%>"
			value="<%=appInvestigationAppointments.getServiceNo()%>"
...
<input name="" type="button" class="buttonBig"
	...
	onclick="submitForm('patientSearch','appointment?method=submitCancelInvestigationAppointment');" />
<%} %>
<div class="Clear"></div>
<div class="bottom">
