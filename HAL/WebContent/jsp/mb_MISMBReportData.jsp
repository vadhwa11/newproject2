...
function PrintGraph()
{
	...
	var url="/hms/hms/medicalBoard?method=showMISMedicalBoardReportGraph&year="+year1;
...
function submitOne()
{
  ...
  alert("2");
	...
	xmlHttp.open("GET","/hms/hms/medicalBoard?method=showMisMedicalBoardReport&searchtype=graphInjsp",true);
...
<input type="checkbox" name="overWeight" tabindex="1" class="radioAuto" value="1" />
<label>Obesity</label>
<input type="checkbox" name="obesity" tabindex="1" id="obesityId" class="radioAuto" value="o" />
<label>Overdue</label>
<input type="checkbox" name="overdue" tabindex="1" class="radioAuto" value="1" />
...
<label class="">Year </label> <select name="year" size="0" tabindex="1"
	...
	<% } 
		 ...
		 %>
</select> <input type="button" name="Search" value="Print" tabindex="1"	class="buttonGraph" accesskey="a"
...
<input type="button" name="Search"
	onclick="if(checkBlankSearch()){submitForm('patientSearch','medicalBoard?method=showMisMedBoardStatics');}"
...
<script type="text/javascript">
	formFields = [ [0,"medExamid","id"],[1,"<%= SERVICE_NO%>"], [2,"<%= RANK%>"], [3,"<%= FULL_NAME %>"], [4,"<%= TRADE_ID %>"], [5,"medCat"], [6,"<%= REPORTED_DATE %>"],  [7,"medExamType"], [8,"<%=VISIT_ID%>"], [9,"examId"], [10,"<%=STATUS%>"], [11,"<%=OVER_WEIGHT%>"],[12,"obesity"] ];
	 statusTd = 10;
	</script></div>
</form>
...
data_header[3][0] = " Branch  "
data_header[3][1] = "data";
data_header[3][2] = "20%";
data_header[3][3] = "<%=TRADE_ID %>";
...
data_header[5][0] = "Date "
data_header[5][1] = "data";
data_header[5][2] = "0%";
data_header[5][3] = "<%=REPORTED_DATE %>";
...
data_header[7][0] = "visitid"
data_header[7][1] = "hide";
data_header[7][2] = "0%";
data_header[7][3] = "<%=VISIT_ID%>";

data_header[8] = new Array;
data_header[8][0] = "medid"
data_header[8][1] = "hide";
data_header[8][2] = "0%";
data_header[8][3] = "examId";
...
data_header[10][0] = "Over weight"
data_header[10][1] = "data";
data_header[10][2] = "0%";
data_header[10][3] = "<%=OVER_WEIGHT%>";

data_header[11] = new Array;
data_header[11][0] = "Obesity"
data_header[11][1] = "data";
data_header[11][2] = "0%";
data_header[11][3] = "obesity";
...
%>
   data_arr[<%= counter%>] = new Array(); 
	   ...
	   data_arr[<%= counter%>][4] = "<%=masexam.getTrade().getTradeName()%>"
		   <%}else{%>
	   data_arr[<%= counter%>][4] = ""   
	   <%}%>
		 
	   <%if(masexam.getPresentMedicalCategory()!=null){%>
	   data_arr[<%= counter%>][5] = "<%=masexam.getPresentMedicalCategory().getCategories()%>"
		   <%}else{%>
	   data_arr[<%= counter%>][5] = ""   
	   <%}%>
	   ...
	   data_arr[<%= counter%>][11] = "<%=masexam.getOverweight()%>"
		   <%}else{%>
	   data_arr[<%= counter%>][11] = ""   
	   <%}%>
	   <%if(masexam.getSD()!=null){%>
	   data_arr[<%= counter%>][11] = "<%=masexam.getSD()%>"
		   <%}else{%>
	   data_arr[<%= counter%>][11] = ""   
	   <%}%>
<%
...
%>
formName ="medicalExamMedicalOfficersearch"
