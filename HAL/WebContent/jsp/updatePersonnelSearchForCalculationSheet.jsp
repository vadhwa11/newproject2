...
<h6>Personnel Search For Updating Calculation Sheet</h6>
<div class="Clear"></div>
...
<input type="button" name="Search"
	onclick="submitForm('personnelSearch','/hms/hms/pension?method=updatePersonnelSearchForCalculationSheetJsp');"
	value="Search" class="cmnButton" accesskey="a" /> <jsp:include
	page="searchResultBlock.jsp" />
<div class="Clear"></div>
<div id="searchresults" tabindex=2>
<div id="searchtable" tabindex=2></div>
<form name="updatePersonnelDetailForCalculation" method="post" action="">
...
<script type="text/javascript" language="javascript">
    ...
    formName = "updatePersonnelDetailForCalculation"
