...
<div class="header">
<div><img height="68" width="75" alt="IAF MedNET Logo" border="0"
	class="floatLeft" src="/hms/jsp/images/IAFLogoThumb.jpg" /></div>
<!--
...
--> <!---for header text--->
<div class="hdText"><!-- <img src="/hms/jsp/images/careIsLogo.gif" class="floatRight" alt="careIs Logo" /> -->
<div class="hdTextFix">&nbsp; <%
 	String noticeData = "";
 	String userName = "";
...
<input type="button" value="Calculator" name="Button" onclick="ajaxFunctionForShowCalculator();"/>
 -->
<div class="clear"></div>
<input type="hidden" id="notice" name="notice" value="" /> <!--  <div>
