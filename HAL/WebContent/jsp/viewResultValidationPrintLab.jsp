...
<%int mapIndex = 0; %> <% 
		  System.out.println("Size of List :"+resultDetailsMapList.size());
...
<%	testCounter++;
		...
		DgResultEntryDetailSen dgResultEntryDetail = dgResultEntryHeader.getDgResultEntryDetailSen().iterator().next(); 
		%> <label
	style="padding-left: 20px; padding-right: 0px; margin-right: 0px; width: 16px;"><%=testCounter%>)</label>
<label
	style="font-size: 11px; color: #000; font-family: arial; padding-left: 0px; width: auto;">Test
