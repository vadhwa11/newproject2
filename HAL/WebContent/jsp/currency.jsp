...
<input type="button" name="Report" value="Generate Report Based on Search" class="buttonBig3" onClick="submitForm('search','/hms/hms/hospital?method=generateReportForGeneralMasters');" accesskey="g" tabindex=1 />
		...
		if(searchCurrencyList.size()>0)
		 {
			...
			{
	%> <h2><a href="generalMaster?method=showCurrencyJsp">Show All Records</a> </h2>
<%
			}
		 }
...
<input	type="hidden" name="<%= POJO_NAME %>" value="MasCurrency">
<input	type="hidden" name="<%=POJO_PROPERTY_NAME %>" value="CurrencyName">
<input type="hidden" name="title" value="Currency">
<input type="hidden" name="<%=JSP_NAME %>" value="currency">
<input type="hidden" name="pojoPropertyCode" value="CurrencyCode"> 
<div class="Clear"></div>
<div class="Block">
...
<label> Currency Name <span>*</span></label>
...
<div class="Clear"></div>
<input type="button" name="add" id="addbutton"	value="Add" class="button"	onClick="submitForm('currency','generalMaster?method=addCurrency');"accesskey="a" tabindex=1 />
<input type="button" name="edit" id="editbutton" value="Update" class="button" onClick="submitForm('currency','generalMaster?method=editCurrency')" accesskey="u" tabindex=1 />
<input type="button" name="Delete"	id="deletebutton" value="Activate" class="button" onClick="submitForm('currency','generalMaster?method=deleteCurrency&flag='+this.value)" accesskey="d" tabindex=1 />
...
<% if(masCurrency.getStatus().equals("y")){ %>
