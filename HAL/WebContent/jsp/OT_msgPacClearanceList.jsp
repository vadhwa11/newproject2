...
if(map.get("otPreAnesthesiahdId") != null){
	otPreAnesthesiahdId = (Integer)map.get("otPreAnesthesiahdId");
}
...
if(map.get("pastHistory") != null){
	pastRecords = (String)map.get("pastHistory");
}
else
{
...
System.out.println("drugTherapy-->"+drugTherapy.trim());
%>
...
<input type="button" name="no" class="button" value="No"
	...
	<input type="button" name="yes" value="Print"	class="button"	onclick="submitForm('message','/hms/hms/ot?method=generatePreAnesthesiaPrint&otPreAnesthesiahdId=<%=otPreAnesthesiahdId %>');" />
