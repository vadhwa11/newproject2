...
<input	type="text" readonly="readonly" maxlength="20"  value="" name="typeOfCommunication"	tabindex="2" />
 ...
 <% }else{%>
<input	tabindex="1" name="<%=DATE_COMMENCEMENT %>" option value="<%=date %>"	validate="Entry Date,date,yes" maxlength="10" class="date"	onKeyUp="mask(this.value,this,'2,5','/');" />
...
<label class="medium"> Remarks</label>
 ...
 <textarea rows="" cols=""  readonly="readonly"	name="<%=DENTAL_REMARKS %>" class="large" onkeyup="chkLength(this,50);" value="<%=medExamObj.getRemarksTeath() %>"><%=medExamObj.getRemarksTeath() %></textarea>

 <% }else{%>
 <textarea rows="" cols=""  readonly="readonly"	name="<%=DENTAL_REMARKS %>" class="large" onkeyup="chkLength(this,50);"></textarea>
 <% }%>
...
<input tabindex="1" type="text" readonly="readonly" maxlength="20"  id="hlfw" value="<%=medExamObj.getEarHearingLfw()  %>" name="<%=HEARING_L_F_W%>" onkeyup="isNumber1(this)" maxlength="6"/> 
	...
	<label>Hearing Both <br /><span class="sublabel">(Cms)</span></label> 
...
<input tabindex="1" type="text" readonly="readonly" maxlength="20"  class="calDate" value="<%=HMSUtil.convertDateToStringWithoutTime(medExamObj.getLastConfinementDate()) %>"	name="<%=DATE_OF_LASTCONFINEMENT %>" maxlength="10" onKeyUp="mask(this.value,this,'2,5','/');" validate="Dental Date,date,no" /> 
   <% }else{%>
<input tabindex="1" type="text" readonly="readonly" maxlength="20"  class="calDate" 	name="<%=DATE_OF_LASTCONFINEMENT %>" maxlength="10" onKeyUp="mask(this.value,this,'2,5','/');" validate="Dental Date,date,no" /> 
 <% }%>
...
<% if(medExamObj.getRemarksGynaecology()!=null){%>
 <textarea rows="" cols="71"  readonly="readonly"	name="<%=GYANAECOLOGY_RAMARKS %>" class="auto" onkeyup="chkLength(this,50);" value="<%=medExamObj.getRemarksGynaecology() %>"><%=medExamObj.getRemarksGynaecology() %></textarea>
...
<textarea rows="" cols="72"  readonly="readonly"	name="cmMdRemarks" class="auto" onkeyup="chkLength(this,50);"><%=medExamObj.getCommandRemarks()%></textarea>
   <% }else{%>
<textarea rows="" cols="72"  readonly="readonly"	name="cmMdRemarks" class="auto" onkeyup="chkLength(this,50);"></textarea>
 <% }%>
