...
<input type="text" id="searchField" name="<%= SEARCH_FIELD%>" value="" validate="DietType,string,no" MAXLENGTH="8" tabindex=1
	onkeypress="return submitenter(this,event,'canteen?method=searchDietType')" />

<input type="button" name="search" value="Search" class="button"
	onclick="submitForm('search','canteen?method=searchDietType','checkSearch')" tabindex=1 /> 
	<%--- Report Button   --%> 
...
<form name="dietType" method="post" action="">
<input
	type="hidden" name="<%= POJO_NAME %>" value="MasDietType"> 
<input
	type="hidden" name="<%=POJO_PROPERTY_NAME %>" value="DietTypeName">

<input type="hidden" name="title" value="DietType"> 
<input
	type="hidden" name="<%=JSP_NAME %>" value="dietType"> 
<input
	type="hidden" name="pojoPropertyCode" value="DietTypeCode"> <br>
<div class="Clear"></div>
<div class="Block">
...
<input id="codeId" type="text"
	name="<%= CODE%>" value="" validate="DietType Code,string,yes"
	 MAXLENGTH="8" / tabindex=1> 
<label><span>*</span> DietType Name</label> 
<input type="text" name="<%= SEARCH_NAME %>" value=""
	validate="DietType Name,string,yes" 
	MAXLENGTH="30" / tabindex=1
	onkeypress="return submitenter(this,event,'canteen?method=addDietType')">
<script>
...
<input type="button" name="add" id="addbutton"
	...
	onClick="submitForm('dietType','canteen?method=addDietType');"
	accesskey="a" tabindex=1 /> 
<input type="button" name="edit"
	id="editbutton" value="Update" class="button"
	onClick="submitForm('dietType','canteen?method=editDietType')"
	accesskey="u" tabindex=1 /> 
<input type="button" name="Delete"
	id="deletebutton" value="Activate" class="button"
	onClick="submitForm('dietType','canteen?method=deleteDietType&flag='+this.value)"
