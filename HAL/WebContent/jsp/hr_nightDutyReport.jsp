...
<h6>Night Duty Entry Report</h6>
<div class="Clear"></div>

<form name="nightReport" target="_blank" method="post" action="">
...
From Date:</label> <input type="text" id="fromDateId" name="<%=FROM_DATE %>"
	...
	onClick="setdate('<%=currentDate%>',document.nightReport.<%=FROM_DATE%>,event);" />
...
<label class="bodytextB"><span>*</span> To Date:</label> <input
	...
	MAXLENGTH="30" /> <img src="/hms/jsp/images/cal.gif" width="16"
	height="16" border="0" validate="Pick a date"
	onClick="setdate('<%=currentDate%>',document.nightReport.<%=TO_DATE%>,event);" />

</div>
<div class="Clear"></div>

<input type="button" name="OK" value="OK" class="cmnButton"
	onClick="submitForm('nightReport','hrRelated?method=generateNightReport');" />
