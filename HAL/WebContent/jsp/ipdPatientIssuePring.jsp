...
<% 
	...
	if(map.get("inpatientId") !=null){
		inpatientId=""+map.get("inpatientId");
	}
	...
	if(map.get("rcStatus")!=null){
		rcStatus=(String)map.get("rcStatus");
	}
	String printUrl = "/hms/hms/stores?method=printPricriptionIssue&inpatientId="+inpatientId+"&serviceNo="+serviceNo+"&hinNo="+hinNo+"&hospitalId="+hospitalId;	
	String printNisUrl = "/hms/hms/stores?method=printNIS&inpatientId="+inpatientId+"&serviceNo="+serviceNo+"&hinNo="+hinNo+"&hospitalId="+hospitalId;	
%>
...
<%if(rcStatus.equals("y")){ %>
<input type="button" value="RC" class="button" onClick="submitForm('message','<%=printNisUrl%>');" />
<%} %> --%>
