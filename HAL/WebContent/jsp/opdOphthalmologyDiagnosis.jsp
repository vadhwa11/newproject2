...
<div class="bottom"><input name="Save" type="button"
	...
	onclick="if(checkBlankForOphthalmology('ophthalmologyDiagnosis')){submitForm('ophthalmologyDiagnosis','opd?method=submitOphthalmologyDiagnosis');}">
<input name="view" type="button" class="button" value="View"
	onclick="submitForm('ophthalmologyDiagnosis','opd?method=viewOphthalmologyDiagnosis&flag=prev');">
