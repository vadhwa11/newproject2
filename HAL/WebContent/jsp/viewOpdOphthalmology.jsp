...
<div class="bottom"><input name="prev" type="button"
	...
	onclick="submitForm('viewOpdOphthalmology','opd?method=viewPatientOphthalmologyDetails&flag=prev');">
<input name="next" type="button" class="button" value="Next"
	onclick="submitForm('viewOpdOphthalmology','opd?method=viewPatientOphthalmologyDetails&flag=next');">
<%
	String url = ""; 
