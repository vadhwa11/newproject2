...
<%if(opdObj != null && opdObj.getGalactorrhoeaText() != null){ %> <textarea
	...
	name="<%=GALACTORRHOEA %>" id="<%=GALACTORRHOEA %>" class="large"
	onpaste="return checkOnPaste(this)"
	oninput="return checkMaxLengthMoz(this)"
	onkeydown="return checkMaxLength(this)" onkeyup="finalCheck(this)"
	maxlength="20"></textarea> <script>document.gynaecology.<%=GALACTORRHOEA%>.innerHTML = "<%=opdObj.getGalactorrhoeaText()%>"</script>
<%}else{ %> <textarea value="" tabindex="1" name="<%=GALACTORRHOEA %>"
	id="<%=GALACTORRHOEA %>" class="large"
	onpaste="return checkOnPaste(this)"
	oninput="return checkMaxLengthMoz(this)"
	onkeydown="return checkMaxLength(this)" onkeyup="finalCheck(this)"
	maxlength="20"></textarea> <%}%>
...
<div class="paddLeft55"><input name="Submit" type="button"
	...
	onclick="submitForm('gynaecology','opd?method=submitGeneralExamination');" /></div>
</div>
</div>
</div>
