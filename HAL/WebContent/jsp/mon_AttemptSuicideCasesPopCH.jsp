...
<%@page import="jkt.hms.masters.business.MasHospital"%><script type="text/javascript" language="javascript" src="/hms/jsp/js/calendar.js"></script>
...
function check(){
var SDate = document.mon_AttemptSuicideCasesCH.<%= FROM_DATE%>.value;
var EDate = document.mon_AttemptSuicideCasesCH.<%= TO_DATE %>.value;
...
%>
<form name="mon_AttemptSuicideCasesCH" method="post" action="" >

<div class="titleBg">
<h2>Attempt Suicide Cases</h2>
</div>
<div class="Block">
...
<a	href="javascript:setdate('<%=f%>',document.mon_AttemptSuicideCasesCH.<%=FROM_DATE%>,true)">
...
<a href="javascript:setdate('<%=t%>',document.mon_AttemptSuicideCasesCH.<%=TO_DATE%>,true)">
<img src="/hms/jsp/images/cal.gif" width="16" height="16" border="0" validate="Pick a date" class="calender" /> </a> 
...
<input type="button" name="Submit" id="addbutton" onclick="submitPopupForm();" tabindex="1"	value="Submit" class="button" accesskey="a" />
...
{
	submitForm('mon_AttemptSuicideCasesCH','/hms/hms/monitoring?method=generateSuicideReport');
}
</script>
