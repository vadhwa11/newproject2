...
function check(){
var SDate = document.examinationReport.<%= FROM_DATE%>.value;
var EDate = document.examinationReport.<%= TO_DATE %>.value;
...
%>
<form name="examinationReport" method="post" action=""><br />
<div class="titleBg"><h2>Examination Stats</h2>
</div>
<div class="Block">
...
<a	href="javascript:setdate('<%=currentDate%>',document.examinationReport.<%=FROM_DATE%>,true)">
...
<a href="javascript:setdate('<%=currentDate%>',document.examinationReport.<%=TO_DATE%>,true)">
...
onClick="submitForm('examinationReport','aviationMedicine?method=generateExamStatsReport','check()');"	accesskey="a" tabindex=1 /> 
