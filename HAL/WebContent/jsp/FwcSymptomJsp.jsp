...
<!--
	...
	function fillSymptom(val)
	{
	  ...
	  if(symptomNo == "")
	  {
	   ...
	   {	submitForm('TreatmentSearchForm','fwc?method=showSymptomPopUp&symptomname='+encodeURIComponent(symptomName));
	     }
		}	
}
	function fillSymptomSubName(val)
	{
	  ...
	  if(symptomNo == "")
	  {
	   ...
	   {	
		submitForm('TreatmentSearchForm','fwc?method=showSymptomSubPopUp&symptomsubname='+encodeURIComponent(subSymptomName));
...
<script type="text/javascript" language="javascript" charset="utf-8">
		  new Ajax.Autocompleter('symptomname','ac2update','fwc?method=autoCompleteForSymptom',{parameters:'requiredField=symptomname'});
...
<script type="text/javascript" language="javascript" charset="utf-8">
		  new Ajax.Autocompleter('symptomsubname','ac2update12','fwc?method=autoCompleteForSymptomSubName',{parameters:'requiredField=symptomsubname'});
