...
function onChangeProposal()
{
	...
	submitForm('ReTenderResupplyOrderForm','tender?method=getReTenderGroupListForProposalCancel&proposalId='+ReTenderResupplyOrderForm.<%=PROPOSAL_ID%>.value);
	}
}

function onChangeTender()
{
if (ReTenderResupplyOrderForm.<%=PROPOSAL_ID%>.value=="" || ReTenderResupplyOrderForm.<%=TENDER_SUPPLIER_GROUP_ID%>.value =="")
	{
	alert("Please select Proposal No & Group!.....");
	ReTenderResupplyOrderForm.<%=TENDER_SUPPLIER_GROUP_ID%>.value = "";
	return;
	}
ReTenderResupplyOrderForm.method="post";
 submitForm('ReTenderResupplyOrderForm','tender?method=getReTenderSupplierListForReLPO&proposalId='+ReTenderResupplyOrderForm.<%=PROPOSAL_ID%>.value);
...
<form name="ReTenderResupplyOrderForm"><input type="hidden"
...
<h6>Re Tender - Re SO For Cancelled</h6>
<div class="Clear"></div>
<div class="blockTitle">Re Tender ReSO Cancelled</div>
