...
<FORM name="livingInRegister" action="" method=post>
<h6>Living In Register</h6>
<DIV class="Clear"></DIV>
...
<img src="/hms/jsp/images/cal.gif" width="16" height="16" border="0"
	onClick="setdate('<%=currentDate%>',document.livingInRegister.<%=DATE%>,event);"
	class="calender" /></DIV>
<div class="division"></div>
<div class="bottom"><input type="button" class=button value="Ok"
	name="print"
	onclick="submitForm('livingInRegister','/hms/hms/hrOrderly?method=printlivingInRegister')" />
