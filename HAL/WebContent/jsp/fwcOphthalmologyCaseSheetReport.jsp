...
<h2 align="left" class="style1">FWC Ophthalmology Format</h2>
<br />
...
<input type="button" name="OK" value="OK" class="button"
	onClick="submitForm('search','fwc?method=printFwcOphthalmology');" /><!-- showFwcOphthalmologyMainCaseSheetReport -->
