...
<!--By Vishnu  -->
<title>Anesthesia Record Waiting List</title>
...
<div class="clear"></div>
<div class="titleBg">
<h2>Anesthesia Record Waiting List</h2>
</div>
<div class="clear"></div>
...
<input type="button" name="Search" value="Search" class="button"
	onClick="submitForm('search','/hms/hms/ot?method=anesthesiaRecordWaitingList');" />
...
<form name="pendingForAnesthesiaRecord" method="post" action="">
