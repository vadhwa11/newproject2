...
<form name="postedOutSearch" action="" method="post"><script
...
<input type="button" name="search" id="search"
	onclick="submitForm('postedOutSearch','/hms/hms/hrOrderly?method=searchRecordsForPostedOut');"
...
formFields = [
[0, "<%= EMPLOYEE_ID%>", "id"],[1,"<%=SERVICE_NO%>"],[2,"<%=RANK_ID%>"],[3,"<%=S_FIRST_NAME%>"]];
statusTd = 3;
</script></form>
