...
<h6>Leave Maintenance Search</h6>
<div class="Clear"></div>
<form name="leaveMaintenanceSearch" action="" method="post">
<%
...
<input type="button" name="Search"
	onclick="submitForm('leaveMaintenanceSearch','hrRelated?method=searchEmployeeForLeaveMaintenance');"
...
<form name="leaveSearch" method="post" action=""><script
	type="text/javascript">
	formFields = [
			[0, "<%= HIN_ID%>"], [1,"servNo"], [2,"firstName"], [3,"rank"]];
	 statusTd = 3;
	</script></form>
</div>
</div>
<script type="text/javascript" language="javascript">
	...
	data_header[1][0] = "Employee"
	data_header[1][1] = "data";
	data_header[1][2] = "15%";
	data_header[1][3] = "firstName";
	...
	%>
			...
			data_arr[<%= counter%>][2] = "<%=masEmployee.getFirstName()%>"
			data_arr[<%= counter%>][3] = "<%=masEmployee.getRank().getRankName()%> "
		<%
				     counter++;
		    	}
			}
