...
<div class="Clear"></div>
<form name="medicalBoardPreceedingsSearch1" action="" method="post">
...
<div class="Clear"></div>
<h6>Medical Board Proceedings Search For Update</h6>
...
<label>Service No.</label> <input name="<%=SERVICE_NO %>" type="text"
   ...
   %>
</select> <label>AD No.</label> <input name="<%=MEDICAL_ADMIN_NO%>" type="text"
	id="searchField3" tabindex="1" />
<div class="Clear"></div>
...
<input type="button" name="Search" id="searchField"
	onclick="submitForm('medicalBoardPreceedingsSearch1','medicalboardSearch?method=searchMedicalBoardProceedingSearch','checkSearchForMedicalBoard');"
...
%>
formName = "medicalBoardPreceedingsSearch1"
start = 0
