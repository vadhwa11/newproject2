...
<input	type="text" maxlength="20"  value="<%=medExamObj.getApparentAge() %>" name="apparentAge"	tabindex="2" maxlength="20" />

 <% }else{%>
<input	type="text" maxlength="20"  value="" name="typeOfCommunication"	tabindex="2" maxlength="20" />

 <% }%>
  <label>Sex</label> 
  <input	type="text" value="" name="apparentAge"	tabindex="2" maxlength="20" />


  <label>Weight  </label> 
 <%if(medExamObj.getPatientweight()!=null)
 { %>
  <input	type="text" value="<%=medExamObj.getPatientweight()%>" name="patientweight"	tabindex="2" maxlength="20" />
 <% }else{%>
   <input	type="text"  name="patientweight"	tabindex="2" maxlength="20" />
 <% }%>
<div class="clear"></div>
...
<%if(medExamObj.getPatientheight()!=null)
 { %>
  <input	type="text" value="<%=medExamObj.getPatientheight()%>" name="patientheight"	tabindex="2" maxlength="20" />
 <% }else{%>
   <input	type="text"  name="patientheight"	tabindex="2" maxlength="20" />
 <% }%>
...
<%if(medExamObj.getPermanentAddress()!=null)
 { %>
  <input	type="text" value="<%=medExamObj.getPermanentAddress()%>" name="<%=PERMANENT_ADDRESS%>"	tabindex="2" maxlength="20" />
 <% }else{%>
   <input	type="text"  name="<%=PERMANENT_ADDRESS%>"	tabindex="2" maxlength="20" />
 <% }%>

 
 <label>Date Of <br /><span class="sublabel">( Commissioning Enrolloment)</span></label> 
  <%if(medExamObj.getDateofcommun()!=null)
 { %>
 <input	tabindex="1" name="<%=DATE_COMMENCEMENT %>" class="date"  value="<%=HMSUtil.convertDateToStringWithoutTime(medExamObj.getDateofcommun()) %>"	validate="Entry Date,date,no" maxlength="10"	onKeyUp="mask(this.value,this,'2,5','/');" />
 <% }else{%>
 <input	tabindex="1" name="<%=DATE_COMMENCEMENT %>" class="date"  	validate="Entry Date,date,no" maxlength="10"	onKeyUp="mask(this.value,this,'2,5','/');" />
 <% }%>
...
<%if(medExamObj.getRecordoffice()!=null)
 { %>
  <input	type="text" value="<%=medExamObj.getRecordoffice()%>" name="<%=RECORDOFFICE%>"	tabindex="2" maxlength="20" />
 <% }else{%>
   <input	type="text"  name="<%=RECORDOFFICE%>"	tabindex="2" maxlength="20" />
 <% }%>
...
<%if(medExamObj.getCeaseduty()!=null && !(medExamObj.getCeaseduty().equals("")))
 { %>
  <input	type="text" value="<%=HMSUtil.convertDateToStringWithoutTime(medExamObj.getCeaseduty())%>" name="<%=CEASEDDUTY%>"	tabindex="2" maxlength="20" />
 <% }else{%>
   <input	type="text"  name="<%=CEASEDDUTY%>"	tabindex="2" maxlength="20" />
 <% }%>
...
<div class="clear"></div>
  ...
  <label>Present Med Categ <br /><span class="sublabel">(Prior To Present Medical Board)</label> 

<%if(medExamObj.getPresentmedicalhistory()!=null)
 { %>
 <input	type="text"  name="<%=PRESENT_MEDICAL_CATEGORY%>"	value="<%=medExamObj.getPresentmedicalhistory()%>" tabindex="2" maxlength="20" />
 <% }else{%>
   <input	type="text"  name="<%=PRESENT_MEDICAL_CATEGORY%>"	tabindex="2" maxlength="20" />
 <% }%>
...
<%}else{ %>	
	...
	<%} %>
	 ...
	 <% if(medExamObj.getHearingLcv() != null){ %>
	  ...
	  <%}else{ %>
	    <input tabindex="1" type="text"  id="hlcv" name="<%=HEARING_L_C_V %>" onkeyup="isNumber1(this)" maxlength="6"/>
	  <%} %>
...
<div class="clear"></div>
<div class="clear paddingTop15"></div>
<h4> PERSONAL STATMENT SERVICE DETAILS <a href="javascript:animatedcollapse.toggle('slide6')">(Click Here)</a></h4>
<div class="clear"></div>
<div id="slide6">
<div class="cmntable">
...
<TR>
<td width="10%"><input tabindex="1" size="2" type="text"	name="<%=SIRIAL_NO+inc1 %>" maxlength="3" value="<%=setMedicalExam.getSerialno() %>"/></td>
<% if(setMedicalExam.getPrincipal()!=null){%>
<td width="10%"><input tabindex="1" type="text"	name="<%=PRINCIPAL+inc1 %>" maxlength="10" value="<%=setMedicalExam.getPrincipal() %>"/></td>
<% }else{%>
<td width="10%"><input tabindex="1" type="text"	name="<%=PRINCIPAL+inc1 %>" maxlength="10" /></td>
<% }%>
<td width="10%">
<% if(setMedicalExam.getOrigindate()!=null){%>
<input	tabindex="1" name="<%=ORIGIN_DATE+inc1 %>" class="date"  	validate="DOB,date,no" maxlength="10" id="<%=ORIGIN_DATE+inc1 %>"
value="<%=HMSUtil.convertDateToStringWithoutTime(setMedicalExam.getOrigindate())%>"	onKeyUp="mask(this.value,this,'2,5','/');" /> 
<% }else{%>
<input	tabindex="1" name="<%=ORIGIN_DATE+inc1 %>" class="date" value="<%=date %>" 	validate="DOB,date,no" maxlength="10" id="<%=ORIGIN_DATE+inc1 %>"
...
<td>
  <img src="/hms/jsp/images/cal.gif" width="16" height="16" border="0"
	...
	onclick="setdate('',medicalBoardExaminationAnnual.<%=ORIGIN_DATE+inc1%>,event);" />
</td>
...
<input	tabindex="1" name="<%=MEDICAL_CAT_DATE+inc1 %>" class="date" value="<%=HMSUtil.convertDateToStringWithoutTime(setMedicalExam.getMedicalcatdate()) %>" 	validate="DOB,date,no" maxlength="10" id="<%=MEDICAL_CAT_DATE+inc1 %>"
	onKeyUp="mask(this.value,this,'2,5','/');" /> 
<% }else{%>
<input	tabindex="1" name="<%=MEDICAL_CAT_DATE+inc1 %>" class="date" value="<%=date %>" 	validate="DOB,date,no" maxlength="10" id="<%=MEDICAL_CAT_DATE+inc1 %>"
	onKeyUp="mask(this.value,this,'2,5','/');" /> 
<% }%>
</td>
<td>
  <img src="/hms/jsp/images/cal.gif" width="16" height="16" border="0"
	validate="Pick a date" class="calender"
	onclick="setdate('',medicalBoardExaminationAnnual.<%=MEDICAL_CAT_DATE+inc1%>,event);" />
</td>
<td width="10%">
<% if(setMedicalExam.getNextcatdate()!=null){%>
<input	tabindex="1" name="<%=NEXT_CAT_DATE+inc1 %>" class="date" value="<%=HMSUtil.convertDateToStringWithoutTime(setMedicalExam.getNextcatdate()) %>" 	validate="DOB,date,no" maxlength="10" id="<%=NEXT_CAT_DATE+inc1 %>"
	onKeyUp="mask(this.value,this,'2,5','/');" /> 
<% }else{%>
<input	tabindex="1" name="<%=NEXT_CAT_DATE+inc1 %>" class="date" value="<%=date %>" 	validate="DOB,date,no" maxlength="10" id="<%=NEXT_CAT_DATE+inc1 %>"
	onKeyUp="mask(this.value,this,'2,5','/');" /> 
<% }%>
</td>
<td>
  <img src="/hms/jsp/images/cal.gif" width="16" height="16" border="0"
	validate="Pick a date" class="calender"
	onclick="setdate('',medicalBoardExaminationAnnual.<%=NEXT_CAT_DATE+inc1%>,event);" />
</td>
...
<% if(medExamObj.getMedicalExamType().equalsIgnoreCase("InitialMedicalBoardAFMSF15")){%>
<div class="Block">
...
<input tabindex="1" type="text" name=<%=PAST_MEDICAL_HISTORY%>  class="Auto" size="20" maxlength="20" />
...
<input	tabindex="1" name="<%=CATEGORIZATION_DATE %>" 	validate="Entry Date,date,no" value="<%=date %>" maxlength="10" class="date"	onKeyUp="mask(this.value,this,'2,5','/');" />
  <img	src="/hms/jsp/images/cal.gif" width="16" height="16" border="0"	validate="Pick a date" onclick="setdate('',medicalBoardExaminationAnnual.<%=DOB%>,event);" />
<div class="clear"></div>
<label >Previous Disablement</label> 
<input tabindex="1" type="text" name=<%=PREVIOUS_DISABLEMENT%>  class="Auto" size="20" maxlength="20" />
<label >Present Disablement</label> 
<input tabindex="1" type="text" name=<%=PRESENT_DISABLEMENT%>  class="Auto" size="20" maxlength="20" />
<label >Reasons <br /> <span class="sublabel">(For Variation)</span></label> 
<input tabindex="1" type="text" name=<%=REASOPNS_VARIATION%>  class="Auto" size="20" maxlength="20" />
<div class="clear"></div>
...
<select id="<%=BOARD_PRESIDENT %>"	name="<%= BOARD_PRESIDENT %>" 	validate="Approved By,string,no" tabindex=1>
...
<select id="<%=BOARD_MEMBER %>"	name="<%= BOARD_MEMBER %>" 	validate="Approved By,string,no" tabindex=1>
	<option value="">Select</option>
	<%
