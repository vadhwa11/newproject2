...
function fillAtleastOne(){
	...
	function submitFormForOrderBookingReport(){
		...
		if(flag == false){
			...
			submitForm('resultDetailListForReport','/hms/hms/investigation?method=showSaparatePrintForResultEntryLab');
		}
...
<form name="provisionalResultSearch" action="" method="post">
<%
...
<h6>Provisional Result Search</h6>
<div class="Clear"></div>
<div class="blockTitle">Provisional Result Search</div>
...
<input type="button" name="Search" id="addbutton"
	onclick="submitForm('provisionalResultSearch','/hms/hms/investigation?method=searchProvisionalResultEntryDetailsLab','fillAtleastOne');"
