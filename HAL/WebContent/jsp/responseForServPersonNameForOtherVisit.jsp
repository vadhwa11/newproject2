...
<input id="hinNoId" type="hidden" name="<%=HIN_NO%>" value=""  validate="Reg. No,metachar,no"/>
<div class="clear"></div>
...
<input	id="serviceNoId" class="auto" size="8" type="text"	name="<%=SERVICE_NO%>" value="<%=serviceNo%>" title="Enter Service No" tabindex="1" validate="HIN,metachar,yes" maxlength="20"
	readOnly="true">
...
document.getElementById('ageId').value='<%=srage%>';
...
<textarea name="<%=ADDRESS%>" id="sraddr"	cols="20" rows="2" tabindex="1" validate="Address,metachar,no" maxlength="200"
	onpaste="return checkOnPaste(this)"	oninput="return checkMaxLengthMoz(this)"	onKeyDown="return checkMaxLength(this)" onKeyUp="finalCheck(this)" onblur=""><%=add%>
</textarea>
...
<%
	for (Object[] masRank : rankList) {
			if (masRank[2].equals(serviceTypeId) && masRank[3].equals(1)) {
				String selected = "";
				if (rankEmp!=0) {
...
<textarea name="<%=ADDRESS%>" id="sraddr"	cols="20" rows="2" tabindex="1" validate="Address,metachar,no" maxlength="200"
	onpaste="return checkOnPaste(this)"	oninput="return checkMaxLengthMoz(this)"	onKeyDown="return checkMaxLength(this)" onKeyUp="finalCheck(this)" onblur="">
</textarea>
...
<label> Contact No.</label> 
<input	type="text" name="<%=SR_NEXT_OF_KIN_PHONE_NO%>" id="srnok1Phone" tabindex="1" value=""	validate="NOK1 Phone No,phone,no" maxlength="11" />
<div class="clear"></div>
<label> Address</label> 
<textarea name="<%=SR_NEXT_OF_KIN_ADDRESS%>" id="srnextOfKinAdd" tabindex="1"	cols="20" rows="2"  validate="Nok1 Address,metachar,no" maxlength="200"
	onpaste="return checkOnPaste(this)"	oninput="return checkMaxLengthMoz(this)"	onKeyDown="return checkMaxLength(this)" onKeyUp="finalCheck(this)"></textarea>
...
<input type="hidden" name="patientStatus" id="patientStatus" value="<%=patientStatus%>"  validate="Patient Status,metachar,no"/>
<div class="clear"></div>
...
<textarea name="<%=ADDRESS%>" id="sraddr" tabindex="1"	cols="20" rows="2" tabindex="1" validate="Address,metachar,no" maxlength="200"
	onpaste="return checkOnPaste(this)"	oninput="return checkMaxLengthMoz(this)"	onKeyDown="return checkMaxLength(this)" onblur="" onKeyUp="finalCheck(this)"></textarea>
...
<label> Contact No.</label> 
<input	type="text" name="<%=SR_NEXT_OF_KIN_PHONE_NO%>" value="" tabindex="1"  id="srnok1Phone"	validate="NOK1 Phone No,phone,no" maxlength="11" />
<div class="clear"></div>
<label> Address</label> 
