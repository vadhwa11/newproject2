...
<div class="titleBg"><h2>MEDICAL BOARD PENDING REGISTER</h2>
</div>
<div class="Block">
...
<input type="button" name="add" id="addbutton" value="Ok" class="button"
	onClick="submitForm('dailyDoctorWise','medicalExam?method=generatependingMedicalBoardReport','check()','checkTargetForYes');"
