		...
		<div id="divSearchResult">
			...
			<table id="tblSearchResultsHeader" class="tblSearchResultsHeader"
				...
				<tr>
					...
					<th id="th4" style='width: 120px;'>Marital Status</th>					
				    <th id="th4" style='width: 120px;'>Ward Name</th>	
				    <th id="th4" style='width: 120px;'>Bed No</th>	
...
<script language="javascript">
	...
	function GetPatientList(MODE) {
		...
		var paymentStatus = $j("#paymentStatus").val();
		var deductionFS = $j("#deductionFS").val(); */

		if (MODE == 'ALL') {
			var data = "PN=" + nPageNo;
		} else {
			var data = "PN=" + nPageNo + "&impHospitalId=" + impHospitalId+"&empNo="+empNo+"&rankCategoryId="+rankCategoryId+"&divisionId="+divisionId+"&paymentStatus="+paymentStatus+"&deductionFS="+deductionFS;
		}
		var url = "referral?method=getInpatientStatus";
	...
	function makeTable(jsonData) {
		...
		for (i = 0; i < jsonData.length; i++) {
			...
			htmlTable = htmlTable + "<td >" + jsonData[i].maritalStatus + "</td>";
			htmlTable = htmlTable + "<td >" + jsonData[i].ward + "</td>"; 
			
			htmlTable = htmlTable + "<td >" + jsonData[i].bed + "</td>";
