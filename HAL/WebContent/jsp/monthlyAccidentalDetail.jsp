...
%>
<h6>Monthly Accidental Detail</h6>
<div class="Clear"></div>

<form name="monthlyAccidentalDetail" target="_blank" method="post" action="">
<div class="Block">
...
<input	type="text" id="fromDateId" name="<%=FROM_DATE %>" 
	...
	class="calender"
	onClick="setdate('<%=currenDate %>',document.monthlyAccidentalDetail.<%=FROM_DATE%>,event)" />
...
<label> To Date<span>*</span> </label> <input type="text" id="ToDateId"
	...
	onClick="setdate('<%=currenDate %>',document.monthlyAccidentalDetail.<%=TO_DATE%>,event)" />
<div class="Clear"></div>
</div>
<div class="Clear"></div>
<input type="button" name="OK" value="Ok" class="button"
onClick="submitForm('monthlyAccidentalDetail','mis?method=printMonthlyAccidentalDetailReport');" />
