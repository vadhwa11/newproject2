...
<script type="text/javascript">
	$(document).ready(function() {
		$('#StudentTableContainer').jtable({
            ...
            actions: {
                listAction: '/hms/hms/pacs?method=pacsUtilforRadiologyReport&action=list<%=map.get("gsonURL")%>',
                createAction:'Controller?action=create',
                updateAction: '/hms/hms/pacs?method=pacsUtilforRadiologyReport&action=search',
                deleteAction: '/hms/hms/pacs?method=pacsUtilforRadiologyReport&action=search'
            },
			fields : {
				patientId : {
					title : 'Reg No',
...
<div class="titleBg">
<h2>Radiology Report (XRAY, CT, USG)</h2>
</div>	
...
function openPopupForPatientPacsViewReport(patientId){ 
...
function openPopupForPatientPacsCommunicationForDoctor(patientId){ 
