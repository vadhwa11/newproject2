...
if(map.get("patientInvestigationHeader")!=null){
	...
	//System.out.println(" patientInvestigationdetails  size--"+patientInvestigationdetails.size());
}
...
<div>
<!--<input	name="investigationTemplate" type="button"	value="Previous Visits" tabindex="1" class="buttonBig2" onClick="submitForm('medicalBoardExamAAuthority','opd?method=showPatientPreviousVisitForViewScreen&visitId=<%=visit.getId()%>&visitNo=<%=visit.getVisitNo()%>&<%=HIN_ID%>=<%=visit.getHin().getId()%>&token=<%=visit.getTokenNo()%>');"" />
-->
...
<input	name="investigationTemplate" type="button"	value="Previous Medical Exams" tabindex="1" class="buttonBig2" onClick="submitForm('medicalBoardExamAAuthority','medicalExam?method=getPrevMedExamFromHIC&serviceNo=<%=visit.getHin().getServiceNo() %>');" />
<input	name="investigationTemplate" type="button"	value="Previous Medical Boards" tabindex="1" class="buttonBig2" onClick="submitForm('medicalBoardExamAAuthority','medicalExam?method=getPrevMedBoardFromHIC&visitId=<%=visit.getId()%>&visitNo=<%=visit.getVisitNo()%>&<%=HIN_ID%>=<%=visit.getHin().getId()%>&serviceNo=<%=visit.getHin().getServiceNo() %>');"" />
<input	name="investigationTemplate" type="button"	value="Previous Hospitalizations" tabindex="1" class="buttonBig2" onClick="submitForm('medicalBoardExamAAuthority','opd?method=showPatientPreviousVisitForHospitality&visitId=<%=visit.getId()%>&visitNo=<%=visit.getVisitNo()%>&<%=HIN_ID%>=<%=visit.getHin().getId()%>');"" />
...
<input type="hidden" name="hin_id" value="<%=visit.getHin().getId()%>"  readonly="readonly" />
</div>
<br/>
<br/>
<br/>
...
<form name="medicalBoardExamAAuthority" action="" method="post">
<div class="Block">
...
<input tabindex="1" type="text"  class="" id="" readonly="readonly" name="<%=AUTHORITY_OF_BOARD %>"maxlength="15" value="<%=medExamObj.getAuthority() %>"
	onKeyUp="limitText(this,100);"  />

 <% }else{%>
<input tabindex="1" type="text"  class="" id="" readonly="readonly" name="<%=AUTHORITY_OF_BOARD %>" maxlength="15"
	onKeyUp="limitText(this,100);"  />
...
<%}else{%>
 ...
 <textarea cols="20" rows="2" disabled="disabled" tabindex="1" maxlength="200" name="<%=PAST_MEDICAL_HISTORY%>" tabindex="2"
 onkeyup="chkLength(this,199);" onpaste="return checkOnPaste(this)"	oninput="return checkMaxLengthMoz(this)"	onKeyDown="return checkMaxLength(this)"><%=medExamObj.getPastmedicalhistory() %></textarea>

 <% }else{%>
 <textarea cols="20" rows="2" disabled="disabled" tabindex="1" maxlength="200" name="<%=PAST_MEDICAL_HISTORY%>" tabindex="2"
 onkeyup="chkLength(this,199);" onpaste="return checkOnPaste(this)"	oninput="return checkMaxLengthMoz(this)"	onKeyDown="return checkMaxLength(this)"></textarea>
 ...
 <select name="<%= PRESENT_MEDICAL_CATEGORY %>"	validate="Signed By,string,no" tabindex=1 disabled="disabled">
 ...
 <input	type="text" maxlength="100" readonly="readonly" value="<%=medExamObj.getLastame() %>" name="<%=LAST_AME%>"	tabindex="1" />
 <% }else{%>
<input	type="text" maxlength="100" readonly="readonly" value="" name="<%=LAST_AME%>"	tabindex="2" />
 <% }%>
...
if(medExamObj.getRemarksTeath()!=null){%>
 <textarea rows="" cols="60"	name="<%=DENTAL_REMARKS %>" disabled="disabled" class="auto" maxlength="299" onkeyup="chkLength(this,299);" value="<%=medExamObj.getRemarksTeath() %>"
 ...
 <% }else{%>
 <textarea rows="" cols="60"	name="<%=DENTAL_REMARKS %>" disabled="disabled" class="auto" onkeyup="chkLength(this,299);" maxlength="299"
...
<input tabindex="1" type="text"  id="<%=BODY_FAT %>" name="<%=BODY_FAT %>"maxlength="10" value="<%=medExamObj.getBodyfat() %>"
 readonly="readonly"	onKeyUp="limitText(this,6);" class="auto" size="10" />

 <% }else{%>
<input tabindex="1" readonly="readonly" type="text"  id="<%=BODY_FAT %>" name="<%=BODY_FAT %>" maxlength="10"
...
<input tabindex="1" type="text" readonly="readonly" name="<%=WITH_GLASSES_NEAR_L %>" maxlength="5" />
 ...
 <input tabindex="1" type="text" readonly="readonly" 	name="<%=WITH_GLASSES_NEAR_CP %>" maxlength="5" value="<%=medExamObj.getNearVisionWithGlassCp()%>"/>
 <% }else{%>
<input tabindex="1" type="text" readonly="readonly"	name="<%=WITH_GLASSES_NEAR_CP %>" maxlength="5" />
 <% }%>
 </td>	--%>
...
<td>
 <% if(medExamObj.getHearingLcv() != null){ %>
	  <input tabindex="1" type="text" readonly="readonly" class="auto" size="10" maxlength="10"  id="hlcv" name="<%=HEARING_L_C_V %>" value="<%= medExamObj.getHearingLcv() %>" onkeyup="isNumber1(this)" maxlength="5" onblur="checkForWiegth(this.value,id);" />	  <%}else{ %>
...
<td>
 <% if(medExamObj.getMobilityR() != null){ %>
	  <input tabindex="1" type="text" readonly="readonly" class="auto" size="10" name="<%=MOBILITYR %>" maxlength="20"  value="<%= medExamObj.getMobilityR()  %>"  />


<%}else{ %>
 <input tabindex="1" type="text" value="Normal" class="auto" readonly="readonly" size="10" name="<%=MOBILITYR %>"  maxlength="20"  />
...
<input tabindex="1" type="text" readonly="readonly" class="auto" size="10" name="<%=MOBILITYL %>" maxlength="20"  value="<%= medExamObj.getMobilityL()  %>"  />
<%}else{ %>
 <input tabindex="1" type="text" value="Normal" readonly="readonly" class="auto" size="10" name="<%=MOBILITYL %>"  maxlength="20"  />
<%} %>
</td>
</table>
...
<label>Nose, Throat &amp; Sinuses</label>
	  ...
	  <input tabindex="1" type="text" readonly="readonly" class="auto" size="21" maxlength="20"  id="bothcv" name="<%=NOSE_THROAT %>" value="<%= medExamObj.getNosethroat()  %>"  />

<%}else{ %>
 <input tabindex="1" type="text" readonly="readonly" class="auto" size="21"  id="bothcv" name="<%=NOSE_THROAT %>"  maxlength="20" value="NAD" />

<%} %>

<label>Audiometry Record</label>
	  	 <% if(medExamObj.getAudiometryRecord() != null){ %>
	  <input tabindex="1" type="text" readonly="readonly" class="auto" size="19" maxlength="20"  id="bothcv" name="<%=AUDIOMETRY_RECORD %>" value="<%= medExamObj.getAudiometryRecord()  %>"  />
<%}else{ %>
 <input tabindex="1" type="text" readonly="readonly" class="auto" size="19"  id="bothcv" name="<%=AUDIOMETRY_RECORD %>"  maxlength="20"  />
<%} %>
...
<% if(medExamObj.getBp()!=null){%>
  <input tabindex="1" type="text" maxlength="7" readonly="readonly"  name="<%=BP1%>" class="autoArial" size="17"   value="<%=medExamObj.getBp() %>"/>
 <label class="unit2">mm Hg</label>
 <% }else{%>
 <input tabindex="1" type="text" maxlength="7" readonly="readonly" name="<%=BP1%>" class="autoArial" size="17"  value="Normal" />
 <label class="unit2">mm Hg</label>
 <% }%>
...
<input tabindex="1" type="text" maxlength="50" readonly="readonly"	name="<%= ARTERIAL_WALLS%>" class="autoArial" size="20"   value="<%=medExamObj.getArterialWalls() %>"/>
 <% }else{%>
 <input tabindex="1" type="text" maxlength="50" readonly="readonly"	name="<%= ARTERIAL_WALLS%>" class="autoArial" size="20"  value="Normal" />
 <% }%>
...
<input tabindex="1" type="text" maxlength="17" readonly="readonly" 	name="<%= HEART_SIZE%>" class="autoArial" size="27" maxlength="50" value="<%=medExamObj.getHeartSize() %>"/>

 <% }else{%>
<input tabindex="1" type="text" maxlength="17" readonly="readonly"	name="<%= HEART_SIZE%>" class="autoArial" size="27" maxlength="50" value="Normal" />
 ...
 <input tabindex="1" type="text" maxlength="50" readonly="readonly" name="<%= SOUND%>" class="autoArial"	size="27"  value="<%=medExamObj.getSounds() %>"/>

 <% }else{%>
 <input tabindex="1" type="text" maxlength="50" readonly="readonly" name="<%= SOUND%>" class="autoArial"	size="27" value="Normal"  />
...
<% if(medExamObj.getRhythm()!=null){%>
 <input tabindex="1" type="text" maxlength="50" readonly="readonly" name="<%= RHYTHM%>" class="autoArial"	size="20"  value="<%=medExamObj.getRhythm() %>"/>

 <% }else{%>
 <input tabindex="1" type="text" maxlength="50" readonly="readonly" name="<%= RHYTHM%>" class="autoArial"	size="20"  value="Regular" />
 <% }%>
...
<% if(medExamObj.getRespiratorySystem()!=null){%>
  <input tabindex="1" type="text" maxlength="50" readonly="readonly"	name="<%=RESPIRATORY_SYSTEM %>" class="auto" size="120"  value="<%=medExamObj.getRespiratorySystem() %>"/>
   <% }else{%>
  <input tabindex="1" type="text" maxlength="50" readonly="readonly"	name="<%=RESPIRATORY_SYSTEM %>" class="auto" size="120"  />
 <% }%>
...
<% if(medExamObj.getLiver()!=null){%>
  <input tabindex="1" type="text" readonly="readonly" 	name="liver" class="auto" size="120" maxlength="50" value="<%=medExamObj.getLiver() %>"/>
   <% }else{%>
  <input tabindex="1" type="text" readonly="readonly"	name="liver" class="auto" size="120" maxlength="50" value="Not Palpable"/>
 <% }%>
<div class="clear"></div>
<label> Spleen</label>
<% if(medExamObj.getSpleen()!=null){%>
  <input tabindex="1" type="text" readonly="readonly"	name="spleen" class="auto" size="120" maxlength="50" value="<%=medExamObj.getSpleen() %>"/>
   <% }else{%>
  <input tabindex="1" type="text" readonly="readonly"	name="spleen" class="auto" size="120" maxlength="50" value="Not Palpable"/>
 <% }%>
...
<input tabindex="1" type="text" maxlength="50" readonly="readonly"	name="<%=HIGHER_MENTAL_FUNCTION %>"   value="<%=medExamObj.getHigherMentalFunction() %>"/>
   <% }else{%>
<input tabindex="1" type="text" maxlength="50" readonly="readonly"	name="<%=HIGHER_MENTAL_FUNCTION %>"   value="Normal"/>
 <% }%>

<label > Speech</label>
<% if(medExamObj.getSpeech()!=null){%>
<input tabindex="1" type="text" name="<%=SPEECH %>" readonly="readonly" maxlength="50" value="<%=medExamObj.getSpeech() %>"/>
   <% }else{%>
<input tabindex="1" type="text" readonly="readonly"	name="<%=SPEECH %>"  maxlength="50" value="Normal"/>
 <% }%>


<label > Reflexes</label>
<% if(medExamObj.getReflexes()!=null){%>
<input tabindex="1" type="text" name="<%=REFLEXES %>" readonly="readonly"  maxlength="50" value="<%=medExamObj.getReflexes() %>"/>
   <% }else{%>
<input tabindex="1" type="text" name="<%=REFLEXES %>" readonly="readonly"  maxlength="50" value="Normal"/>
 <% }%>
...
<input tabindex="1" type="text" name="locomoterSystem" readonly="readonly" class="" size="20" maxlength="50" value="<%=medExamObj.getLocomoterSystem() %>"/>
   <% }else{%>
<input tabindex="1" type="text" name="locomoterSystem" readonly="readonly" class="" size="20" maxlength="50" value="NAD"/>
 <% }%>
<label>Spine</label>
<% if(medExamObj.getSpine()!=null){%>
<input tabindex="1" type="text" name="spine" class="" readonly="readonly" size="20" maxlength="50" value="<%=medExamObj.getSpine() %>"/>
   <% }else{%>

<input tabindex="1" type="text" name="spine" class="" readonly="readonly" size="20" maxlength="50" value="NAD"/>
 <% }%>


<label>Hernia</label>
<% if(medExamObj.getHerniaMusic()!=null){%>
<input tabindex="1" type="text"  name="<%=HERNIA_MUSCLE %>" readonly="readonly" class="" size="20" maxlength="50" value="<%=medExamObj.getHerniaMusic() %>"/>
   <% }else{%>

<input tabindex="1" type="text" name="<%=HERNIA_MUSCLE %>" readonly="readonly" class="" size="20" maxlength="50" value="Nil"/>
 <% }%>
...
<input tabindex="1" type="text" name="<%=HYDROCELE %>" readonly="readonly" class="" size="20" maxlength="50" value="<%=medExamObj.getHydrocele() %>"/>
   <% }else{%>

<input tabindex="1" type="text" name="<%=HYDROCELE %>" class="" readonly="readonly" size="20" maxlength="50" value="Nil"/>
 <% }%>


<label>Haemorrhoids</label>
<% if(medExamObj.getHemorrhoids()!=null){%>
<input tabindex="1" type="text" name="<%=HEMONHOIDS %>" readonly="readonly" class="" size="20" maxlength="50" value="<%=medExamObj.getHemorrhoids() %>"/>
   <% }else{%>
<input tabindex="1" type="text" name="<%=HEMONHOIDS %>" readonly="readonly" class="" size="20" maxlength="50" value="Nil"/>
 <% }%>


<label>Breast</label>
<% if(medExamObj.getBreasts()!=null){%>
<input tabindex="1" type="text" name="<%=BREASTS %>" readonly="readonly" class="" size="20" maxlength="50" value="<%=medExamObj.getBreasts() %>"/>
   <% }else{%>
<input tabindex="1" type="text" name="<%=BREASTS %>" readonly="readonly" class="" size="20" maxlength="50" value="NAD"/>
 <% }%>
...
<input tabindex="1" type="text" maxlength="50" readonly="readonly"	name="<%=MENSTRUAL_HISTORY %>" class="auto" size="20" value="<%=medExamObj.getMenstrualHistory() %>"/>
   <% }else{%>
<input tabindex="1" type="text" maxlength="50" readonly="readonly"	name="<%=MENSTRUAL_HISTORY %>" class="auto" size="20"  />
 <% }%>
...
<input tabindex="1" type="text" readonly="readonly"	name="<%=VAGINAL_DISCHARGE %>" class="auto" size="20" maxlength="50" value="<%=medExamObj.getVaginalDischarge() %>"/>
   <% }else{%>
<input tabindex="1" type="text" readonly="readonly"	name="<%=VAGINAL_DISCHARGE %>" class="auto" size="20" maxlength="50" />
 <% }%>


<label	>Prolapse</label>
<% if(medExamObj.getProlapse()!=null){%>
<input tabindex="1" type="text" readonly="readonly"	name="<%=PROLAPSE %>" class="calDate" size="20" maxlength="50" value="<%=medExamObj.getProlapse() %>"/>
   <% }else{%>
<input tabindex="1" type="text" readonly="readonly"	name="<%=PROLAPSE %>" class="calDate" size="20" maxlength="50" />
 <% }%>


<label >USG Abdomen</label>
<% if(medExamObj.getUsgAbdomen()!=null){%>
<input tabindex="1" type="text" readonly="readonly" name="<%=USG_ABORTION %>" class="calDate" size="20" maxlength="50" value="<%=medExamObj.getUsgAbdomen() %>"/>
   <% }else{%>
<input tabindex="1" type="text" readonly="readonly" name="<%=USG_ABORTION %>" class="calDate" size="20" maxlength="50" />
 <% }%>
<div class="clear"></div>
 <input size="145" class="transparent" />
...
<input tabindex="2" type="text" maxlength="50" 	name="<%=CORONORY_RISK_FACTOR %>"  size="20" maxlength="50"
	value="<%=medExamObj.getCoronaryRiskFactor() %>" readonly="readonly"/>
   <% }else{%>
<input tabindex="2" type="text" maxlength="50" 	name="<%=CORONORY_RISK_FACTOR %>" size="20" maxlength="50"
readonly="readonly"/>
 <% }%>
...
<%}else{ %>
<input type="checkbox" name="smokerLess10" value="" class="radioAuto2" readonly="readonly" disabled="disabled"/>
<%} %>
<label class="auto">>10</label>
<%if(smokerMore10.equalsIgnoreCase("y")){ %>
 ...
 <label>Alcohol</label> <select name="alcohol"
	id="<%=COVER_TEST %>" value="<%=medExamObj.getHin().getAlcohol() %>" tabindex="1" disabled="disabled">
...
<input tabindex="1" type="text"  maxlength="100" readonly="readonly" id="remarks"	name="<%=MEDICIN_REMARKS %>" class="Auto" size="20"  value="<%=medExamObj.getRemarks() %>"/>
   <% }else{%>
...
<input tabindex="1" type="text" name="aaFinalObservation" value="<%=medExamObj.getAprovAuthFinalObservation() %>"   size="20" maxlength="100" />
  <% }else{%>
 <input tabindex="1" type="text" name="aaFinalObservation" value=""  size="20" maxlength="100" />
...
<label >Signed By</label>
<input tabindex="1" type="text" name="aaSignedBy"  size="20" maxlength="100" value="<%=signedByAA%>"  readonly="readonly"/>
<%--
<%
String sendTo="";
//System.out.println("Exam Type 1=====>"+medExamObj.getMedicalExamType());
if(medExamObj.getMedicalExamType().equalsIgnoreCase("Annual Medical Exam(AFMSF-3B)"))
{
	//System.out.println("Exam Type 2=====>"+medExamObj.getMedicalExamType());
	//System.out.println("medExamObj.getHin().getRank().getRankCategory()=====>"+medExamObj.getHin().getRank().getRankCategory().getRankCategoryCode());
	//System.out.println("medExamObj.getHin().getRank().getRankName()=====>"+medExamObj.getHin().getRank().getRankName());
...
%>
<label >Send To</label>
<input tabindex="1" type="text" name="aaSendTo" value="<%=sendTo %>" size="20" maxlength="100" />
...
<%
  if(medExamObj.getPerAuthRemarks()!=null){
  		%>
  <div class="clear paddingTop15"></div>
<h4>Rejection Remark By Perusing Authority</h4>
<div class="clear"></div>

<div class="Block">
<label >Final Observation</label>
<% if(medExamObj.getPerFinalObservation()!=null){%>
<input tabindex="1" type="text" readonly="readonly" name="paFinalObservation" value="<%=medExamObj.getPerFinalObservation() %>"  size="20" maxlength="100" />
<% }else{%>
<input tabindex="1" type="text" readonly="readonly" name="paFinalObservation"  size="20" maxlength="100" />
<% }%>
<label >Remarks</label>
<% if(medExamObj.getPerAuthRemarks()!=null){%>
<textarea cols="20" rows="2" tabindex="1" maxlength="100" name="paRemarks" tabindex="1" readonly="readonly"
onkeyup="chkLength(this,99);" onpaste="return checkOnPaste(this)"	oninput="return checkMaxLengthMoz(this)"	onKeyDown="return checkMaxLength(this)"><%=medExamObj.getPerAuthRemarks() %></textarea>
<% }else{%>
<textarea cols="20" rows="2" tabindex="1" maxlength="100" name="paRemarks" tabindex="1" readonly="readonly"
...
<input tabindex="1" name="Button"	type="button" class="button" value="VALIDATE"	onClick="submitForm('medicalBoardExamAAuthority','medicalExam?method=validateMedExamApprovingAuthority');" />
<input tabindex="1" name="Button"	type="button" class="button" value="REJECT"	onClick="if(checkRemarksAA()){submitForm('medicalBoardExamAAuthority','medicalExam?method=rejectMedExamAA');}" />
...
function fileViewForSpecialistOpinion()
{
	  ...
	  var url="/hms/hms/medicalExam?method=viewUploadDocumentsDetails&hinId=<%=medExamObj.getHin().getId()%>&visitId=<%=medExamObj.getVisit().getId()%>&masExam_Id=<%=medExamObj.getId()%>&folderName=specialistOpinion&flagForm=appExam";
...
function isNumber(field) {
 ...
 else
 {
  ...
  function jsViewDocument(rowVal)
  {
  	...
  	//	alert("hearin ===>"+folderName)
     //    document.medicalBoardExaminationAnnual.method="post";

       //  submitForm('medicalBoardExaminationAnnual','medicalExam?method=viewUploadDocumentsDetailsInvest&hinId='+hin_id+'&InvestId='+invest_id+'&hinNo='+hinNo+'&masExamId='+masExamId);
  ...
  function jsViewFileUploadWindow()
  {
	...
	var url="/hms/hms/medicalExam?method=viewUploadDocumentsDetails&hinId=<%=medExamObj.getHin().getId()%>&visitId=<%=medExamObj.getVisit().getId()%>&masExam_Id=<%=medExamObj.getId()%>&folderName=hearing&flagForm=appExam&flagForm=appExam";
