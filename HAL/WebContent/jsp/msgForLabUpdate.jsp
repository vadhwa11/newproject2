...
%> <input type="button" name="yes" value="Yes" class="button"
	onclick="submitForm('messageLab','/hms/hms/lab?method=printOrderBooking&hinNo=<%=hinNo %>&visitNo=<%=visitNo %>&orderNo=<%=orderNo %>','checkTargetForYes');" />
<input type="button" name="no" value="No" class="button"
	onclick="submitForm('messageLab','/hms/hms/lab?method=showOpOrderBookingSearchJsp','checkTargetForNo');" />
<input type="button" name="UpdateOrder" value="Update Order"
	class="button"
	onclick="submitForm('messageLab','/hms/hms/lab?method=getUpdatableOrderListJsp');" />
