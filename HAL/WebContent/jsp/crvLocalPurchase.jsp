...
<input type="text" name="supplyType"  id="supplyType" value="l">
...
<select name="proformaNo" id="indentCombo" tabindex=1  onchange="submitProtoAjaxforProformaNo('grnGrid','/hms/hms/stores?method=responseProformaList');">
...
<select	name="<%=RequestConstants.SUPPLIER_ID %>" id="supplierCombo"	validate="Vendor Name, String ,yes"  tabindex=1>
	<option value="">Select</option>	
</select>
