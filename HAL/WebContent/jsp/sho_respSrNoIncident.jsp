...
<input type="text" name="<%=DATE %>" value="<%=HMSUtil.changeDateToddMMyyyy(flyingIncident.getFlyingDate()) %>" MAXLENGTH="20" class="date" id="toAppDate" validate="Date,string,yes" tabindex="1"/>
<%}else{ %>
<input type="text" name="<%=DATE %>" value="<%=currentDate %>" MAXLENGTH="11" class="date" id="toAppDate" validate="Date,string,yes" tabindex="1"/>
<%} %>
...
<div class="clear"></div>
<Label>Rank</Label>
<select	id="<%=RANK_ID %>" name="<%=RANK_ID %>"	validate="rank,string,no" tabindex="1">
...
<label>Gender</label>
	<select	id="<%=SEX_ID %>" name="<%=SEX_ID %>"	validate="Gender,string,no" tabindex="1">
...
<select	id="<%=AIRCRAFT_TYPE_ID %>" name="<%=AIRCRAFT_TYPE_ID %>"	validate="Aircraft Type,string,no" tabindex="1">
<option value="0">Select</option>
...
<input class="transparent" size="8" />
<label>Date</label>
<input type="text" name="<%=DATE %>" value="<%=currentDate %>" MAXLENGTH="20" class="date" id="toAppDate" validate="Date,string,yes" tabindex="1"/>
...
<label>Gender</label>
<select name="<%=SEX_ID %>" id="sexId" validate=" Gender,string,no" tabindex="1">
	<%
