...
<select name="<%=HIN_ID %>" validate="Admission Number,,yes"
	onclick="submitProtoAjaxWithDivName('notifiableDisease','mis?method=getHinAdNoForND&flag=admission','testDiv');">
...
<%}else{ %>
<label class="bodytextB">Ad No: </label>
<select name="<%=AD_NO%>" validate="Admission Number,,yes"
	onclick="submitProtoAjaxWithDivName('notifiableDisease','mis?method=showFatalCase','show');">
	<option value="">Select</option>
