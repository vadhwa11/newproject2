...
<input tabindex="1" type="text"  id="" name="<%=AUTHORITY_OF_BOARD %>"maxlength="20" value="<%=medExamObj.getAuthority() %>"
	onKeyUp="limitText(this,20);"  />

 <% }else{%>
<input tabindex="1" type="text"  id="" name="<%=AUTHORITY_OF_BOARD %>" maxlength="20" 
	onKeyUp="limitText(this,20);"  />
...
<input tabindex="1" type="text" maxlength="20"  id="" name="<%=PLACE %>" value="<%=medExamObj.getPlace() %>"
	onKeyUp="limitText(this,20);"  />
...
<input tabindex="1" type="text" maxlength="20"  id="" name="<%=FULL_NAME %>" value="<%=medExamObj.getNameInFull() %>"
	onKeyUp="limitText(this,20);"  />

 <% }else{%>
<input tabindex="1" type="text" maxlength="20"  id="" name="<%=FULL_NAME %>" 
	onKeyUp="limitText(this,20);"  />
...
<input tabindex="1" type="text" maxlength="20"  id="" name="<%=SERVICE_NO %>"maxlength="6" value="<%=medExamObj.getServiceNo() %>"
	onKeyUp="limitText(this,6);"  />

 <% }else{%>
<input tabindex="1" type="text" maxlength="20"  id="" name="<%=SERVICE_NO %>" maxlength="6" 
	onKeyUp="limitText(this,6);"  />
...
<img src="/hms/jsp/images/cal.gif" width="16" height="16" border="0"
 ...
 <input type="text" maxlength="20" 	 name="<%=UNIT %>" tabindex="2" value="<%=medExamObj.getUnit().getUnitName() %>"/>
 <input type="hidden" value="<%=medExamObj.getUnit().getId() %>" name="<%=UNIT_ID%>"	tabindex="2" />
 <% }else{%>
 <input type="text" maxlength="20" 	 name="<%=UNIT %>" tabindex="2" />
 <% }%>
 
 <div class="clear"></div>
 <label>Service IAF  </label> 
 <% if(medExamObj.getServiceiaf()!=null){%>
 <input type="text" maxlength="20" 	 name="serviceiaf" tabindex="2" value="<%=medExamObj.getServiceiaf() %>"/>
...
<label>Branch/Trade  </label> 
 ...
 <input	type="text" maxlength="20"  value="<%=medExamObj.getTotalService() %>" name="<%=TOTAL_SERVICE%>"	tabindex="2" />
...
<input tabindex="1" type="text" maxlength="20"  id="" name="<%=IDENTIFICATION_MARKS1 %>" value="<%=medExamObj.getIdentificationMarks1() %>"
	onKeyUp="limitText(this,20);"  size="70" class="auto" />

 <% }else{%>
<label class="valueAuto">1.)</label>
<input tabindex="1" type="text" maxlength="20"  id="" name="<%=IDENTIFICATION_MARKS1 %>" 
	onKeyUp="limitText(this,20);" size="70" class="auto" />
...
<input tabindex="1" type="text" maxlength="20"  id="" name="<%=IDENTIFICATION_MARKS2 %>" value="<%=medExamObj.getIdentificationMarks2() %>"
	onKeyUp="limitText(this,20);" size="70" class="auto" />

 <% }else{%>
<label class="valueAuto">2.)</label>
<input tabindex="1" type="text" maxlength="20"  id="" name="<%=IDENTIFICATION_MARKS2 %>" 
	onKeyUp="limitText(this,20);" size="70" class="auto" />
...
<h4> PERSONAL STATEMENT SERVICE DETAILS <a href="javascript:animatedcollapse.toggle('slide2')">(Click Here)</a></h4>
<div class="clear"></div>
<div id="slide2">
<div class="cmntable">
...
<td width="10%"><input size="2" tabindex="1" type="text"	name="<%=SIRIAL_NO+inc1 %>" maxlength="3" value="<%=setMedicalExam.getSerialno() %>"/></td>
  <% }else{%>
<td width="10%"><input size="2" tabindex="1" type="text"	name="<%=SIRIAL_NO+inc1 %>" maxlength="10" /></td>
 <% }%>
...
<td width="10%"><input tabindex="1" size="2" type="text"	name="<%=SIRIAL_NO1+inc11 %>" maxlength="3" value="<%=setMedicalExam.getSerialNo1() %>"/></td>
  <% }else{%>
<td width="10%"><input tabindex="1" size="2" type="text"	name="<%=SIRIAL_NO1+inc11 %>" maxlength="3" /></td>
 <% }%>
...
<select name="<%=DISABILITY %>" size="0" tabindex="1" id="disabilitypension" class="small">
	<option value="0">select</option>
...
<input	tabindex="1" name="<%=UPLOADED_DATE %>" id="uploadeddate" class="date" 	validate="DOB,date,no" maxlength="10"
 ...
 <img src="/hms/jsp/images/cal.gif" width="16" height="16" border="0"
	validate="Pick a date" class="calender" 
	onclick="setdate('',medicalBoardExaminationReleaseDischarge.<%=UPLOADED_DATE%>,event);" />
<div class="clear"></div> 

	
<label > Disability Attributable <br /><span class="sublabel">(to service)</span></label> 
<select name=<%=DISABILITY%> size="0" tabindex="1" id="disability" class="small">
	<option value="0">select</option>
	<option value="Yes">Yes</option>
	<option value="No">No</option>
</select>
...
<select name=<%=AGGRAVATED_SERVICE_LABEL%> size="0" tabindex="1" id="aggravated" class="small">
	<option value="0">select</option>
	<option value="Yes">Yes</option>
	<option value="No">No</option>
</select>
...
<input tabindex="1" type="text"  id="weight" class="date"	name="<%=ACTUAL_WEIGHT %>" maxlength="6" value="<%=medExamObj.getActualweight() %>"
	onKeyUp="limitText(this,6);" onblur="checkForWiegth(this.value,id);calculateBMI();"
...
<input tabindex="1" type="text"  id="<%=IDEAL_WEIGHT %>" name="<%=IDEAL_WEIGHT %>" class="date"	maxlength="6" value="<%=medExamObj.getIdealweight() %>"
	onKeyUp="limitText(this,6);" onblur="checkForWiegth(this.value,id);" /><label class="smallAuto">kg</label>

 <% }else{%>
<input tabindex="1" type="text"  id="<%=IDEAL_WEIGHT %>" name="<%=IDEAL_WEIGHT %>" class="date"	maxlength="6" 
	onKeyUp="limitText(this,6);" onblur="checkForWiegth(this.value,id);" /><label class="smallAuto">kg</label>
...
<input tabindex="1" type="text"  id="hlfw" value="<%=medExamObj.getEarHearingLfw()  %>" name="<%=HEARING_L_F_W%>" onkeyup="isNumber1(this)" maxlength="6" onblur="checkForWiegth(this.value,id);" /> 
	...
	<label>Hearing <br /><span class="sublabel">bothFW(Cms)</span></label> 
...
<%}else{ %>	
	...
	<%} %>
	 ...
	 <% if(medExamObj.getHearingLcv() != null){ %>
	  ...
	  <%} %>
	  <label>Hearing <br /><span class="sublabel">both CV(Cms)</span></label> 
...
<input tabindex="1" type="text" 	name="<%=NO_OF_PREGNANCY %>" class="Auto" size="20" maxlength="3" value="<%=medExamObj.getNoOfPregnancies() %>"/>
   <% }else{%>
<input tabindex="1" type="text" 	name="<%=NO_OF_PREGNANCY %>" class="Auto" size="20" maxlength="3" />
 <% }%>
 
<div class="clear"></div>	
<label >No of Abortions</label>
<% if(medExamObj.getNoOfAbortions()!=null){%>
<input tabindex="1" type="text" 	name="<%=NO_OF_ABORTION %>" class="Auto" size="20" maxlength="3" value="<%=medExamObj.getNoOfAbortions() %>"/>
   <% }else{%>
<input tabindex="1" type="text" 	name="<%=NO_OF_ABORTION %>" class="Auto" size="20" maxlength="3" />
 <% }%>
<label >No. of Children</label> 
<% if(medExamObj.getNoOfChildren()!=null){%>
<input tabindex="1" type="text" 	name="<%=NO_OF_CHILDREN %>" class="Auto" size="20" maxlength="3" value="<%=medExamObj.getNoOfChildren() %>"/>
   <% }else{%>
<input tabindex="1" type="text"  	name="<%=NO_OF_CHILDREN %>" class="Auto" size="20" maxlength="3" />
 <% }%>
...
<input tabindex="1" type="text"  class="calDate"	name="<%=GYANAECOLOGY_DATE%>" maxlength="10"	onKeyUp="mask(this.value,this,'2,5','/');"	validate="Dental Date,date,no" value="<%=HMSUtil.convertDateToStringWithoutTime(medExamObj.getGynaecologyDate()) %>"/> 
   <% }else{%>
<input tabindex="1" type="text"  class="calDate"	name="<%=GYANAECOLOGY_DATE%>" maxlength="10"	onKeyUp="mask(this.value,this,'2,5','/');"	validate="Dental Date,date,no" /> 
 <% }%>


<img src="/hms/jsp/images/cal.gif"	width="16" height="16" border="0" validate="Pick a date"
	class="date"
	onclick="setdate('',medicalBoardExaminationReleaseDischarge.<%=GYANAECOLOGY_DATE%>,event);" />
	
<label >Remarks</label> 
<% if(medExamObj.getRemarksGynaecology()!=null){%>
 <textarea rows="" cols="72"	name="<%=GYANAECOLOGY_RAMARKS %>" class="auto" onkeyup="chkLength(this,300);" value="<%=medExamObj.getRemarksGynaecology() %>"><%=medExamObj.getRemarksGynaecology() %></textarea>

 <% }else{%>
 <textarea rows="" cols="72"	name="<%=GYANAECOLOGY_RAMARKS %>" class="auto" onkeyup="chkLength(this,300);"></textarea>
 <% }%>
...
<input tabindex="1" type="text" maxlength="20"  class="calDate" readonly="readonly " name="<%=DOM %>" maxlength="10"	onKeyUp="mask(this.value,this,'2,5','/');" validate="Dental Date,date,no" value="<%=HMSUtil.convertDateToStringWithoutTime(medExamObj.getDom()) %>"/> 
   <% }else{%>
<input tabindex="1" type="text" maxlength="20"  class="calDate" readonly="readonly " name="<%=DOM %>" maxlength="10"	onKeyUp="mask(this.value,this,'2,5','/');" validate="Dental Date,date,no" />  <% }%>
<img src="/hms/jsp/images/cal.gif"
	width="16" height="16" border="0" validate="Pick a date"
	class="calender"
	onclick="setdate('',medicalBoardExaminationReleaseDischarge.<%=DOM%>,event);" />
...
<input tabindex="1" type="text" maxlength="20" 	name="<%=CORONORY_RISK_FACTOR %>" class="Auto" size="20" maxlength="20" value="<%=medExamObj.getCoronaryRiskFactor() %>"/>
   <% }else{%>
<input tabindex="1" type="text" maxlength="20" 	name="<%=CORONORY_RISK_FACTOR %>" class="Auto" size="20" maxlength="20" />
 <% }%>


<label class="auto">F.M. of DM/Malignancy/HTM/Hyperlypidemia/Arthritis</label> 
<% if(medExamObj.getFmdm()!=null){%>
<input tabindex="1" type="text" maxlength="20" 	name="<%=FM_DM %>" class="Auto" size="20" maxlength="20" value="<%=medExamObj.getFmdm() %>"/>
   <% }else{%>
<input tabindex="1" type="text" maxlength="20" 	name="<%=FM_DM %>" class="Auto" size="20" maxlength="20" />
 <% }%>
<div class="clear"></div>
<label >Any Known Allergy</label> 
<% if(medExamObj.getAllergies()!=null){%>
<input tabindex="1" type="text" maxlength="20" 	name="<%=KNOWN_ALLERGY %>" class="Auto" size="20" maxlength="20" value="<%=medExamObj.getAllergies() %>"/>
   <% }else{%>
<input tabindex="1" type="text" maxlength="20" 	name="<%=KNOWN_ALLERGY %>" class="Auto" size="20" maxlength="20" />
 <% }%>


<label class="medium">Signed By</label> 

<select id="signidBy" value="<%=medExamObj.getSignedBy() %>"	name="<%= SIGNED_BY %>"	validate="Signed By,string,no" tabindex=1>
...
<select id="<%=APPROVED_BY %>"	name="<%= APPROVED_BY %>" 	validate="Approved By,string,no" tabindex=1>
	<option value="">Select</option>
	<%
...
<label class="medium">Send To</label> 

<select name="<%=SEND_TO %>" size="0" tabindex="1" id="sendto">
	<option value="0">select</option>
...
<div class="clear"></div>
<input tabindex="1" name="Button"	type="button" class="button" value="SUBMIT"	onClick="submitForm('medicalBoardExaminationReleaseDischarge','medicalBoard?method=updateMedicalExamEntry');" />
