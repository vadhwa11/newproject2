...
<%
		...
		System.out.println("procedureHeaderId--- "+procedureHeaderId);
	%>
...
<table border="0" align="center" cellpadding="0" cellspacing="0" id="proceduregrid">
	...
	<tr>
		<td>
		<input type="text" name="procedure<%=i %>" id="procedure<%=i %>" value="" tabindex="1" size="80" onblur="if(this.value!=''){getProcedureId(this.value,1);}"/>
		...
		<td>	
			<input	type="text" name="remarks<%=i %>" value="" tabindex="1" id="remarks<%=i %>" size="80" />
			</td>
		<td><input name="Button" type="button" class="buttonAdd" value="" tabindex="1"
			onclick="addProcedureRow();" tabindex="1" /></td>
			<td>
			<input type="button" name="delete" value="" class="buttonDel" onclick="removeRow();" tabindex="1" tabindex="1" />
			</td>
	</tr>
