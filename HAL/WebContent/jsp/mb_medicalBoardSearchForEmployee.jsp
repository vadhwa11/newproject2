...
<form name="medicalBoardProceedingSearchForEmployee1" action=""
	method="post">
<div class="Clear"></div>
...
--><input type="button" name="Search"
	onclick="submitForm('medicalBoardProceedingSearchForEmployee1','medicalBoard?method=searchMedicalBoardProceedingForEmployee');"
	value="Search" tabindex="1" class="cmnButton" accesskey="a" /></form>
</div>
<div class="Clear"></div>
<jsp:include page="searchResultBlock.jsp" />
<div class="Clear"></div>
<form name="medicalBoardProceedingSearchForEmployee" method="post"
	action="">
...
for(MasEmployee patient : patientList){
%>
   data_arr[<%= counter%>] = new Array();
   data_arr[<%= counter%>][0] = <%= patient.getId()%>
   data_arr[<%= counter%>][1] = "<%=patient.getServiceNo()%>"  
   data_arr[<%= counter%>][2] = "<%=patient.getFirstName()%>"
   data_arr[<%= counter%>][3] = "<%=patient.getLastName()%>"
...
%>
formName = "medicalBoardProceedingSearchForEmployee"
start = 0
