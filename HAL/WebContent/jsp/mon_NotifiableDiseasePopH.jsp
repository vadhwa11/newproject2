...
function check(){
var SDate = document.mon_NotifiableDiseaseH.<%= FROM_DATE%>.value;
var EDate = document.mon_NotifiableDiseaseH.<%= TO_DATE %>.value;
...
%>
<form name="mon_NotifiableDiseaseH" method="post" action="" >
...
<a	href="javascript:setdate('<%=f%>',document.mon_NotifiableDiseaseH.<%=FROM_DATE%>,true)">
...
<a href="javascript:setdate('<%=t%>',document.mon_NotifiableDiseaseH.<%=TO_DATE%>,true)">
<img src="/hms/jsp/images/cal.gif" width="16" height="16" border="0" validate="Pick a date" class="calender" /> </a> 
...
{
	submitForm('mon_NotifiableDiseaseH','/hms/hms/monitoring?method=printNotifiableDiseaseReport');
}
</script>