...
<script type="text/javascript">
	...
	function showJSP(formName)
	{
  		...
  		obj.action = "/hms/hms/opd?method=viewGastroEnterologyColonoscopy&flag=prev&viewScreen=no";
 		obj.submit();
	}
...
if((b1=="0")&&(b2=="")&&(b3=="")&&(b4=="")&&(b5=="")&&(b6=="")&&(b7=="")&&(b8=="")&&(b9==""))
{
...
<%
	...
	if(map.get("opdGastroEnterologyColonoscopy")!=null){
		opdGastroEnterologyColonoscopy = (OpdGastroEnterologyColonoscopy)map.get("opdGastroEnterologyColonoscopy");
	}
...
<form name="gastroEnterologyColonoscopy" action="" method="post">
...
<%}else{ %> <label class="valueNoWidth">-</label> <%} %> <label
	class="medium">ECHS No. </label> <%if(visit.getHin().getEchsNo()!= null){ %>
...
<!--Block one Ends--> <%
	...
	readonly="readonly" /> 
<%if(opdGastroEnterologyColonoscopy!=null){ %>
<input type="hidden" value="<%=opdGastroEnterologyColonoscopy.getId()%>" name="opdGastroEnterologyColonoscopyId" />
<%}else{ %>
<input type="hidden" value="0" name="opdGastroEnterologyColonoscopyId" />
<%} %>
<label class="common">Report Date</label>
<%if(opdGastroEnterologyColonoscopy!=null && opdGastroEnterologyColonoscopy.getReportDate()!=null){ %>
<label class="valueNoWidth"><%=HMSUtil.convertDateToStringWithoutTime(opdGastroEnterologyColonoscopy.getReportDate()) %></label>
<%}else{ %>
<label class="valueNoWidth"><%=date %></label>
<%} %>
<div class="Clear"></div>
<label class="common">Refered By </label>
<select id="b1" name="<%=EMPLOYEE_ID %>" validate="Refered By,string,no">
	<option value="0">Select</option>
	<%for (MasEmployee masEmployee : employeeList) {
	    if(opdGastroEnterologyColonoscopy!=null && opdGastroEnterologyColonoscopy.getReferredBy().getId().equals(masEmployee.getId()) ){
	%>
...
<%} %>
<div class="Clear"></div>
<label class="common">AnalCanal</label>
<%if(opdGastroEnterologyColonoscopy != null && opdGastroEnterologyColonoscopy.getAnalCanal()!=null){ %>
<input type="text" value="<%=opdGastroEnterologyColonoscopy.getAnalCanal()%>" class="large" name="<%=ANAL_CANCAL %>" id="b2" maxlength="30" />
<%}else{ %>
<input type="text" value="NORMAL" class="large" name="<%=ANAL_CANCAL %>" id="b2" maxlength="30" />
<%} %>
<div class="Clear"></div>

<label class="common">Rectum</label>
<%if(opdGastroEnterologyColonoscopy != null && opdGastroEnterologyColonoscopy.getRectum()!=null){%>
<input type="text" value="<%=opdGastroEnterologyColonoscopy.getRectum()%>" class="large" name="<%=RECTUM %>" id="b3" maxlength="30" />
<%}else{ %>
<input type="text" value="" class="large" name="<%=RECTUM %>" id="b3" maxlength="30" />
<%} %>
<div class="Clear"></div>

<label class="common">Sigmoid</label>
<%if(opdGastroEnterologyColonoscopy != null && opdGastroEnterologyColonoscopy.getSigmoid()!=null){%>
<input type="text" value="<%=opdGastroEnterologyColonoscopy.getSigmoid() %>" class="large" name="<%=SIGMOID %>" id="b4" maxlength="30" />
<%}else{ %>
<input type="text" value="Normal" class="large" name="<%=SIGMOID %>" id="b4" maxlength="30" />
<%} %>
<div class="Clear"></div>

<label class="common">Descending Colon</label>
<%if(opdGastroEnterologyColonoscopy != null && opdGastroEnterologyColonoscopy.getDescendingColon()!=null){%>
<input type="text" value="<%=opdGastroEnterologyColonoscopy.getDescendingColon() %>" class="large" name="<%=DESCENDING_COLON %>"	id="b5" maxlength="30" />
<%}else{ %>
<input type="text" value="" class="large" name="<%=DESCENDING_COLON %>"	id="b5" maxlength="30" />
<%} %>
<div class="Clear"></div>

<label class="common">Transverse Colon</label>
<%if(opdGastroEnterologyColonoscopy != null && opdGastroEnterologyColonoscopy.getTransverseColon()!=null){%>
<input type="text" value="<%=opdGastroEnterologyColonoscopy.getTransverseColon() %>" class="large" name="<%=TRANSVERSE_COLON %>" id="b6" maxlength="10" />
<%}else{ %>
<input type="text" value="Normal" class="large" name="<%=TRANSVERSE_COLON %>" id="b6" maxlength="10" />
<%} %>
<div class="Clear"></div>

<label class="common">Cecum</label>
<%if(opdGastroEnterologyColonoscopy != null && opdGastroEnterologyColonoscopy.getCecum()!=null){%>
<input type="text" value="<%=opdGastroEnterologyColonoscopy.getCecum() %>" class="large" name="<%=CECUM %>" id="b7" maxlength="30" />
<%}else{ %>
<input type="text" value="" class="large" name="<%=CECUM %>" id="b7" maxlength="30" />
<%} %>
<div class="Clear"></div>

<label class="common">Biopsy</label>
<%if(opdGastroEnterologyColonoscopy != null && opdGastroEnterologyColonoscopy.getBiopsy()!=null){%>
<input type="text" value="<%=opdGastroEnterologyColonoscopy.getBiopsy() %>" class="large" name="<%=BIOPSY %>" id="b8" maxlength="30" />
<%}else{ %>
<input type="text" value="" class="large" name="<%=BIOPSY %>" id="b8" maxlength="30" />
<%} %>
<div class="Clear"></div>



<label class="common">Final diagnosis</label>
<%if(opdGastroEnterologyColonoscopy != null && opdGastroEnterologyColonoscopy.getFinalDiagnosis()!=null){%>
<input type="text" value="<%=opdGastroEnterologyColonoscopy.getFinalDiagnosis() %>" class="large" name="<%=FINAL_DIAGNOSIS %>" id="b9" maxlength="30" />
<%}else{ %>
<input type="text" value="" class="large" name="<%=FINAL_DIAGNOSIS %>" id="b9" maxlength="30" />
<%} %>
<div class="Clear"></div>
...
<input type="button" class="button" value="Submit"
	onclick="submitForm('gastroEnterologyColonoscopy','opd?method=addGastroEnterologyColonoscopy','blankSpace');"
	align="right" /> <input type="button" class="button" value="View"
	onclick="showJSP('gastroEnterologyColonoscopy');" /> <input name="Back"
	type="button" src="images/phaseII/delete.gif" alt="Back" value="Back"
	class="button" onclick="history.go(-1);return false;" align="right" /></div>
