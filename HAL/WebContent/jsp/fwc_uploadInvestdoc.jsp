...
function jsImport()
{
	...
	submitForm('investigationUploadDoc','fwc?method=submitUploadDocumentsInvestigation'+fileNames +'&hin_id='+ hin_id+'&hin_no='+hin_no+'&invest_id='+invest_id+'&visitId='+visit_id+'&uploadCount='+inc);
...
function viewPatientDocuments()
{
   ...
   document.investigationUploadDoc.method="post";
   submitForm('investigationUploadDoc','fwc?method=viewUploadDocumentsInvestigationDetails&hinId='+hin_id+'&visitId='+visit_id+'&invest_id='+invest_id);
