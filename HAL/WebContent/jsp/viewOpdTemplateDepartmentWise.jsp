		...
		<table border="0" cellpadding="2" cellspacing="0" width="100%">
			<tr>
				...
				<%if(opdTemplateDepartmentWise.getResult()!=""){ %> <label
					class="valueNoWidth"><%=opdTemplateDepartmentWise.getResult() %></label>
				<%}else{ %> <label class="value">-</label> <%} %>
				</td>
			</tr>
			<tr>
				<td><label class="noWidth">Remarks</label> <%if(opdTemplateDepartmentWise.getRemarks()!=""){ %>
				<label class="valueNoWidth"><%=opdTemplateDepartmentWise.getRemarks() %></label>
				<%}else{ %> <label class="value">-</label> <%} %>
				</td>
			</tr>
		</table>
