...
String orderByDepartment = "&nbsp;";
	...
	out.print("dgResultEntryHeaderByOrderNo="+dgResultEntryHeaderByOrderNo.size());
...
<div class="Clear"></div>
<span>This Investigation Result is confidential </span>
<div class="Clear"></div>
<%}else{ %>
...
<jsp:include page="viewSingleResultReportLabOrderNoWise.jsp" flush="true">
<jsp:param name="resultEntryIndex" value="<%=resultEntryIndex%>" />
