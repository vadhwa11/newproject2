...
<%} %>
	...
	<label class="auto_text" >Select Unit</label>
...
<input type="button" name="add" id="addbutton" value="Display" class="button" onClick="if(chk()){submitForm('proformaApproval','stores?method=getPendingProformaForApproval')};" accesskey="a" tabindex=1 />
