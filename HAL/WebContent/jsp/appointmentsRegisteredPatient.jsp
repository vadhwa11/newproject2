		...
		for(var i = 0; i < document.getElementsByName('parent').length; i++)
		{
			  if(document.getElementsByName('parent')[i].checked == true && document.getElementsByName('parent')[i].value!=null)
			  {
					...
					if(document.getElementById("patientType"+i)!=null){
							window.opener.document.getElementById("patientType"+rowCount).value = document.getElementById("patientType"+i).value;
							window.opener.document.getElementById("patientType"+rowCount).readOnly=true;
					}
