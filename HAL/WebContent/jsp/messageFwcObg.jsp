...
<input type="button" name="yes"	value="Yes" class="button" onclick="submitForm('patientAD','fwc?method=printFwcObg');" />
<input	type="button" name="no" value="No" class="button" onclick="submitForm('patientAD','fwc?method=showWaitingPatientListJsp');" />

<input type="button" name="Back" value="Back" class="button" onclick="submitForm('patientAD','fwc?method=showFWCMainJsp&visitId=<%=visitId%>');"/>
<div class="Clear"></div>
</form>
</div>