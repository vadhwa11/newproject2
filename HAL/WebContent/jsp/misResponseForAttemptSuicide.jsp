...
<div id="hinDiv">
<label>HIN</label>
		<select name="<%=HIN_ID%>" validate="Hin No,string,no" id="hinId" onblur="if(this.value!=''){submitProtoAjaxWithDivName('caseofAttemptedSuicide','/hms/hms/mis?method=getServiceNoDetailsForAttemptSucide','hinDiv11');}" tabindex="1">
