...
%>
<div id="contentspace">
<form name="defectiveItemRetrun" method="post" action=""><br />
<br />
<div class="panelbar">
<div class="paneltext"">Defective Item Return Report</div>
</div>
<br />
...
<img src="/hms/jsp/images/cal.gif" width="16" height="16" border="0"
	...
	onClick="setdate('<%=currentDate%>',document.defectiveItemRetrun.<%=FROM_DATE%>,event)" />
...
<img src="/hms/jsp/images/cal.gif" width="16" height="16" border="0"
	validate="Pick a date" class="calender" tabindex="1"
	onClick="setdate('<%=currentDate%>',document.defectiveItemRetrun.<%=TO_DATE%>,event)" />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input type="button" name="add"
	id="addbutton" value="Ok" class="button"
	onClick="submitForm('defectiveItemRetrun','stores?method=generateDefectiveItemReturnReport','check()');"
	accesskey="a" tabindex=1 /> <input type="button" name="clear"
	id="clearbutton" value="Clear" class="button"
	onClick="clearButton('defectiveItemRetrun');" accesskey="a" tabindex=1 />
</form>
</div>
