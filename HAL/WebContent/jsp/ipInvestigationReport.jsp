...
<div class="titleBg"><h2 >Investigation Slip</h2></div>
<div class="clear"></div>
<form name="ipInvestigationReport" target=_blank action=""	method="post">
<div class="Block">
...
<input type="button" name="Submit" 	id="addbutton"	onClick="submitForm('ipInvestigationReport','ipd?method=printIPPrescriptionInvestReport&flag=investigation');"	value="Submit" class="button" accesskey="a" />
...
function getPatientName(val)
{
	...
	submitProtoAjaxWithDivName('ipInvestigationReport','/hms/hms/ipd?method=showPatientHinNo&paramName='+val,'hinDiv');
}
...
function getAdNo(val)
{
	...
	submitProtoAjaxWithDivName('ipInvestigationReport','/hms/hms/ipd?method=showPatientName&paramName='+val+'&flag=p','adDiv');
