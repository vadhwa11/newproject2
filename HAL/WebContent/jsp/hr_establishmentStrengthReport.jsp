...
<div class="Clear"></div>
<label><span>*</span> Unit</label> <select name="<%=UNIT_ID %>">
...
<input type="button" name="OK" value="OK" class="cmnButton"
	onClick="if(establishmentReport.unitId.value!=0){submitForm('establishmentReport','hrRelated?method=generateEstablishmentReport');}else{alert('Select Unit');}" />
