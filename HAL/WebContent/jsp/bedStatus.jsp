...
<div class="Block">
<label class="auto">Bed Status Code </label> 
<input type="radio" class="radioAuto" name="<%=SELECTED_RADIO  %>" value="1" checked="checked" /> 
<label class="auto">Bed Status Name </label> 
...
<input type="hidden" name="<%=JASPER_FILE_NAME%>" value="Mas_bed_status">
</div>
</form>
...
<% 
  if(searchBedStatusList.size()>0)
   ...
   {
 %> 
<h4><a href="inPatientMaster?method=showBedStatusJsp">Show All Records</a></h4> <%
   }
   }
...
<input type="hidden" name="<%= POJO_NAME %>" value="MasBedStatus"> 
<input type="hidden" name="<%=POJO_PROPERTY_NAME %>" value="BedStatusName">
<input type="hidden" name="bedStatus" value="BedStatus"> 
<input type="hidden" name="<%=JSP_NAME %>" value="bedStatus"> 
<input type="hidden" name="pojoPropertyCode" value="BedStatusCode"> 
<div class="clear"></div>
<div class="clear"></div>
<div class="Block">
<label> Bed Status Code <span>*</span></label> 
<input id="codeId" type="text" name="<%= CODE%>" value="" validate="Bed Status Code,string,yes" MAXLENGTH="8"   tabindex="1"> 
<label> Bed Status Name <span>*</span> </label> 
<input type="text" name="<%= SEARCH_NAME %>" value="" validate="Bed Status Name,string,yes"  MAXLENGTH="30"   tabindex="1" onkeypress="return submitenter(this,event,'inPatientMaster?method=addBedStatus')">
<script>
...
<div class="clear"></div>
<div id="edited"></div>
<input type="button" name="add" id="addbutton" value="Add" class="button" onClick="submitForm('bedStatus','inPatientMaster?method=addBedStatus');" accesskey="a" tabindex="1" /> 
<input type="button" name="edit" id="editbutton" value="Update" class="button" onClick="submitForm('bedStatus','inPatientMaster?method=editBedStatus')" accesskey="u" tabindex="1" /> 
<input type="button" name="Delete" id="deletebutton" value="Activate" class="button" onClick="submitForm('bedStatus','inPatientMaster?method=deleteBedStatus&flag='+this.value)" accesskey="d" tabindex="1" /> 
...
data_arr[<%= counter%>][3] = "<%= masBedStatus.getLastChgBy() %>"
