...
<input type="hidden" name="supplyType"  id="supplyType" value="G">
...
<label class="value">Other Govt. Source</label>
<input type="hidden" name="<%=SOURCE_OF_SUPPLY%>" id="sourceCombo"	tabindex=1  validate='Dispensery Name,num,Yes' value="G">


<!-- -<label>
<span>*</span>Source of Supply</label>
...
<label >Other Govt. Sources<span>*</span></label>
<input type="text" name="<%=HOW_RECEIVED %>" value="" MAXLENGTH="50" tabindex=1 />
<input type="hidden" name="<%=SUPPLIER_ID %>" id="supplierCombo"  validate="Other Gov. Source,String,no"  / >

</div>
<!-- -
<div id=indentDiv><label>Indent No/PO No</label> <select
...
<input type="hidden" name="<%=CHANGED_BY%>" value="<%=userName%>" /> <input
	...
	<input type="hidden" name="checkJsp" value="crvOtherGovSource"/>
	<script
