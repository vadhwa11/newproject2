...
<h6>Personnel Search For Form 8 Entry</h6>
<div class="Clear"></div>
<%
...
<input type="button" name="Search"
	onclick="submitForm('personnelSearch','/hms/hms/pension?method=personnelSearchJsp&jspName=form8');"
...
<form name="personnelSearchForForm8" method="post" action=""><script
...
<script type="text/javascript" language="javascript">
    ...
    formName = "personnelSearchForForm8"
