...
<input type="text" id="serviceNo." name="<%=SERVICE_NO%>" value=""	 MAXLENGTH="30"	onblur="if(validateMetaCharacters(this.value)){document.getElementById('testDiv').value='';getHinNo('search','opd?method=getHinNoForpatientpres&flag=previousOpd')}" />
...
<input type="hidden" name="backFlag" value="previousOpd">
</form>
