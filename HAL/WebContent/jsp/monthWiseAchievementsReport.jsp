...
<form name="monthWiseAchievementsReport" method="post" action="">

<div class="titleBg">
<h2>Month wise Achievements Report</h2>
</div>
<div class="Block">
...
<label> From Month</label> <select name="<%=FROM_MONTH %>" 	validate="Month,string,yes" onchange="convertMonthInString(this.value)">
	<option value="0">Select</option>
...
<label> To Month</label> <select name="<%=TO_MONTH %>" 	validate="Month,string,yes" onchange="convertMonthInString(this.value)">
	<option value="0">Select</option>
	<option value="1">January</option>
	<option value="2">February</option>
	<option value="3">March</option>
...
<div class="Clear"></div>
<input type="button" name="OK" value="OK" class="button" onClick="submitForm('monthWiseAchievementsReport','fwc?method=showMonthWiseAchievementsReport');" />
