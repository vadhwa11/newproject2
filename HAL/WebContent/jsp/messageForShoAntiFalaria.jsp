...
%>
<form name="MessageForBreakDown" method="post">
...
<input type="button" name="Yes" value="Print" onclick="submitForm('MessageForBreakDown','/hms/hms/mis?method=printSanitaryRoundDetail');" />
-->
