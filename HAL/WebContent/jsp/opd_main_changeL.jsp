...
#contentHolder select.listSm{
	...
	<h4><%=visit.getDepartment().getDepartmentName() %></h4><h6>OPD- Patient Prescription </h6>
	<div class="Clear"></div>
	<%} %>	
	<script type="text/javascript">
...
<div class="blockFrame">
	...
	<%if(patientName!= null){ %>
	<label class="valuemedium" style="width: auto;"><%=patientName %> </label>
	<%}else{ %>
	<label class="valuemedium">- </label>
	<%} %>
	...
	<%} %>
		<div class="Clear"></div>
	<label class="medium">Phone Number</label>
	...
	<label class="medium">Mobile Number</label>
	...
	%>
	<label class="valueNoWidth"><%=fullDoctorName%></label>
...
<br/>
	...
	<input name="bp" id="bp" type="text" tabindex="1" class="medium" onblur="validateBpValue(this.value);" maxlength="7"/>
...
<label class="bodytextB">Delete Existing Item:</label>
...
<br>
<div id="templateDivToShowHide">
<label class="small" style="padding: 0px 0px 0px 0px;">Template</label>
<div id="treatmentDiv">
<select name="templateId" id="templateId" tabindex="1" style="padding: 0px 0px 0px 0px;" onchange="showHideDrugTemplateCombo(this.value);">
    <option value="0">Select</option>
    <%
...
<div id="prevButtonDivToShowHide">
	<input name="Prevoius2" tabindex="1" type="button" value="Prev Prescription" class="cmnButton"  onclick="openPopupForPatientPrescription('<%=visit.getVisitNo()%>','<%=visit.getHin().getId()%>','<%=visit.getDepartment().getId()%>','<%=visit.getId()%>')"  />
</div>
...
<div id="createPresDivToShowHide">
	<input name="createPrescriptionTemplate" tabindex="1" type="button" value="Create Prescription Template" class="cmnButton"  onclick="showCreatePrescriptionTempate();"  />
</div>
<div id="copyPrevPrescriptionTemplateDiv" style="display: block;">
    <input name="copyPrevPrescriptionTemplate" tabindex="1" type="button" value="Copy Prev Prescription" 
    	class="cmnButton" style="margin-left:54px;" onclick="copyPrevPrescriptionTempate('<%=visit.getVisitNo()%>','<%=visit.getHin().getId()%>');"  />
</div>
...
<div id="testDiv">
	...
	<table border="0" align="center" cellpadding="0" cellspacing="0" id="grid">
	  ...
	  <tr>
	    ...
	    <td>
		    <select name="instructionACPC1" id="instructionACPC1"  tabindex="1">
	    ...
	    <td>
	    <input type="text" name ="typeLeftRight1" tabindex="1" size="50" id="typeLeftRight1" maxlength="195"/>
...
<div style="padding-left:280px;">
<label class="bodytextB">Delete Existing Item:</label>
<input type="checkbox" id="deleteInvItem" name="deleteInvItem" >
</div>
<div class="Clear"></div>
<%if(pInvList.size() > 0){%>
...
<div id="prevButtonDivInvestigationToShowHide">
	<input name="Prevoius" type="button" value="Prev Investigation" tabindex="1"class="cmnButton" onclick="openPopupForPatientInvestigation('<%=visit.getVisitNo()%>','<%=visit.getHin().getId()%>')"  />
</div>	
	<input type="button" class="ButtonDel"  alt="Delete"tabindex="1" style="margin-left:10px;" value="&nbsp;" onclick="removeRowForInvestigation();" align="right" />
...
<div id="createInvestigationDivToShowHide">	
	<input name="investigationTemplate" type="button" value="Create Investigation Template" tabindex="1"class="cmnButton" onclick="showCreateInvestigationTemplate();"  />
</div> 
<div id="copyPrevInvestigationTemplateDiv" style="display: block;">
    <input name="copyPrevInvestigationTemplate" tabindex="1" type="button" value="Copy Prev Investigation" 
    	class="cmnButton" style="margin-left:54px;" onclick="copyPrevInvestigationTempate('<%=visit.getVisitNo()%>','<%=visit.getHin().getId()%>');"  />
</div>

<div id="investigationImportButton" style="display:none">
	<input name="investigationImportButton1" tabindex="1" type="button" value="Import New Investigation" class="cmnButton" onclick="getListForTreatment('investigationDiv');" />
</div>
	...
	<!-- 	    <th scope="col">Test Code </th>
		  ...
		  <tr>
		    ...
		    <%int inc=1; %>
				...
				<div id="ac2update2" style="display:none; font-weight:normal; border:1px solid black; padding-right: 10px; background-color:white;">
				</div>
				<script type="text/javascript" language="javascript" charset="utf-8">
...
<div class="Clear"></div>
<div class="paddLeft25"><div class="bottom">

<label >Plan</label>
<textarea rows="" cols=""tabindex="1" maxlength="1000" onkeyup="return ismaxlength(this)" name="plan"></textarea>
...
var xmlHttp;
  ...
  <script type="text/javascript">
     ...
     function openPopupForPatientInvestigation(visitNo,hinId){
        ...
        newwindow=window.open(url,'name','left=30,top=200,height=320,width=960,status=1,scrollbars=1,resizable=1');
        }else{
          alert("This is Patient's First Visit. ")
        }
     }
  ...
  function showCreatePrescriptionTempate(){
	    ...
	    newwindow=window.open(url,'name',"height=500,width=990,status=1,top=90,left=10");
  }
