...
<input type="hidden" name="flag" value="command"/>
<div class="Block">
<label>Authority Of Board</label>
 <% if(medExamObj.getAuthority()!=null){%>
<input tabindex="1" type="text" readonly="readonly" readonly="readonly" maxlength="20"  id="" name="<%=AUTHORITY_OF_BOARD %>"maxlength="6" value="<%=medExamObj.getAuthority() %>"
...
<label class="valueAuto">1.)</label><input tabindex="1" type="text" class="auto" size="70" readonly="readonly" maxlength="20"  id="" name="<%=IDENTIFICATION_MARKS1 %>"maxlength="6" value="<%=medExamObj.getIdentificationMarks1() %>"
	onKeyUp="limitText(this,20);" readonly="readonly" />

 <% }else{%>
<label  class="valueAuto">1.)</label><input tabindex="1" type="text" class="auto" size="70" readonly="readonly" maxlength="20"  id="" name="<%=IDENTIFICATION_MARKS1 %>" maxlength="6" 
	onKeyUp="limitText(this,20);" readonly="readonly" />
...
<label  class="valueAuto">2.)</label><input tabindex="1" type="text" class="auto" size="70" readonly="readonly" maxlength="20"  id="" name="<%=IDENTIFICATION_MARKS2 %>"maxlength="6" value="<%=medExamObj.getIdentificationMarks2() %>"
	onKeyUp="limitText(this,6);"  />

 <% }else{%>
<label  class="valueAuto">2.)</label><input tabindex="1" type="text" class="auto" size="70" readonly="readonly" maxlength="20"  id="" name="<%=IDENTIFICATION_MARKS2 %>" maxlength="6" 
	onKeyUp="limitText(this,6);"  />
...
<textarea  readonly="readonly" rows="" cols="72"   	name="<%=OTHER_INFORMATION %>" class="auto" onkeyup="chkLength(this,50);" ><%=medExamObj.getAnyOtherInformationAboutYourHealth() %></textarea>
 <% }else{%>
<textarea  readonly="readonly" rows="" cols="72"   	name="<%=OTHER_INFORMATION %>" class="auto" onkeyup="chkLength(this,50);" ></textarea>
 <% }%>
</div>
</div>
<div class="clear paddingTop15"></div>
...
<% if(medExamObj.getRemarksGynaecology()!=null){%>
 <textarea  readonly="readonly" rows="" cols="72"	name="<%=GYANAECOLOGY_RAMARKS %>" class="auto" onkeyup="chkLength(this,300);" value="<%=medExamObj.getRemarksGynaecology() %>"><%=medExamObj.getRemarksGynaecology() %></textarea>

 <% }else{%>
 <textarea  readonly="readonly" rows="" cols="72"	name="<%=GYANAECOLOGY_RAMARKS %>" class="auto" onkeyup="chkLength(this,300);"></textarea>
 <% }%>
