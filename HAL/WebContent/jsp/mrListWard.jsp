...
function GetMRList(MODE)
{
	...
	var url = "stores?method=getListOfMRWard";
	var bClickable = true;
...
function makeTable(jsonData)
{
	...
	for(i=0;i<jsonData.length;i++)
		{			
			...
			else if(jsonData[i].Status == 'w')
			{
				MRStatus = "Partial Issued";
			}
...
function ViewUpdateMR(Id)
{
	...
	window.location = "stores?method=ViewUpdateMRDetailsWard&mrId="+Id+"&appId=A1523";	
