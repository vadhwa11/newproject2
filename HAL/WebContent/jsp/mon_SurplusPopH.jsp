...
function check(){
var SDate = document.mon_SurplusH.<%= FROM_DATE%>.value;
var EDate = document.mon_SurplusH.<%= TO_DATE %>.value;
...
%>
<form name="mon_SurplusH" method="post" action="" >
...
<a	href="javascript:setdate('<%=f%>',document.mon_SurplusH.<%=FROM_DATE%>,true)">
...
<a href="javascript:setdate('<%=t%>',document.mon_SurplusH.<%=TO_DATE%>,true)">
<img src="/hms/jsp/images/cal.gif" width="16" height="16" border="0" validate="Pick a date" class="calender" /> </a> 
...
<input  type="button"	tabindex="1" align="right" class="button" value="Ok" onclick="submitForm('mon_SurplusH','/hms/hms/mis?method=generateSurplusReport');" />
