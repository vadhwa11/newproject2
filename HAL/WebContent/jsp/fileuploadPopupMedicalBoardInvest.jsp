...
function jsImport()
{
	...
	{ 
      ...
      submitForm('attachMedicalBoardDocument','medicalBoard?method=submitInvestigationUploadDocuments&hinId='+hin_id+'&invest_id='+invest_id+'&masExamId='+masExamId+'&hinNo='+hinNo+'&filename='+filename);
		 //  window.close();
	}
}
function jsViewDocument()
{
		...
		hinNo='<%=hinNo%>';
	   document.attachMedicalBoardDocument.method="post";
       submitForm('attachMedicalBoardDocument','medicalBoard?method=viewUploadDocumentsDetailsInvest&hinId='+hin_id+'&InvestId='+invest_id+'&hinNo='+hinNo+'&masExamId='+masExamId);
}
</script>
