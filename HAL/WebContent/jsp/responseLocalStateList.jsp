...
<div id="localStateDiv">
		...
		<select id="localState" name="localState" validate="State ,string,no"    onchange="submitProtoAjaxWithDivNameToShowStatus('employee','/hms/hms/personnel?method=getLocalDistrictList','localDistrictDiv');">
