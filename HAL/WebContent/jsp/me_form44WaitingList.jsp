...
<script type="text/javascript"
	...
	<form name="medicalExamForm44" action="" method="post">
...
<input type="button" name="Submit11" id="addbutton" onclick="submitForm('medicalExamForm44','/hms/hms/medicalExam?method=submitMedicalExamForm44');" value="Submit" class="button" accesskey="a" />
