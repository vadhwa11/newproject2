...
<h4><%=message %></h4>
<div class="Clear"></div>
<div class="titleBg"><h2>Empanelled Result Entry</h2></div>
<%
String subDept = "";
String dept="";
int SubChargeId=0;
...
<input name="<%= DEPARTMENT_ID %>" id="<%= DEPARTMENT_ID %>"	type="hidden" value="<%= deptId %>" />
...
%>
<label class="value"><%= obj.getFirstName()+" "+(obj.getMiddleName()!=null?obj.getMiddleName():"")+" "+(obj.getLastName()!=null?obj.getLastName():"")%></label>
<%}
	}%>
...
<div class="clear"></div>
<input type="button" name="submitForDisable" id="submitForDisable"	tabindex="1" class="button" value="Submit"	onclick="submitEmpanelledForm('sampleCollection','investigation?method=submitResultEntryForEmpanelledAllInvestigationType');"	align="right" />
...
function submitEmpanelledForm(formName,url)
{
	//alert("sub");
	
	 var length = document.getElementsByName("resultSingleValue").length;
	length = length * 1;
	
	for(var i=1;i<=length;i++)
		{
			document.getElementById("resultSingleValue"+i).value="Empanelled Result";
		} 
	
	 var length1 = document.getElementsByName("result").length;
		length1 = length1 * 1;
		alert("length1="+length1);
		for(var i=1;i<=length1-1;i++)
			{
				document.getElementById("result"+i).value="Empanelled Result";
			} 
	
	submitFormToDisableSubmit('sampleCollection','investigation?method=submitResultEntryForEmpanelledAllInvestigationType');
