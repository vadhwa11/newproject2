...
%>
 <input type="button" name="yes" value="Yes" class="button"
	onclick="submitForm('messageLab','/hms/hms/lab?method=generatePrintResultForLab&hinNo=<%=hinNo %>&visitNo=<%=visitNo %>&orderNo=<%=orderNo %>');" />
<input type="button" name="no" value="No" class="button"
	onclick="submitForm('messageLab','/hms/hms/opd?method=printPatientInvestigationReport','checkTargetForNo');" />
<!--
