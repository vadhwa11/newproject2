...
<%@page import="jkt.hms.masters.business.MdSpecialInvestigationHd"%><script type="text/javascript" language="javascript" src="/hms/jsp/js/calendar.js"></script>
...
<%
		...
		if(map.get("patientList") != null){
			patientList= (List<MdSpecialInvestigationHd>)map.get("patientList");
		}
...
<input type="button" name="Submit" id="addbutton" value="Search" class="button" accesskey="a" 
	onclick="if(checkBlankSearch()){submitForm('patientSearch','/hms/hms/mediClaim?method=showPatientDetailsForContingentBill');}"/>
<div class="Clear"></div></form>

<jsp:include page="searchResultBlock.jsp" />
<div id="searchresults" tabindex=2>
<div id="searchtable" tabindex=2></div>
<form name="searchContingentBill" method="post" action=""><script
	type="text/javascript">
	formFields = [
			[0, "specInvHdId", "id"],[1,"dateOfRequest"], [2,"servNo"], [3,"hin"], [4,"patName"], [5,"rank"], [6,"sPersonName"]];
	 statusTd = 5;
</script></form>
</div>
<script type="text/javascript" language="javascript">
	...
	data_header[0][0] = "Date Of Request"
	...
	<% 	for(MdSpecialInvestigationHd specialInvestigationHd : patientList){
		...
		String invs_date=specialInvestigationHd.getSpecialDate().toString();
