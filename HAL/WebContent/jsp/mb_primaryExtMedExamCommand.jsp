...
<div class="clear"></div>
<form name="medExamPrimaryCommand" action="" method="post">
<!--Block One Starts-->
<div class="Block">
...
<label class="medium"> Remarks</label> <textarea rows="" cols=""
	name="<%=DENTAL_REMARKS %>" class="large" onkeyup="chkLength(this,300);" readonly="readonly" ></textarea>
...
<input tabindex="1" type="text" name="<%=EYE_DATE %>" readonly="readonly" class="calDate" value="<%=HMSUtil.convertDateToStringWithoutTime(medExamObj.getDateSpecialExam()) %>"	maxlength="10" onKeyUp="mask(this.value,this,'2,5','/');"	validate="EyeDate,date,no" readonly="readonly"/> 
	<%}else{ %>
<input tabindex="1" type="text" name="<%=EYE_DATE %>" readonly="readonly" class="calDate"	maxlength="10" onKeyUp="mask(this.value,this,'2,5','/');"	validate="EyeDate,date,no" /> 
	...
	class="calender"
	onclick="setdate('',medExamPrimaryCommand.<%=EYE_DATE%>,event);" />
	</div>
...
<label class="medium"> Remarks</label> <textarea rows="" cols=""
	name="cmMdRemarks" class="large" onkeyup="chkLength(this,300);" readonly="readonly"></textarea>
...
<div class="clear"></div>
<input tabindex="1" name="Button"	type="button" class="button" value="VALIDATE"	onClick="submitForm('medExamPrimaryCommand','medicalExam?method=validateMedExam');" />
<input tabindex="1" name="Button"	type="button" class="button" value="REJECT"	onClick="submitForm('medExamPrimaryCommand','medicalExam?method=rejectMedExam');" />
