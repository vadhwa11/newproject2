...
<%-- 	<li>
	<a
		href="#" onclick="javascript:openPopupInvestigation(<%=visit.getId()%>,<%=visit.getVisitNo()%>,<%=visit.getDepartment().getId()%>,<%=visit.getHin().getId()%>)">
...
--%>
	<li><a href="#"
				      onclick="openWindow('/hms/hms/opd?method=viewAllPrevoiusSession&hinId=<%=visit.getHin().getId()%>')">Previous Dental Procedure
					 </a></li> 
			...
			<li>
			 ...
			 <a href="#"
				onclick="javascript:openDentalXray('<%=hinNo%>')">
					Dental X-Ray</a></li>
					
					<%--  <a href="#"
				onclick="javascript:openDentalXray('33550')">
					Dental X-Ray</a></li> --%>
...
%>
	...
	<label>Present Complaint <span>*</span></label>
			...
			<textarea class="opdMainTextArea yellowBackground"
				...
				validate="Present Complaint,string,yes" cols="0" rows="0"><%=opdPatientHistory != null && opdPatientHistory.getPresentComplain()!= null?opdPatientHistory.getPresentComplain().replace(",", "\n"):"" %></textarea>
 ...
 --%>
	...
	//if(opdPatientDetails!=null  && opdPatientDetails.getReferralVisit()!=null && opdPatientDetails.getReferralVisit().getId().equals(visit.getId()) &&  opdPatientDetails.getReferredDeptInt()!=null && opdPatientDetails.getReferredDeptInt().getId().equals(deptId) )
	 ...
	 String name=visit.getRefereeOpdPatientdetailsId().getEmployee().getFirstName();
		/* if(opdPatientDetails.getEmployee().getMiddleName()!=null && !opdPatientDetails.getEmployee().getMiddleName().equals(""))
			name=name+" "+opdPatientDetails.getEmployee().getMiddleName();
		if(opdPatientDetails.getEmployee().getLastName()!=null && !opdPatientDetails.getEmployee().equals(""))
...
<input tabindex="1"	type="text"   name="conditionOfGums" id="txtAlpha" style="width: 290px;" value=""
...
<input tabindex="1" type="checkbox"
	name="<%=MUR_8%>" value="" class="radioAuto" id="ATUR18" onclick="fillDentalValue(this.id);fillDentalValue(this.id);chkValueMissing(this);chkDentalValue(this);"  />
	<label class="smallAuto">18</label>

<input tabindex="1" type="checkbox"
	name="<%=MUR_7%>" value="" class="radioAuto" id="ATUR17" onclick="fillDentalValue(this.id);chkValueMissing(this);chkDentalValue(this);" />
	<label class="smallAuto">17</label>
<input tabindex="1" type="checkbox"
	name="<%=MUR_6%>" value="" class="radioAuto" id="ATUR16" onclick="fillDentalValue(this.id);chkValueMissing(this);chkDentalValue(this);" />
<label class="smallAuto">16</label>
<input tabindex="1" type="checkbox"
	name="<%=MUR_5%>" value="" class="radioAuto" id="ATUR15" onclick="fillDentalValue(this.id);chkValueMissing(this);chkDentalValue(this);" />
<label class="smallAuto">15</label>

<input tabindex="1" type="checkbox"
	name="<%=MUR_4%>" value="" class="radioAuto" id="ATUR14"  onclick="fillDentalValue(this.id);chkValueMissing(this);chkDentalValue(this);" />
	<label class="smallAuto">14</label>

<input tabindex="1" type="checkbox"
	name="<%=MUR_3%>" value="" class="radioAuto" id="ATUR13"  onclick="fillDentalValue(this.id);chkValueMissing(this);chkDentalValue(this);" />
<label class="smallAuto">13</label>

<input tabindex="1" type="checkbox"
	name="<%=MUR_2%>" value="" class="radioAuto" id="ATUR12" onclick="fillDentalValue(this.id);chkValueMissing(this);chkDentalValue(this);" />
<label class="smallAuto">12</label>

<input tabindex="1" type="checkbox"
	name="<%=MUR_1%>" value="" class="radioAuto" id="ATUR11"  onclick="fillDentalValue(this.id);chkValueMissing(this);chkDentalValue(this);" />
<label class="smallAuto">11</label>

<input tabindex="1" type="checkbox"
	name="<%=MUL_1%>" value="" class="radioAuto" id="ATUL21" onclick="fillDentalValue(this.id);chkValueMissing(this);chkDentalValue(this);" />
	<label class="smallAuto">21</label>
	
<input tabindex="1" type="checkbox"
name="<%=MUL_2%>" value="" class="radioAuto" id="ATUL22" onclick="fillDentalValue(this.id);chkValueMissing(this);chkDentalValue(this);" />
<label class="smallAuto">22</label>

<input tabindex="1" type="checkbox"
	name="<%=MUL_3%>" value="" class="radioAuto" id="ATUL23" onclick="fillDentalValue(this.id);chkValueMissing(this);chkDentalValue(this);" />
	<label class="smallAuto">23</label>
	
<input tabindex="1" type="checkbox"
name="<%=MUL_4%>" value="" class="radioAuto" id="ATUL24" onclick="fillDentalValue(this.id);chkValueMissing(this);chkDentalValue(this);" />
<label class="smallAuto">24</label>

<input tabindex="1" type="checkbox"
	name="<%=MUL_5%>" value="" class="radioAuto" id="ATUL25" onclick="fillDentalValue(this.id);chkValueMissing(this);chkDentalValue(this);" />
	<label class="smallAuto">25</label>
	
<input tabindex="1" type="checkbox"
name="<%=MUL_6%>" value="" class="radioAuto" id="ATUL26" onclick="fillDentalValue(this.id);chkValueMissing(this);chkDentalValue(this);" />
<label class="smallAuto">26</label>

<input tabindex="1" type="checkbox"
	name="<%=MUL_7%>" value="" class="radioAuto" id="ATUL27" onclick="fillDentalValue(this.id);chkValueMissing(this);chkDentalValue(this);" />
	<label class="smallAuto">27</label>


<input tabindex="1" type="checkbox"
	name="<%=MUL_8%>" value="" class="radioAuto" id="ATUL28" onclick="fillDentalValue(this.id);chkValueMissing(this);chkDentalValue(this);" />
	<label class="smallAuto">28</label>
	<label class="smallAuto">UL</label>
<div class="clear"></div>
<label class="smallAuto" >LR</label>
<input tabindex="1" type="checkbox"
	name="<%=MLR_8%>" value="" class="radioAuto" id="ATLR48"  onclick="fillDentalValue(this.id);chkValueMissing(this);chkDentalValue(this);" />
	<label class="smallAuto">48</label>

<input tabindex="1" type="checkbox"
	name="<%=MLR_7%>" value="" class="radioAuto" id="ATLR47"  onclick="fillDentalValue(this.id);chkValueMissing(this);chkDentalValue(this);" />
	<label class="smallAuto">47</label>

<input tabindex="1" type="checkbox"
	name="<%=MLR_6%>" value="" class="radioAuto" id="ATLR46" onclick="fillDentalValue(this.id);chkValueMissing(this);chkDentalValue(this);" />
	<label class="smallAuto">46</label>
<input tabindex="1" type="checkbox"
	name="<%=MLR_5%>" value="" class="radioAuto" id="ATLR45" onclick="fillDentalValue(this.id);chkValueMissing(this);chkDentalValue(this);" />
	<label class="smallAuto">45</label>

<input tabindex="1" type="checkbox"
	name="<%=MLR_4%>" value="" class="radioAuto" id="ATLR44" onclick="fillDentalValue(this.id);chkValueMissing(this);chkDentalValue(this);" />
	<label class="smallAuto">44</label>

<input tabindex="1" type="checkbox"
	name="<%=MLR_3%>" value="" class="radioAuto" id="ATLR43" onclick="fillDentalValue(this.id);chkValueMissing(this);chkDentalValue(this);" />
	<label class="smallAuto">43</label>
<input tabindex="1" type="checkbox"
	name="<%=MLR_2%>" value="" class="radioAuto" id="ATLR42" onclick="fillDentalValue(this.id);chkValueMissing(this);chkDentalValue(this);" />
	<label class="smallAuto">42</label>
<input tabindex="1" type="checkbox"
	name="<%=MLR_1%>" value="" class="radioAuto" id="ATLR41" onclick="fillDentalValue(this.id);chkValueMissing(this);chkDentalValue(this);" />
	<label class="smallAuto">41</label>
	
<input tabindex="1" type="checkbox"
	name="<%=MLL_1%>" value="" class="radioAuto" id="ATLL31" onclick="fillDentalValue(this.id);chkValueMissing(this);chkDentalValue(this);" />
	<label class="smallAuto">31</label> 
	
	<input tabindex="1" type="checkbox"
	name="<%=MLL_2%>" value="" class="radioAuto" id="ATLL32" onclick="fillDentalValue(this.id);chkValueMissing(this);chkDentalValue(this);" />
	<label class="smallAuto">32</label>
	
	<input tabindex="1" type="checkbox"
	name="<%=MLL_3%>" value="" class="radioAuto" id="ATLL33" onclick="fillDentalValue(this.id);chkValueMissing(this);chkDentalValue(this);" />
	<label class="smallAuto">33</label>
	
	<input tabindex="1" type="checkbox"
	name="<%=MLL_4%>" value="" class="radioAuto" id="ATLL34" onclick="fillDentalValue(this.id);chkValueMissing(this);chkDentalValue(this);" />
	<label class="smallAuto">34</label>
	
	<input tabindex="1" type="checkbox"
	name="<%=MLL_5%>" value="" class="radioAuto" id="ATLL35" onclick="fillDentalValue(this.id);chkValueMissing(this);chkDentalValue(this);" />
	<label class="smallAuto">35</label>
	
	<input tabindex="1" type="checkbox"
	name="<%=MLL_6%>" value="" class="radioAuto" id="ATLL36" onclick="fillDentalValue(this.id);chkValueMissing(this);chkDentalValue(this);" />
	<label class="smallAuto">36</label>
	
	<input tabindex="1" type="checkbox"
	name="<%=MLL_7%>" value="" class="radioAuto" id="ATLL37" onclick="fillDentalValue(this.id);chkValueMissing(this);chkDentalValue(this);" />
	<label class="smallAuto">37</label>
	
	<input tabindex="1" type="checkbox"
	name="<%=MLL_8%>" value="" class="radioAuto" id="ATLL38" onclick="fillDentalValue(this.id);chkValueMissing(this);chkDentalValue(this);" />
...
<label class="smallAuto">UR</label>
<input tabindex="1" type="checkbox"
	name="<%=UUR_8%>" value="" class="radioAuto" id="CTUR55" onclick="fillDentalValue(this.id);chkValue(this);chkDentalValue(this);" />
	<label class="smallAuto">55</label>

<input tabindex="1" type="checkbox"
	name="<%=UUR_7%>" value="" class="radioAuto" id="CTUR54" onclick="fillDentalValue(this.id);chkValue(this);chkDentalValue(this);chkDentalValue(this);" />
	<label class="smallAuto">54</label>

<input tabindex="1" type="checkbox"
	name="<%=UUR_6%>" value="" class="radioAuto" id="CTUR53" onclick="fillDentalValue(this.id);chkValue(this);chkDentalValue(this);" />
	<label class="smallAuto">53</label>
<input tabindex="1" type="checkbox"
	name="<%=UUR_5%>" value="" class="radioAuto" id="CTUR52" onclick="fillDentalValue(this.id);chkValue(this);chkDentalValue(this);" />
	<label class="smallAuto">52</label>

<input tabindex="1" type="checkbox"
	name="<%=UUR_4%>" value="" class="radioAuto" id="CTUR51" onclick="fillDentalValue(this.id);chkValue(this);chkDentalValue(this);" />
	<label class="smallAuto">51</label>
<%-- 
<input tabindex="1" type="checkbox"
	name="<%=UUR_3%>" value="" class="radioAuto" id="CTUR" onclick="fillDentalValue(this.id);chkValue(this);chkDentalValue(this);" />
	<label class="smallAuto">13</label>
<input tabindex="1" type="checkbox"
	name="<%=UUR_2%>" value="" class="radioAuto" id="CTUR12" onclick="fillDentalValue(this.id);chkValue(this);chkDentalValue(this);" />
	<label class="smallAuto">12</label>
<input tabindex="1" type="checkbox"
	name="<%=UUR_1%>" value="" class="radioAuto" id="CTUR11" onclick="fillDentalValue(this.id);chkValue(this);chkDentalValue(this);" />
	<label class="smallAuto">11</label>
	 --%>
<input tabindex="1" type="checkbox"
	name="<%=UUL_1%>" value="" class="radioAuto" id="CTUL61" onclick="fillDentalValue(this.id);chkValue(this);chkDentalValue(this);" />
	<label class="smallAuto">61</label>
	
	<input tabindex="1" type="checkbox"
	name="<%=UUL_2%>" value="" class="radioAuto" id="CTUL62" onclick="fillDentalValue(this.id);chkValue(this);chkDentalValue(this);" />
	<label class="smallAuto">62</label>
	
	<input tabindex="1" type="checkbox"
	name="<%=UUL_3%>" value="" class="radioAuto" id="CTUL63" onclick="fillDentalValue(this.id);chkValue(this);chkDentalValue(this);" />
	<label class="smallAuto">63</label>
	
	<input tabindex="1" type="checkbox"
	name="<%=UUL_4%>" value="" class="radioAuto" id="CTUL64" onclick="fillDentalValue(this.id);chkValue(this);chkDentalValue(this);" />
	<label class="smallAuto">64</label>
	
	<input tabindex="1" type="checkbox"
	name="<%=UUL_5%>" value="" class="radioAuto" id="CTUL65" onclick="fillDentalValue(this.id);chkValue(this);chkDentalValue(this);" />
	<label class="smallAuto">65</label>
<%-- 	
	<input tabindex="1" type="checkbox"
	name="<%=UUL_6%>" value="" class="radioAuto" id="CTUL26" onclick="fillDentalValue(this.id);chkValue(this);chkDentalValue(this);" />
	<label class="smallAuto">26</label>
	
	<input tabindex="1" type="checkbox"
	name="<%=UUL_7%>" value="" class="radioAuto" id="CTUL27" onclick="fillDentalValue(this.id);chkValue(this);chkDentalValue(this);" />
	<label class="smallAuto">27</label>
	
	<input tabindex="1" type="checkbox"
	name="<%=UUL_8%>" value="" class="radioAuto" id="CTUL28" onclick="fillDentalValue(this.id);chkValue(this);chkDentalValue(this);" />
	<label class="smallAuto">28</label> --%>
<label  class="smallAuto">UL</label>
...
<label  class="smallAuto">LR</label>
<input tabindex="1" type="checkbox"
	name="<%=ULR_8%>" value="" class="radioAuto" id="CTLR85" onclick="fillDentalValue(this.id);chkValue(this);chkDentalValue(this);" />
	<label class="smallAuto">85</label>

<input tabindex="1" type="checkbox"
	name="<%=ULR_7%>" value="" class="radioAuto" id="CTLR84" onclick="fillDentalValue(this.id);chkValue(this);chkDentalValue(this);" />
	<label class="smallAuto">84</label>

<input tabindex="1" type="checkbox"
	name="<%=ULR_6%>" value="" class="radioAuto" id="CTLR83" onclick="fillDentalValue(this.id);chkValue(this);chkDentalValue(this);" />
	<label class="smallAuto">83</label>
<input tabindex="1" type="checkbox"
	name="<%=ULR_5%>" value="" class="radioAuto" id="CTLR82" onclick="fillDentalValue(this.id);chkValue(this);chkDentalValue(this);" />
	<label class="smallAuto">82</label>

<input tabindex="1" type="checkbox"
	name="<%=ULR_4%>" value="" class="radioAuto" id="CTLR81" onclick="fillDentalValue(this.id);chkValue(this);chkDentalValue(this);" />
	<label class="smallAuto">81</label>

<%-- <input tabindex="1" type="checkbox"
	name="<%=ULR_3%>" value="" class="radioAuto" id="CTLR43" onclick="fillDentalValue(this.id);chkValue(this);chkDentalValue(this);" />
	<label class="smallAuto">43</label>
<input tabindex="1" type="checkbox"
	name="<%=ULR_2%>" value="" class="radioAuto" id="CTLR42" onclick="fillDentalValue(this.id);chkValue(this);chkDentalValue(this);" />
	<label class="smallAuto">42</label>
<input tabindex="1" type="checkbox"
	name="<%=ULR_1%>" value="" class="radioAuto" id="CTLR41" onclick="fillDentalValue(this.id);chkValue(this);chkDentalValue(this);" />
	<label class="smallAuto">41</label> --%>
	
<input tabindex="1" type="checkbox"
	name="<%=ULL_1%>" value="" class="radioAuto" id="CTLL71" onclick="fillDentalValue(this.id);chkValue(this);chkDentalValue(this);" />
	<label class="smallAuto">71</label>
	
	<input tabindex="1" type="checkbox"
	name="<%=ULL_2%>" value="" class="radioAuto" id="CTLL72" onclick="fillDentalValue(this.id);chkValue(this);chkDentalValue(this);" />
	<label class="smallAuto">72</label>
	
	<input tabindex="1" type="checkbox"
	name="<%=ULL_3%>" value="" class="radioAuto" id="CTLL73" onclick="fillDentalValue(this.id);chkValue(this);chkDentalValue(this);" />
	<label class="smallAuto">73</label>
	
	<input tabindex="1" type="checkbox"
	name="<%=ULL_4%>" value="" class="radioAuto" id="CTLL74" onclick="fillDentalValue(this.id);chkValue(this);chkDentalValue(this);" />
	<label class="smallAuto">74</label>
	
	<input tabindex="1" type="checkbox"
	name="<%=ULL_5%>" value="" class="radioAuto" id="CTLL75" onclick="fillDentalValue(this.id);chkValue(this);chkDentalValue(this);" />
	<label class="smallAuto">75</label>
	
	<%-- <input tabindex="1" type="checkbox"
	name="<%=ULL_6%>" value="" class="radioAuto" id="CTLL36" onclick="fillDentalValue(this.id);chkValue(this);chkDentalValue(this);" />
	<label class="smallAuto">36</label>
	
	<input tabindex="1" type="checkbox"
	name="<%=ULL_7%>" value="" class="radioAuto" id="CTLL37" onclick="fillDentalValue(this.id);chkValue(this);chkDentalValue(this);" />
	<label class="smallAuto">37</label>
	
	<input tabindex="1" type="checkbox"
	name="<%=ULL_8%>" value="" class="radioAuto" id="CTLL38" onclick="fillDentalValue(this.id);chkValue(this);chkDentalValue(this);" />
	<label class="smallAuto">38</label> --%>
...
<input name="treatableTooth" value="<%=opdDetailListForFollowUp.size()>0?opdDetailListForFollowUp.get(0).getTreatableTooth()!=null?opdDetailListForFollowUp.get(0).getTreatableTooth():"":""%>" id="treatableTooth" tabindex="1" maxlength="40" class="auto" size="63"/>
<div class="clear"></div>
<label>Treatment Required</label>
<textarea name="teethRemarks" id="teethRemarks" class="auto"  cols="60" rows="0" maxlength="400" 	tabindex="1" onpaste="return checkOnPaste(this)"
	oninput="return checkMaxLengthMoz(this)"
	onKeyDown="return checkMaxLength(this)" onKeyUp="finalCheck(this)"class="auto"><%=opdDetailListForFollowUp.size()>0?opdDetailListForFollowUp.get(0).getMissingTeethRemark()!=null?opdDetailListForFollowUp.get(0).getMissingTeethRemark():"":""%></textarea>
...
<label style="width:150px;">Remarks</label>
<input type="text" name="anesthesiaRemark" tabindex="1" validate="Remarks,string,no" id="anesthesiaRemark" maxlength="100" style="width:476px;"/>
...
<label class="auto">Teeth Conserved (With RT)</label>
...
<input name="Prevoius2"	tabindex="1" type="button" value="Previous" class="button"	onclick="openPopupForPatientPrescription('<%=visit.getVisitNo()%>','<%=visit.getHin().getId()%>','<%=visit.getDepartment().getId()%>','<%=visit.getId()%>')" />
			...
			<div id="prescriptionImportButton" class="floatLeft">
				<input name="prescriptionImportButton1" tabindex="1" type="button"
					value="Import New" class="button"
					onclick="getListForTreatment('treatmentDiv');" />
		...
		<th scope="col">Intake</th> -->
					...
					<tr>
						<td><input type="text" value="" tabindex="1"
							...
							<div id="ac2updatenip2" style="display: none;" class="autocomplete"></div>
							<script type="text/javascript" language="javascript"
								charset="utf-8">
			
			  new Ajax.Autocompleter('nomenclature<%=nipInc%>','ac2updatenip2','opd?method=getNipItemListForAutoCompleteItem',{parameters:'requiredField=nomenclature<%=nipInc%>'});
			</script></td>
   ...
   <div class="Block">
		...
		<textarea name="otherTreatment" id="otherTreatment" cols="50" rows="0" maxlength="500"tabindex="1" onkeyup="return ismaxlength(this)" class="auto"></textarea>
...
<div class="clear paddingTop15"></div>
		...
		<label>Dental Procedure Advice</label> <input name="investigationTemplate" value="Dental Procedure Calendar"onclick="openWindow('/hms/hms/opd?method=showProcedureCalenderDoctorWise&opdFlag=y&dentalFalg=y')" tabindex="1" class="buttonBig" type="button">
		<div class="clear"></div>
		<div class="clear"></div>
		<div class="clear"></div>
		<div class="floatRight" style="margin-right: 173px">
			<input type="button" class="buttonAdd" alt="Add" tabindex="4"
				value="" onclick="addRowTherapy('d');" align="left" />
			<input type="button" class="buttonDel" tabindex="3" alt="Delete"
		...
		<div class="clear"></div><div class="cmntable">
		<div id="divTemplet" style="width: 700px;">
			<table border="0" align="center" cellpadding="0" cellspacing="0"
				id="gridTherapy">
	...
	%>
				<tr>
					...
					<td>
						...
						size="35" name="therapy_nursing<%=incr%>" <%-- onkeypress="selectSNOMEDCT('ACTIVE','PROCEDURE','ALL',returnlimit_IN,callbck_index,'procedureName_nursing<%=incr%>');" --%> 	
										 />
						<%}else{%> <input type="text" class="opdTextBoxSmall textYellow"
						value="<%=nursingCare %>" id="therapy_nursing<%=incr%>" onfocus="fillProcedure(this,<%=incr%>);"
						size="35" name="therapy_nursing<%=incr%>" <%-- onkeypress="selectSNOMEDCT('ACTIVE','PROCEDURE','ALL',returnlimit_IN,callbck_index,'procedureName_nursing<%=incr%>');" --%> 
										  />
						<%}%>
						<div id="ac2updates_therapy<%=incr%>" style="display: none;"
							class="autocomplete"></div> <script type="text/javascript"
							language="javascript" charset="utf-8">
											  new Ajax.Autocompleter('therapy_nursing<%=incr%>','ac2updates_therapy<%=incr%>','registration?method=getProcedureForAutoComplete&procedureType=d',{
											  callback: function(element, entry) {
			...
			<%-- 		<td>
				...
				<td>
					...
					<td>
						<textarea size="20" class="large" id="remark_therapy<%=incr%>" name="remark_therapy<%=incr%>" validate="Remarks,string,no" value="" tabindex="1" style="width: 250px; height: 50px;" maxlength="300"></textarea></td>
			...
			<input type="hidden" id="therapyHeaderId" name="therapyHeaderId"
				value="<%=procedureHeaderId%>" />
			</td> <input type="hidden" name="therapyhdb" value="<%=incr%>"
				id="therapyhdb" />
		</div>
	</div>
...
%>
		...
		<div id="disposalDiv" style="display: inline">
			...
			<textarea name="presentAdvice" id="presentAdvice"cols="50" rows="0" maxlength="300"
				tabindex="1" onkeyup="return ismaxlength(this)" class="auto"></textarea>
			<div class="clear"></div>
...
<%} %>
				...
				<label>Refer Date:</label> <input type="text" id="referVisitDate"
					name="referVisitDate" class="date" value="<%=currentDate%>"
					readonly="readonly" />
				<!-- onblur="checkAdmte()" -->
...
<input	name="consultationDate"  id="consultationDate" type="hidden" value="<%=consultationDate%>" />
...
/* 	 if(document.getElementById('referedToMH').checked == true){
	 ...
	 if(validatePregnancy()  &&  validateNip() && validateFrequency() && validateDays()  && validateTherapy() && validateReferal() && validateAdmission() && validateSurgery()  ){
