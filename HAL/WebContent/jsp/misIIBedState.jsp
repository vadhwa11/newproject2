...
<h2 align="left" class="style1">II Bed State</h2>
<br />
<%	String userName = "";
			 ...
			 %>
<form name="BedState" target=_blank method="post" action=""><label
	...
	onClick="setdate('<%=currenDate %>',document.BedState.<%=FROM_DATE%>,event)" />
<label class="bodytextB">To Date:</label> <input type="text"
	id="ToDateId" name="<%=TO_DATE %>" value="<%=currenDate %>"
	class="textbox_date" readonly="readonly" MAXLENGTH="30" /> <img
	id="calendar" src="/hms/jsp/images/cal.gif" width="16" height="16"
	border="0" validate="Pick a date" class="calender"
	onClick="setdate('<%=currenDate %>',document.BedState.<%=TO_DATE%>,event)" />
<br />
<input type="button" name="OK" value="OK" class="button"
	onClick="submitForm('BedState','mis?method=showIIBedStateReport');" />
