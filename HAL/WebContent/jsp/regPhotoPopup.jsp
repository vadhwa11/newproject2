...
function jsImport()
{
	...
	submitForm('attachPhoto','registration?method=addPhotoFile&filename='+filename);
//	window.close();
	}
}
...
<div class="clear"></div>
<label style="font-size:8px;padding-left:115px;width:250px;color: #AC1400;">only .jpg files are accepted</label>
</div>
