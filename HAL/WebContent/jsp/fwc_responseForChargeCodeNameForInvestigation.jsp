...
<%
       ...
       System.out.println("chargeCode :"+rowVal);
       System.out.println("chargeCodeId :"+rowVal);
   %>
<div id="chargeCodeVal"><input id="chargeCode<%=rowVal %>"
	type="text" size="10" id="chargeCode<%=rowVal%>"
	name="chargeCode<%=rowVal%>" value="<%=chargeCode %>" readonly /> <input
	type="text" name="chargeCodeId" value="<%=chargeCodeId%>" /></div>
