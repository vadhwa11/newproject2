...
<div class="titleBg">
<h2>ANNUAL EXAMINATION REPORT ON RELEASE/DISCHARGE</h2>
</div>
<div class="clear"></div>
<form name="medicalBoardExaminationRelease" action="" method="post">
...
<input tabindex="1" type="text" readonly="readonly" maxlength="20"  id="" name="<%=AUTHORITY_OF_BOARD %>"maxlength="6" value="<%=medExamObj.getAuthority() %>"
	onKeyUp="limitText(this,6);"  />

 <% }else{%>
<input tabindex="1" type="text" readonly="readonly" maxlength="20"  id="" name="<%=AUTHORITY_OF_BOARD %>" maxlength="6" 
	onKeyUp="limitText(this,6);"  />
...
<input tabindex="1" type="text" readonly="readonly" maxlength="20"  id="" name="<%=PLACE %>"maxlength="6" value="<%=medExamObj.getPlace() %>"
	onKeyUp="limitText(this,6);"  />
...
<input tabindex="1" type="text" readonly="readonly" maxlength="20"  id="" name="<%=FULL_NAME %>"maxlength="6" value="<%=medExamObj.getNameInFull() %>"
	onKeyUp="limitText(this,6);"  />

 <% }else{%>
<input tabindex="1" type="text" readonly="readonly" maxlength="20"  id="" name="<%=FULL_NAME %>" maxlength="6" 
	onKeyUp="limitText(this,6);"  />
...
<label >Permanent Address</label> 
 ...
 <textarea  readonly="readonly" rows="" cols=""   	name="<%=PERMANENT_ADDRESS %>" onkeyup="chkLength(this,50);" ><%=medExamObj.getParmanentAddress() %></textarea>

 <% }else{%>
<textarea  readonly="readonly" rows="" cols=""   	name="<%=PERMANENT_ADDRESS %>"  onkeyup="chkLength(this,50);" ></textarea>
 ...
 <input	type="text" readonly="readonly"  name="<%=PAST_MEDICAL_HISTORY%>"	tabindex="2"  value="<%=medExamObj.getPastmedicalhistory() %>"/>
  <% }else{%>
<input	type="text" readonly="readonly" value="" name="<%=PAST_MEDICAL_HISTORY%>"	tabindex="2" />
 <% }%>
 
 <div class="clear"></div>
 <label >Identification Marks</label> 
 <% if(medExamObj.getIdentificationMarks1()!=null){%>
<label class="valueAuto">1.)</label><input tabindex="1" type="text" class="auto" size="72" readonly="readonly" maxlength="20"  id="" name="<%=IDENTIFICATION_MARKS1 %>"maxlength="6" value="<%=medExamObj.getIdentificationMarks1() %>"
	onKeyUp="limitText(this,20);"  />

 <% }else{%>
<label class="valueAuto">1.)</label><input tabindex="1" type="text" class="auto" size="72" readonly="readonly" maxlength="20"  id="" name="<%=IDENTIFICATION_MARKS1 %>" maxlength="6" 
	onKeyUp="limitText(this,20);"  />
...
<label class="valueAuto">2.)</label><input tabindex="1" type="text" class="auto" size=72 readonly="readonly" maxlength="20"  id="" name="<%=IDENTIFICATION_MARKS2 %>"maxlength="6" value="<%=medExamObj.getIdentificationMarks2() %>"
	onKeyUp="limitText(this,6);"  />

 <% }else{%>
<label class="valueAuto">2.)</label><input tabindex="1" type="text" class="auto" size="72" readonly="readonly" maxlength="20"  id="" name="<%=IDENTIFICATION_MARKS2 %>" maxlength="6" 
	onKeyUp="limitText(this,6);"  />
...
<td width="10%"><input tabindex="1" type="text" readonly="readonly"	name="<%=PLACE+inc1 %>" maxlength="10" value="<%=setMedicalExam.getPlace() %>"/></td>
...
<!--<select id="serviceTypeId" name="<%=SERVICE_TYPE_ID %>" validate="Service Type,string,yes"  tabindex="1" onchange="populateRank('registration');populateRecordOfficeAddress(this.value,'registration');getServicePersonName('registration','registration?method=getServicePersonName');checkServiceType(this.value);getHin();">
		-->
	<select disabled="disabled"  id="serviceTypeId" name="<%=SERVICE_TYPE_ID %>" validate="Service Type,string,no"  tabindex="1" onchange="populateRank('registration');getServicePersonName('registration','registration?method=getServicePersonName');checkServiceType(this.value);getHin();">
		<option value="0">Select</option>
...
<!--Block Four Ends-->
<div class="clear paddingTop15"></div>
<h4> DISEASE<a href="javascript:animatedcollapse.toggle('slide3')">(Click Here)</a></h4>
<div class="clear"></div>
<div id="slide3">
<div class="Block">
  <label>Date <span>*</span> </label>
...
<img src="/hms/jsp/images/cal.gif" width="16" height="16" border="0"
	validate="Pick a date" class="calender"
	onclick="setdate('',medicalBoardExaminationReleaseDischarge.<%=DATE_DISEASE%>,event);" />
...
<input	tabindex="1" name="<%=DATE_APPROXIMATE %>" class="date" 	validate="DOB,date,no" maxlength="10" value="<%=HMSUtil.convertDateToStringWithoutTime(medExamObj.getDateapproximate())%>"
	onKeyUp="mask(this.value,this,'2,5','/');" /> 

 <% }else{%>
<input	tabindex="1" name="<%=DATE_APPROXIMATE %>" class="date" 	validate="DOB,date,no" maxlength="10"
	onKeyUp="mask(this.value,this,'2,5','/');" /> 

 <% }%>	
<img src="/hms/jsp/images/cal.gif" width="16" height="16" border="0"
	validate="Pick a date" class="calender"
	onclick="setdate('',medicalBoardExaminationReleaseDischarge.<%=DATE_APPROXIMATE%>,event);" />
  
<label >Disability <br /><span class="sublabel">(Before Air Force)</span></label> 

<select disabled="disabled"  name="<%=DISABILITY_BEFORE %>" size="0" tabindex="1" id="disabilitybefore">
	<option value="0">select</option>
	<option value="Yes">Yes</option>
	<option value="No">No</option>
</select>
...
<select disabled="disabled"  name="<%=CLAMING_DISABILITY %>" size="0" tabindex="1" id="clamingdisability">
	<option value="0">select</option>
	<option value="Yes">Yes</option>
	<option value="No">No</option>
</select>
...
<textarea  readonly="readonly" rows="" cols="71"   	name="<%=OTHER_INFORMATION %>" class="auto" onkeyup="chkLength(this,50);" ><%=medExamObj.getAnyOtherInformationAboutYourHealth() %></textarea>
 <% }else{%>
<textarea  readonly="readonly" rows="" cols="71"   	name="<%=OTHER_INFORMATION %>" class="auto" onkeyup="chkLength(this,50);" ></textarea>
 <% }%>
</div>
</div>
<div class="clear paddingTop15"></div>
...
<div class="clear paddingTop15"></div>
<h4>Dental <a href="javascript:animatedcollapse.toggle('slide4')">(Click Here)</a></h4>
<div class="clear"></div>
<div id="slide4">
<div class="Block">
<div class="clear"></div>
...
if(medExamObj.getRemarksTeath()!=null){%>
 <textarea  readonly="readonly" rows="" cols=""	name="<%=DENTAL_REMARKS %>" class="large" onkeyup="chkLength(this,300);" value="<%=medExamObj.getRemarksTeath() %>"><%=medExamObj.getRemarksTeath() %></textarea>
 <% }else{%>
 <textarea  readonly="readonly" rows="" cols=""	name="<%=DENTAL_REMARKS %>" class="large" onkeyup="chkLength(this,300);"></textarea>
 <% }%>
...
<h4> PHYSICAL DEVELOPMENT <a href="javascript:animatedcollapse.toggle('slide5')">(Click Here)</a></h4>
<div class="clear"></div>
<div id="slide5">
<div class="Block">
<label >Height</label> 
...
<h4> EYES <a href="javascript:animatedcollapse.toggle('slide6')">(Click Here)</a></h4>
<div class="clear"></div>
<div id="slide6">
...
<h4> Ear <a	href="javascript:animatedcollapse.toggle('slide7')">(Click Here)</a></h4>
<div class="clear"></div>
<div id="slide7">
<div class="Block">
<div class="clear"></div>
...
<h4>Investigation <a href="javascript:animatedcollapse.toggle('slide8')">(Click Here)</a></h4>
<div id="slide8">
<div class="Block">
...
<h4>RESPIRATORY SYSTEM <a href="javascript:animatedcollapse.toggle('slide10')">(Click Here)</a></h4>
<div class="clear"></div>
<div id="slide10">
<div class="Block">
<div class="clear"></div>
...
<h4>GASTRO INTESTINAL SYSTEM <a	href="javascript:animatedcollapse.toggle('slide11')">(Click Here)</a></h4>
<div class="clear"></div>
<div id="slide11">
<div class="Block">
<div class="clear"></div>
...
<h4>CENTRAL NERVOUS SYSTEM <a href="javascript:animatedcollapse.toggle('slide12')">(Click Here)</a></h4>
<div class="clear"></div>
<div id="slide12">
<div class="Block">
<div class="clear"></div>
...
<h4>GYNAECOLOGY EXAM <a href="javascript:animatedcollapse.toggle('slide13')">(Click Here)</a></h4>
<div class="clear"></div>
<div id="slide13">
<div class="Block">
...
<img src="/hms/jsp/images/cal.gif"	width="16" height="16" border="0" validate="Pick a date"
	class="calender"
	onclick="setdate('',medicalBoardExaminationRelease.<%=DATE_OF_LASTCONFINEMENT%>,event);" />
<div class="clear"></div>
...
<img src="/hms/jsp/images/cal.gif"	width="16" height="16" border="0" validate="Pick a date"
	class="date"
	onclick="setdate('',medicalBoardExaminationRelease.<%=GYANAECOLOGY_DATE%>,event);" />
	
<label >Remarks</label> 
<% if(medExamObj.getRemarksGynaecology()!=null){%>
 <textarea  readonly="readonly" rows="" cols="71"	name="<%=GYANAECOLOGY_RAMARKS %>" class="auto" onkeyup="chkLength(this,300);" value="<%=medExamObj.getRemarksGynaecology() %>"><%=medExamObj.getRemarksGynaecology() %></textarea>

 <% }else{%>
 <textarea  readonly="readonly" rows="" cols="71"	name="<%=GYANAECOLOGY_RAMARKS %>" class="auto" onkeyup="chkLength(this,300);"></textarea>
 <% }%>
...
<div class="clear paddingTop15"></div>
<h4>IMMUNIZATION STATUS <a	href="javascript:animatedcollapse.toggle('slide14')">(Click Here)</a></h4>
<div class="clear"></div>
<div id="slide14">
<div class="Block">
<div class="clear"></div>
...
<img src="/hms/jsp/images/cal.gif"
	...
	class="calender"
	onclick="setdate('',medicalBoardExaminationRelease.<%=DOM%>,event);" />
...
<div class="clear paddingTop15"></div>
<h4>LIFE CYCLE FACTORS <a	href="javascript:animatedcollapse.toggle('slide15')">(Click Here)</a></h4>
<div class="clear"></div>
<div id="slide15">
<div class="Block">
<div class="clear"></div>
...
<div class="clear"></div>
<input tabindex="1" name="Button"	type="button" class="button" value="VALIDATE"	onClick="submitForm('medicalBoardExaminationRelease','medicalExam?method=validateMedExam');" />
<input tabindex="1" name="Button"	type="button" class="button" value="REJECT"	onClick="submitForm('medicalBoardExaminationRelease','medicalExam?method=rejectMedExam');" />
