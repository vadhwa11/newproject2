...
<div class="Block">
<label>ServiceType Code</label><input type="radio" class="radioAuto"
	name="<%=SELECTED_RADIO  %>" value="1" checked="checked" /> <label class="noWidth">ServiceType
Name</label> <input type="radio" class="radioAuto"
	name="<%=SELECTED_RADIO %>" value="2" />  <input type="text" id="searchField" name="<%= SEARCH_FIELD%>"
	value="" validate="ServiceType Code,string,no" MAXLENGTH="8" tabindex=1
...
<input type="button" name="search" value="Search" class="button"
	...
	name="<%=JASPER_FILE_NAME%>" value="Mas_service_type"></form>
...
<h4><a href="hospital?method=showServiceTypeJsp">Show All Records</a></h4> <%
			}
		 }
...
<form name="serviceType" method="post" action=""><input
...
<div class="Clear"></div>
<div class="Block">
<label>  ServiceType Code <span>*</span></label>

<input type="text"	name="<%= CODE%>" value="" validate="ServiceType Code,string,yes" MAXLENGTH="8" / tabindex=1>
	 
<label> ServiceType Name<span>*</span></label>
<input type="text" name="<%= SEARCH_NAME %>" value="" validate="ServiceType Name,string,yes" MAXLENGTH="30" / tabindex=1 onkeypress="return submitenter(this,event,'hospital?method=addServiceType')">
<script>
document.serviceType.<%=CODE%>.focus();
</script>
			
<label>Short Description<span>*</span> </label>
<input type="text" name="<%= SHORT_DESCRIPTION%>" value=""	validate="Short Description,string,yes"	MAXLENGTH="5" / tabindex=1> 
