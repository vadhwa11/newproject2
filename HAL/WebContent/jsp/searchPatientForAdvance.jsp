...
<title>Search Billing Deposits</title>
...
<label>Hin:</label> <input type="text" name="<%=HIN_NO %>" value=""
	class="textbox_size20" MAXLENGTH="50" /> <label class="bodytextB1">Patient
...
<input type="button" name="submit" id="addbutton"
	onclick="submitForm('billingDepositsSearch','billing?method=searchPatient&flag=deposit');"
...
<form name="patientAdvance" method="post" action=""><script
...
<script type="text/javascript" language="javascript">
	...
	<% 	for(Patient patient : patientList){
		if(patient.getPatientStatus().equals("In Patient")){
			...
			if(patient.getBlPatientLedgers() != null && patient.getBlPatientLedgers().size() > 0){
