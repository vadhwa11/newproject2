...
<script type="text/javascript">
  ...
  obj.action = "/hms/hms/stores?method=dailyIssueSummryReportPatientWise";
  obj.submit();
  }
</script>
...
<input type="button" name="add1" id="addbutton1" value="Print" class="button" onClick="submitForm('dailyIssueSummry','stores?method=generateDailyIssueSummryPatientWise');" accesskey="a" tabindex=1 />  
