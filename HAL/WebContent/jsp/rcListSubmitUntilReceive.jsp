...
<div id="divSearchResult">
  	...
  	<table id="tblSearchResultsHeader" class="tblSearchResultsHeader" cellspacing="0" cellpadding="0" border="0">
			<tr>
				...
				<th id="th1">RC No</th>
				<th id="th2">RC Date</th>
				<th id="th2">Vendor</th>
				<th id="th3">Created By</th>
				<!-- <th id="th4">From Date</th>	
				<th id="th4">To Date</th>				
				 -->
...
function GetMPRList(MODE)
{
	...
	var url = "stores?method=rcListSubmitUntilReceive";
	var bClickable = true;
...
function makeTable(jsonData)
{
	...
	for(i=0;i<jsonData.length;i++)
		{			
			...
			htmlTable = htmlTable +"<td style='width: 100px;'>"+jsonData[i].Vendor+"</td>";
			htmlTable = htmlTable +"<td style='width: 120px;'>"+jsonData[i].RequestedBy+"</td>";
		/* 	htmlTable = htmlTable +"<td style='width: 120px;'>"+jsonData[i].FromDate+"</td>";
			htmlTable = htmlTable +"<td style='width: 120px;'>"+jsonData[i].ToDate+"</td>"; */
...
function ViewUpdateMR(Id)
{
	...
	window.location = "stores?method=viewUpdateRCSubmitUntilReceive&requestHeaderId="+Id+"&appId=A1523";	
