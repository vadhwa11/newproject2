...
<label><span>*</span> Service No.</label> <input typ="text"
	name="<%=SERVICE_NO %>" id="<%=SERVICE_NO %>" value=""
	validate="ServiceNo,string,yes" maxlength="15" tabindex="1"
	onblur="ajaxFunctionForMA(allotAirmen1);" /> <label>Service
Person</label> <input typ="text" value="" name="<%=SERVICE_PERSON_NAME %>"
	id="<%=SERVICE_PERSON_NAME %>" validate="Service Person Name,string,no"
...
<input type="button" class="button" value="Submit"
	onclick="submitForm('allotAirmen1','accom?method=submitAllotmentDetailsOfficer');"
