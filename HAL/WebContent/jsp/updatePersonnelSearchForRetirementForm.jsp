...
<h6>Personnel Search For Updating Retirement Form Details</h6>
<div class="Clear"></div>
<%
...
<div class="blockFrame"><label>Personnel Name</label> <input
	type="text" name="personnelName" value="" class="textbox_size20"
	MAXLENGTH="30" /> <label>Pass No. </label> <input type="text"
	name="passNo" value="" class="textbox_size20" MAXLENGTH="6" />
...
<input type="button" name="Search"
	onclick="submitForm('personnelSearch','/hms/hms/pension?method=personnelSearchJsp&jspName=updateRetirementForm');"
...
<form name="updatePersonnelsearchForRetirementForm" method="post"
...
<script type="text/javascript" language="javascript">
    ...
    formName = "updatePersonnelsearchForRetirementForm"
