...
<form name="monAncVisit" method="post" action="" >
<div class="titleBg">
<h2>ANC Visit</h2>
</div>
<div class="Block">
...
<img id="calendar" src="/hms/jsp/images/cal.gif" width="16" height="16" border="0" validate="Pick a date" class="calender" onClick="setdate('<%=f %>',document.monAncVisit.<%=FROM_DATE%>,event)" />


<label>To Date<span>*</span> </label> 
<input type="text" id="ToDateId" name="<%=TO_DATE %>" value="<%=t %>" class="date" readonly="readonly" MAXLENGTH="30" /> 
<img id="calendar" src="/hms/jsp/images/cal.gif" width="16" height="16" border="0" validate="Pick a date" class="calender" onClick="setdate('<%=t %>',document.monAncVisit.<%=TO_DATE%>,event)" />
...
<div class="Clear"></div>
 <input type="button" name="OK" value="Ok" class="button" onClick="submitForm('monAncVisit','/hms/hms/registration?method=showOPDRegisterFwcReport');" />
