...
<input type="hidden" name="<%=VISIT_ID %>" id="visitId"
	...
	<input type="button" name="yes" value="Yes" class="button" onclick="submitForm('patientAD','opd?method=printOpdUrologyCaseSheetHaeC','checkTargetForYes');" />
...
<input type="button" name="Back" value="Back" class="button"
		onclick="submitForm('patientAD','opd?method=showOPDMainJsp&visitId=<%=visitId%>');"/>
