...
<script type="text/javascript">
  ...
  obj.action = "/hms/hms/stores?method=UnusedMedicineRegister";
  obj.submit();
  }
</script>
...
<form name="UnusedMedicineRegister" method="post" action="">
<div class="titleBg">
<h2>Unused Medicine Register</h2>
</div>
<div class="Block">
...
<input type="button" name="add1" id="addbutton1" value="Print" class="button" onClick="submitForm('UnusedMedicineRegister','stores?method=printUnusedMedicineRegister');" accesskey="a" tabindex=1 />  
<input type="button" name="clear" id="clearbutton" value="Reset" class="button" onClick="clearButton('UnusedMedicineRegister');" accesskey="a" tabindex=1 />
<div class="clear"></div>
