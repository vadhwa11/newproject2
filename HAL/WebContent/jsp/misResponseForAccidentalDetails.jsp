...
<div id="hinDiv">
<label>HIN</label>
		<select name="hin" validate="Hin No,string,no" id="hinId" onchange="if(this.value!=''){submitProtoAjaxWithDivName('AccidentDetails','/hms/hms/mis?method=getPatientDetailForAccidentalDetails','DivPillion');}" tabindex="1">
