...
<h6>Personnel Search For Updating Form 7</h6>
<div class="Clear"></div>
<%
...
<div class="blockFrame"><label>Personnel Name</label> <input
	...
	name="passNo" value="" class="textbox_size20" MAXLENGTH="30" />
...
<input type="button" name="Search"
	onclick="submitForm('personnelSearch','/hms/hms/pension?method=updatePersonnelSearchForForm7');"
	value="Search" class="cmnButton" accesskey="a" /> <jsp:include
	page="searchResultBlock.jsp" />
<div class="Clear"></div>
<div id="searchresults" tabindex=2>
<div id="searchtable" tabindex=2></div>
<form name="updatePersonnelsearchForForm7" method="post" action="">
...
<script type="text/javascript" language="javascript">
    ...
    formName = "updatePersonnelsearchForForm7"
