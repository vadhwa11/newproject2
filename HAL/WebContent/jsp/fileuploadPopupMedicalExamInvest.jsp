...
function jsImport()
{
	...
	}else
	{
      ...
      document.attachMedicalExamDocument.method="post";
       submitForm('attachMedicalExamDocument','medicalExam?method=submitInvestigationUploadDocuments&hinId='+hin_id+'&invest_id='+invest_id+'&masExamId='+masExamId+'&hinNo='+hinNo+'&filename='+filename);
...
function jsViewDocument()
{
		...
		hinNo='<%=hinNo%>';
	   document.attachMedicalExamDocument.method="post";
       submitForm('attachMedicalExamDocument','medicalExam?method=viewUploadDocumentsDetailsInvest&hinId='+hin_id+'&InvestId='+invest_id+'&hinNo='+hinNo+'&masExamId='+masExamId);
...
<form name="attachMedicalExamDocument" method="post"  enctype="multipart/form-data">
<%
	if(message!= null){
%>
<h4><%=message %></h4>
