...
<form name="getReferralWaitingList" method="post" action="">
    <h4><%=message %></h4>
	<h2>Submission of Invoice for Division </h2>
...
<script language="javascript">
	...
	function GetPatientList(MODE) {
		...
		var url = "referral?method=getInvoiceWaitingListRejected";
		var bClickable = true;
	...
	function executeClickEvent(Id)
	 ...
	 window.location="referral?method=generateInvoicePage&opdId="+Id;
	 }
