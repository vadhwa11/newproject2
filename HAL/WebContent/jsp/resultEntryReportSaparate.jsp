...
function fillAtleastOne(){
	...
	function submitFormForOrderBookingReport(){
		...
		if(flag == false){
			...
			submitForm('resultDetailListForReport','/hms/hms/investigation?method=printProvisionalResultEntry');
		}
...
<h6>Provisional Report Search</h6>
<div class="Clear"></div>
<div class="blockTitle">Provisional Report Search</div>
...
<input type="button" name="Search" id="addbutton"
	onclick="submitForm('provisionalResultSearch','/hms/hms/investigation?method=searchProvisionalResultEntryDetails','fillAtleastOne');"
