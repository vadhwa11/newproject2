...
int inpatientId =0 ;
if(splOpinionList != null)
{
	ipdSpecialistOpinion = splOpinionList.get(0);
   inpatient=(Inpatient)ipdSpecialistOpinion.getInpatient();
...
<label>Course of Illness</label>
 <textarea rows="" cols="" class="large" name="courseOfIllness" readonly="readonly" onkeyup="chkLength(this,200);"><%=ipdSpecialistOpinion.getCourseOfIllness()!=null?ipdSpecialistOpinion.getCourseOfIllness():"" %></textarea>
<div class="clear"></div>
<label>General Exam</label>
 <textarea rows="" cols="" class="large" name="generalExam" readonly="readonly" onkeyup="chkLength(this,200);"><%=ipdSpecialistOpinion.getGeneralExam()!=null?ipdSpecialistOpinion.getGeneralExam():"" %></textarea>
...
<input name="weight" tabindex="1" type="text" id="weight" readonly="readonly" value="<%=ipdSpecialistOpinion.getWeight()!=null?ipdSpecialistOpinion.getWeight():"" %>"  onblur="calculateBMI()" class="auto" size="5" validate="weight,int,no" maxlength="3" />
<label class="unit">kg</label> 

<label  class="">Height</label> 
<input name="height" tabindex="1" readonly="readonly" type="text" id="height" value="<%=ipdSpecialistOpinion.getHeight()!=null?ipdSpecialistOpinion.getHeight():"" %>" class="auto" onblur="calculateIdealWeight();calculateBMI();" size="5" validate="height,int,no"  maxlength="3" />
<label class="unit">cm</label>

 <label	class="">BMI</label> 
<input tabindex="1" type="text" id="bmi" name="bmi" readonly="readonly" maxlength="6" value="<%=ipdSpecialistOpinion.getBmi()!=null?ipdSpecialistOpinion.getBmi():"" %>" onKeyUp="limitText(this,6);" class="auto" size="5" />
<label class="unit">kg/m<sup>2</sup></label> 
  <div class="clear"></div>
<label	class="">Ideal Weight</label>
 <input name="idealWeight" type="text" id="idealWeightId" tabindex="1" readonly="readonly" class="auto" size="5" value="<%=ipdSpecialistOpinion.getIdealWeight()!=null?ipdSpecialistOpinion.getIdealWeight():"" %>" tabindex="1" validate="Ideal Weight,string,no" maxlength="3" />
 <label class="unit">kg</label> 
 <label class="">Temperature</label>
 <input name="temperature" id="tempId" type="text" tabindex="1" value="<%=ipdSpecialistOpinion.getTemperature()!=null?ipdSpecialistOpinion.getTemperature():"" %>" readonly="readonly" class="auto" size="5" maxlength="5" />
 <label class="unit">&deg;F</label>
 <label	class="">Pulse</label>
 <input name="pulse" type="text" tabindex="1" value="<%=ipdSpecialistOpinion.getPulse()!=null?ipdSpecialistOpinion.getPulse():"" %>" class="auto" size="5" readonly="readonly" tabindex="1" validate="pulse,int,no" maxlength="3" />
 <label class="unit">/min</label> 
   
   <div class="clear"></div>
   
 <label class="">BP</label>
 <input	name="bp" id="bp" type="text" tabindex="1" value="<%=ipdSpecialistOpinion.getBp()!=null?ipdSpecialistOpinion.getBp():"" %>" class="auto" readonly="readonly" size="5" onblur="validateBpValue(this.value);" maxlength="7" />
 <label class="unit">mm/Hg</label>
 <label class="">RR</label>
 <input	name="rr" id="rr" type="text" tabindex="1" value="<%=ipdSpecialistOpinion.getRr()!=null?ipdSpecialistOpinion.getRr():"" %>" class="auto" readonly="readonly" size="5" maxlength="3" />
 <label class="unit">/min</label>
...
<input type="text" name="generalPhysicalExam" id="generalPhysicalExam" value="<%=ipdSpecialistOpinion.getGeneralPhysicalExam()!=null?ipdSpecialistOpinion.getGeneralPhysicalExam():"" %>" readonly="readonly" size="100" class="auto"
   maxlength="49" validate="General Physical Exam,string,no"/>
<div class="clear"></div>
<label>Cardiovascular System</label>
<input type="text" name="cardiovascularSystem" id="cardiovascularSystem" value="<%=ipdSpecialistOpinion.getCardiovascularSyatem()!=null?ipdSpecialistOpinion.getCardiovascularSyatem():"" %>" readonly="readonly" size="100" class="auto"
	maxlength="49" validate="Cardiovascular System,string,no"/>
<div class="clear"></div>

<label>Respiratory System</label>

 <input tabindex="1" type="text" value="<%=ipdSpecialistOpinion.getRespiratorySystem()!=null?ipdSpecialistOpinion.getRespiratorySystem():"" %>" name="respiratorySystem" class="auto" readonly="readonly" size="100" maxlength="99" validate="Respiratory System,string,no"/>
...
<input type="text" name="gastroIntestinalSystem" id="gastroIntestinalSystem" value="<%=ipdSpecialistOpinion.getGastroIntestinalSystem()!=null?ipdSpecialistOpinion.getGastroIntestinalSystem():"" %>" readonly="readonly" size="100" class="auto"
...
<% if(medExamObj.getCentralNervousSystemMMHG()!=null){%>
 ...
 <% }%>--%>
 <input type="text" name="centralNervousSystem" id="centralNervousSystem" value="<%=ipdSpecialistOpinion.getCentralNervousSystem()!=null?ipdSpecialistOpinion.getCentralNervousSystem():"" %>" readonly="readonly" size="100" class="auto"
...
<textarea rows="" cols="" name="SpecilaistOpinion" id="SpecilaistOpinion" readonly="readonly" onkeyup="chkLength(this,100);" ><%=ipdSpecialistOpinion.getSpecialistOpenion()!=null?ipdSpecialistOpinion.getSpecialistOpenion():"" %></textarea>


<label>Treatment Advice</label>
<textarea rows="" cols="" name="SpecilaistTreatmentAdvice"  id="SpecilaistTreatmentAdvice" readonly="readonly" onkeyup="chkLength(this,200);" ><%=ipdSpecialistOpinion.getTreatmentAdvice()!=null?ipdSpecialistOpinion.getTreatmentAdvice():"" %></textarea>
</div>
</div>
<div class="clear"></div>
<div class="division"></div>
<input type="button" name="Back" value="Back" class="button" onclick="submitForm('splOpinion','/hms/hms/ipd?method=viewSpecialistOpinion&inpatientId=<%=inpatientId %>')" accesskey="r" />
