...
response.addHeader("Content-Disposition", "attachment;filename=\"VED.xls\""); %>
<h2>VED REPORT</h2>
</div>
...
<input type="button" name="add" id="addbutton" value="Generate" class="button" onClick="submitForm('vedReport','stores?method=vedAnalysisJspReport&flag=j');" accesskey="a" tabindex=1 />
...
<input type="button" name="clear" id="clearbutton" value="Cancel" class="button" onClick="clearButton('vedReport');" accesskey="a" tabindex=1 />
</form>
