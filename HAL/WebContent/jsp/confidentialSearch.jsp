<%-- 
	 ...
	 * Tables Used         : 
	 * Description         : 
	 * @author  Create Date: 07.03.2008    Name: Naresh
...
function fillAtleastOne(){
	...
	function submitFormForConfidentialOrder(){
		...
		if(flag == false){
			...
			submitForm('orderNoListForConfidential','/hms/hms/lab?method=printConfidentialTestDetailsReport');
		}
	...
	function fillOrderNo(printValueObj){
		...
		function setColorForRow(obj){
			
			obj.style.backgroundColor = '#39D7FF';
			//obj.style.fontWeight = 'bold';			
			
		}
		function setColorToOriginal(obj){
			
			obj.style.backgroundColor = 'EEEAEA';
...
<form name="confidentialOrderSearch" action="" method="post">
<%
...
<h6>Confidential Order Request Search</h6>
<div class="Clear"></div>
<div class="blockTitle">Confidential Order Search</div>
...
<input type="button" name="Search" id="addbutton"
	onclick="submitForm('confidentialOrderSearch','/hms/hms/lab?method=searchConfidentialOrderDetails','fillAtleastOne');"
...
<form name="orderNoListForConfidential" method="post" action=""
	...
	onclick="submitFormForConfidentialOrder();" value="print"
...
%>
    ...
    formName = "orderNoListForConfidential";
	start = 0
