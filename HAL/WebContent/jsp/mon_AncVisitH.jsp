...
function check(){
var SDate = document.mon_AncVisitH.<%= FROM_DATE%>.value;
var EDate = document.mon_AncVisitH.<%= TO_DATE %>.value;
...
%>
<form name="mon_AncVisitH" method="post" action="" >
...
<a	href="javascript:setdate('<%=f%>',document.mon_AncVisitH.<%=FROM_DATE%>,true)">
...
<a href="javascript:setdate('<%=t%>',document.mon_AncVisitH.<%=TO_DATE%>,true)">
<img src="/hms/jsp/images/cal.gif" width="16" height="16" border="0" validate="Pick a date" class="calender" /> </a> 
...
<input type="button" name="OK" value="Ok" class="button" onClick="submitForm('mon_AncVisitH','/hms/hms/registration?method=showOPDRegisterFwcReport');" />
