...
<div class="clear"></div>
<div class="titleBg">
<h2>PENDING PRESCRIPTIONS (Corporate FAC OPD)</h2>
</div>
<div class="Block">
<div class="clear"></div>
...
<input type="button" name="search" id="addbutton"	onclick="submitForm('searchPrescription','/hms/hms/opd?method=showPendingPrescriptionJspCorporateFAC');"	value="Search" class="button" accesskey="a" />
...
<input type="button" name="search" id="showAll"	onclick="window.location.href='/hms/hms/opd?method=showPendingPrescriptionJspCorporateFAC&facStatus=y'"	value="Show All" class="button" accesskey="a" />
...
<form name="pendingPrescriptionCorporateFAC" method="post" action="">
...
formName = "pendingPrescriptionCorporateFAC"
start = 0
