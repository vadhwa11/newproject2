...
%>
<div id="contentspace">
<form name="paymentForm" method="post" action=""><br />
...
<input type="button" name="add" id="addbutton" value="OK" class="button"
	...
	onClick="window.close();" accesskey="a" tabindex=1 />
</form>
<script>
	function check(){
		var count = 0;
		...
		window.opener.document.getElementById('<%=PAY_TERMS %>').value =document.getElementById('<%=PO_DELIVERY_TERMS_DESC%>').value;
			window.close();
			return true;
		}
	}
