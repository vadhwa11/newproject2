...
<div class="floatLeft"><input name="patient fast history3"
	...
	onclick="submitForm('ophthalmologyRetinal','fwc?method=showOpdOphthamologyJsp&visitId=<%=visit.getId() %>');" />
<input name="patient fast history" type="button" class="navButtons"
	value="Follow Up"
	onclick="submitForm('ophthalmologyRetinal','/hms/hms/fwc?method=showOphthalmologyFollowUpJsp');" />
<input name="patient fast history23" type="button" class="navButtons"
	value="Diagnosis"
	onclick="submitForm('ophthalmologyRetinal','fwc?method=showOphthalmologyDiagnosisJsp');" />
</div>
...
<div class="bottom"><input name="Save" type="button"
	...
	onclick="if(checkBlankForOphthalmology('ophthalmologyRetinal')){submitForm('ophthalmologyRetinal','fwc?method=submitOphthalmologyRetinal');}">
<input name="view" type="button" class="button" value="View"
	onclick="submitForm('ophthalmologyRetinal','fwc?method=viewOphthalmologyRetinal&flag=prev');">
