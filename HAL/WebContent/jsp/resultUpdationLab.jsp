...
<%}else{ %>
<div class="titleBg"><h2>Result Updation</h2></div>
<%} %>
<div class="Clear"></div>
...
<form name="pendingResultUpdationLab" method="post" action="">
<script type="text/javascript">
	formFields = [
...
<script type="text/javascript" language="javascript">
	...
	data_arr = new Array();
		...
		String stringOfIds = "";
			...
			if (patientList.size() > 0){ 
			  ...
			  %> <jsp:include page="resultUpdationLabGrid.jsp"
	flush="true">
	...
	formName = "pendingResultUpdationLab";
	start = 0
	...
	function searchKeyPress(e) {
		...
		e = e || window.event;
		 if (e.keyCode == 13) { 
			 ...
			 submitForm('patientSearch','/hms/hms/investigation?method=searchPatientForResultUpdationLab');
