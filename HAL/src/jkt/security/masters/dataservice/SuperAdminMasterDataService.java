...
public interface SuperAdminMasterDataService {
	...
	// ---------------end of methods added for security
	// screen-------------------
	...
	// -------------------------End of methods added foer assign
	// module-------------------
	...
	Map<String, Object> getEmpNameByLoginName(String loginName);
	...
	Map<String, Object> getDepartmentUserList();
