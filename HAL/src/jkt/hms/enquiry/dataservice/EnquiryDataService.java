...
public interface EnquiryDataService {
	...
	Map<String, Object> getPatientDetailsForEnquiry(
			Map<String, Object> enquiryMap);

	Map<String, Object> getInPatientDetailsForEnquiry(
			Map<String, Object> enquiryMap);

	Map<String, Object> getDetailsForSearch();

	Map<String, Object> getInPatientDetailsForEnquiry2(
	...
	Map<String, Object> getAllEnquiry1(Map<String, Object> dataMap);
