...
public interface RegistrationHandlerService {
	...
	boolean addTrade(MasTrade masTrade, String ss);
...
//	Map<String, Object> submitDMAStockDetails(Box box);
	...
	Map getPatientTypeCodeAndRelationCode(HttpServletRequest request);
	...
	Map<String, Object> cancleOnlineAppointment(Map<String, Object> map);
