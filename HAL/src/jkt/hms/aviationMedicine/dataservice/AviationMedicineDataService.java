...
public interface AviationMedicineDataService {
	...
	AviFlyingClothingInspection aviFlyingClothingInspection,Map<String, Object> generalMap);
	...
	Boolean submitRenewableApplication(AviCa34 aviCa34, Patient patient,Visit visit, Map<String, Object> dataMap);
	...
	//Boolean updatePilotRegistration(Map<String, Object> infoMap);
