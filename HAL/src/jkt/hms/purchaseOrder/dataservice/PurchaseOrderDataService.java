...
public interface PurchaseOrderDataService {
	...
	Map<String, Object> poModifyMap(int id, int pageNo, String buttonFlag);
	...
	boolean submitApprovalAuthority(String approvalIds, int poId);
