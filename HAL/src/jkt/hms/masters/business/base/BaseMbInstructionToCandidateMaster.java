 ...
 * mb_instruction_to_candidate_master table. Do not modify this class because it
 * will be overwritten if the configuration file related to this class is
 * modified.
 * 
 * @hibernate.class table="mb_instruction_to_candidate_master"
 */

public abstract class BaseMbInstructionToCandidateMaster implements
		Serializable {

	public static String REF = "MbInstructionToCandidateMaster";
	...
	// constructors
	public BaseMbInstructionToCandidateMaster() {
		initialize();
	}
	 ...
	 */
	public BaseMbInstructionToCandidateMaster(java.lang.Integer id) {
		this.setId(id);
		initialize();
	}
	 ...
	 *               column="intruction_to_candidate_master_id"
	 */
	...
	public boolean equals(Object obj) {
		if (null == obj)
			return false;
		if (!(obj instanceof jkt.hms.masters.business.MbInstructionToCandidateMaster))
			return false;
		else {
			jkt.hms.masters.business.MbInstructionToCandidateMaster mbInstructionToCandidateMaster = (jkt.hms.masters.business.MbInstructionToCandidateMaster) obj;
			if (null == this.getId()
					|| null == mbInstructionToCandidateMaster.getId())
				return false;
			else
				return (this.getId().equals(mbInstructionToCandidateMaster
						.getId()));
		}
	}
