 ...
 * 
 * @hibernate.class table="mas_patient_status"
 */
...
public abstract class BaseMasPatientStatus implements Serializable {
	 ...
	 * 
	 * @hibernate.id generator-class="native" column="patient_status_id"
	 */
	 ...
	 * 
	 * @param patientStatusName
	 *            the patient_status_name value
	 */
	...
	public boolean equals(Object obj) {
		if (null == obj)
			return false;
		if (!(obj instanceof jkt.hms.masters.business.MasPatientStatus))
			return false;
		else {
			jkt.hms.masters.business.MasPatientStatus masPatientStatus = (jkt.hms.masters.business.MasPatientStatus) obj;
			if (null == this.getId() || null == masPatientStatus.getId())
				return false;
			else
				return (this.getId().equals(masPatientStatus.getId()));
		}
	}
