...
/**
 * This is an object that contains data related to the patient_address_history
 * table. Do not modify this class because it will be overwritten if the
 * configuration file related to this class is modified.
 * 
 * @hibernate.class table="patient_address_history"
 */

public abstract class BasePatientAddressHistory implements Serializable {

	public static String REF = "PatientAddressHistory";
	...
	// constructors
	public BasePatientAddressHistory() {
		initialize();
	}
	 ...
	 */
	public BasePatientAddressHistory(java.lang.Integer id) {
		this.setId(id);
		initialize();
	}
	 ...
	 *               column="patient_address_history_id"
	 */
	...
	public boolean equals(Object obj) {
		if (null == obj)
			return false;
		if (!(obj instanceof jkt.hms.masters.business.PatientAddressHistory))
			return false;
		else {
			jkt.hms.masters.business.PatientAddressHistory patientAddressHistory = (jkt.hms.masters.business.PatientAddressHistory) obj;
			if (null == this.getId() || null == patientAddressHistory.getId())
				return false;
			else
				return (this.getId().equals(patientAddressHistory.getId()));
		}
	}
