...
/**
 * This is an object that contains data related to the opd_instruction_treatment
 * table. Do not modify this class because it will be overwritten if the
 * configuration file related to this class is modified.
 * 
 * @hibernate.class table="opd_instruction_treatment"
 */
...
public abstract class BaseOpdInstructionTreatment implements Serializable {
	 ...
	 * opd_instruction_treatment_code
	 */
	 ...
	 * 
	 * @param opdInstructionTreatmentCode
	 *            the opd_instruction_treatment_code value
	 */
	public void setOpdInstructionTreatmentCode(
			java.lang.String opdInstructionTreatmentCode) {
	 ...
	 * 
	 * @param opdInstructionTreatmentName
	 *            the opd_instruction_treatment_name value
	 */
	public void setOpdInstructionTreatmentName(
			java.lang.String opdInstructionTreatmentName) {
	 ...
	 * 
	 * @param opdTemplateTreatments
	 *            the OpdTemplateTreatments value
	 */
	public void setOpdTemplateTreatments(
			java.util.Set<jkt.hms.masters.business.OpdTemplateTreatment> opdTemplateTreatments) {
		this.opdTemplateTreatments = opdTemplateTreatments;
	}

	public void addToOpdTemplateTreatments(
			jkt.hms.masters.business.OpdTemplateTreatment opdTemplateTreatment) {
		if (null == getOpdTemplateTreatments())
			setOpdTemplateTreatments(new java.util.TreeSet<jkt.hms.masters.business.OpdTemplateTreatment>());
	...
	public boolean equals(Object obj) {
		if (null == obj)
			return false;
		if (!(obj instanceof jkt.hms.masters.business.OpdInstructionTreatment))
			return false;
		else {
			...
			if (null == this.getId() || null == opdInstructionTreatment.getId())
				return false;
			else
				return (this.getId().equals(opdInstructionTreatment.getId()));
		}
	}
