...
/**
 * This is an object that contains data related to the room table. Do not modify
 * this class because it will be overwritten if the configuration file related
 * to this class is modified.
 * 
 * @hibernate.class table="room"
 */
...
public abstract class BaseRoom implements Serializable {
	 ...
	 * 
	 * @hibernate.id generator-class="native" column="room_id"
	 */
	...
	public boolean equals(Object obj) {
		if (null == obj)
			return false;
		if (!(obj instanceof jkt.hms.masters.business.Room))
			return false;
		else {
			jkt.hms.masters.business.Room room = (jkt.hms.masters.business.Room) obj;
			if (null == this.getId() || null == room.getId())
				return false;
			else
