...
/**
 * This is an object that contains data related to the MAS_SECTION table.
...
public abstract class BaseMasSection  implements Serializable {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof jkt.hms.masters.business.MasSection)) return false;
		else {
			jkt.hms.masters.business.MasSection masSection = (jkt.hms.masters.business.MasSection) obj;
			if (null == this.getId() || null == masSection.getId()) return false;
			else return (this.getId().equals(masSection.getId()));
		}
	}
