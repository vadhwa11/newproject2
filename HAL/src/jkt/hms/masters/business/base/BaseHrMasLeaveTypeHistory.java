...
/**
 * This is an object that contains data related to the hr_mas_leave_type_history table.
 * Do not modify this class because it will be overwritten if the configuration file
 * related to this class is modified.
 *
 * @hibernate.class
 *  table="hr_mas_leave_type_history"
 */
...
public abstract class BaseHrMasLeaveTypeHistory  implements Serializable {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof jkt.hms.masters.business.HrMasLeaveTypeHistory)) return false;
		else {
			jkt.hms.masters.business.HrMasLeaveTypeHistory hrMasLeaveTypeHistory = (jkt.hms.masters.business.HrMasLeaveTypeHistory) obj;
			if (null == this.getId() || null == hrMasLeaveTypeHistory.getId()) return false;
			else return (this.getId().equals(hrMasLeaveTypeHistory.getId()));
		}
	}
