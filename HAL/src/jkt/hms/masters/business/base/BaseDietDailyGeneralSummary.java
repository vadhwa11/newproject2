 ...
 * diet_daily_general_summary table. Do not modify this class because it will be
 * overwritten if the configuration file related to this class is modified.
 * 
 * @hibernate.class table="diet_daily_general_summary"
 */

public abstract class BaseDietDailyGeneralSummary implements Serializable {

	public static String REF = "DietDailyGeneralSummary";
	...
	// constructors
	public BaseDietDailyGeneralSummary() {
		initialize();
	}
	 ...
	 */
	public BaseDietDailyGeneralSummary(java.lang.Integer id) {
		this.setId(id);
		initialize();
	}
	 ...
	 * 
	 * @hibernate.id generator-class="native" column="general_diet_summary_id"
	 */
	...
	public boolean equals(Object obj) {
		if (null == obj)
			return false;
		if (!(obj instanceof jkt.hms.masters.business.DietDailyGeneralSummary))
			return false;
		else {
			jkt.hms.masters.business.DietDailyGeneralSummary dietDailyGeneralSummary = (jkt.hms.masters.business.DietDailyGeneralSummary) obj;
			if (null == this.getId() || null == dietDailyGeneralSummary.getId())
				return false;
			else
				return (this.getId().equals(dietDailyGeneralSummary.getId()));
		}
	}
