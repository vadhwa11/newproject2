...
/**
 * This is an object that contains data related to the mas_store_group table. Do
 * not modify this class because it will be overwritten if the configuration
 * file related to this class is modified.
 * 
 * @hibernate.class table="mas_store_group"
 */
...
public abstract class BaseMasStoreGroup implements Serializable {
	...
	public boolean equals(Object obj) {
		if (null == obj)
			return false;
		if (!(obj instanceof jkt.hms.masters.business.MasStoreGroup))
			return false;
		else {
			jkt.hms.masters.business.MasStoreGroup masStoreGroup = (jkt.hms.masters.business.MasStoreGroup) obj;
			if (null == this.getId() || null == masStoreGroup.getId())
				return false;
			else
				return (this.getId().equals(masStoreGroup.getId()));
		}
	}
