...
/**
 * This is an object that contains data related to the hr_encashment_details_history table.
 * Do not modify this class because it will be overwritten if the configuration file
 * related to this class is modified.
 *
 * @hibernate.class
 *  table="hr_encashment_details_history"
 */
...
public abstract class BaseHrEncashmentDetailsHistory  implements Serializable {
	...
	private jkt.hms.masters.business.HrEmployeeBalanceNew balance;
	 ...
	 */
	public jkt.hms.masters.business.HrEmployeeBalanceNew getBalance () {
		return balance;
	}
	 ...
	 */
	public void setBalance (jkt.hms.masters.business.HrEmployeeBalanceNew balance) {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof jkt.hms.masters.business.HrEncashmentDetailsHistory)) return false;
		else {
			jkt.hms.masters.business.HrEncashmentDetailsHistory hrEncashmentDetailsHistory = (jkt.hms.masters.business.HrEncashmentDetailsHistory) obj;
			if (null == this.getId() || null == hrEncashmentDetailsHistory.getId()) return false;
			else return (this.getId().equals(hrEncashmentDetailsHistory.getId()));
		}
	}
