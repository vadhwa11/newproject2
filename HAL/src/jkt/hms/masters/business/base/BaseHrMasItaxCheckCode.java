...
public abstract class BaseHrMasItaxCheckCode  implements Serializable {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof jkt.hms.masters.business.HrMasItaxCheckCode)) return false;
		else {
			jkt.hms.masters.business.HrMasItaxCheckCode hrMasItaxCheckCode = (jkt.hms.masters.business.HrMasItaxCheckCode) obj;
