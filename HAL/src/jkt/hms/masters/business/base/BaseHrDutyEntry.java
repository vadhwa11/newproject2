...
/**
 * This is an object that contains data related to the hr_duty_entry table. Do
 * not modify this class because it will be overwritten if the configuration
 * file related to this class is modified.
 * 
 * @hibernate.class table="hr_duty_entry"
 */

public abstract class BaseHrDutyEntry implements Serializable {

	public static String REF = "HrDutyEntry";
	 ...
	 */
	public BaseHrDutyEntry(java.lang.Integer id) {
		this.setId(id);
		initialize();
	}
	...
	public boolean equals(Object obj) {
		if (null == obj)
			return false;
		if (!(obj instanceof jkt.hms.masters.business.HrDutyEntry))
			return false;
		else {
			jkt.hms.masters.business.HrDutyEntry hrDutyEntry = (jkt.hms.masters.business.HrDutyEntry) obj;
			if (null == this.getId() || null == hrDutyEntry.getId())
				return false;
			else
				return (this.getId().equals(hrDutyEntry.getId()));
		}
	}
