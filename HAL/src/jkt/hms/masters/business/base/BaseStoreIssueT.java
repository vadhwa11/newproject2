...
public abstract class BaseStoreIssueT  implements Serializable {
	...
	public static String PROP_CIV_LOAN = "CivLoan";
	...
	private java.lang.String civLoan;
	...
	/**
	 * Return the value associated with the column: CIV_LOAN
	 */
	public java.lang.String getCivLoan () {
		return civLoan;
	}

	/**
	 * Set the value related to the column: CIV_LOAN
	 * @param civLoan the CIV_LOAN value
	 */
	public void setCivLoan (java.lang.String civLoan) {
		this.civLoan = civLoan;
	}
