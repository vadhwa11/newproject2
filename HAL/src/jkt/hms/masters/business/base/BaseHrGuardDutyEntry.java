...
/**
 * This is an object that contains data related to the hr_guard_duty_entry
 * table. Do not modify this class because it will be overwritten if the
 * configuration file related to this class is modified.
 * 
 * @hibernate.class table="hr_guard_duty_entry"
 */

public abstract class BaseHrGuardDutyEntry implements Serializable {

	public static String REF = "HrGuardDutyEntry";
	 ...
	 */
	public BaseHrGuardDutyEntry(java.lang.Integer id) {
		this.setId(id);
		initialize();
	}
	...
	public boolean equals(Object obj) {
		if (null == obj)
			return false;
		if (!(obj instanceof jkt.hms.masters.business.HrGuardDutyEntry))
			return false;
		else {
			jkt.hms.masters.business.HrGuardDutyEntry hrGuardDutyEntry = (jkt.hms.masters.business.HrGuardDutyEntry) obj;
			if (null == this.getId() || null == hrGuardDutyEntry.getId())
				return false;
			else
				return (this.getId().equals(hrGuardDutyEntry.getId()));
		}
	}
