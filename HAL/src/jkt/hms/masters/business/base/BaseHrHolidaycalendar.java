...
public abstract class BaseHrHolidaycalendar  implements Serializable {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof jkt.hms.masters.business.HrHolidaycalendar)) return false;
		else {
			jkt.hms.masters.business.HrHolidaycalendar hrHolidaycalendar = (jkt.hms.masters.business.HrHolidaycalendar) obj;
			if (null == this.getId() || null == hrHolidaycalendar.getId()) return false;
			else return (this.getId().equals(hrHolidaycalendar.getId()));
		}
	}
