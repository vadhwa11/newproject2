...
/**
 * This is an object that contains data related to the hr_orderly_duty_entry table.
 * Do not modify this class because it will be overwritten if the configuration file
 * related to this class is modified.
 *
 * @hibernate.class
 *  table="hr_orderly_duty_entry"
 */

public abstract class BaseHrOrderlyDutyEntry  implements Serializable {

	public static String REF = "HrOrderlyDutyEntry";
	 ...
	 */
	public BaseHrOrderlyDutyEntry (java.lang.Integer id) {
		this.setId(id);
		initialize();
	}
	 ...
	 * @param dutyDate the duty_date value
	 */
	 ...
	 * @param typeStatus the type_status value
	 */
	 ...
	 * @param holidayStatus the holiday_status value
	 */
	 ...
	 * @param dutyTime the duty_time_id value
	 */
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof jkt.hms.masters.business.HrOrderlyDutyEntry)) return false;
		else {
			jkt.hms.masters.business.HrOrderlyDutyEntry hrOrderlyDutyEntry = (jkt.hms.masters.business.HrOrderlyDutyEntry) obj;
			if (null == this.getId() || null == hrOrderlyDutyEntry.getId()) return false;
			else return (this.getId().equals(hrOrderlyDutyEntry.getId()));
		}
	}
