...
/**
 * This is an object that contains data related to the mas_caste table. Do not
 * modify this class because it will be overwritten if the configuration file
 * related to this class is modified.
 * 
 * @hibernate.class table="mas_caste"
 */
...
public abstract class BaseMasCaste implements Serializable {
	 ...
	 */
	public BaseMasCaste(java.lang.Integer id, java.lang.String status) {
	 ...
	 * 
	 * @hibernate.id generator-class="native" column="caste_id"
	 */
	...
	public boolean equals(Object obj) {
		if (null == obj)
			return false;
		if (!(obj instanceof jkt.hms.masters.business.MasCaste))
			return false;
		else {
			jkt.hms.masters.business.MasCaste masCaste = (jkt.hms.masters.business.MasCaste) obj;
			if (null == this.getId() || null == masCaste.getId())
				return false;
			else
				return (this.getId().equals(masCaste.getId()));
		}
	}
