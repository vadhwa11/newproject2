...
/**
 * This is an object that contains data related to the dg_org_dtl table. Do not
 * modify this class because it will be overwritten if the configuration file
 * related to this class is modified.
 * 
 * @hibernate.class table="dg_org_dtl"
 */
...
public abstract class BaseDgOrgDtl implements Serializable {
	 ...
	 */
	public void setAntibioticLab(
			jkt.hms.masters.business.MasAntibioticLab antibioticLab) {
	...
	public boolean equals(Object obj) {
		if (null == obj)
			return false;
		if (!(obj instanceof jkt.hms.masters.business.DgOrgDtl))
			return false;
		else {
			jkt.hms.masters.business.DgOrgDtl dgOrgDtl = (jkt.hms.masters.business.DgOrgDtl) obj;
			if (null == this.getId() || null == dgOrgDtl.getId())
				return false;
			else
				return (this.getId().equals(dgOrgDtl.getId()));
		}
	}
