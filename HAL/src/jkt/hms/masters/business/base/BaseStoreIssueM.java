...
public abstract class BaseStoreIssueM  implements Serializable {
	...
	private jkt.hms.masters.business.MasHospital toHospital;
	private jkt.hms.masters.business.RcRequestHeader requestHeader;
	...
	/**
	 * Return the value associated with the column: to_hospital
	 */
	public jkt.hms.masters.business.MasHospital getToHospital () {
		return toHospital;
	}

	/**
	 * Set the value related to the column: to_hospital
	 * @param toHospital the to_hospital value
	 */
	public void setToHospital (jkt.hms.masters.business.MasHospital toHospital) {
	 ...
	 */
	public jkt.hms.masters.business.RcRequestHeader getRequestHeader () {
	 ...
	 */
	public void setRequestHeader (jkt.hms.masters.business.RcRequestHeader requestHeader) {
