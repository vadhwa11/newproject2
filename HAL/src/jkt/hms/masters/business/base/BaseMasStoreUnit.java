...
/**
 * This is an object that contains data related to the mas_store_unit table. Do
 * not modify this class because it will be overwritten if the configuration
 * file related to this class is modified.
 * 
 * @hibernate.class table="mas_store_unit"
 */
...
public abstract class BaseMasStoreUnit implements Serializable {
	 ...
	 * 
	 * @hibernate.id generator-class="native" column="unit_id"
	 */
	...
	public boolean equals(Object obj) {
		if (null == obj)
			return false;
		if (!(obj instanceof jkt.hms.masters.business.MasStoreUnit))
			return false;
		else {
			jkt.hms.masters.business.MasStoreUnit masStoreUnit = (jkt.hms.masters.business.MasStoreUnit) obj;
			if (null == this.getId() || null == masStoreUnit.getId())
				return false;
			else
				return (this.getId().equals(masStoreUnit.getId()));
		}
	}
