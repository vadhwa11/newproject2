...
/**
 * This is an object that contains data related to the mas_document table. Do
 * not modify this class because it will be overwritten if the configuration
 * file related to this class is modified.
 * 
 * @hibernate.class table="mas_document"
 */
...
public abstract class BaseMasDocument implements Serializable {
	...
	public boolean equals(Object obj) {
		if (null == obj)
			return false;
		if (!(obj instanceof jkt.hms.masters.business.MasDocument))
			return false;
		else {
			jkt.hms.masters.business.MasDocument masDocument = (jkt.hms.masters.business.MasDocument) obj;
			if (null == this.getId() || null == masDocument.getId())
				return false;
			else
				return (this.getId().equals(masDocument.getId()));
		}
	}
