...
/**
 * This is an object that contains data related to the pension_eol table. Do not
 * modify this class because it will be overwritten if the configuration file
 * related to this class is modified.
 * 
 * @hibernate.class table="pension_eol"
 */

public abstract class BasePensionEol implements Serializable {

	public static String REF = "PensionEol";
	 ...
	 */
	public BasePensionEol(java.lang.Integer id) {
		this.setId(id);
		initialize();
	}
	...
	public boolean equals(Object obj) {
		if (null == obj)
			return false;
		if (!(obj instanceof jkt.hms.masters.business.PensionEol))
			return false;
		else {
			jkt.hms.masters.business.PensionEol pensionEol = (jkt.hms.masters.business.PensionEol) obj;
			if (null == this.getId() || null == pensionEol.getId())
				return false;
			else
				return (this.getId().equals(pensionEol.getId()));
		}
	}
