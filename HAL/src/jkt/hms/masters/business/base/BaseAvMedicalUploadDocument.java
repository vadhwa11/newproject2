...
/**
 * This is an object that contains data related to the AV_MEDICAL_UPLOAD_DOCUMENT table.
 * Do not modify this class because it will be overwritten if the configuration file
 * related to this class is modified.
 *
 * @hibernate.class
 *  table="AV_MEDICAL_UPLOAD_DOCUMENT"
 */

public abstract class BaseAvMedicalUploadDocument  implements Serializable {

	public static String REF = "AvMedicalUploadDocument";
	...
	public static String PROP_AV_MEDICAL_EXAM_REPORT = "AvMedicalExamReport";
	public static String PROP_HIN = "Hin";
	public static String PROP_FILE_FLAG = "FileFlag";


	// constructors
	public BaseAvMedicalUploadDocument () {
		initialize();
	}
	 ...
	 */
	public BaseAvMedicalUploadDocument (java.lang.Integer id) {
		this.setId(id);
		initialize();
	}
	...
	private jkt.hms.masters.business.AvMedicalExamMaMo avMedicalExamReport;
	...
	/**
	 * Return the value associated with the column: av_exam_id
	 */
	public jkt.hms.masters.business.AvMedicalExamMaMo getAvMedicalExamReport () {
		return avMedicalExamReport;
	}

	/**
	 * Set the value related to the column: av_exam_id
	 * @param avMedicalExamReport the av_exam_id value
	 */
	public void setAvMedicalExamReport (jkt.hms.masters.business.AvMedicalExamMaMo avMedicalExamReport) {
		this.avMedicalExamReport = avMedicalExamReport;
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof jkt.hms.masters.business.AvMedicalUploadDocument)) return false;
		else {
			jkt.hms.masters.business.AvMedicalUploadDocument avMedicalUploadDocument = (jkt.hms.masters.business.AvMedicalUploadDocument) obj;
			if (null == this.getId() || null == avMedicalUploadDocument.getId()) return false;
			else return (this.getId().equals(avMedicalUploadDocument.getId()));
		}
	}
