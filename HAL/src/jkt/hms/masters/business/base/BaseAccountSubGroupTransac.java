...
/**
 * This is an object that contains data related to the account_sub_group_transac table.
 * Do not modify this class because it will be overwritten if the configuration file
 * related to this class is modified.
 *
 * @hibernate.class
 *  table="account_sub_group_transac"
 */

public abstract class BaseAccountSubGroupTransac  implements Serializable {

	public static String REF = "AccountSubGroupTransac";
	public static String PROP_SUB_GROUP = "SubGroup";
	...
	// constructors
	public BaseAccountSubGroupTransac () {
		initialize();
	}
	 ...
	 */
	public BaseAccountSubGroupTransac (java.lang.Integer id) {
		this.setId(id);
		initialize();
	}
	...
	private jkt.hms.masters.business.FaMasAccountSubGroup subGroup;
	 ...
	 */
	public jkt.hms.masters.business.FaMasAccountSubGroup getSubGroup () {
		return subGroup;
	}

	/**
	 * Set the value related to the column: sub_group_id
	 * @param subGroup the sub_group_id value
	 */
	public void setSubGroup (jkt.hms.masters.business.FaMasAccountSubGroup subGroup) {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof jkt.hms.masters.business.AccountSubGroupTransac)) return false;
		else {
			jkt.hms.masters.business.AccountSubGroupTransac accountSubGroupTransac = (jkt.hms.masters.business.AccountSubGroupTransac) obj;
			if (null == this.getId() || null == accountSubGroupTransac.getId()) return false;
			else return (this.getId().equals(accountSubGroupTransac.getId()));
		}
	}
