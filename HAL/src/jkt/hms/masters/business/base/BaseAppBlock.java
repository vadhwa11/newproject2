...
/**
 * This is an object that contains data related to the app_block table. Do not
 * modify this class because it will be overwritten if the configuration file
 * related to this class is modified.
 * 
 * @hibernate.class table="app_block"
 */

public abstract class BaseAppBlock implements Serializable {

	public static String REF = "AppBlock";
	 ...
	 */
	public BaseAppBlock(java.lang.Integer id) {
		this.setId(id);
		initialize();
	}
	...
	public boolean equals(Object obj) {
		if (null == obj)
			return false;
		if (!(obj instanceof jkt.hms.masters.business.AppBlock))
			return false;
		else {
			jkt.hms.masters.business.AppBlock appBlock = (jkt.hms.masters.business.AppBlock) obj;
			if (null == this.getId() || null == appBlock.getId())
				return false;
			else
				return (this.getId().equals(appBlock.getId()));
		}
	}
