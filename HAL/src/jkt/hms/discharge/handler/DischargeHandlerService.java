 ...
 * Class DischargeHandlerService.java 
 ...
 * @version 1.0  
 * @see DischargeController.java, DischargeHandlerServiceImpl.java, DischargeDataService.java, DischargeDataServiceImpl.java
 **/
...
public interface DischargeHandlerService {
