...
public interface MonitoringHandlerService {
	Map<String, Object> getHealthMonitoringDetails(int userId);

	Map<String, Object> getMedExamBoardMonitoringDetails(Integer id);
	...
	Map<String, Object> getAirHqStoregDetails(Integer id);
