...
public class UpdateAgendaPointsForWorkServicesDataServiceImpl extends
		HibernateDaoSupport implements
		UpdateAgendaPointsForWorkServicesDataService {
	...
	public boolean editUpdateAgendaPointsForWorkServicesToDatabase(
		...
		accepted = (String) generalMap.get("accepted");
		...
		if (accepted.equalsIgnoreCase("A")) {

			masUpdateAgendaPointsForWorkServices.setStatus(accepted);

		}
		if (accepted.equalsIgnoreCase("R")) {
		...
		masUpdateAgendaPointsForWorkServices.setAgenaRemarks(remarks);
