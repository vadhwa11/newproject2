...
<div class="titleBg">
<h2>Family Welfare Program Final Report</h2>
</div>
<div class="Clear"></div>
<form name="programFinalReport" target="_blank" method="post" action="">
<div class="Block"><label> From Date</label> <input
	...
	class="calender"
	onClick="setdate('<%=currenDate %>',document.programFinalReport.<%=FROM_DATE%>,event)" />
...
<label> To Date</label> <input type="text" id="ToDateId"
	...
	onClick="setdate('<%=currenDate %>',document.programFinalReport.<%=TO_DATE%>,event)" />
<div class="Clear"></div>
</div>
<div class="Clear"></div>
...
<input type="button" name="OK" value="OK" class="button"
	onClick="submitForm('programFinalReport','fwc?method=showProgramFinalReport');" />
