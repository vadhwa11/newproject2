...
<input type="text" readonly="readonly"
	...
	value="22" /> <input type="hidden" name="pageNo" value="<%=pageNo%>" />
	...
	<tbody>
		...
		<% }   %> <%}//this is if(previousPage.equals("no")) end
    	   ...
    	   for(StoreIndentT storeIndentT:previousStoreIndentTList){
    		   ...
    		   System.out.println("storeIndentT.getIndent().getId() "+storeIndentT.getIndent().getId());
    		   if(((storeIndentT.getIndent().getId())==indentId)&&(inc<=incTemp)){
