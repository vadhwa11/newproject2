...
function GetMPRList(MODE)
{
	...
	var url = "stores?method=getListOfRC&flag=dept";
	var bClickable = true;
...
function ViewUpdateMR(Id)
{
	...
	window.location = "stores?method=ViewUpdateRCDetails&requestHeaderId="+Id+"&appId=A1523";	
