...
/**
 * This is an object that contains data related to the mas_store_supplier_type
 * table. Do not modify this class because it will be overwritten if the
 * configuration file related to this class is modified.
 * 
 * @hibernate.class table="mas_store_supplier_type"
 */
...
public abstract class BaseMasStoreSupplierType implements Serializable {
	 ...
	 * 
	 * @hibernate.id generator-class="native" column="supplier_type_id"
	 */
	 ...
	 * 
	 * @param masStoreSuppliers
	 *            the MasStoreSuppliers value
	 */
	public void setMasStoreSuppliers(
			java.util.Set<jkt.hms.masters.business.MasStoreSupplier> masStoreSuppliers) {
		this.masStoreSuppliers = masStoreSuppliers;
	}

	public void addToMasStoreSuppliers(
			jkt.hms.masters.business.MasStoreSupplier masStoreSupplier) {
		if (null == getMasStoreSuppliers())
			setMasStoreSuppliers(new java.util.TreeSet<jkt.hms.masters.business.MasStoreSupplier>());
	...
	public boolean equals(Object obj) {
		if (null == obj)
			return false;
		if (!(obj instanceof jkt.hms.masters.business.MasStoreSupplierType))
			return false;
		else {
			jkt.hms.masters.business.MasStoreSupplierType masStoreSupplierType = (jkt.hms.masters.business.MasStoreSupplierType) obj;
			if (null == this.getId() || null == masStoreSupplierType.getId())
				return false;
			else
				return (this.getId().equals(masStoreSupplierType.getId()));
		}
	}
