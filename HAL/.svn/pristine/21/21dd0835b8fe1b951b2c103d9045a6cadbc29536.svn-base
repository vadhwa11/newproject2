...
/**
 * This is an object that contains data related to the ot_pre_anesthesia_hd table.
 * Do not modify this class because it will be overwritten if the configuration file
 * related to this class is modified.
 *
 * @hibernate.class
 *  table="ot_pre_anesthesia_hd"
 */

public abstract class BaseOtPreAnesthesiaHd  implements Serializable {

	public static String REF = "OtPreAnesthesiaHd";
	...
	public static String PROP_ECO = "Eco";
	...
	public static String PROP_PREVIOUS_ANESTHETICS = "PreviousAnesthetics";
	public static String PROP_OEDEMA = "Oedema";
	public static String PROP_ABDOMEN = "Abdomen";
	public static String PROP_HOSPITAL = "Hospital";
	public static String PROP_CHEST_XRAY = "ChestXray";
	 ...
	 */
	public BaseOtPreAnesthesiaHd (java.lang.Integer id) {
		this.setId(id);
		initialize();
	}
	...
	private java.lang.String previousAnesthetics;
	...
	private java.util.Set<jkt.hms.masters.business.OtPreAnesthesiaDetail> otPreAnesthesiaDetails;
	private java.util.Set<jkt.hms.masters.business.OtPreOpDrugsEntry> otPreOpDrugsEntries;
	private java.util.Set<jkt.hms.masters.business.PreAnesthesiaConsultDoctorHd> preAnesthesiaConsultDoctorHds;
	...
	/**
	 * Return the value associated with the column: chest_xray
	 */
	...
	/**
	 * Set the value related to the column: chest_xray
	 * @param chestXray the chest_xray value
	 */
	...
	/**
	 * Return the value associated with the column: eco
	 */
	...
	/**
	 * Set the value related to the column: eco
	 * @param eco the eco value
	 */
	...
	/**
	 * Return the value associated with the column: previous_anesthetics
	 */
	public java.lang.String getPreviousAnesthetics () {
		return previousAnesthetics;
	}

	/**
	 * Set the value related to the column: previous_anesthetics
	 * @param previousAnesthetics the previous_anesthetics value
	 */
	public void setPreviousAnesthetics (java.lang.String previousAnesthetics) {
		this.previousAnesthetics = previousAnesthetics;
	}
	 ...
	 */
	public java.util.Set<jkt.hms.masters.business.OtPreAnesthesiaDetail> getOtPreAnesthesiaDetails () {
	 ...
	 */
	public void setOtPreAnesthesiaDetails (java.util.Set<jkt.hms.masters.business.OtPreAnesthesiaDetail> otPreAnesthesiaDetails) {
		this.otPreAnesthesiaDetails = otPreAnesthesiaDetails;
	}

	public void addToOtPreAnesthesiaDetails (jkt.hms.masters.business.OtPreAnesthesiaDetail otPreAnesthesiaDetail) {
		if (null == getOtPreAnesthesiaDetails()) setOtPreAnesthesiaDetails(new java.util.TreeSet<jkt.hms.masters.business.OtPreAnesthesiaDetail>());
		getOtPreAnesthesiaDetails().add(otPreAnesthesiaDetail);
	}



	/**
	 * Return the value associated with the column: OtPreOpDrugsEntries
	 */
	public java.util.Set<jkt.hms.masters.business.OtPreOpDrugsEntry> getOtPreOpDrugsEntries () {
		return otPreOpDrugsEntries;
	}

	/**
	 * Set the value related to the column: OtPreOpDrugsEntries
	 * @param otPreOpDrugsEntries the OtPreOpDrugsEntries value
	 */
	public void setOtPreOpDrugsEntries (java.util.Set<jkt.hms.masters.business.OtPreOpDrugsEntry> otPreOpDrugsEntries) {
		this.otPreOpDrugsEntries = otPreOpDrugsEntries;
	}

	public void addToOtPreOpDrugsEntries (jkt.hms.masters.business.OtPreOpDrugsEntry otPreOpDrugsEntry) {
		if (null == getOtPreOpDrugsEntries()) setOtPreOpDrugsEntries(new java.util.TreeSet<jkt.hms.masters.business.OtPreOpDrugsEntry>());
		getOtPreOpDrugsEntries().add(otPreOpDrugsEntry);
	}



	/**
	 * Return the value associated with the column: PreAnesthesiaConsultDoctorHds
	 */
	public java.util.Set<jkt.hms.masters.business.PreAnesthesiaConsultDoctorHd> getPreAnesthesiaConsultDoctorHds () {
		return preAnesthesiaConsultDoctorHds;
	}

	/**
	 * Set the value related to the column: PreAnesthesiaConsultDoctorHds
	 * @param preAnesthesiaConsultDoctorHds the PreAnesthesiaConsultDoctorHds value
	 */
	public void setPreAnesthesiaConsultDoctorHds (java.util.Set<jkt.hms.masters.business.PreAnesthesiaConsultDoctorHd> preAnesthesiaConsultDoctorHds) {
		this.preAnesthesiaConsultDoctorHds = preAnesthesiaConsultDoctorHds;
	}

	public void addToPreAnesthesiaConsultDoctorHds (jkt.hms.masters.business.PreAnesthesiaConsultDoctorHd preAnesthesiaConsultDoctorHd) {
		if (null == getPreAnesthesiaConsultDoctorHds()) setPreAnesthesiaConsultDoctorHds(new java.util.TreeSet<jkt.hms.masters.business.PreAnesthesiaConsultDoctorHd>());
		getPreAnesthesiaConsultDoctorHds().add(preAnesthesiaConsultDoctorHd);
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof jkt.hms.masters.business.OtPreAnesthesiaHd)) return false;
		else {
			jkt.hms.masters.business.OtPreAnesthesiaHd otPreAnesthesiaHd = (jkt.hms.masters.business.OtPreAnesthesiaHd) obj;
			if (null == this.getId() || null == otPreAnesthesiaHd.getId()) return false;
			else return (this.getId().equals(otPreAnesthesiaHd.getId()));
		}
	}
