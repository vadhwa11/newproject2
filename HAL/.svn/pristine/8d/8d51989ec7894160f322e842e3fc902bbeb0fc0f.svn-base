...
<%
		if(map.get("message") != null){
		   ...
		   %>
		   <label class="auto"><%=message %></label>
		  <%}
    %>
<div class="titleBg"><h2>Modify Stock Details</h2></div>
		    ...
		    int  i=0;
		          while(iterator.hasNext())
		           {    
		        	 ...
		        	 System.out.println("value of nomenclature------"+nomenclature+"----value of brand name----"+brandName);
		%>
