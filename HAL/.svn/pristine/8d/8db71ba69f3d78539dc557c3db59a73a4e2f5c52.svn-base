...
<script language="javascript">
	...
	function GetPatientList(MODE) {
		...
		if (MODE == 'ALL') {
			...
			var data = "PN=" + nPageNo + "&impHospitalId=" + impHospitalId+"&empNo="+empNo+"&rankCategoryId="+rankCategoryId+"&divisionId="+divisionId;
		}
		var url = "referral?method=getExtensionWaitingList";
		var bClickable = true;
	...
	function executeClickEvent(Id)
	 ...
	 window.location="referral?method=generateExtensionLetterPage&opdId="+Id;
	 }
