...
<form name="pnc" action="" method="post"><input type="hidden"
...
<div class="clear"></div>
<label>No. of Children</label> <input type="text" name="noOfChildren"
	class="auto" size="4" maxlength="1" /> <label class="auto">Gender</label>
<select class="smallest">
	<option>Male</option>
	<option>Female</option>
</select> <label>Delivery</label> <select>
...
<ul class="categoryitems">
	...
	<li><a
		href="#" onclick="submitFormForButton('pnc','opd?method=showPatientPreviousVisitForViewScreen&visitId=<%=visit.getId()%>&visitNo=<%=visit.getVisitNo()%>&deptId=<%=visit.getDepartment().getId()%>&<%=HIN_ID%>=<%=visit.getHin().getId()%>&token=<%=visit.getTokenNo()%>')">
	...
	--%>
	<li><a
		href="#" onclick="submitFormForButton('pnc','medicalExam?method=getPrevMedExamFromHIC&serviceNo=<%=visit.getHin().getServiceNo() %>')">
	Previous Medical Exams </a></li>
	<li><a
		href="#" onclick="submitFormForButton('pnc','medicalExam?method=getPrevMedBoardFromHIC&visitId=<%=visit.getId()%>&visitNo=<%=visit.getVisitNo()%>&deptId=<%=visit.getDepartment().getId()%>&<%=HIN_ID%>=<%=visit.getHin().getId()%>&serviceNo=<%=visit.getHin().getServiceNo() %>')">
	Previous Medical Boards</a></li>
	<li><a
		href="#" onclick="submitFormForButton('pnc','opd?method=showPatientPreviousVisitForHospitality&visitId=<%=visit.getId()%>&visitNo=<%=visit.getVisitNo()%>&deptId=<%=visit.getDepartment().getId()%>&<%=HIN_ID%>=<%=visit.getHin().getId()%>')">
	...
	<li><!-- Code for Open In popup mode
	...
	Investigations</a></li>
	 --%><li> <a
		href="#" onclick="javascript:openPopupPrescriptions(<%=visit.getId()%>,<%=visit.getVisitNo()%>,<%=visit.getDepartment().getId()%>,<%=visit.getHin().getId()%>)">
	...
	<%-- <li><a
		href="#" onclick="submitFormForButton('pnc','opd?method=showAllergyDetailsJsp&visitId=<%=visit.getId() %>&hinId=<%=visit.getHin().getId() %>')">Allergies</a></li>--%>
	<li><a
		href="#" onclick="submitFormForButton('pnc','adt?method=showMlcJsp&hinId=<%=visit.getHin().getId() %>')">MLC
	Details</a></li>
	<li><a
		href="#" onclick="submitFormForButton('pnc','opd?method=showUploadingDocumentsJsp&visitId=<%=visit.getId() %>')">Upload
	Documents </a></li>
...
<div class="opdArea"><label>Return from Hospital</label> <input
	type="checkbox" name="returnfromHospital" class="radio"
	id="returnValue" value="false" onclick="valueChange()" /><%--  <label>Follow
Up</label> <input type="checkbox" name="followUp" class="radio" id="returnValue"
	value="false" />--%>
<div class="clear"></div>


<div id=hospidataId style="display: none"><label>Hospital
Name</label> <input type="text" name="hospName" tabindex="1" size="100" value=""
	maxlength="150" /> <label class="auto">DOA</label> <input type="text"
	name="doa" class="date" id="doa" MAXLENGTH="30"
	validate="Pick a from date,date,no" value="" readonly="readonly" /> <img
	src="/hms/jsp/images/cal.gif" width="16" height="16" border="0"
	onclick="javascript:setdate('doa',document.pnc.doa, event)"
	validate="Pick a date" /> <label class="auto">DOD</label> <input
	type="text" name="dod" value="" class="date" id="dod" MAXLENGTH="30"
	validate="Pick a from date,date,no" readonly="readonly" /> <img
	src="/hms/jsp/images/cal.gif" width="16" height="16" border="0"
	onclick="javascript:setdate('dod',document.pnc.dod, event)"
...
<label>Diagnosis</label> <input type="text" class="auto" size="48"
	...
	maxlength="100" />
<div class="clear"></div>
<label>Advise on Discharge</label> <textarea name="adviceOnDischarge"
	cols="0" rows="0" maxlength="300" value="" tabindex="1"
...
<div class="floatLeft"><label>Complaints<span>*</span></label> <!--  <input type="text" id="presentComplain"  name="presentComplain" maxlength="100"/>-->
<textarea name="presentComplain" cols="0" rows="0" maxlength="950"
	validate="Complaints,string,yes" value="" validate tabindex="1"
	onkeyup="return ismaxlength(this)">
	<%=opdPatientHistory != null && opdPatientHistory.getPresentComplain()!=null ?opdPatientHistory.getPresentComplain():"" %>
	</textarea>
<div class="clear"></div>
...
</script> <!-- <textarea name="familyHistory" cols="0" rows="0"  maxlength="300"	value=""  tabindex="1" onkeyup="return ismaxlength(this)"></textarea> -->
<div class="clear"></div>
<label>Risk Factors</label> <!--  <input type="text" id="presentComplain"  name="presentComplain" maxlength="100"/>-->
<textarea name="riskFactor" cols="0" rows="0" maxlength="300" value=""
	tabindex="1" onkeyup="return ismaxlength(this)">
...
<h4>VISION</h4>
<div class="Block"><label>Distant Vision</label> 
<input
	type="text" name="distantVision" value="<%=opdDetailsForFollowup != null && opdDetailsForFollowup.getDistantVision()!=null ?opdDetailsForFollowup.getDistantVision():"" %>" id="distantVision" maxlength="5" validate='DistantVision,int,no' /> <label>Near
Vision</label> <input type="text" name="nearVision" value="<%=opdDetailsForFollowup != null && opdDetailsForFollowup.getNearVision()!=null ?opdDetailsForFollowup.getNearVision():"" %>"  id="nearVision"  maxlength="5" validate='NearVision,int,no'/>

<label>Others</label> <input type="text" name="othersVision" value="<%=opdDetailsForFollowup != null && opdDetailsForFollowup.getOthersVision()!=null ?opdDetailsForFollowup.getOthersVision():"" %>" validate='OtherVision,int,no'
	id="othersVision" maxlength="5" /></div>

<h4>Vitals</h4>
<div class="Block"><label class="">Weight</label> 
<input
	name="weight" tabindex="1" type="text" id="weight" value="<%=opdDetailsForFollowup !=null && opdDetailsForFollowup.getVweight()!=null?opdDetailsForFollowup.getVweight():"" %>" 
	onblur="calculateBMI()" class="auto" size="5" validate="weight,int,no"
	maxlength="3" /> <label class="unit">kg</label> <label class="">Height</label>
<input name="height" tabindex="1" type="text" id="height" value="<%=opdDetailsForFollowup !=null && opdDetailsForFollowup.getHeight() != null ?opdDetailsForFollowup.getHeight():"" %>"
	class="auto" onblur="calculateIdealWeight();calculateBMI();" size="5"
	validate="height,int,no" maxlength="3" /> <label class="unit">cm</label>

<label class="">BMI</label> <input tabindex="1" type="text" id="bmi"
	name="bmi" readonly="readonly" maxlength="6" value="<%=opdDetailsForFollowup != null && opdDetailsForFollowup.getBmi() != null ? opdDetailsForFollowup.getBmi():"" %>"
...
<label class="">Ideal Weight</label> <input name="idealWeight"
	...
	value="<%=opdDetailsForFollowup!= null && opdDetailsForFollowup.getIdealWeight()!= null ?opdDetailsForFollowup.getIdealWeight():"" %>" tabindex="1" validate="Ideal Weight,string,no" maxlength="3" />
<label class="unit">kg</label> 
<label class="">Temperature</label> <input
	name="temperature" id="tempId" type="text" tabindex="1" value="<%=opdDetailsForFollowup!= null && opdDetailsForFollowup.getTemperature()!= null?opdDetailsForFollowup.getTemperature():"" %>"
	class="auto" size="5" onblur="convertFarenhiteToCelcius();" validate="Temperature,float,no"
	maxlength="5" /> 
	<label class="unit">&deg;F</label> <label class="">Temperature</label>
<input name="temperature" id="tempInCelciusId" type="text" tabindex="1"
	value="" class="auto" size="5" maxlength="5"
	onblur="convertCelciusToFarenhite();" /> <label class="unit">&deg;C</label>
<div class="clear"></div>
<label class="">Pulse</label> <input name="pulse" type="text"
	tabindex="1" value="<%=opdDetailsForFollowup != null && opdDetailsForFollowup.getPulse() != null?opdDetailsForFollowup.getPulse():"" %>"  class="auto" size="5" tabindex="1"
	validate="pulse,int,no" maxlength="3" /> <label class="unit">/min</label>


<label class="">BP</label> <input name="bp" id="bp" type="text"
	tabindex="1" value="<%=opdDetailsForFollowup != null && opdDetailsForFollowup.getBp()!= null?opdDetailsForFollowup.getBp():"" %>"  class="auto" size="5"
	onblur="validateBpValue(this.value);" maxlength="7" /> <label
	class="unit">mm/Hg</label> <label class="">RR</label> <input name="rr"
	id="rr" type="text" tabindex="1" value="<%=opdDetailsForFollowup != null && opdDetailsForFollowup.getRr()!= null?opdDetailsForFollowup.getRr():"" %>"  class="auto" size="5" validate="RR,float,no"
	maxlength="3" /> <label class="unit">/min</label>

<div class="clear"></div>

<label>On Examination</label> <textarea name="onExamination" cols="120"
	rows="0" value="" maxlength="300" class="auto" tabindex="1"
...
<%if(au != null){ %>
 ...
 %>
		...
		<td><input type="text" name="route<%=inc1%>" tabindex="1" id="route<%=inc1%>" value="<%=route %>"  size="5" maxlength="20"	 validate="Route,string,no" />
			<input type="hidden" name="total<%=inc1%>" tabindex="1" id="total<%=inc1%>" /></td>
			<%}else{ %>
			<td><input type="text" name="route<%=inc1%>" tabindex="1" id="route<%=inc1%>" value="PO"  size="5" maxlength="20"	 validate="Route,string,no" />
			<input type="hidden" name="total<%=inc1%>" tabindex="1" id="total<%=inc1%>" /></td>
			<%} %>
		<%-- <%
...
<h4>Gynaecological Examination</h4>

<div class="Block">
<label>Breast Exam</label>
 <input type="text" name="breastExam" value="<%=opdDetailsForFollowup != null && opdDetailsForFollowup.getBreastExam() != null ? opdDetailsForFollowup.getBreastExam():"" %>" id="breastExam" maxlength="45" />
...
<input type="text" name="papSmear" value="<%=opdDetailsForFollowup != null && opdDetailsForFollowup.getPapSmear() != null ? opdDetailsForFollowup.getPapSmear():"" %>" id="papSmear" maxlength="45" />
 <label>Other Observation</label>
  <input type="text" name="otherObservation" id="otherObservation" value="<%=opdDetailsForFollowup != null && opdDetailsForFollowup.getOtherObservation() != null ? opdDetailsForFollowup.getOtherObservation():"" %>" maxlength="45" />
  </div>
<div class="clear paddingTop15"></div>
...
<label>Any Systemic Disorder</label>
 <textarea rows="" cols="" name="systemicDisorder" maxlength="95" validate="Systemic Disorder,string,no" value=""  tabindex="1" onkeyup="return ismaxlength(this)" >
...
<%} %>
 ...
 <select name="referredDepartmentId" tabindex="1" multiple="4"
	size="3" id="referredDepartmentId" class="listBig"
	onchange="referedchange(this)">
	<option value="0">Select</option>
	<%
...
<div class="Block">
 	...
 	<label>Special Advise/Follow up</label>
	 <textarea rows="" cols="" name="specialAdviseFollowup" maxlength="95" validate="Special Advise Followup,string,no" value=""  tabindex="1" onkeyup="return ismaxlength(this)"></textarea>
	 --%>
