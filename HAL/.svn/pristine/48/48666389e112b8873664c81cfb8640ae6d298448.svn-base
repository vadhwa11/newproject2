...
<%	
		...
		System.out.println("MisResponse FOr FoodHandler");
...
<label>HIN</label>
<select name="<%=HIN_NO%>" class="auto" onblur="submitProtoAjaxForHin('foodHandler','mis?method=getPatientDetailForFoodHandler')"  >
