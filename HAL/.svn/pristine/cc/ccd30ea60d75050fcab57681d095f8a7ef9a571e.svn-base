		...
		<div id="divSearchResult">
			...
			<table id="tblSearchResultsHeader" class="tblSearchResultsHeader"
				...
				<tr>
					...
					<th id="th2" style='width: 100px;'>From Date</th>
					<th id="th3" style='width: 120px;'>To Date</th>
...
<%out.print(hospitalId);%>
	...
	function makeTable(jsonData) {
		...
		for (i = 0; i < jsonData.length; i++) {
			...
			htmlTable = htmlTable + "<td >" + jsonData[i].venderName
					+ "</td>";
			htmlTable = htmlTable + "<td >" + jsonData[i].departmentName + "</td>";
			htmlTable = htmlTable + "<td >" + jsonData[i].fromDate + "</td>";
			htmlTable = htmlTable + "<td >" + jsonData[i].toDate + "</td>";
