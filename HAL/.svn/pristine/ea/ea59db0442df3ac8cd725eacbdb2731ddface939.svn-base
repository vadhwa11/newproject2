...
<form name="pendingMDWatingList" method="post" action="">
<div class="clear"></div>
...
data_header[5][0] = "Appointment date"
...
%>
   data_arr[<%= counter%>] = new Array();
	   ...
	   <%}%>
	   <%if(masexam.getPastmedicalhistory()!=null){%>
	   data_arr[<%= counter%>][6] = "<%=masexam.getAppointmentDate()%>"
		   <%}else{%>
	   data_arr[<%= counter%>][6] = ""   
	   <%}%>
