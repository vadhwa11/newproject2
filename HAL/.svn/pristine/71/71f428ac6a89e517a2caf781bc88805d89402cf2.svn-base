...
function GoPage() {	
	...
	submitForm('rangeFiringDutyAddForm','hrOrderly?method=getGridDataForRangeFiringEmployeeAdd');
}
...
function jsAdd()
{
		...
		{
			rangeFiringDutyAddForm.method="post";
				submitForm('rangeFiringDutyAddForm','hrOrderly?method=AddRangeFiringDutyEntry');
...
function jsSearch()
{
	...
	{
		rangeFiringDutyAddForm.method="post";
		submitForm('rangeFiringDutyAddForm','hrOrderly?method=searchRangeFiringDutyEntry');
	}		
}			            
	function jsClose()
	{
	  window.opener.location.href = "hrOrderly?method=showRangeFiringDutyEntryJsp";
	  ...
	  %>
		<tr>
			...
			<td><input type="text" size="9"
				value="<%=masEmployee.getServiceNo()%>" name="serviceNo"
				readonly="readonly" /></td>
			<td><input type="text" size="9"
				value="<%=masEmployee.getFirstName()%>" name="empName"
				readonly="readonly" /></td>
			<td><input type="text"
