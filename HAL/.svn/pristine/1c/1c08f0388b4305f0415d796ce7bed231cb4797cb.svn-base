...
<input
	...
	value="<%=currenDate %>" class="date" readonly="readonly" validate="From Date,frdate,yes"
	MAXLENGTH="30" /> <img id="calendar" src="/hms/jsp/images/cal.gif"
	width="16" height="16" border="0" validate="Pick a date"
	class="calender"
	onClick="setdate('<%=currenDate %>',document.dentalRegister.<%=FROM_DATE%>,event)" />
...
<label> To <span>*</span> </label> <input type="text" id="ToDateId" validate="To Date,frdate,yes"
	...
	onClick="setdate('<%=currenDate %>',document.dentalRegister.<%=TO_DATE%>,event)" />
<div class="Clear"></div>
<label>Rank</label>
...
<input type="text" class="transparent" size="14">
<input type="text" name="<%=SERVICE_NO %>" value=""MAXLENGTH="30" validate="Service No,alphanumeric,no"/>
<label>Gender </label>
...
<input type="text" class="transparent" size="14">
<select name="disposal" validate="Relation,metachar,no">
<option value="">Select</option>
<%
...
<!--<label>ICD No.</label>
<input type="text" class="transparent" size="14">
<input type="text" name="icdNo" value="" id="icdNo" validate="ICD No,alphanumeric,no" />
<label>ICD Diagnosis</label>
<input type="text" tabindex="1"	value="" id="icd"  name="icd"	class="auto"  size="60"  validate="ICD Diagnosis,string,no"/>
...
<input type="text" tabindex="1"	value="" id="procedure"  name="procedure"	class="auto"  size="60"  validate="Procedure,string,no"/>
<div id="ac2update"	style="display: none;" class="autocomplete"></div>
<script type="text/javascript" language="javascript" charset="utf-8">
		  new Ajax.Autocompleter('procedure','ac2update','dental?method=getPocedureList',{parameters:'requiredField=procedure'});
</script>
<div class="Clear"></div>
</div>
<div class="Clear"></div>
...
<div class="Clear"></div>
<input type="button" name="OK" value="OK" class="button" onClick="submitForm('dentalRegister','dental?method=showDentalRegisterOnScreen');" />
...
<script>
function openGraph(){
	var url = "registration?method=showOPDStatisticsGraph&"+getNameAndData('dentalRegister');
