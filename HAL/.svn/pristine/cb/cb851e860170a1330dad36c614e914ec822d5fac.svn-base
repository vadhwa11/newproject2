...
<form name="getReferralWaitingList" method="post" action="">
    <h4><%=message %></h4>
	<h2>Generate Excel Waiting List </h2>
		...
		<div id="divSearchResult">
			...
			<table id="tblSearchResultsHeader" class="tblSearchResultsHeader"
				...
				<tr>
					...
					<th id="th6" style='width: 100px;'>Excel Status</th>
...
/*
	...
	function validateRadio() {
		...
		function fileValidation()
		{
			...
			submitForm('getReferralWaitingList','/hms/hms/referral?method=uploadExcelForHAL')
