...
<a
	href="javascript:setdate('<%=currentDate%>',document.dailyOPDInvestigations.<%=FROM_DATE%>,true)">
...
<input type="text" name="<%=TO_DATE%>" value="<%=currentDate %>" class="date" MAXLENGTH="30"
	...
	href="javascript:setdate('<%=currentDate%>',document.dailyOPDInvestigations.<%=TO_DATE%>,true)">
<img src="/hms/jsp/images/cal.gif" width="16" height="16" border="0"
	validate="Pick a date" class="calender" /> </a> 
<div class="clear"></div>
<label > Department <span>*</span></label> 
<select id="deptId" name="<%=DEPARTMENT_ID%>"
	onchange="populateDoctorName(this.value,'dailyOPDInvestigations')"
...
<center><input type="button" name="add" id="addbutton"
	...
	onClick="submitForm('dailyOPDInvestigations','opd?method=generateDailyOPDInvestigationsReport','check()','checkTargetForYes');"
	accesskey="a" tabindex=1 /> 
<input type="button" name="clear" id="clearbutton" value="Cancel" class="button" onClick="submitForm('dailyOPDInvestigations','opd?method=showDailyOPDInvestigationsReportJsp','check()','checkTargetForNo');" accesskey="a" tabindex=1 />
</center>
<div class="clear"></div>
<div class="division"></div>
<div class="clear"></div>
