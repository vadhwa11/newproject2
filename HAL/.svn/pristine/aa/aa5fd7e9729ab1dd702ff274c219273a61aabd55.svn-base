...
/**
 * This is an object that contains data related to the AV_AIRCREW_RATION table.
 * Do not modify this class because it will be overwritten if the configuration file
 * related to this class is modified.
 *
 * @hibernate.class
 *  table="AV_AIRCREW_RATION"
 */

public abstract class BaseAvAircrewRation  implements Serializable {

	public static String REF = "AvAircrewRation";
	 ...
	 */
	public BaseAvAircrewRation (java.lang.Integer id) {
		this.setId(id);
		initialize();
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof jkt.hms.masters.business.AvAircrewRation)) return false;
		else {
			jkt.hms.masters.business.AvAircrewRation avAircrewRation = (jkt.hms.masters.business.AvAircrewRation) obj;
			if (null == this.getId() || null == avAircrewRation.getId()) return false;
			else return (this.getId().equals(avAircrewRation.getId()));
		}
	}
