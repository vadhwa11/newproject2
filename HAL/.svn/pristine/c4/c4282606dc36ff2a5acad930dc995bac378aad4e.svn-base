...
<div class="floatLeft"><input name="patient fast history"
	...
	onclick="submitForm('opdOphthalmology','/hms/hms/fwc?method=showOphthalmologyFollowUpJsp');">
<input name="patient fast history3" type="button" class="navButtons"
	value="Retinal"
	onclick="submitForm('opdOphthalmology','/hms/hms/fwc?method=showOphthalmologyRetinalJsp');">
<input name="patient fast history23" type="button" class="navButtons"
	value="Diagnosis"
	onclick="submitForm('opdOphthalmology','fwc?method=showOphthalmologyDiagnosisJsp');">
</div>
...
<div class="bottom">
<input name="Save" type="button" class="button" value="Submit" onclick="if(checkBlankForOphthalmology('opdOphthalmology')){submitForm('opdOphthalmology','fwc?method=submitOphthalmologyDetails');}">
<input name="view" type="button" class="button" value="View" onclick="submitForm('opdOphthalmology','fwc?method=viewPatientOphthalmologyDetails&flag=prev&viewScreen=no');">
