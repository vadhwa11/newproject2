...
/**
 * This is an object that contains data related to the dg_org_grp_dtl table. Do
 * not modify this class because it will be overwritten if the configuration
 * file related to this class is modified.
 * 
 * @hibernate.class table="dg_org_grp_dtl"
 */
...
public abstract class BaseDgOrgGrpDtl implements Serializable {
	 ...
	 * 
	 * @hibernate.id generator-class="native" column="org_grp_dtl_id"
	 */
	...
	public boolean equals(Object obj) {
		if (null == obj)
			return false;
		if (!(obj instanceof jkt.hms.masters.business.DgOrgGrpDtl))
			return false;
		else {
			jkt.hms.masters.business.DgOrgGrpDtl dgOrgGrpDtl = (jkt.hms.masters.business.DgOrgGrpDtl) obj;
			if (null == this.getId() || null == dgOrgGrpDtl.getId())
				return false;
			else
				return (this.getId().equals(dgOrgGrpDtl.getId()));
		}
	}
