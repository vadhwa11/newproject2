...
function check(){
var SDate = document.mon_MonthlyMalariaCaseH.<%= FROM_DATE%>.value;
var EDate = document.mon_MonthlyMalariaCaseH.<%= TO_DATE %>.value;
...
%>
<form name="mon_MonthlyMalariaCaseH" method="post" action="" >

<div class="titleBg">
<h2>Monthly Malaria Case</h2>
</div>
<div class="Block">
...
<a	href="javascript:setdate('<%=f%>',document.mon_MonthlyMalariaCaseH.<%=FROM_DATE%>,true)">
...
<a href="javascript:setdate('<%=t%>',document.mon_MonthlyMalariaCaseH.<%=TO_DATE%>,true)">
<img src="/hms/jsp/images/cal.gif" width="16" height="16" border="0" validate="Pick a date" class="calender" /> </a> 
...
{
	submitForm('mon_MonthlyMalariaCaseH','/hms/hms/monitoring?method=printMonthlyMalariaCaseReport');
}
</script>
