...
<label>From Date</label> <input type="text" name="<%= FROM_DATE %>"
	class="date" maxlength="30" tabindex=1 onkeyup="mask(this.value,this,'2,5','/');" onblur="validateExpDate(this,'fromDate');" id="fromDate" /> <img id="calendar"
...
<div class="clear"></div>
<label>CRV/RV No.</label>
 <input type="text" name="<%=GRN_NO%>" value=""
...
<input type="hidden" name="supplyType"  id="supplyType" value="a">
...
<form name="grnGrid" method="post"></form>
...
<label>CRV/RV No.<span>*</span></label> <% if(storeGrnObj != null){%> <input
	...
	readonly="readonly" tabindex=1 id="grnNo" /> 
	<%}else{ %><!-- 
	<input	id="grnNo" type="text" name="<%=GRN_NO %>" value="<%=max %>"	readonly="readonly" tabindex=1 />
	 -->
	<input	id="grnNo" type="text" name="<%=GRN_NO %>" value="<%=max %>" tabindex=1 maxlength="10" onblur="checkGrnNo(this.value);" validate="CRV/RV No.,string,yes" title="i.e. 10/12-13 or 111/12-13"/>
	 <%} %>
	<label>CRV/RV Date<span>*</span></label> <%--<input type="text" class="date"
	name="<%=GRN_DATE%>" value="<%=currentDate %>" readonly="readonly" MAXLENGTH="30" tabindex=1
	id="grnDate" />  --%>
	<input type="text" class="date"
	name="<%=GRN_DATE%>" value="<%=currentDate %>" MAXLENGTH="10" tabindex=1 onkeyup="mask(this.value,this,'2,5','/');"
	onblur="validateExpDate(this,'grnDate');" id="grnDate" />
	
	<img id="calendar" src="/hms/jsp/images/cal.gif"
	width="16" height="16" border="0" validate="Pick a date"
	class="calender" tabindex="1"
	onClick="setdate('<%=currentDate%>',document.grnForm.<%=GRN_DATE%>,event)" />
...
<select name="<%=INDENT_ID %>" id="indentCombo" tabindex=1>
</select>
</div>
 <!-- -
...
<%--<input type="text" class="date" name="<%=RECEIVED_DATE%>" value="<%=currentDate %>"
	MAXLENGTH="30" readonly tabindex=1 />  --%>
	
	<input type="text" class="date" name="<%=RECEIVED_DATE%>" id="receivedDate" value="<%=currentDate%>"
	MAXLENGTH="10" onkeyup="mask(this.value,this,'2,5','/');" tabindex=1  onblur="validateExpDate(this,'receivedDate');"/> 
	
	<img id="calendar"
	src="/hms/jsp/images/cal.gif" width="16" height="16" border="0"
	class="calender" validate="Pick a date" tabindex="1"
	onClick="setdate('<%=currentDate%>',document.grnForm.<%=RECEIVED_DATE%>,event)" />
...
Date</label><%--<input type="text" class="date" name="<%=INVOICE_DATE%>" readonly
	...
	<input type="text" class="calDate" name="<%=INVOICE_DATE%>" id="invoiceDate" value="<%=currentDate%>"
	MAXLENGTH="10" onkeyup="mask(this.value,this,'2,5','/');" tabindex=1 onblur="validateExpDate(this,'receivedDate');" /> 
	
<img id="calendar" src="/hms/jsp/images/cal.gif" width="16" height="16"
	border="0" validate="Pick a date" class="calender" tabindex="1"
	onClick="setdate('',document.grnForm.<%=INVOICE_DATE%>,event)" />
...
</select> --> <label> Unpacked-Checked By<span>*</span></label> <select
