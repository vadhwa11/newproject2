...
/**
 * This is an object that contains data related to the hr_mas_leave_type table.
 * Do not modify this class because it will be overwritten if the configuration file
 * related to this class is modified.
 *
 * @hibernate.class
 *  table="hr_mas_leave_type"
 */

public abstract class BaseHrMasLeaveType  implements Serializable {

	public static String REF = "HrMasLeaveType";
	 ...
	 */
	public BaseHrMasLeaveType (java.lang.Integer id) {
		this.setId(id);
		initialize();
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof jkt.hms.masters.business.HrMasLeaveType)) return false;
		else {
			jkt.hms.masters.business.HrMasLeaveType hrMasLeaveType = (jkt.hms.masters.business.HrMasLeaveType) obj;
			if (null == this.getId() || null == hrMasLeaveType.getId()) return false;
			else return (this.getId().equals(hrMasLeaveType.getId()));
		}
	}
