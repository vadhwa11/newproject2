...
<%}%>
	...
	%>
	data_arr[<%= counter%>][11] = "<%=patientPresc.getVisit().getDoctor().getRank().getRankName()+" "+patientPresc.getVisit().getDoctor().getFirstName()+" "+patientPresc.getVisit().getDoctor().getLastName()%>"
	<%}else{%>
	data_arr[<%= counter%>][11] =" "
	<%}%>
	<%
