 ...
 * messageForUserGroupAccessRights.jsp  
 * Purpose of the JSP -  This is Message for User Group Rights.
 * @author  Mansi
 * @author  Deepali
 * Create Date: 02nd Jul,2007 
 * Revision Date:      
 * Revision By: 
 * @version 1.2
--%>
...
%>
			<p align="center" class="bodytextB_blue">Access Rights to user
			group has been assigned successfully.</p>
			<%
		}else{
%>
			<p align="center" class="bodytextB_blue">Access Rights for user
			group has been deleted successfully.</p>
			<%
		}
%>
			</div>
