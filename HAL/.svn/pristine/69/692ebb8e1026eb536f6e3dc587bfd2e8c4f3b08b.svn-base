...
<input type="text" name="employeeNo" id="employeeNo"  onblur="submitForm('searchPrescription','/hms/hms/opd?method=showPendingPrescriptionAdminJsp&byAdmin=n');" />
...
<form name="pendingPrescription" method="post" action="">
