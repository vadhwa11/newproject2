...
<div class="titleBg">
<h2>Updation of other patient</h2>
</div>
<div class="clear"></div>
...
<input id="sFNameId" type="text" name="<%=S_FIRST_NAME %>" value="" tabindex="1"		validate="First Name,string,yes" MAXLENGTH="150"	onblur="" /> 
...
<select name="<%=SR_SEX %>" id="srSexId" validate="Service Person Gender,metachar,yes" tabindex="1"	onchange="">
	<%
...
<textarea name="<%=ADDRESS %>" id="sraddr"	cols="20" rows="2" tabindex="1" validate="Address,metachar,no" maxlength="200"
	onpaste="return checkOnPaste(this)"	oninput="return checkMaxLengthMoz(this)"	onKeyDown="return checkMaxLength(this)" onKeyUp="finalCheck(this)" onblur="" ></textarea>
...
<div class="clear"></div>
<label> First Name <span>*</span></label> 
<input type="text"	id="pFirstNameId" name="<%=P_FIRST_NAME %>" value="" tabindex="1"	title="First Name"	validate="Patient First Name,regName,yes" MAXLENGTH="150" />

<label>Middle Name</label> 
<input type="text" id="pMiddleNameId"	name="<%=P_MIDDLE_NAME%>" value="" tabindex="1"	validate="Middle Name,name,no" MAXLENGTH="30" /> 

<label>Last Name</label> 
<input type="text" id="pLastNameId" name="<%=P_LAST_NAME %>"	value="" validate="Last Name,name,no" MAXLENGTH="30"	tabindex="1" /> 
...
<textarea name="<%=ADDRESS %>" id="addr" cols="20" rows="2" tabindex="1" validate="Address,metachar,no"	onpaste="return checkOnPaste(this)"
 maxlength="200"	oninput="return checkMaxLengthMoz(this)"	onKeyDown="return checkMaxLength(this)" onKeyUp="finalCheck(this)"	  onblur=""></textarea>
...
<div id="edited"></div>
 ...
 <input type="button" name="Submit11" value="Update" tabindex="1" class="button"	onClick="if(fillSelfDetails()){if(checkPatientStatus() && checkNameSpaces() ){submitRegistration()}}" />
<input type="reset" name="Reset" value="Reset" class="button" tabindex="1" onClick="submitFormForButton('registration','/hms/hms/registration?method=updateOtherPatientInformationJsp');" accesskey="r" />
...
function submitRegistration(){
	...
	if(validateMetaCharacters(flag))
		{
		if(document.getElementById('regHinId').value != null && document.getElementById('regHinId').value.trim()!="")
		{
		submitForm('registration','/hms/hms/registration?method=updateOtherPatientInformation&flag='+flag,'checkTargetForNo');
		}
		else
			{
			alert("New Registration Not Allowed Kindly Contact Registration Counter");
			}
		}
