...
<input tabindex="1" type="text" id="medboardDuration" name="medboardDuration"  class="autoArial" size="2" value="<%=medboardDuration%>" onkeyup="isNumber1(this)" validate="Duration,num,no" maxlength="2"/>
...
<img src="/hms/jsp/images/cal.gif" width="16" height="16"
	border="0" validate="Pick a date" class="calender"
	onclick="setdate('',MedicalBoardInitialMedExamJsp.SpecilaistOpinionDate,event);" />
...
<%if(medExamObj.getId()!=null)
{ %>
<!--<input tabindex="1" name="Button"	type="button" class="button" value="Update"	onClick="submitForm('MedicalBoardInitialMedExamJsp','medicalBoard?method=updateMedicalExamEntry&Labresult=<%=Labresult.trim() %>&SecialFlag=<%=SecialFlag%>&directFlag=<%=directFlag%>&specialist=yes');" />-->
<input tabindex="1" name="Button"	type="button" class="button" value="Update"	onClick="submitForm('MedicalBoardInitialMedExamJsp','medicalBoard?method=updateMedicalExamEntryBySpecialist&Labresult=<%=Labresult.trim() %>&SecialFlag=<%=SecialFlag%>&directFlag=<%=directFlag%>&specialist=yes');" />
...
{
		submitForm('MedicalBoardInitialMedExamJsp','medicalBoard?method=validateMedExamSpecialOpinion&flagForward=v&directFlag=<%=directFlag%>');
}
