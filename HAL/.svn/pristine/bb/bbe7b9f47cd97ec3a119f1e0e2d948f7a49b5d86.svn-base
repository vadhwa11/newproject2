...
<FORM name="nominalRollRegister" action="" method=post>
<h6>Nominal Roll Register</h6>
<DIV class="Clear"></DIV>

<DIV class="blockFrame"><Label><span>*</span> From Period</Label>
<input type="text" name="<%=FROM_DATE%>" value="" class="calDate"
	readonly="readonly" MAXLENGTH="30" validate="Pick a from date,date,yes" />
<img src="/hms/jsp/images/cal.gif" width="16" height="16" border="0"
	onClick="setdate('<%=currentDate%>',document.nominalRollRegister.<%= FROM_DATE%>,event);"
	class="calender" /> <LABEL><span>*</span> To Period</LABEL> <input
	type="text" name="<%=TO_DATE%>" value="" class="calDate"
	readonly="readonly" validate="Pick a to date,date,yes" MAXLENGTH="30" />
<img src="/hms/jsp/images/cal.gif" width="16" height="16" border="0"
	onClick="setdate('<%=currentDate%>',document.nominalRollRegister.<%= TO_DATE%>,event);"
	class="calender" /></DIV>
<div class="division"></div>
<div class="bottom"><input type="button" class=button value="Ok"
	name="print"
	onclick="submitForm('nominalRollRegister','/hms/hms/hrOrderly?method=printMomRegister')" />
