...
if(medExamObj.getClinicalReferMh() !=null){
	referredToMh=medExamObj.getClinicalReferMh().getHospitalName();
}
...
if(medExamObj.getGastroIntestinalSystem()!=null){
	cardiovascularSys=medExamObj.getGastroIntestinalSystem();
}
%>
...
<label>Central Nervous System </label>
  <input type="text"name="<%=NERVOUS_BRAKDOWN%>" class="auto" size="100" value="<%=centralNervousMM%>" readonly="readonly" tabindex="1"/>
