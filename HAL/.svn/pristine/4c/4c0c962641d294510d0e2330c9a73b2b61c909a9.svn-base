...
/**
 * This is an object that contains data related to the mas_delivery table. Do
 * not modify this class because it will be overwritten if the configuration
 * file related to this class is modified.
 * 
 * @hibernate.class table="mas_delivery"
 */
...
public abstract class BaseMasDelivery implements Serializable {
	 ...
	 * 
	 * @hibernate.id generator-class="native" column="delivery_id"
	 */
	...
	public boolean equals(Object obj) {
		if (null == obj)
			return false;
		if (!(obj instanceof jkt.hms.masters.business.MasDelivery))
			return false;
		else {
			jkt.hms.masters.business.MasDelivery masDelivery = (jkt.hms.masters.business.MasDelivery) obj;
			if (null == this.getId() || null == masDelivery.getId())
				return false;
			else
				return (this.getId().equals(masDelivery.getId()));
		}
	}
