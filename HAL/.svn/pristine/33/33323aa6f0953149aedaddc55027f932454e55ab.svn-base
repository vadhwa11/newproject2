...
<form name="getReferralWaitingList" method="post" action="">
    <h4><%=message %></h4>
	<h2>Consolidation of Bills Hospital Wise</h2>
...
<select name ="impHospitalId" id="impHospitalId" validate="Hospital,string,yes" onchange="GetPatientList('FILTER');">
<option value="0">Select</option>
	<%
...
<div class="clear" style="padding-top: 10px;"></div>
		...
		<div id="divSearchResult" style="overflow:scroll;height:650px;" >
			...
			<table id="tblSearchResultsHeader" class="tblSearchResultsHeader"
				...
				<tbody id="tblListOfPatient"  style = "overflow:scroll;">
...
<script language="javascript">
	...
	function GetPatientList(MODE) {
		...
		var url = "referral?method=getInvoiceWaitingListForGM";
