...
<h6>Report Entry For Modification</h6>
...
<!--Block Two Ends--> <!-- Block Three Starts --> <input type="hidden"
	...
	id="resultEnteredBy" name="<%= RESULT_ENTERED_BY %>" type="hidden"
	value="<%=resultEnteredByForTemplate %>"
	validate="Report Entered By,string,yes" tabindex=1 /> </input> <input
...
<input type="button" class="button" value="Submit"
	onclick="formSubmission();" align="right" /> <input name="Button"
	type="button" class="button" value="Reset" onclick="resetResult();" />
...
submitForm('resultValidationEntry','investigation?method=submitResultEntryModificationForTemplateLab&resultId='+resultId+'&resultType='+resultType+'&resultNo='+resultNo+'&additionalRemarks='+additionalRemarks+'&resultIdStringForTemplate='+resultIdStringForTemplate+'');
