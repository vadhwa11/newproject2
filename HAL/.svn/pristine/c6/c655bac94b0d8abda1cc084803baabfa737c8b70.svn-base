...
<div class="titleBg">
<h2>Report for Different Voucher</h2>
</div>
<div class="Block">
<label> From Date <span >*</span></label>
<input type="text"  name="<%=FROM_DATE %>" id="<%=FROM_DATE %>" tabindex="1" value="" class="calDate" size="7" validate="From Date From,date,no"  onkeyup="mask(this.value,this,'2,5','/');"	 maxlength="10" onblur="validateExpDate(this,'<%=FROM_DATE %>');" />

<label>To Date <span>*</span></label>
<input type="text"  name="<%=TO_DATE %>" id="<%=TO_DATE %>" tabindex="1" value="" class="calDate" size="7" validate="To Date From,date,no"  onkeyup="mask(this.value,this,'2,5','/');"	 maxlength="10" onblur="validateExpDate(this,'<%=TO_DATE %>');" />
...
<option value="PRV">Purchase Voucher</option>
