...
<%=serviceNo %> <%=suffix%> </label> <label
	style="font-size: 11px; color: #000; font-family: arial; padding-left: 91px; width: 50px; padding-right: 0px; margin-right: 0px;">Rank</label>
<label class="value"
...
Name</label> <label class="value"
	...
	style="font-size: 11px; color: #000; font-family: arial; padding-left: 10px; width: 50px; padding-right: 0px; margin-right: 0px;">Relation</label>
<label class="value"
