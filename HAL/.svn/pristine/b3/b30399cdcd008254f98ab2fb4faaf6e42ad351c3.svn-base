...
%>
<form name="InternalIssueReport" method="post" action="">
...
<div class="clear"></div>
<center><input type="button" name="add" id="addbutton" value="Ok" class="button" onClick="submitForm('InternalIssueReport','stores?method=showInternalIssueReport');" accesskey="a" tabindex=1 /> 
<input type="button" name="clear" id="clearbutton" value="Cancel" class="button" onClick="clearButton('InternalIssueReport');" accesskey="a" tabindex=1 />
</center>
<div class="clear"></div>
<div class="division"></div>
<div class="clear"></div>
