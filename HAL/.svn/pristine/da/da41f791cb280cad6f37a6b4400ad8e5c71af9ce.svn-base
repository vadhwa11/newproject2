...
function GetMRList(MODE)
{
	...
	var url = "stores?method=getListOfReceiveMR";
	var bClickable = true;
...
{
    var Id = Id.split("&");
	window.location = "stores?method=searchIndentDetails&requestNo="+Id[0]+"&requestByName="+Id[1]+"&departmentId="+Id[2]+"&appId=A1523";	
