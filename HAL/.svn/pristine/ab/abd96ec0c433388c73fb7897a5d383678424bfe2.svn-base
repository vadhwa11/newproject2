...
<h6>Personnel Search For Calculation Sheet</h6>
<div class="Clear"></div>
<div class="blockTitle">Personnel Search</div>
<div class="blockTitleCurve"></div>
<div class="Clear"></div>
<div class="blockFrame"><label>Name</label> <input type="text"
	name="personnelName" value="" class="textbox_size20" MAXLENGTH="25" />

<label>Pass No.</label> <input type="text" name="passNo" value=""
	class="textbox_size20" MAXLENGTH="6" />
...
<input type="button" name="Search"
	onclick="submitForm('personnelSearch','/hms/hms/pension?method=personnelSearchForCalculationSheetJsp');"
...
<form name="personnelDetailForCalculation" method="post" action="">
...
<script type="text/javascript" language="javascript">
    ...
    formName = "personnelDetailForCalculation"
