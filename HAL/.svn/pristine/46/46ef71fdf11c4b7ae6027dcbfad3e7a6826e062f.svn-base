...
<select id="<%= ITEM_TYPE_ID %>"	name="<%=ITEM_TYPE_ID %>" validate="Item Type,string,no" tabindex=1 onblur="submitProtoAjaxWithDivName('actualStockReport','/hms/hms/stores?method=getSectionGLList&itemType='+this.value,'testDiv');" tabindex=1>
...
<label> Section</label> 
<select id="sectionId"	name="<%= SECTION_ID %>" validate="Section Name,string,no" 	tabindex=1>
