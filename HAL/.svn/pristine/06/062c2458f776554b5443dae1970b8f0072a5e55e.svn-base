...
<title>Form 356</title>
<div id="contentspace"><br />

<form name="form356" action="" method="post">
<h6>Form 356</h6>
<%
...
<font class="boxtitle">Form 356</font></div>
...
<input type="button" name="Print"
	onclick="submitForm('form356','/hms/hms/pension?method=printForm356Jsp');"
