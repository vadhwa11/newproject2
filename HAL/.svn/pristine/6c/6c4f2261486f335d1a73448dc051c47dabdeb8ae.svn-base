...
function check(){
var SDate = document.MonthlyMalariaCaseCH.<%= FROM_DATE%>.value;
var EDate = document.MonthlyMalariaCaseCH.<%= TO_DATE %>.value;
...
%>
<form name="MonthlyMalariaCaseCH" method="post" action="" >
...
<a	href="javascript:setdate('<%=f%>',document.MonthlyMalariaCaseCH.<%=FROM_DATE%>,true)">
...
<a href="javascript:setdate('<%=t%>',document.MonthlyMalariaCaseCH.<%=TO_DATE%>,true)">
<img src="/hms/jsp/images/cal.gif" width="16" height="16" border="0" validate="Pick a date" class="calender" /> </a> 
...
{
	submitForm('MonthlyMalariaCaseCH','/hms/hms/monitoring?method=printMonthlyMalariaCaseReport');
}
</script>
