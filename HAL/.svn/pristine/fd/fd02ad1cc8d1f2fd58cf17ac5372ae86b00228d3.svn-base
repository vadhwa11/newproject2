...
int serviceNo = box.getInt("serviceNo");
			...
			List<Object[]> othersCategoryList = new ArrayList<Object[]>();
...
<div class="titleBg">
<h2>Registration of other patient</h2>
</div>
<div class="clear"></div>
<ul id="countrytabsIn" class="shadetabsIn" style="display:none">
...
<input	id="serviceNoId" class="auto" size="8" type="text"	name="<%=SERVICE_NO %>" value="" title="Enter Service No" tabindex="1" validate="Service No.,metachar,no" maxlength="20"  onKeyPress="return isNumber(event)"
...
<input type="hidden" value=""  id="regHinId" name="regHinId"/>
...
<input id="sFNameId" type="text" name="<%=S_FIRST_NAME %>" value="" tabindex="1"	title="First Name"	validate="First Name,string,yes" MAXLENGTH="150"	onblur="" /> 
...
<input id="sLNameId" type="text"	name="<%=S_LAST_NAME %>" value="" tabindex="1"	validate="Last Name,string,no" MAXLENGTH="30"	onchange="" />
...
<select name="<%=SR_SEX %>" id="srSexId" validate="Gender,metachar,yes" tabindex="1"	onchange="">
	<%
...
<input type="text" id="srdobId" name="<%=SR_DOB %>"	tabindex="1" value="" validate="Date of Birth,date,yes" MAXLENGTH="30" class="calDate" onkeyup="mask(this.value,this,'2,5','/');"		onblur="if(validateExpDateHAL(this,'srdobId')){if(setAge(this.value, 'srAgeId')){setAge(this.value, 'ageId');}}" /> 
...
<input id="phoneNo" name="<%=TELEPHONE_NO %>" type="text" tabindex="1" maxlength="11" onblur=""  validate="Telephone No.(Off.),metachar,no" /> 
<label>Mobile No.</label> 
<input id="mobileNo" name="<%=MOBILE_NO %>" type="text" tabindex="1"	maxlength="11" onblur=""  validate="Mobile No.,metachar,no" />
...
<label>City</label> 
<select name="<%=DISTRICT%>" validate="City,string,no" id="srcityId" tabindex="1" onblur="">
	<option value="0">Select</option>
	<%
		for(Object[] masDistrict : districtList){
	%>
...
<label>City</label> 
<select name="permCityId" validate="City,string,no" id="perCityId" tabindex="1" onchange="">
	<option value="0">Select</option>
	<%
		for(Object[] masDistrict : districtList){
	%>
...
<div class="clear"></div>
<label>  Name</label>
<input type="text" name="<%=SR_NEXT_OF_KIN_NAME%>" value=""	validate="NOK1 Name,string,no" id="srnokNameId" maxlength="30"/>
...
<input	type="text" name="<%=SR_NEXT_OF_KIN_PHONE_NO%>" value="" id="srnok1Phone"	validate="NOK1 Contact No,phone,no" maxlength="11" />
<div class="clear"></div>
<label> Address</label> 
<textarea name="<%=SR_NEXT_OF_KIN_ADDRESS %>" id="srnextOfKinAdd" maxlength="500" cols="20" rows="2" tabindex="1" validate="Nok1 Address,string,no"
	></textarea>
<label>Police Station</label> 
...
<div class="clear"></div>
<label>  Name</label>
<input type="text" name="srnok2Name" value=""	validate="NOK2 Name,string,no" id="srnok2NameId" maxlength="30"/>
...
<label> Contact No.</label> 
<input	type="text" name="srnok2ContactNo" value="" id="srnok2Contact"	validate="NOK2 Contact No,phone,no" maxlength="11" />
<div class="clear"></div>
<label> Address</label> 
<textarea name="srnok2Address" id="srnok2Add"	cols="20" maxlength="500" rows="2" tabindex="1" validate="Nok2 Address,string,no"
	></textarea>
<label>Police Station</label> 
...
<div class="clear"></div>
<label> First Name <span>*</span></label> 
<input type="text"	id="pFirstNameId" name="<%=P_FIRST_NAME %>" value="" tabindex="1"	title="First Name"	validate="First Name,string,yes" MAXLENGTH="150" />

<label>Middle Name</label> 
<input type="text" id="pMiddleNameId"	name="<%=P_MIDDLE_NAME%>" value="" tabindex="1"	validate="Middle Name,string,no" MAXLENGTH="30" /> 

<label>Last Name</label> 
<input type="text" id="pLastNameId" name="<%=P_LAST_NAME %>"	value="" validate="Last Name,string,no" MAXLENGTH="30"	tabindex="1" /> 
...
<label>DOB</label> 
<input type="text" id="dobId"	name="<%=DATE_OF_BIRTH %>" tabindex="1" value=""	onkeyup="mask(this.value,this,'2,5','/');"		onblur="if(this.value!=''){if(validateExpDateHAL(this,'dobId')){setAge(this.value, 'ageId');}}" validate="Date of Birth,date,no" MAXLENGTH="10" class="calDate" /> 
...
<select id="ageId"	name="<%=AGE%>" validate="Age of Patient,metachar,no" tabindex="1"	class="smallest" >
	<option value="">Select</option>
	<%
...
<textarea name="<%=ADDRESS %>" id="addr" cols="20" rows="2" tabindex="1" validate="Address,string,no"	
 maxlength="500"	onblur=""></textarea>
	
<label>City</label> 
<select name="<%=DISTRICT%>"	validate="City,string,no" id="cityId" tabindex="1" onblur="populateStateForCity(this.value,'stateId');">
	<option value="0">Select</option>
	<%
		for(Object[] masDistrict : districtList){
	%>
...
<div class="clear"></div>
<label>State</label> 
<select id="stateId" name="<%=STATE%>"	validate="State,string,no" tabindex="1"	onChange="populateDistrict(this.value,'registration','cityId')," onblur="">
	<option value="0">Select</option>
	<%
...
<label>Contact No.</label> 
<input type="text"	name="<%=CONTACT_NUMBER %>" id="contactNo" value=""	validate="Contact No.,phone,no" MAXLENGTH="20" tabindex="1" onblur="" />
<label>Mobile No.</label> 
<input id="depmobileNo" name="<%=MOBILE_NO %>" type="text" tabindex="1"	maxlength="11" onblur="" validate="Mobile No.,phone,no"/>
<div class="clear"></div>
<label>Police Station</label> 
<input id="deppoliceStation" name="policeStation" type="text" tabindex="1" maxlength="15" onblur="" validate="Police Station,metachar,no"/> 
<label>Pin Code</label> 
...
<div class="clear"></div>
<label> Address</label> 
<textarea name="<%=NEXT_OF_KIN_ADDRESS %>" id="nextOfKinAdd"	cols="20" rows="2" tabindex="1" validate="Nok1 Address,string,no" maxlength="500"
	></textarea>
<label>Police Station</label> 
...
<div class="clear"></div>
<label> Address</label> 
<textarea name="nok2Address" id="nok2Add"	cols="20" rows="2" tabindex="1" validate="Nok2 Address,string,no" maxlength="500"
	></textarea>
<label>Police Station</label> 
...
<div id="edited"></div>
 ...
 <input type="button" name="Submit11" value="Submit" tabindex="1" class="button"	onClick="if(fillSelfDetails()){if(checkPatientStatus() && checkNameSpaces()){submitRegistration()}}" />
<input type="reset" name="Reset" value="Reset" class="button" tabindex="1" onClick="submitFormForButton('registration','/hms/hms/registration?method=showRegistrationJspHAL');" accesskey="r" />
...
function submitRegistration(){
	...
	if(validateMetaCharacters(flag))
		submitForm('registration','/hms/hms/registration?method=submitPatientInformationHAL&flag='+flag,'checkTargetForNo');
}
