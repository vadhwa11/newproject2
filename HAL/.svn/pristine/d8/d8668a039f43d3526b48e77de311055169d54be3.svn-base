...
<h2 align="left" class="style1">OPD OnCo Surgery Format</h2>
<br />
...
<div id="testDiv"><label class="bodytextB">Visit No</label> <input
	type="text" id="visitNo" name="<%=VISIT_ID%>" value=""
	class="textbox_date" MAXLENGTH="6" /></div>
<br />
<br />

<input type="button" name="OK" value="OK" class="button"
	onClick="submitForm('search','opd?method=printOpdOncosurgery');" /><!-- //showOpdOncosurgeryCaseSheetReport -->
