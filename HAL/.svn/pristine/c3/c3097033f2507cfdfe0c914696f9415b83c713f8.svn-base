...
/**
 * This is an object that contains data related to the charge_details table. Do
 * not modify this class because it will be overwritten if the configuration
 * file related to this class is modified.
 * 
 * @hibernate.class table="charge_details"
 */

public abstract class BaseChargeDetails implements Serializable {

	public static String REF = "ChargeDetails";
	 ...
	 */
	public BaseChargeDetails(java.lang.Integer id) {
		this.setId(id);
		initialize();
	}
	 ...
	 */
	public BaseChargeDetails(java.lang.Integer id,
			java.lang.Integer chargeCodeId) {
	 ...
	 * 
	 * @hibernate.id generator-class="native" column="charge_details_id"
	 */
	...
	public boolean equals(Object obj) {
		if (null == obj)
			return false;
		if (!(obj instanceof jkt.hms.masters.business.ChargeDetails))
			return false;
		else {
			jkt.hms.masters.business.ChargeDetails chargeDetails = (jkt.hms.masters.business.ChargeDetails) obj;
			if (null == this.getId() || null == chargeDetails.getId())
				return false;
			else
				return (this.getId().equals(chargeDetails.getId()));
		}
	}
