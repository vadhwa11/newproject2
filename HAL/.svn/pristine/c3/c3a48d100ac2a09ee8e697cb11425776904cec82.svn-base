...
<form name="familydetails" action="" method="post">
...
<font class="boxtitle">Family Details</font></div>
...
<input type="button" name="Print"
	onclick="submitForm('familydetails','/hms/hms/pension?method=printFamilyDetailsJsp');"
