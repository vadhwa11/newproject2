...
%>
<form name="mon_MedLecturePop" method="post" action="" >
...
<a	href="javascript:setdate('<%=f%>',document.mon_MedLecturePop.<%=FROM_DATE%>,true)">
...
<a href="javascript:setdate('<%=t%>',document.mon_MedLecturePop.<%=TO_DATE%>,true)">
<img src="/hms/jsp/images/cal.gif" width="16" height="16" border="0" validate="Pick a date" class="calender" /> </a> 
...
{
	submitForm('mon_MedLecturePop','/hms/hms/monitoring?method=printMonthlyAccidentalDetailReport');
}
</script>
