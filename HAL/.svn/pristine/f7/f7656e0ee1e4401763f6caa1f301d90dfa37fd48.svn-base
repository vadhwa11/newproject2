...
function check(){
var SDate = document.mon_PncVisitH.<%= FROM_DATE%>.value;
var EDate = document.mon_PncVisitH.<%= TO_DATE %>.value;
...
%>
<form name="mon_PncVisitH" method="post" action="" >
...
<a	href="javascript:setdate('<%=f%>',document.mon_PncVisitH.<%=FROM_DATE%>,true)">
...
<a href="javascript:setdate('<%=t%>',document.mon_PncVisitH.<%=TO_DATE%>,true)">
<img src="/hms/jsp/images/cal.gif" width="16" height="16" border="0" validate="Pick a date" class="calender" /> </a> 
