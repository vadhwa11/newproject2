...
<input type="text" name="<%=SERVICE_NO %>" id="serviceNo" value="<%= patient.getServiceNo()%>" validate="Service No.,metachar,yes" onblur="submitProtoAjaxWithDivName('admissionByHin','/hms/hms/adt?method=getHinNoForAdm','hinDiv');" tabindex="1" />
<%-- 
