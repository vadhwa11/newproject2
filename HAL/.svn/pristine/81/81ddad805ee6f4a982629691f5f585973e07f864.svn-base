...
/**
 * This is an object that contains data related to the hrorderly_sgt_duty_entry
 * table. Do not modify this class because it will be overwritten if the
 * configuration file related to this class is modified.
 * 
 * @hibernate.class table="hrorderly_sgt_duty_entry"
 */

public abstract class BaseHrOrderlySgtDutyEntry implements Serializable {

	public static String REF = "HrOrderlySgtDutyEntry";
	...
	// constructors
	public BaseHrOrderlySgtDutyEntry() {
		initialize();
	}
	 ...
	 */
	public BaseHrOrderlySgtDutyEntry(java.lang.Integer id) {
		this.setId(id);
		initialize();
	}
	...
	public boolean equals(Object obj) {
		if (null == obj)
			return false;
		if (!(obj instanceof jkt.hms.masters.business.HrOrderlySgtDutyEntry))
			return false;
		else {
			jkt.hms.masters.business.HrOrderlySgtDutyEntry hrOrderlySgtDutyEntry = (jkt.hms.masters.business.HrOrderlySgtDutyEntry) obj;
			if (null == this.getId() || null == hrOrderlySgtDutyEntry.getId())
				return false;
			else
				return (this.getId().equals(hrOrderlySgtDutyEntry.getId()));
		}
	}
