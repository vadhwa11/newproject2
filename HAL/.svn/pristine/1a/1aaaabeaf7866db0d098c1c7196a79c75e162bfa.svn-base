...
<form name="rangeFiringReport" target="_blank" method="post" action="">
<div id="divId" class="blockFrame "><label><span>*</span>
Quarter</label> <select name="quarter" id="quarter">
...
<input type="button" name="OK" value="OK" class="cmnButton"
	onClick="if(rangeFiringReport.quarter.value!=0 && rangeFiringReport.year.value!=0){submitForm('rangeFiringReport','hrRelated?method=generateRangeFiringReport');}else{alert('Select Quarter and Year');}" />
