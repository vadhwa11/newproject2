...
<form name="medicalExamToPrint" method="post" action="">
<div class="clear"></div>
<%--
...
<div class="clear"></div>
<input type="button" name="pdf" value="Print" class="button" id="printpdfreport" onclick="submitForm('medicalExamToPrint','/hms/hms/medicalExam?method=generateMBToPrint','validateRadioForOrderNo')"  />
<input type="hidden" name="medExamid" value="" />
</form>
<script type="text/javascript">
