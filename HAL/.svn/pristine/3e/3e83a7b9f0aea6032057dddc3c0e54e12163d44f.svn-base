...
function check(){
var SDate = document.mon_AttemptSuicideCasesH.<%= FROM_DATE%>.value;
var EDate = document.mon_AttemptSuicideCasesH.<%= TO_DATE %>.value;
...
%>
<form name="mon_AttemptSuicideCasesH" method="post" action="" >
...
<a	href="javascript:setdate('<%=f%>',document.mon_AttemptSuicideCasesH.<%=FROM_DATE%>,true)">
...
<a href="javascript:setdate('<%=t%>',document.mon_AttemptSuicideCasesH.<%=TO_DATE%>,true)">
<img src="/hms/jsp/images/cal.gif" width="16" height="16" border="0" validate="Pick a date" class="calender" /> </a> 
...
{
	submitForm('mon_AttemptSuicideCasesH','/hms/hms/monitoring?method=generateSuicideReport');
}
</script>
