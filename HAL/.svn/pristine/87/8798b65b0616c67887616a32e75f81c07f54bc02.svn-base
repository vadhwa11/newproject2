...
public abstract class BaseProcedureHeader  implements Serializable {
	...
	public static String PROP_PROCEDURE_TYPE = "ProcedureType";
	...
	/**
	 * Return the value associated with the column: procedure_type
	 */
	...
	/**
	 * Set the value related to the column: procedure_type
	 * @param procedureType the procedure_type value
	 */
