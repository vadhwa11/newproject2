...
/**
 * This is an object that contains data related to the mas_bank_master table. Do
 * not modify this class because it will be overwritten if the configuration
 * file related to this class is modified.
 * 
 * @hibernate.class table="mas_bank_master"
 */
...
public abstract class BaseMasBankMaster implements Serializable {
	 ...
	 * 
	 * @hibernate.id generator-class="native" column="bank_id"
	 */
	...
	public boolean equals(Object obj) {
		if (null == obj)
			return false;
		if (!(obj instanceof jkt.hms.masters.business.MasBankMaster))
			return false;
		else {
			jkt.hms.masters.business.MasBankMaster masBankMaster = (jkt.hms.masters.business.MasBankMaster) obj;
			if (null == this.getId() || null == masBankMaster.getId())
				return false;
			else
				return (this.getId().equals(masBankMaster.getId()));
		}
	}
