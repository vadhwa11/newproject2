...
function check(){
var SDate = document.mon_SurplusCH.<%= FROM_DATE%>.value;
var EDate = document.mon_SurplusCH.<%= TO_DATE %>.value;
...
%>
<form name="mon_SurplusCH" method="post" action="" >
...
<a	href="javascript:setdate('<%=f%>',document.mon_SurplusCH.<%=FROM_DATE%>,true)">
...
<a href="javascript:setdate('<%=t%>',document.mon_SurplusCH.<%=TO_DATE%>,true)">
<img src="/hms/jsp/images/cal.gif" width="16" height="16" border="0" validate="Pick a date" class="calender" /> </a> 
...
<input  type="button"	tabindex="1" align="right" class="button" value="Submit" onclick="submitForm('mon_SurplusCH','/hms/hms/mis?method=generateSurplusReport');" />
