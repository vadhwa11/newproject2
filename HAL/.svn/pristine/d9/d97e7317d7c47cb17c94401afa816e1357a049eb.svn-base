...
<h6>Personnel Search For Retirement Entry</h6>
<div class="Clear"></div>
<%
...
<input type="button" name="Search"
	onclick="submitForm('personnelSearch','/hms/hms/pension?method=personnelSearchJsp&jspName=retirementEntry');"
...
<form name="personnelSearchForRetirementEntry" method="post" action="">
...
<script type="text/javascript" language="javascript">
    ...
    formName = "personnelSearchForRetirementEntry"
