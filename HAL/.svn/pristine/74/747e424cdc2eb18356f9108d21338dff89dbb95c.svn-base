...
<%@ page import="static jkt.hms.util.RequestConstants.RANK_CATEGORY_ID"%>
...
<div class="titleBg">
<h2>IP Admission Register</h2>
</div>
<div class="Clear"></div>
<form name="ipAdmissionRegister" method="post" action="">
<input type="hidden" name="hospitalId" value="<%=hospitalId %>"  validate="hospitalid,metachar,yes">
<div class="Block">
<label>Date:</label>
...
<input
	...
	value="<%=currenDate %>" class="date"  validate="From Date,frdate,yes" readonly="readonly" 
	MAXLENGTH="10" /> <img id="calendar" src="/hms/jsp/images/cal.gif"
...
<label> To <span>*</span> </label> <input type="text" id="ToDateId"
	name="<%=TO_DATE %>" value="<%=currenDate %>" class="date"  validate="To Date,frdate,yes"
	readonly="readonly" MAXLENGTH="10" /> <img id="calendar"
...
<label>A&D No.:</label>
<label class="medium"> From </label>
<input type="text" name="fromAdNo" value="" validate="From A&D No.,metachar,no"/>
<label> To </label>
<input type="text" name="toAdNo" value="" validate="To A&D No.,metachar,no"/>
<div class="Clear"></div>	
...
<input type="text" class="transparent" size="14" validate="Marital Status,string,no">
...
<label>ICD No.</label>
<input type="text" class="transparent" size="14">
<input type="text" name="icdNo" value="" id="icdNo" validate="ICD No.,icd,no" onblur="getICDID('ipAdmissionRegister',this.value);">
<input type="hidden" name="icdId" value="" id="icdId" validate="ICD Id,num,no" />
<label>ICD Diagnosis</label>
<input type="text" tabindex="1"	value="" id="icd"  name="icd"	class="auto"  size="60" validate="ICD Diagnosis,icd,no" />
...
<div class="Clear"></div>
<input type="button" name="OK" value="OK" class="button" onClick="submitForm('ipAdmissionRegister','adt?method=showIPRegisterOnScreen');" />
<input type="button" name="print" value="Print" class="button" onClick="submitForm('ipAdmissionRegister','adt?method=showIpAdmissionRegisterReport');" />
...
<script>
function openGraph(){
	/*var inputs = eval('document.ipAdmissionRegister.elements');
	...
	var url = "adt?method=showIpAdmissionRegisterGraph&"+getNameAndData('ipAdmissionRegister');
