...
<h6>Print Instruction To Candidate</h6>
<div class="Clear"></div>

<div class="blockFrame">
<form name="instructionToCandidatePrint1" action="" method="post">
...
<label>Entry No</label> <input id="searchField1" type="text"
	...
	onclick="setdate('',document.instructionToCandidatePrint1.<%=ENTRY_DATE%>,event)" ; />
...
<input tabindex="1" type="button" name="Search"
	onclick="submitForm('instructionToCandidatePrint1','instructionToCandidateSearch?method=searchInstructionToCandidateSearch','checkSearchForWorkService');"
...
<form name="instructionToCandidatePrint" method="post" action="">
<script type="text/javascript">
...
%>
formName = "instructionToCandidatePrint"
start = 0
