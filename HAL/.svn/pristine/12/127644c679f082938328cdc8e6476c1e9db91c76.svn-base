...
<h2 align="left" class="style1">Food Tasting Report</h2>
<br />
...
<form name="foodTastingReprt" method="post" action=""><label>
From Date:</label> <input type="text" id="fromDateId" name="<%=FROM_DATE %>"
	value="<%=currenDate %>" class="textbox_date" readonly="readonly"
	MAXLENGTH="30" /> <a
	href="javascript:setdate('<%=currenDate %>',document.foodTastingReprt.<%=FROM_DATE%>)">
<img src="/hms/jsp/images/cal.gif" width="16" height="16" border="0"
	...
	href="javascript:setdate('<%=currenDate %>',document.foodTastingReprt.<%=TO_DATE%>)">
<img src="/hms/jsp/images/cal.gif" width="16" height="16" border="0"
...
<input type="button" name="OK" value="OK" class="button"
	onClick="submitForm('foodTastingReprt','mis?method=showFoodTastingReprt');" />
