...
<input tabindex="1" type="text"  class="Auto" id="" name="<%=AUTHORITY_OF_BOARD %>"maxlength="6" value="<%=medExamObj.getAuthority() %>"
	onKeyUp="limitText(this,6);"  />

 <% }else{%>
<input tabindex="1" type="text"  class="Auto" id="" name="<%=AUTHORITY_OF_BOARD %>" maxlength="6" 
	onKeyUp="limitText(this,6);"  />
...
<label>Service Number </label>
 ...
 <input type="text" maxlength="10" 	 name="<%=TRADE%>" tabindex="2" value="<%=medExamObj.getTrade().getTradeName() %>"/>
  <input	type="hidden"  name="<%=TRADE_ID%>"	tabindex="2" value="<%=medExamObj.getTrade().getId() %>"/>
 <% }else{%>
 <input type="text" maxlength="10" 	 name="<%=TRADE_ID%>" tabindex="2" />
 <% }%>
...
<label>Last AME carried On </label> 
 ...
 <% }%>
 <img	src="/hms/jsp/images/cal.gif" width="16" height="16" border="0"	validate="Pick a date" 	onclick="setdate('',medicalBoardExaminationAnnual.<%=DATE_OF_LASTCONFINEMENT%>,event);" />
...
<input	tabindex="1" type="text" maxlength="20"  name="<%=CONDITION_OF_GUMS %>" value="<%=medExamObj.getConditionOfGums() %>"
	class="small" onKeyUp="isNumber(this);" maxlength="2" />

 <% }else{%>
<input	tabindex="1" type="text" maxlength="20"  name="<%=CONDITION_OF_GUMS %>"
	class="small" onKeyUp="isNumber(this);" maxlength="2" />
...
<%}%>
 ...
 <label>Mobility <br /><span class="sublabel">(Valsalva)</span></label> 
	  ...
	  <input tabindex="1" type="text"  name="<%=MOBILITYV %>" maxlength="100"  value="<%= medExamObj.getMobilityV()  %>"  />
<%}else{ %>
 <input tabindex="1" type="text"  name="<%=MOBILITYV %>"  maxlength="100"  />
<%} %> 
<div class="clear"></div>
...
<input tabindex="1" type="text" maxlength="20" 	name="locomoterSystem" class="Auto" size="20" maxlength="10" value="<%=medExamObj.getLocomoterSystem() %>"/>
   <% }else{%>
<input tabindex="1" type="text" maxlength="20" 	name="locomoterSystem" class="Auto" size="20" maxlength="10" />
 <% }%>
<label>Spine</label> 
<% if(medExamObj.getSpine()!=null){%>
<input tabindex="1" type="text" maxlength="20" 	name="spine" class="Auto" size="20" maxlength="10" value="<%=medExamObj.getSpine() %>"/>
   <% }else{%>
<input tabindex="1" type="text" maxlength="20" 	name="spine" class="Auto" size="20" maxlength="10" />
 <% }%>


<label>Hernia</label> 
<% if(medExamObj.getHerniaMusic()!=null){%>
<input tabindex="1" type="text" maxlength="20" 	name="<%=HERNIA_MUSCLE %>" class="Auto" size="20" maxlength="100" value="<%=medExamObj.getHerniaMusic() %>"/>
   <% }else{%>
<input tabindex="1" type="text" maxlength="20" 	name="<%=HERNIA_MUSCLE %>" class="Auto" size="20" maxlength="100" />
 <% }%>
...
<input tabindex="1" type="text" maxlength="20" 	name="<%=HYDROCELE %>" class="Auto" size="20" maxlength="10" value="<%=medExamObj.getHydrocele() %>"/>
   <% }else{%>
<input tabindex="1" type="text" maxlength="20" 	name="<%=HYDROCELE %>" class="Auto" size="20" maxlength="10" />
 <% }%>


<label>Haemorrhoids</label> 
<% if(medExamObj.getHemorrhoids()!=null){%>
<input tabindex="1" type="text" maxlength="20" 	name="<%=HEMONHOIDS %>" class="Auto" size="20" maxlength="10" value="<%=medExamObj.getHemorrhoids() %>"/>
   <% }else{%>
<input tabindex="1" type="text" maxlength="20" 	name="<%=HEMONHOIDS %>" class="Auto" size="20" maxlength="10" />
 <% }%>


<label>Breast</label> 
<% if(medExamObj.getBreasts()!=null){%>
<input tabindex="1" type="text" maxlength="20" 	name="<%=BREASTS %>" class="Auto" size="20" maxlength="10" value="<%=medExamObj.getBreasts() %>"/>
   <% }else{%>
<input tabindex="1" type="text" maxlength="20" 	name="<%=BREASTS %>" class="Auto" size="20" maxlength="10" />
 <% }%>
...
<input tabindex="1" type="text" maxlength="30" 	name="<%=MENSTRUAL_HISTORY %>" class="Auto" size="20" maxlength="30" value="<%=medExamObj.getMenstrualHistory() %>"/>
   <% }else{%>
<input tabindex="1" type="text" maxlength="30" 	name="<%=MENSTRUAL_HISTORY %>" class="Auto" size="20" maxlength="30" />
 <% }%>
 

<label>LMP</label>
<% if(medExamObj.getLmp()!=null){%>
<input tabindex="1" type="text"	name="<%=LMP %>" class="Auto" size="20" maxlength="10" value="<%=medExamObj.getLmp() %>"/>
   <% }else{%>
<input tabindex="1" type="text" name="<%=LMP %>" class="Auto" size="20" maxlength="10" />
 <% }%>

<label >No. of pregnancies</label>
<% if(medExamObj.getNoOfPregnancies()!=null){%>
<input tabindex="1" type="text"  name="<%=NO_OF_PREGNANCY %>" class="Auto" size="20" maxlength="6" value="<%=medExamObj.getNoOfPregnancies() %>"/>
   <% }else{%>
<input tabindex="1" type="text" name="<%=NO_OF_PREGNANCY %>" class="Auto" size="20" maxlength="6" />
 <% }%>
...
<input tabindex="1" type="text"  name="<%=NO_OF_CHILDREN %>" class="Auto" size="20" maxlength="6" value="<%=medExamObj.getNoOfChildren() %>"/>
   <% }else{%>
<input tabindex="1" type="text" name="<%=NO_OF_CHILDREN %>" class="Auto" size="20" maxlength="6" />
 <% }%>


<label >Date <br /><span class="sublabel">(last confinement)</span></label>
<% if(medExamObj.getLastConfinementDate()!=null){%>
<input tabindex="1" type="text" maxlength="10"  class="calDate" readonly="readonly " value="<%=HMSUtil.convertDateToStringWithoutTime(medExamObj.getLastConfinementDate()) %>"	name="<%=DATE_OF_LASTCONFINEMENT %>" maxlength="10" onKeyUp="mask(this.value,this,'2,5','/');" validate="Dental Date,date,no" /> 
   <% }else{%>
<input tabindex="1" type="text" maxlength="10"  class="calDate" readonly="readonly "	name="<%=DATE_OF_LASTCONFINEMENT %>" maxlength="10" onKeyUp="mask(this.value,this,'2,5','/');" validate="Dental Date,date,no" /> 
 <% }%>
...
<select name="<%=MED_CAT_REC %>" size="0" tabindex="1" id="medcatrec">
<option value="0">select</option>
	...
	<%
		...
		System.out.println("employeeListjsp--"+employeeList.size());
			...
			//	if ((medExamObj.getSignedBy()!=null)&&(masEmployeecode.getId()==Integer.parseInt(medExamObj.getSignedBy()))) {
				...
				%>
	<option value="<%=fullname%>" ><%=masEmployeecode.getEmployeeCode()%>
