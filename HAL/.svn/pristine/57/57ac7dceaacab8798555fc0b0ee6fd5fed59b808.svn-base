...
<div class="Clear"></div>
		 ...
		 class="calender"onClick="setdate('',document.commandentReport.<%=TO_DATE%>,event)" />

</div>
<div class="Clear"></div>

			<input type="button" name="OK" value="OK" class="button" onClick="submitForm('commandentReport','mis?method=printCommandentReport');" />
