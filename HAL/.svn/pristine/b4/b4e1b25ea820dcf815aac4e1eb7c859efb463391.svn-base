...
function showBack(formName)
{
  ...
  obj.action = "/hms/hms/fwc?method=showOPDPatientSearchJsp";
  obj.submit();
}
</script>
<%
...
<div class="bottom"><input type="button" name="yes" value="Yes"
	class="button"
	onclick="submitForm('message','/hms/hms/fwc?method=printSurgeryRequisitionForInPatient&orderNo=<%=orderNo %>');" />
