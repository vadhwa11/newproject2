...
<h6>Personnel Search For Updating Data Sheet</h6>
<%
...
No: </label> <input type="text" name="passNo" value="" MAXLENGTH="30" /> <label>Unit</label>
<select name="unitId">
...
<input type="button" name="Search"
	onclick="submitForm('personnelSearch','/hms/hms/pension?method=updatePersonnelSearchForDataSheetJsp');"
...
<form name="updatePersonnelsearchForDataSheet" method="post" action="">
...
<script type="text/javascript" language="javascript">
    ...
    formName = "updatePersonnelsearchForDataSheet"
