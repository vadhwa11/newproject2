...
<h4 align="left" class="style1"><%=deptName%> Ward</h4>
</div>
<br />
...
<br />
<div
	style="overflow-x: hidden; overflow-y: scroll; border: 1px solid #737373; margin-left: 15px; width: 645px; height: 250px;">
...
<input type="button" name="cancel" id="addbutton" value="Cancel"
	...
	type="hidden" name="counter" id="counter" value="<%=i %>" /></div>
<%}else{ %> NoRecords Found!!
<div style="padding-left: 15px;">
<div id="edited"></div>
<input type="button" name="cancel" id="addbutton" value="Cancel"
