 ...
 * dietIndentItemFormula.jsp  
 * Purpose of the JSP -  This is for Diet Indent Item Formula.
 * @author Ritu
...
%>
<h6>Diet Indent Item Formula</h6>
<div id="searcharea">
<div id="searchbar">
<div class="header">
<form name="search" method="post" action="">
<label>Item Name:</label>
<input type="text" id="searchField" name="<%=ITEM_NAME%>" value=""  validate="Item Name,string,no" MAXLENGTH="8" onkeypress="return submitenter(this,event,'diet?method=searchInedntItemFormula')"/>
<input type="button" name="search" value="Search" class="button" onclick="submitForm('search','diet?method=searchIndentItemFormula','checkSearch')" tabindex=1  />
...
<h2>    <a href="diet?method=showMenuItemFormulaJsp">Show All Records</a></h2>
	<%
			}
		 }
...
%>
  ...
  <form name="indentItemFormula" method="post" action="">
   <div class="Clear"></div>
 	...
 	<div class="blockFrame">
		...
		<input type="text" name="<%= QUANTITY%>" value="" validate="Quantity,num,yes" class="textbox_size20" MAXLENGTH="8" tabindex=1 />
		...
		<img src="/hms/jsp/images/cal.gif" width="16" height="16" border="0" validate="Pick a date" class="calender" onclick="setdate('',document.indentItemFormula.<%=VALID_FROM_DATE%>,event)"/> 

</div>
		 <div class="Clear"></div>
		 <div id="edited"></div>
			<input type="button" name="add" id="addbutton" value="Add" class="button" onClick="submitForm('indentItemFormula','diet?method=addIndentItemFormula','checkValidityStartDate');" accesskey="a" tabindex=1/>
			<input type="button" name="edit" id="editbutton" value="Update" class="button" onClick="submitForm('indentItemFormula','diet?method=editIndentItemFormula')" accesskey="u" tabindex=1 />
			<input type="button" name="Delete" id="deletebutton" value="Activate" class="button" onClick="submitForm('indentItemFormula','diet?method=deleteIndentItemFormula&flag='+this.value)" accesskey="d" tabindex=1/>		
...
<%
		for(MasDietIndentItem dietIndentItem : indentItemList){
			 ...
			 if(dietIndentItem.getId().equals(indentItemFormula.getIndentItem().getId()) && dietIndentItem.getStatus().equals("y")){%>
