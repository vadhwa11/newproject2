...
/**
 * This is an object that contains data related to the mas_leave_application
 * table. Do not modify this class because it will be overwritten if the
 * configuration file related to this class is modified.
 * 
 * @hibernate.class table="mas_leave_application"
 */

public abstract class BaseMasLeaveApplication implements Serializable {

	public static String REF = "MasLeaveApplication";
	...
	// constructors
	public BaseMasLeaveApplication() {
		initialize();
	}
	 ...
	 */
	public BaseMasLeaveApplication(java.lang.Integer id) {
		this.setId(id);
		initialize();
	}
	...
	public boolean equals(Object obj) {
		if (null == obj)
			return false;
		if (!(obj instanceof jkt.hms.masters.business.MasLeaveApplication))
			return false;
		else {
			jkt.hms.masters.business.MasLeaveApplication masLeaveApplication = (jkt.hms.masters.business.MasLeaveApplication) obj;
			if (null == this.getId() || null == masLeaveApplication.getId())
				return false;
			else
				return (this.getId().equals(masLeaveApplication.getId()));
		}
	}
