...
<div class="Clear"></div>
<label
	style="font: bold 13px arial color : #000; width: 100%; font-weight: bold; text-align: center; font-size: 17px; float: right; margin-top: 10px">Diagnostic
...
<label
	style="font-size: 14px; color: #000; font-family: arial; padding-left: 20px; width: 90px; padding-right: 0px; margin-right: 0px;">OrderBy</label>
<label class="value"
	...
	style="font-size: 14px; color: #000; font-family: arial; padding-left: 20px; width: 94px; padding-right: 0px; margin-right: 0px;">Main
...
<div class="Clear"></div>
<label
	style="font-size: 14px; color: #000; font-family: arial; padding-left: 20px; width: 90px; padding-right: 0px; margin-right: 0px;">Sub
Group</label> <label class="value"
	...
	style="font-size: 14px; color: #000; font-family: arial; padding-left: 50px; width: 94px; padding-right: 0px; margin-right: 0px;">Patient
...
<div class="divisionR"></div>
<label
	style="font-size: 14px; color: #000; font-family: arial; padding-left: 20px; width: 90px; padding-right: 0px; margin-right: 0px;">Result
...
%> <label
	style="font-size: 14px; color: #000; font-family: arial; padding-left: 137px; width: 98px; padding-right: 0px; margin-right: 0px;">Patient
Name</label> <label class="value"
	style="width: 198px; margin-left: 0px; padding-left: 0px;">: <%=pFullName %></label>

<div class="Clear"></div>
<label
	style="font-size: 14px; color: #000; font-family: arial; padding-left: 20px; width: 90px; padding-right: 0px; margin-right: 0px;">Hin
No</label> <label class="value"
	...
	style="font-size: 14px; color: #000; font-family: arial; padding-left: 16px; width: 100px; padding-right: 0px; margin-right: 0px;">Service
No.</label> <label class="value"
...
<div class="Clear"></div>
<label
	style="font-size: 14px; color: #000; font-family: arial; padding-left: 20px; width: 90px; padding-right: 0px; margin-right: 0px;">Test
Name</label> <label class="value"
	style="width: 235px; margin-left: 0px; padding-left: 0px;">: <%=dgResultEntryDetail.getInvestigation().getInvestigationName() %>
</label> <label
	style="font-size: 14px; color: #000; font-family: arial; padding-left: 12px; width: 99px; padding-right: 0px; margin-right: 0px;">Remarks</label>
...
%> <label
	style="font-size: 15px; color: #000; font-family: arial; width: auto; padding-left: 24px;">Result
