...
<input type="button" name="Submit" id="addbutton"
	onclick="if(checkBlankSearch()){submitForm('patientSearch','/hms/hms/mediClaim?method=showPatientUpdateCardicBill');}"
...
<form name="searchUpdateCardicBill" method="post" action=""><script
...
<script type="text/javascript" language="javascript">
    ...
    formName = "searchUpdateCardicBill"
