...
<form name="messageForHealthPromotionActivity" method="post">
...
-->
<input type="button" name="No" value="Back" class="button"	onclick="submitForm('messageForHealthPromotionActivity','/hms/hms/sHO?method=showHealthPromotion');" />
<div class="clear"></div>
<div class="division"></div>
</form>