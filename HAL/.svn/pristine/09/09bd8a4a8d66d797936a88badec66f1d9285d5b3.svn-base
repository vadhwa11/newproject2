...
<div class="Block">
     ...
     <div class="Clear"></div>
	  ...
	  <input type="text"  name="<%=UNIT_ID%>" id="name" value="" class="" MAXLENGTH="30" validate="Name,String,Yes" />
	    ...
	    <input type="text"  name="<%=LAST_BOARD%>" id="name" value="" class="date" MAXLENGTH="30" validate="Name,String,Yes" />
	    ...
	    <input type="text"  name="<%=NEXT_REVIEW%>" id="name" value="" class="date" MAXLENGTH="30" validate="Name,String,Yes" />
	    <img id="calendar" src="/hms/jsp/images/cal.gif" width="16" height="16" border="0" validate="Pick a date" 
	...
	<input type="button" name="generate" value="Generate Report" class="buttonBig" />
		
	    <div class="Clear"></div>
 		<input type="hidden" name="<%= CHANGED_BY%>" value="<%=userName%>" class="date" readonly="readonly" MAXLENGTH="8"/ tabindex=3 />
