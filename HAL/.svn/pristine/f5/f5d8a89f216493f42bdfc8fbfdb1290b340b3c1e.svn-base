...
function fillValues(){
    ...
    submitForm('PvmsSurplusReport','stores?method=showItemSurplus');    
}
</script>

<div class="titleBg">
<h2>Store Medicine Receipt</h2>
</div>
<form name="StoreMedicineReceipt" method="post" action="">
<div class="Block">
<label>Crv No</label>
<input type="text"	value="" id="crv_NO"  name="crvNo" /> 
</div>
<div class="clear"></div>
<div class="paddingTop5"></div>
<div class="clear"></div>
<input type="button" name="OK" value="OK" class="button" onClick="submitForm('StoreMedicineReceipt','stores?method=showStoreMedicineReceipt');" />
<input type="button" name="Cancel" value="Cancel" class="button" onClick="submitForm('StoreMedicineReceipt','stores?method=showStoreMedicineReceipt');" accesskey="r" />
<input type="button" name="ExportToExel" value="ExportToExel" class="button" onClick="submitForm('StoreMedicineReceipt','stores?method=showStoreMedicineReceipt');" />
