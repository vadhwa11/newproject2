...
<div id="hinDiv">
<label>HIN</label>
		<select name="<%=HIN_ID%>" validate="Hin No,string,no" id="hinId" onblur="if(this.value!=''){submitProtoAjaxWithDivName('AccidentDetails','/hms/hms/mis?method=getPatientDetailForAccidentalDetails','DivPillion');}" tabindex="1">
