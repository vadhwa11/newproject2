...
<div class="header">
<div>
<img height="68" width="75" alt="IAF MedNET Logo" border="0" class="floatLeft" src="/hms/jsp/images/IAFLogoThumb.gif" />
...
%> <%=userName%> | Dept: <span style="color:#AC1400; font-size:12px;"><%=deptName %></span> <%} %>
...
if(!userName.equals("")){
%>  <a href="#" onclick="submitForm('header','/hms/hms/login?method=showHomeJsp')">Home</a> |<%} %> </span>
<a href="http://www.maintguru.iaf.in/forum" target="_blank">Forum</a> |
<%--<a	href="/hms/jsp/ACKNOWLEDGEMENT.pdf" target="blank">Acknowledgement</a> --%>
