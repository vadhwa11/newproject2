...
function check(){
var SDate = document.mon_NotifiableDiseasePop.<%= FROM_DATE%>.value;
var EDate = document.mon_NotifiableDiseasePop.<%= TO_DATE %>.value;
...
%>
<form name="mon_NotifiableDiseasePop" method="post" action="" >
...
<a	href="javascript:setdate('<%=f%>',document.mon_NotifiableDiseasePop.<%=FROM_DATE%>,true)">
...
<a href="javascript:setdate('<%=t%>',document.mon_NotifiableDiseasePop.<%=TO_DATE%>,true)">
<img src="/hms/jsp/images/cal.gif" width="16" height="16" border="0" validate="Pick a date" class="calender" /> </a> 
...
{
	submitForm('mon_NotifiableDiseasePop','/hms/hms/monitoring?method=printMonthlyAccidentalDetailReport');
}
</script>
