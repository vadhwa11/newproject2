...
<input type="text" value="<%=opdPatientDetails.getReferredFor()!=null?opdPatientDetails.getReferredFor():""%>" name="referredFor" id="referredFor"/>
...
<div class="Clear"></div>
         ...
         <div class="Clear"></div>
         <label>Referral Doctor Notes</label>
         <textarea name="tt" id="tt" style="width:500px; height:140px"><%=opdPatientDetails.getReferralNotes()!=null?opdPatientDetails.getReferralNotes():""%></textarea>
...
<input type="button" class="button" value="Back" align="left"
	onClick="submitFormForButton('generateReferralLetterPage','referral?method=referredPatientListForDoctor');" />
