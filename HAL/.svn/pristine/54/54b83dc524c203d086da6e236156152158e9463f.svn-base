 ...
 * hrorderly_officer_duty_entry table. Do not modify this class because it will
 * be overwritten if the configuration file related to this class is modified.
 * 
 * @hibernate.class table="hrorderly_officer_duty_entry"
 */

public abstract class BaseHrorderlyOfficerDutyEntry implements Serializable {

	public static String REF = "HrorderlyOfficerDutyEntry";
	...
	// constructors
	public BaseHrorderlyOfficerDutyEntry() {
		initialize();
	}
	 ...
	 */
	public BaseHrorderlyOfficerDutyEntry(java.lang.Integer id) {
		this.setId(id);
		initialize();
	}
	...
	public boolean equals(Object obj) {
		if (null == obj)
			return false;
		if (!(obj instanceof jkt.hms.masters.business.HrorderlyOfficerDutyEntry))
			return false;
		else {
			jkt.hms.masters.business.HrorderlyOfficerDutyEntry hrorderlyOfficerDutyEntry = (jkt.hms.masters.business.HrorderlyOfficerDutyEntry) obj;
			if (null == this.getId()
					|| null == hrorderlyOfficerDutyEntry.getId())
				return false;
			else
				return (this.getId().equals(hrorderlyOfficerDutyEntry.getId()));
		}
	}
