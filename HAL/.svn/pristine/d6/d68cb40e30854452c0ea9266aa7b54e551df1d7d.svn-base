<%-- 
	 ...
	 * File Name           : patientVisitSearchPhysiotherapy.jsp 
	 * Tables Used         : 
	 * Description         : 
...
<title>Patient Visit Search</title>
<div id="contentHolder">
<form name="patientVisitSearchPhysiotherapy" action="" method="post">
...
function checkAppointmentDate(){
	...
	%> <br>
<div class="blockTitle">Patient Search (Re-Visit)</div>
<div class="blockTitleCurve"></div>
<div class="Clear"></div>
<div class="blockFrame"><label>Hin</label> <input type="text"
	name="<%=HIN_NO %>" value="" MAXLENGTH="50" /> <label>Patient
First Name</label> <input type="text" name="<%=P_FIRST_NAME %>" value=""
	MAXLENGTH="15" /> <label>Patient Mid Name</label> <input type="text"
	name="<%=P_MIDDLE_NAME %>" value="" MAXLENGTH="15" />
<div class="Clear"></div>
...
<div class="Clear"></div>
<label>Rank</label> <select name="<%=RANK_ID %>">
...
<input type="button" name="Submit" id="addbutton"
	onclick="submitForm('patientVisitSearchPhysiotherapy','/hms/hms/opd?method=showVisitDetails');"
...
<form name="patientVisitPhysiotherapy" method="post" action=""><script
...
<script type="text/javascript" language="javascript">
    ...
    formName = "patientVisitPhysiotherapy"
