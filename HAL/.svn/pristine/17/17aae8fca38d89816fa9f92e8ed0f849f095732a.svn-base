...
<title>Surgery Enquiry</title>
<div id="contentspace">

<form name="surgeryEnquirySearch1" action="" method="post">
<%
		...
		if(map.get("surgeryMap") != null){
			patientMap= (Map<String, Object>)map.get("surgeryMap");
		}
...
<font class="boxtitle">Surgery Patient Search</font></div>
<div style="width: 15px; float: left;"><img
	src="/hms/jsp/images/tab_edge_ltbl.gif" /></div> -->

<div class="titleBg">
<h2>Surgery Patient Search</h2>
</div>

<div class="Block">
<label>Service No:</label> <input type="text"	name="<%=SERVICE_NO %>" value="" MAXLENGTH="30" />

<label>Ser.First Name: </label> <input type="text"
	name="<%=SERVICE_PERSON_NAME %>" value="" class="textbox_size20"
	MAXLENGTH="30" /> <label>Ser.Mid Name: </label> <input	type="text" name="<%=S_MIDDLE_NAME %>" value="" MAXLENGTH="30" />
	
	<div class="Clear"></div>
	<label>Ser.Last Name: </label> <input
	type="text" name="<%=S_LAST_NAME %>" value="" MAXLENGTH="30" />
	<div class="Clear"></div>
...
<label>Hin No:</label> <input type="text"name="<%=HIN_NO %>" value="" MAXLENGTH="30" />
<div class="Clear"></div>
<label>A&D No:</label> <input type="text"
	name="<%=AD_NO%>" value="" MAXLENGTH="30" /> <label>Patient First Name:</label> <input type="text"
	name="<%=PATIENT_NAME %>" value="" MAXLENGTH="30" /> <label>Patient Mid Name:</label> <input
	type="text" name="<%=P_MIDDLE_NAME %>" value="" MAXLENGTH="30" /> 
<div class="Clear"></div>	
<label>Patient Last Name:</label>
<input type="text" name="<%=P_LAST_NAME %>" value="" MAXLENGTH="30" />

<label>Address:</label> <input type="text"
	name="<%=ADDRESS %>" value="" MAXLENGTH="30" />

<label>District/City: </label> <select
	name="<%=DISTRICT_ID %>">
...
<div class="Clear"></div>
<label>State:</label> <select name="<%=STATE_ID %>"">
	...
	<%
				...
				%>
</select> <label class="<label>">Patient Status:</label> <select
	name="<%=PATIENT_STATUS %>">
...
<input type="button" name="Search"
	onclick="submitForm('surgeryEnquirySearch1','/hms/hms/ot?method=searchsurgeryForEnquiry');"
...
<form name="surgeryEnquiry" method="post" action=""><script
