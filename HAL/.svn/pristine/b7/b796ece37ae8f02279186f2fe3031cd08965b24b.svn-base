...
<input type="text" id="serviceNo" name="serviceNo" value="" validate="Service No.,String,yes"
MAXLENGTH="30" onblur="getPatientName(this.value)"/> 
<!--<div id=patient>
...
-->
<div id="hinDiv"><label> Patient <span>*</span></label> <input type="text" validate="Hin,String,yes"
	name="<%=HIN_NO%>" value="" MAXLENGTH="50"
	onchange="getAdNo(this.value);" /></div>
<div id=adDiv>
<label>A&D No. <span>*</span></label> 
<input type="text" id="adNo" name="adNo" value="" MAXLENGTH="30" onblur="setHinNo();" validate="A&D No.,String,yes"/> 
</div>
<div class="Clear"></div>

<div class="Clear"></div>
<label> Clinical Chart</label>
<input type="checkbox" name="clinicalChart" value="y" class="radioCheck" checked="checked"/>	
<label> Intake/Output Chart</label>
<input type="checkbox" name="ioChart" value="y"  class="radioCheck" checked="checked"/>
<div class="Clear"></div>	
</div>
<div class="clear"></div>
<div class="division"></div>
<div class="clear"></div>
<input type="hidden" name="hinNo12" id="hinNo12" value="">
<input type="button" name="OK" value="OK" class="button" onClick="submitForm('cashSheet','ipd?method=showPatientMedicalCaseSheetReportForWard');" />
...
function getAdNo(val)
{
	...
	submitProtoAjaxWithDivName('cashSheet','/hms/hms/ipd?method=showPatientName&paramName='+val+'&flag=p'+'&flag1=j','adDiv');
}
