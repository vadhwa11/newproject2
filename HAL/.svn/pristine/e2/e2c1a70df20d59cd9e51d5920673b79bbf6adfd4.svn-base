 ...
 * ot_surgey_pa_employee_detail table. Do not modify this class because it will
 * be overwritten if the configuration file related to this class is modified.
 * 
 * @hibernate.class table="ot_surgey_pa_employee_detail"
 */
...
public abstract class BaseOtSurgeyPaEmployeeDetail implements Serializable {
	...
	public boolean equals(Object obj) {
		if (null == obj)
			return false;
		if (!(obj instanceof jkt.hms.masters.business.OtSurgeyPaEmployeeDetail))
			return false;
		else {
			...
			if (null == this.getId()
					|| null == otSurgeyPaEmployeeDetail.getId())
				return false;
			else
				return (this.getId().equals(otSurgeyPaEmployeeDetail.getId()));
		}
	}
