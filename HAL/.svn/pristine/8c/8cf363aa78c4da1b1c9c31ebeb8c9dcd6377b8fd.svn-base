 ...
 * hrorderly_guard_duty_entry table. Do not modify this class because it will be
 * overwritten if the configuration file related to this class is modified.
 * 
 * @hibernate.class table="hrorderly_guard_duty_entry"
 */

public abstract class BaseHrorderlyGuardDutyEntry implements Serializable {

	public static String REF = "HrorderlyGuardDutyEntry";
	...
	// constructors
	public BaseHrorderlyGuardDutyEntry() {
		initialize();
	}
	 ...
	 */
	public BaseHrorderlyGuardDutyEntry(java.lang.Integer id) {
		this.setId(id);
		initialize();
	}
	...
	public boolean equals(Object obj) {
		if (null == obj)
			return false;
		if (!(obj instanceof jkt.hms.masters.business.HrorderlyGuardDutyEntry))
			return false;
		else {
			jkt.hms.masters.business.HrorderlyGuardDutyEntry hrorderlyGuardDutyEntry = (jkt.hms.masters.business.HrorderlyGuardDutyEntry) obj;
			if (null == this.getId() || null == hrorderlyGuardDutyEntry.getId())
				return false;
			else
				return (this.getId().equals(hrorderlyGuardDutyEntry.getId()));
		}
	}
