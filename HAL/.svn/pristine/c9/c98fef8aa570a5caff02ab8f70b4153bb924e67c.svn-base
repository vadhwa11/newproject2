...
<div class="blockFrame">
	...
	<select name="departmentId" id="departmentId" onchange="submitProtoAjaxWithDivName('opdSurgery','/hms/hms/opd?method=showAjaxResponseForSurgeryRequisitionJsp','ajaxResponse');">
		 ...
		 <!--   <th scope="col">Surgery Code </th> -->
		  ...
		  <tr>
			...
			<script type="text/javascript" language="javascript" charset="utf-8">
				...
				new Ajax.Autocompleter('chargeCodeName1','ac2update2','opd?method=getChargeCodeListForAutoComplete',{parameters:'requiredField=chargeCodeName1', callback: eventCallback});
			</script>
...
<div class="Clear"></div>
		<input name="Submit" type="button" align="right" class="button" value="Submit"  onclick="if(checkSubmitSurgery()){submitForm('opdSurgery','opd?method=submitSurgeryRequisitionDetailsOPD&orderNo=<%=orderNo %>');}" />
		<input name="Back" type="button" alt="Back" value="Back" class="button" onclick="submitForm('opdSurgery','opd?method=showOPDMainJsp&visitId=<%=visit.getId()%>&deptId=<%=visit.getDepartment().getId()%>');"  align="right"/>
...
<script type="text/javascript">
	...
	new Ajax.Autocompleter('chargeCodeName'+iteration,'ac2update2','opd?method=getChargeCodeListForAutoComplete&deptId='+departmentId,{parameters:'requiredField=chargeCodeName'+iteration});
	...
	if(val != ""){
		...
		submitProtoAjaxWithDivNameToShowStatus('opdSurgery','/hms/hms/opd?method=fillChargeCode&chargeCodeNAmeForAjax='+ tempChargeCodeString+'&rowVal=1',chargeCodeTdDiv);
