<%-- 
	 ...
	 * File Name           : certificateByTheCandidatePrint.jsp 
	 * Tables Used         : 
	 * Description         : 
...
<h6>Print Certificate By The Candidate</h6>
<div class="Clear"></div>

<div class="blockFrame">
<form name="certificateByTheCandidatePrint1" action="" method="post">
...
<label>Entry No.</label> <input id="searchField1" type="text"
	...
	onclick="setdate('',document.certificateByTheCandidatePrint1.<%=ENTRY_DATE%>,event)" ; />
...
<input type="button" tabindex="1" name="Search"
	onclick="submitForm('certificateByTheCandidatePrint1','certificateByTheCandidateSearch?method=searchCertificateByTheCandidateSearch','checkSearchForWorkService');"
...
<form name="certificateByTheCandidatePrint" method="post" action="">
<script type="text/javascript">
...
<div class="bottom"><input type="hidden" name="<%=STATUS %>"
	...
	name="<%=FLAG_FOR_PRINT%>" type="hidden" value="y" /> <label>Changed
...
%>
formName = "certificateByTheCandidatePrint"
start = 0
