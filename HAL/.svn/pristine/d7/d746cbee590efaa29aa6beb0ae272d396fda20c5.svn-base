    ...
    function validateTokenDiv()
    {
    	...
    	for(var i=1; i<=divCount; i++)
        	...
        	if(deptId!=0 && doctorId!=0 && sesId!=0)
        		{
        		/* submitProtoAjaxWithDivName('visitEmployee','/hms/hms/registration?method=getTokenNoForDepartmentMultiVisit&row='+i,'displayToken'+i); */
...
<input	id="tempserviceNoId" class="auto" size="13" type="text"	name="tempserviceNoId" value="" title="Enter Employee No"   validate="Employee No,string,yes" maxlength="20" onkeypress="return searchKeyPress(event);"
 />
...
<input id="sFNameId" type="text" name="<%=S_FIRST_NAME %>" value=""  		validate="Patient First Name,string,no" MAXLENGTH="15"	onblur="fillPatientName(this);" /> 
...
<div class="clear"></div>
<label> Address</label> 
<textarea name="srnok2Address" id="srnok2Add"	maxlength="500" cols="20" rows="2"   validate="Nok2 Address,string,no"
	></textarea>
<label>Police Station</label> 
...
<label>First Name<span>*</span></label> 
<input type="text"	id="pFirstNameId" name="<%=P_FIRST_NAME %>" value=""  		validate="Patient First Name,string,yes" MAXLENGTH="15" />
<label>Middle Name</label> 
...
document.getElementById("tempserviceNoId").focus();
