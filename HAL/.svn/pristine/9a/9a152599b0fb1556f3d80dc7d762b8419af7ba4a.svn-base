...
<div class="clear paddingTop15"></div>
<div class="cmntable">
<table border="0" align="center" cellpadding="0" cellspacing="0" id="gridService" style="display: none">
<tr>
<th>Sl No.</th>
<th>Service No.</th>
<th>Name</th>
...
function showMoName()
{
	...
	function getPilotDetails(){
		var unitNameId = document.getElementById('unitNameId').value;
			...
			numOfRows=10;
			var pageType="add";
		   if(unitNameId != 0 && unitNameId != "" && validateMetaCharacters(pageType)){
		  	   var url="/hms/hms/aviationMedicine?method=findPilotDetail&unitNameId="+unitNameId+"&pageType="+pageType;
