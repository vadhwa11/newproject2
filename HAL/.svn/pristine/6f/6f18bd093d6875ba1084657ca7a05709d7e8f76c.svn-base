...
<form name="POList" method="post" action="">
 ...
 <div class="titleBg">
<h2>Awaiting List of RR Inspection</h2>
</div>
...
function GetRRList(MODE)
{
	...
	if(MODE == 'ALL')
		{
			var data = "PN="+nPageNo+"&flag=Entered&ddlRequestYear=0&ddlSupplier=0";
		}
	else
		{
			var data = "PN="+nPageNo+"&flag=Entered&ddlRequestYear="+ddlRequestYear+"&ddlSupplier="+ddlSupplier;
		}
...
{
	ViewRRforInspection(Id);
}

function ViewRRforInspection(Id)
{

	window.location = "stores?method=ViewRRforInspection&headerId="+Id+"&appId=A1644";	
