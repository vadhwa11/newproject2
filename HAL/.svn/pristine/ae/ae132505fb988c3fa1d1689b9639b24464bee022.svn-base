...
<div class="bottom"><input type="button" name="yes" value="Yes"
	class="button"
	onclick="submitForm('patientAD','/hms/hms/ot?method=printOtPostAnesthesiaProcedureReport&yearlySlNo=<%=YearlySrNo %>','checkTargetForYes');" />

<input type="button" name="Back" class="button" value="Back"
	onclick="showBack('patientAD')" /></div>
</form>
</div>