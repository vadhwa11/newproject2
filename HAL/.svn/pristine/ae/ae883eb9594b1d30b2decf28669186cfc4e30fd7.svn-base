...
<div class="titleBg">
<h2>Daily PAC Register</h2>
</div>
<div class="Block">

<label class="bodytextB1"><font id="error">*</font>From Date :</label> 
<input type="text" id="fromDate" name="<%=FROM_DATE %>" value="" MAXLENGTH="30" readonly="readonly" /> 
...
<label class="bodytextB1"><font id="error">*</font>To Date :</label> 
<input type="text" name="<%=TO_DATE%>" value="" class="textbox_date" MAXLENGTH="30" validate="Pick a to date,date,yes" readonly="readonly" />
<img src="/hms/jsp/images/cal.gif" width="16" height="16" border="0" validate="Pick a date" class="calender" onClick="setdate('<%=currentDate %>',document.otPost.<%=TO_DATE%>,event);" />

<div class="Clear"></div>

<div id="contentHolder">
<input type="button" name="add" id="addbutton" value="Ok" class="button" onClick="submitForm('otPost','ot?method=generateOtDailyPacReport','check()');" accesskey="a" tabindex=1 /> 
