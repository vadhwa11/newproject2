...
<!--By Vishnu  -->
<title>Transfer to Ward waiting list</title>
...
<div class="clear"></div>
<div class="titleBg">
<h2>Pending for Transfer to Ward</h2>
</div>
<div class="clear"></div>
...
<input type="button" name="Search" value="Search" class="button"
	onClick="submitForm('search','/hms/hms/ot?method=showTransferToWardWaitingList');" />
...
<form name="transferToWardPatientSearch" method="post" action="">
...
formName = "transferToWardPatientSearch"
start = 0
