...
<div class="floatLeft"><input name="patient fast history3"
	...
	onclick="submitForm('ophthalmologyFollowUp','opd?method=showOpdOphthamologyJsp');">
<input name="patient fast history" type="button" class="navButtons"
	value="Retinal"
	onclick="submitForm('ophthalmologyFollowUp','/hms/hms/opd?method=showOphthalmologyRetinalJsp');">
...
<div class="bottom">
<input name="Save" type="button" class="button" value="Submit" onclick="if(checkBlankForOphthalmology('ophthalmologyFollowUp')){submitForm('ophthalmologyFollowUp','opd?method=submitOphthalmologyFollowUp');}" />
<input name="view" type="button" class="button" value="View" onclick="submitForm('ophthalmologyFollowUp','opd?method=viewOphthalmologyFollowUp&flag=prev');" />
