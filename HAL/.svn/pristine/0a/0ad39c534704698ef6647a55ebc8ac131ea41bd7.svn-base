...
<div class="floatLeft"><input name="patient fast history"
	...
	onclick="submitForm('ent','/hms/hms/fwc?method=showOphthalmologyFollowUpUpdateJsp');">
<input name="patient fast history3" type="button" class="navButtons"
	value="Retinal"
	onclick="submitForm('ent','/hms/hms/fwc?method=showOphthalmologyRetinalUpdateJsp');">
<input name="patient fast history23" type="button" class="navButtons"
	value="Diagnosis"
	onclick="submitForm('ent','fwc?method=showOphthalmologyDiagnosisUpdateJsp');">
</div>
...
<div class="Clear"></div>
<input name="prev" type="button" class="button" value="Update" onclick="submitForm('ent','fwc?method=updateFwcOpht');"> <%
	String url = ""; 
