...
<!--Block one Ends--> <%if(gastroEnterologyEndoscopyList.size() > 0){
...
<label class="large">Report No </label> <label class="value"><%=gastroEnterologyEndoscopy.getReportNo() %></label>

<label class="common">Report Date</label> <label class="value"><%=reportDateInString %></label>

<div class="Clear"></div>
<label class="large">Refered By</label>
<%if(gastroEnterologyEndoscopy.getReferredBy()!=null){ %> 
<label class="value"><%=gastroEnterologyEndoscopy.getReferredBy().getFirstName() %><%=gastroEnterologyEndoscopy.getReferredBy().getMiddleName() %><%=gastroEnterologyEndoscopy.getReferredBy().getLastName() %></label>
<%}else{ %>
...
<label class="large">Esophagus</label> <%if(gastroEnterologyEndoscopy.getEsophagus() ==null){%>
<label class="value">-</label> <%} else{%> <label class="valueNoWidth">
<%=gastroEnterologyEndoscopy.getEsophagus() %></label> <%} %>

<div class="Clear"></div>

<label class="large">Stomach</label> <%if(gastroEnterologyEndoscopy.getStomach()==null){%>

<label class="valueNoWidth">-</label> <%} else{%> <label
	class="valueNoWidth"> <%=gastroEnterologyEndoscopy.getStomach() %></label>
<%} %>

<div class="Clear"></div>

<label class="large">Duodenum</label> <%if(gastroEnterologyEndoscopy.getDuodenum()==null){%>
<label class="valueNoWidth">-</label> <%} else{%> <label
	class="valueNoWidth"><%=gastroEnterologyEndoscopy.getDuodenum() %></label>
<%} %>

<div class="Clear"></div>

<label class="large">Biopsy</label> <%if(gastroEnterologyEndoscopy.getBiopsy()==null){%>
<label class="valueNoWidth">-</label> <%} else{%> <label
	class="valueNoWidth"><%=gastroEnterologyEndoscopy.getBiopsy() %></label>
<%} %>

<div class="Clear"></div>

<label class="large">Gastric antum for H Pylori</label> <%if(gastroEnterologyEndoscopy.getGastricAntumForHpylori()==null){%>
<label class="valueNoWidth">-</label> <%} else{%> <label
	class="valueNoWidth"><%=gastroEnterologyEndoscopy.getGastricAntumForHpylori() %></label>
<%} %>

<div class="Clear"></div>
<label class="large">Other/Remarks</label> <%if(gastroEnterologyEndoscopy.getOthersRemarks()==null){%>
<label class="valueNoWidth">-</label> <%} else{%> <label
	class="valueNoWidth"><%=gastroEnterologyEndoscopy.getOthersRemarks() %></label>
<%} %>

<div class="Clear"></div>

<label class="large">Final diagnosis</label> <%if(gastroEnterologyEndoscopy.getFinalDiagnosis()==null){%>
<label class="valueNoWidth">-</label> <%} else{%> <label
	class="valueNoWidth"><%=gastroEnterologyEndoscopy.getFinalDiagnosis() %></label>
<%} %>
...
<input name="prev" type="button" class="button" value="Prev"
	onclick="submitForm('gastroEnterologyEndoscopy','opd?method=viewGastroEnterologyEndoscopy&flag=prev','patientVisitPrev');">
<input name="next" type="button" class="button" value="Next"
	onclick="submitForm('gastroEnterologyEndoscopy','opd?method=viewGastroEnterologyEndoscopy&flag=next','patientVisitNext');">
<%
	String url = ""; 
...
%> <input name="Back" type="button" src="images/phaseII/delete.gif"
	...
	onclick="submitForm('gastroEnterologyEndoscopy','opd?method=showGastroEnterologyEndoscopyJsp&visitId=<%=currentVisitId%>');"
	align="right" /></div>
...
<input type="hidden" id="currentVisitId" name="currentVisitId"
	...
	name="max" value="<%=max %>"> <input type="hidden" id="visitId"
	value="<%=visit.getId() %>"> <%}else{%> <label><span>No
