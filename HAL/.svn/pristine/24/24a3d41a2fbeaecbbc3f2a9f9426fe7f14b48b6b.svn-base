 ...
 * showEditUserGroup.jsp  
 * Purpose of the JSP -  This is for Show/Edit User Group
 * @author  Deepali
 * @author  Mansi
...
<BODY BGCOLOR=#FFFFFF LEFTMARGIN=0 TOPMARGIN=0 MARGINWIDTH=0
	MARGINHEIGHT=0>
<form name="showEditUserGroup" method="post">
<%
	Map map = new HashMap();
String displayEditUserGroup=" Edit User Group ";
...
<table
	...
	<tbody>
		...
		<tr>
			...
			</bc:breadcrumbs> <bc:breadcrumb display="<%=displayEditUserGroup%>">
									...
									<tr>
										...
										<table align="center" border="0" cellpadding="0"
											...
											<tr>
												...
												<td width="100"><select name=<%=USER_GROUP%>
													class="select">
...
%>
											...
											<tr>
												...
												<td align="right" width="84"><input type="button"
													class="button" name="editGroup" value="  Edit Group  "
													onclick="return editUserGroup('showEditUserGroup','/hms/hms/login?method=editUserGroup');" />
												</td>
												<td align="right" width="50">&nbsp;</td>
												<td align="left" width="100"><input type="button"
													class="button" name="deleteGroup" value="Delete Group"
													onclick="return deleteUserGroupConfirmation('showEditUserGroup','/hms/hms/login?method=deleteUserGroup')" />
												</td>
											</tr>
										</table>
										<div align="center"></div>
