...
<div class="clear"></div>
<div class="titleBg">
<h2>ABC Analysis (BASED ON CONSUMPTION)</h2>
</div>
<div class="clear"></div>
<div class="Block">
...
<input type="button" name="report" onClick="methodForReport2()" value="Print" class="button">
...
function methodForReport2(){


	submitForm('actualStockReport','stores?method=generateABCAnalysisReport&flag=e');
}
