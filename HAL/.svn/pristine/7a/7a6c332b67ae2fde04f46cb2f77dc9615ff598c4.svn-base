...
<h6>Duty Exemption Search</h6>
<div class="Clear"></div>
<form name="dutyExemptionSearch" action="" method="post">
<%
...
<input type="button" name="Search"
	onclick="submitForm('dutyExemptionSearch','hrRelated?method=searchEmployeeForDutyExemption');"
...
<form name="dutySearch" method="post" action=""><script
