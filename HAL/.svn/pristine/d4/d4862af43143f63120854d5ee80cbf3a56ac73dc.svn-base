			   ...
			   <div class="Block">
			    <label>Formation Code</label>
					...
					<input type="radio" class="radioAuto" name="<%=SELECTED_RADIO %>" value="2"  />
					 ...
					 <input type="text" id="searchField" name="<%= SEARCH_FIELD%>" value=""  validate="Formation Code,string,no"   MAXLENGTH="8" tabindex=1 onkeypress="return submitenter(this,event,'personnel?method=searchFormation')" />
                    <input type="button" name="search" value="Search" class="button" onclick="submitForm('search','personnel?method=searchFormation','checkSearch')" tabindex=1  />
					<%--- Report Button   --%>  
                    ...
                    <input type="hidden" name="<%=JASPER_FILE_NAME%>" value="Mas_formation">
                    </div>
		     </form>
<div class="Clear"></div>
...
<div class="Clear"></div>
   ...
   <h4> <a href="personnel?method=showFormationJsp">Show All Records</a></h4>
	<%
			}
		 }
  ...
  <form name="formation" method="post" action="">
  <input type="hidden" name="<%= POJO_NAME %>" value = "MasFormation">
  <input type="hidden" name="<%=POJO_PROPERTY_NAME %>" value = "FormationName">
  <input type="hidden" name="title" value = "Formation">
  <input type="hidden" name="<%=JSP_NAME %>" value = "formation">
  <input type="hidden" name="pojoPropertyCode" value = "FormationCode">
<div class="Clear"></div>	  		
 	<div class="Block">

	  	<label >  Formation Code <span>*</span></label>
		<input type="text" name="<%= CODE%>" value="" validate="Formation Code,string,yes"  MAXLENGTH="8"/ tabindex=1 >
  		<label > Formation Name <span>*</span></label>
			<input type="text" class="large" name="<%= SEARCH_NAME %>" value="" validate="Formation Name,string,yes"  MAXLENGTH="30"/ tabindex=1 >
			<script>
				document.formation.<%=CODE%>.focus();
			</script>
			
			<label class="noWidth"> Service Type Name <span>*</span></label>
			<select name="<%= SERVICE_TYPE_ID %>" validate="Formation,string,yes" tabindex=1 onkeypress="return submitenter(this,event,'personnel?method=addFormation')">
...
<div class="Clear"></div>
			<div id="edited"></div>
			<input type="button" name="add" id="addbutton" value="Add" class="button" onClick="submitForm('formation','personnel?method=addFormation');" accesskey="a" tabindex=1/>
			<input type="button" name="edit" id="editbutton" value="Update" class="button" onClick="submitForm('formation','personnel?method=editFormation')" accesskey="u" tabindex=1 />
			<input type="button" name="Delete" id="deletebutton" value="Activate" class="button" onClick="submitForm('formation','personnel?method=deleteFormation&flag='+this.value)" accesskey="d" tabindex=1/>		
