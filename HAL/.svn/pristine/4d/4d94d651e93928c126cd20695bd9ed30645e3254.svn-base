...
<%
	...
	<h4><%=message %></h4>
	<div class="clear"></div>
	<div class="titleBg"><h2>Physiotherapy</h2></div>
	<div class="clear"></div>
		...
		if(visitObj.getOpdPatientDetails()!= null){
			...
			for(OpdPatientDetails opdPatientDetails : patientDetails){
			      ...
			      Visit visit=  opdPatientDetails.getVisit();
					...
					working = opdPatientDetails.getInitialDiagnosis()!=null?opdPatientDetails.getInitialDiagnosis():"";
...
<textarea rows="" cols=""class="large" readonly="readonly"><%=working%></textarea>
<div class="clear"></div>
</div>
...
<table border="0" align="center" cellpadding="0" cellspacing="0" id="procedure">
	<tr>
		<!-- <th scope="col"></th> -->
		<th scope="col">Physiotherapy Name</th>
		<th scope="col">Physiotherapy Start Date</th>		
