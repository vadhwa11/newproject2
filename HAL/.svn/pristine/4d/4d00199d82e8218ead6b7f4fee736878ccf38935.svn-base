...
function check(){
var SDate = document.mon_AttemptSuicideCases.<%= FROM_DATE%>.value;
var EDate = document.mon_AttemptSuicideCases.<%= TO_DATE %>.value;
...
%>
<form name="mon_AttemptSuicideCases" method="post" action="" >
...
<a	href="javascript:setdate('<%=f%>',document.mon_AttemptSuicideCases.<%=FROM_DATE%>,true)">
...
<a href="javascript:setdate('<%=t%>',document.mon_AttemptSuicideCases.<%=TO_DATE%>,true)">
<img src="/hms/jsp/images/cal.gif" width="16" height="16" border="0" validate="Pick a date" class="calender" /> </a> 
...
{
	submitForm('mon_AttemptSuicideCases','/hms/hms/monitoring?method=generateSuicideReport');
}
</script>
