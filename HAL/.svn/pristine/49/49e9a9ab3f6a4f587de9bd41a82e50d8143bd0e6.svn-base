...
%>
<div class="titleBg"><h2>PVMS/NIV Section Master</h2></div>
<div class="Clear"></div>
...
<div class="Block">
			  <form name="search" method="post" action="">
			    <label class="auto">Section Code</label>
					...
					<input type="radio" class="radioAuto" name="<%=SELECTED_RADIO %>" value="2" maxlength="2" />
...
<% if(masStoreSection.getStatus().equals("y")){ %>
