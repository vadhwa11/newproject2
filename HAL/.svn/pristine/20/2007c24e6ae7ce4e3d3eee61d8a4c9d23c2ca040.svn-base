...
<form name="fwcPatientVisitFromFWCScreen" method="post" action="">
...
<script type="text/javascript" language="javascript">
		...
		formName = "fwcPatientVisitFromFWCScreen"
...
<input name="Back" type="button" alt="Back" value="Back" class="button"
	onclick="submitForm('fwcPatientVisitFromFWCScreen','fwc?method=showFWCMainJsp&visitId=<%=visitId%>&deptId=<%=deptId%>');"
	align="right" /></div>
<script type="text/javascript">
<!--
