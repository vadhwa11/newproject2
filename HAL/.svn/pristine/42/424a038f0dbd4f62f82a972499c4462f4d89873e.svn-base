...
<label>RC No. </label>
<select name="rc_id" validate="RC No." tabindex=1	>
...
<input type="button" name="add" id="addbutton" value="Print" class="button" onClick="submitForm('nisDetails','/hms/hms/stores?method=printRCJsp');"  tabindex=1 />
