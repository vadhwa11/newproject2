...
public interface AccountDataService {
	...
	Map<String, Object> getAccountCodeForAutoComplete(Map<String, Object> parameterMap);
	...
	Map<String, Object> getAccountNarrationForAutoComplete(Map<String, Object> parameterMap);
	...
	Map<String, Object> getOpeningBalanceFromOpeningEntry(Map<String, Object> generalMap);
	...
	boolean deleteAccountSubGroupNew(int accountGroupId,Map<String, Object> generalMap);
	...
	boolean editBankToDatabase(Map<String, Object> editBankToDatabase);
