...
<div class="clear"></div>
	...
	if(Status.equalsIgnoreCase("s"))
	{
		%>
			...
			<input type="button" name="Submit"  class="button" value="Submit" onclick="submitMR('MR','stores?method=submitSendRC&requestHeaderId=<%out.print(mrHeaderId); %>&appId=A1523');"/>
		<%
	}
