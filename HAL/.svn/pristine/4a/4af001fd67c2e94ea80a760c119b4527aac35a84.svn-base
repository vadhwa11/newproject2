...
<h6>Personnel Search For Data Sheet</h6>
<div class="Clear"></div>
<%
...
<div class="Clear"></div>
<div class="blockFrame"><label>Name:</label> <input type="text"
	name="personnelName" value="" MAXLENGTH="30" /> <label>Pass
No: </label> <input type="text" name="passNo" value="" MAXLENGTH="6"
	validate="Pass No,int,no" /> <label>Unit</label> <select name="unitId">
...
<div class="Clear"></div>
<label>Designation</label> <select name="designationId">
	<option value="0">Select</option>
	<%
...
<input type="button" name="Search"
	onclick="submitForm('personnelSearch','/hms/hms/pension?method=personnelSearchForCalculationSheetJsp&jspName=DataSheet');"
...
<form name="personnelDetailForDataSheet" method="post" action="">
...
<script type="text/javascript" language="javascript">
    ...
    formName = "personnelDetailForDataSheet"
