...
<form name="deficientAfmsf1" method="post"><label
	...
	onblur="if(! validateMetaCharacters(this.value)){submitProtoAjaxWithDivName('deficientAfmsf1','/hms/hms/mis?method=getHinNoForDeficient&serviceNo='+this.value,'deficientId')};" />
<br />
<br />
<div id="deficientId">
<div
