...
<div class="blockFrame"><label>Admission No:</label> <input
	type="text" name="<%=AD_NO %>" value="" MAXLENGTH="30" /> <label>Hin:</label>
<input type="text" name="<%=HIN_NO %>" value="" MAXLENGTH="50" /> <label>Ward:</label>
<select name="<%=WARD_ID %>">
...
<label>P First Name:</label> <input type="text"
	name="<%=P_FIRST_NAME %>" value="" MAXLENGTH="15" /> <label>P
Mid Name:</label> <input type="text" name="<%=P_MIDDLE_NAME %>" value=""
	MAXLENGTH="15" /> <label>P Last Name:</label> <input type="text"
	name="<%=P_LAST_NAME%>" value="" MAXLENGTH="15" />

<div class="Clear"></div>

<label>Ser. First Name:</label> <input type="text"
	name="<%=S_FIRST_NAME %>" value="" MAXLENGTH="15" /> <label>Ser.
Mid Name:</label> <input type="text" name="<%=S_MIDDLE_NAME %>" value=""
	MAXLENGTH="15" /> <label>Ser. Last Name:</label> <input type="text"
	name="<%=S_LAST_NAME%>" value="" MAXLENGTH="15" />
<div class="Clear"></div>

<label>Service No:</label> <input type="text" name="<%=SERVICE_NO %>"
	value="" MAXLENGTH="20" /> <label>Service Type:</label> <select
...
<label>Unit:</label> <select name="<%=UNIT_ID %>">
...
<input type="button" name="Search" id="addbutton"
	onclick="submitForm('searchIP','/hms/hms/enquiry?method=searchIP');"
...
<form name="ipE" method="post" action=""><script
