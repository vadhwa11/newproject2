...
--><%//}else{
%>	
	<input type="button" name="createVisit" value="Next Updation"	class="buttonBig"
	onclick="submitForm('messageAdt','/hms/hms/registration?method=updateOtherPatientInformationJsp','checkTargetForNo');" />
<%//}
for(UserButtonRights  userButtonRights : userRightsList){
