...
<div class="clear"></div>
	...
	{
		%>
			<input type="button" name="Save"  class="button" value="Save" onclick="saveMR('MR','stores?method=updateSavedRCCDS&requestHeaderId=<%out.print(requestHeaderId); %>&appId=A1523');"/>
			<input type="button" name="Submit"  class="button" value="Submit" onclick="submitMR('MR','stores?method=updateSavedRCCDS&requestHeaderId=<%out.print(requestHeaderId); %>&appId=A1523');"/>
		<%
	}
