...
<select name ="paymentStatus" id="paymentStatus"  onchange="GetPatientList('FILTER');">
<option value="0">Select</option>
<option value="P">Pending</option>
<option value="C">Complete</option>
</select>

<label>Deduction From Salary</label>

<select name ="deductionFS" id="deductionFS"  onchange="GetPatientList('FILTER');">
<option value="0">Select</option>
<option value="p">Pending</option>
<option value="d">Deducted</option>
<option value="n">No Deduction</option>
</select>
		...
		<!-- 	<table class="tblSearchActions" cellspacing="0" cellpadding="0"
			...
			<table id="tblSearchResultsHeader" class="tblSearchResultsHeader"
				...
				<tr>
					...
					<th id="th4" style='width: 120px;'>Cleared Referrals</th>
					<th id="th4" style='width: 120px;'>Cleared Bills</th>		
					<th id="th4" style='width: 120px;'>Pending Referrals</th>
					<th id="th4" style='width: 120px;'>Pending Bills</th>		
...
<script language="javascript">
	 ...
	 */
		...
		var url = "referral?method=getReferralDashboardData";
		var bClickable = true;
	...
	function makeTable(jsonData) {
		...
		for (i = 0; i < jsonData.length; i++) {
			...
			htmlTable = htmlTable + "<td><a href='referral?method=invoiceWaitingListForAllDashboard&divisionId="+jsonData[i].divisionId+"'>" + jsonData[i].divisionName	+ "</a></td>";
			htmlTable = htmlTable + "<td><a href='referral?method=invoiceWaitingListForAllDashboard&paymentStatus=C&divisionId="+jsonData[i].divisionId+"&message="+jsonData[i].divisionName+" Cleared Referrals'>" + jsonData[i].accountedReferral	+ "</a></td>";
			htmlTable = htmlTable + "<td><a href='referral?method=accountedAndUnaccountedBills&paymentStatus=C&divisionId="+jsonData[i].divisionId+"&message="+jsonData[i].divisionName+" Cleared Referrals'>" + jsonData[i].accountedBills	+ "</a></td>";
			htmlTable = htmlTable + "<td><a href='referral?method=invoiceWaitingListForAllDashboard&paymentStatus=P&divisionId="+jsonData[i].divisionId+"&message="+jsonData[i].divisionName+" Pending Referrals'>" + jsonData[i].unAccountedReferral	+ "</a></td>";
			htmlTable = htmlTable + "<td><a href='referral?method=accountedAndUnaccountedBills&paymentStatus=P&divisionId="+jsonData[i].divisionId+"&message="+jsonData[i].divisionName+" Pending Referrals'>" + jsonData[i].unAccountedBills	+ "</a></td>";			
