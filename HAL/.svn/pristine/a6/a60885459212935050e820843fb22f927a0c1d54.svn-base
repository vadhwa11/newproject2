...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	...
	<tr>
	    ...
	    <a href="#"	 onClick="parent.location='fwc?method=viewMedicalExamInvestigationUploadDocument&filename=<%=masMedicalUploadDocument.getFileName()%>&fileExt=<%=masMedicalUploadDocument.getFileExtension() %>&investId=<%=masMedicalUploadDocument.getDgMasInvestigation().getId() %>&hinId=<%=masMedicalUploadDocument.getHin().getId() %>'">
