	...
	<% 
	     	...
	     	{ 
	     		for (Iterator iterator = yearlySerialNoList.iterator(); iterator.hasNext();) {
	    			...
	    			OtProcedureNotesEntryHeader otProcedureNotesEntryHeader = (OtProcedureNotesEntryHeader)iterator.next();
	    			
				%>
	<option value="<%=otProcedureNotesEntryHeader.getYearlySerialNo()%>"><%=otProcedureNotesEntryHeader.getYearlySerialNo()%>
	</option>
	<% 
