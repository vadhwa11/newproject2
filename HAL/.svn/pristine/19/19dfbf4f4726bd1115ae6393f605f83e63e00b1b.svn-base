...
<input type="button" name="search" value="Search" class="button" onclick="submitForm('search','inPatientMaster?method=searchDischargeStatus','checkSearch')" tabindex="1" /> <%--- Report Button   --%> 
...
<h4><a href="inPatientMaster?method=showDischargeStatusJsp">Show All Records</a></h4> 
<%
   }
   }
...
<form name="dischargeStatus" method="post" action="">
...
<div class="clear"></div>
<div class="Block">
<label> DS Code  <span>*</span></label> 
<input id="codeId" type="text" name="<%= CODE%>" value="" validate="DS Code,string,yes" MAXLENGTH="8" / tabindex="1"> 
<label>DS Name <span>*</span></label> 
<input type="text" name="<%= SEARCH_NAME %>" value="" validate="DS Name,string,yes"  MAXLENGTH="30" tabindex="1" onkeypress="return submitenter(this,event,'inPatientMaster?method=addDischargeStatus')">
<script>
...
<input type="button" name="edit" id="editbutton" value="Update" class="button" onClick="submitForm('dischargeStatus','inPatientMaster?method=editDischargeStatus')" accesskey="u" tabindex="1" /> 
<input type="button" name="Delete" id="deletebutton" value="Activate" class="button" onClick="submitForm('dischargeStatus','inPatientMaster?method=deleteDischargeStatus&flag='+this.value)" accesskey="d" tabindex="1" /> 
...
data_arr[<%= counter%>][3] = "<%= masDischargeStatus.getLastChgBy() %>"
