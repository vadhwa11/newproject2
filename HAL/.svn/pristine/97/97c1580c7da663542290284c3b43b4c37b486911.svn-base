...
<table cellpadding="4" cellspacing="1" border="0">
	...
	<tr>
		<td colspan="2" align="right" class="vbmenu_option"
			...
			onClick="submitForm('search','fwc?method=searchWaitingPatientListJsp');"
...
<div class="bottom"><input name="Yes" type="button" align="right"
	...
	onclick="submitForm('fwcPatientList','<%=urlDept%>','checkTargetForNo');" />
...
<input name="button3" type="button" align="right" class="cmnButton"
	...
	onclick="submitForm('fwcPatientList','fwc?method=showUpdatePatientPrescribtionJsp','checkTargetForNo');" />
</div>
<%   } %> <%}
%> <script type="text/javascript">
<!--
