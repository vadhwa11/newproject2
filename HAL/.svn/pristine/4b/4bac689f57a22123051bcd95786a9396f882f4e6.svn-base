...
public interface OPDHandlerService {
	...
	/** methods added by shailesh */
	List<Patient> getPatientNameForUpadteOpdDetails(Map<String, Object> map);
	...
	/**
	 * showDiseaseWisePatient(Map<String, Object> dataMap)
	...
	/**
	 * exportDiseaseWisePatient(Map<String, Object> dataMap)
	 * @author Mukesh.narayan
	 * @param Map 
	 * @param response map
	 * @throws IOException
	...
	List<PatientPrescriptionHeader> getPresVisitNoForIssueNo(String hinId);
	...
	Map<String, Object> showPatientDirectPrescriptionResponse(Map<String, Object> map);
	...
	Map<String, Object> getPatientVaccineDetails(Map<String, Object>  mapForDS);
