...
<div class="titleBg"><h2>CAT/RECAT REGISTER</h2>
</div>
<div class="Block">
...
<input class="auto" type="text" name="<%=TO_DATE%>" value="<%=currentDate %>" class="date" MAXLENGTH="30"
...
<input type="button" name="add" id="addbutton" value="Ok" class="button"
	onClick="submitForm('dailyDoctorWise','medicalExam?method=generateCatRegisterReport','check()','checkTargetForYes');"
