...
<form name="messageForFreeFromInfection" method="post">
...
-->
<input type="button" name="No" value="Back" class="button"	onclick="submitForm('messageForFreeFromInfection','/hms/hms/sHO?method=showFreeFromInfection');" />
<div class="clear"></div>
<div class="division"></div>
</form>