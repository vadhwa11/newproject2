...
<input type="hidden" name="ageId" id="ageId" value="<%=patient.getAge() %>">
...
<input name="tradeId"  readonly="readonly" value="" type="text" tabindex="1" maxlength="50" />
<%} %>
        				 <label>Gender</label>
        <%if(patient.getSex() != null){  %>
<input type="text" readonly="readonly" name="gender" id="gender" value="<%=patient.getSex().getAdministrativeSexName() %>"> 
<input type="hidden" readonly="readonly" name="genderId" id="genderId" value="<%=patient.getSex().getId() %>"> 

<%}else{ %>				 
<input type="text" readonly="readonly" name="genderId" id="genderId" > 
...
<label>Medical Board Type <span>*</span></label> 
...
<input tabindex="1" type="text" name="<%=REPORTED_DATE %>" 	class="calDate" maxlength="10" class="auto"
	...
	value="" maxlength="5"
	onblur="calculateIdealWeight();checkForWiegth(this.value,id);" /><label
	class="unit">cm</label>
	
	<label>Weight</label> 
   <input tabindex="1" type="text" id="weight" class="auto" size="10"
	name="<%=ACTUAL_WEIGHT %>" maxlength="5" 
	value="" onKeyUp="limitText(this,6);"
...
<input tabindex="1" type="text" id="idealWeightId" 
	...
	value="" onKeyUp="limitText(this,6);" onblur="checkForWiegth(this.value,id);" /><label class="unit">%</label>

	<label>Blood Group</label>	
	<%if(patient.getBloodGroup()!=null) {%>
	<input type="text" maxlength="30" value="<%=patient.getBloodGroup().getBloodGroupName() %>" name="bloodGroup" tabindex="1" />
	<%}else{ %>
<input type="text" maxlength="30" readonly="readonly" value=" " name="bloodGroup" tabindex="1" />
...
<input tabindex="1" name="Button" type="button" class="buttonBig"
	value="Add" onClick="submitForm('addMedicalExamDetails','medicalBoard?method=addOldMedicalBoardData');" />
<div class="clear paddingTop15"></div>
<div class="clear"></div>
<div class="division"></div>
