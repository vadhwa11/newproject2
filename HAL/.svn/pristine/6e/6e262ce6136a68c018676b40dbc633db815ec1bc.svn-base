...
<h4>Occupation Hazard/ Swimming Pool</h4>
...
<td><input type="text" name="Purpose" class="date" size="" /></td>

<td><input type="text" name="place" class="" size="" /></td>

<td><input type="text" name="particularInd" class="" size="" /></td>

<td><input type="text" name="fitUnfit" class="date" size="" /></td>
