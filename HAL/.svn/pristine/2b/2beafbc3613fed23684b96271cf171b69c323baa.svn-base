...
<form name="messageForWaterSurvillance" method="post">
...
-->
<input type="button" name="No" value="Back" class="button"	onclick="submitForm('messageForWaterSurvillance','/hms/hms/sHO?method=showWaterSurveillance');" />
<div class="clear"></div>
<div class="division"></div>
</form>