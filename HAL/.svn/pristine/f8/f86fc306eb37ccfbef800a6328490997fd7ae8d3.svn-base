 ...
 * dischargeByServiceNo  
 * Purpose of the JSP -  This is for Discharge process by Service No.
 * @author  Ritu
...
<form name="dischargeByServiceNo" method="post" action=""><script
...
<script type="text/javascript" language="javascript">
	...
	<%
		int  counter=0;
	System.out.println("in jsp  "+patientList.size());
	    for( Patient  patient : patientList)
	    {				
	    	System.out.println("hin  "+patient.getId());
	    	  	if(patient.getDischarges().size() == 0){
