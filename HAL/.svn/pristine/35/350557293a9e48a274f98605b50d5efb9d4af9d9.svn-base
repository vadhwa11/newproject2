...
<form name="getReferralWaitingList" method="post" action="">
    <h4><%=message %></h4>
	<h2>Approval of Finance Audit</h2>
...
<script language="javascript">
	...
	function GetPatientList(MODE) {
		...
		var url = "referral?method=getInvoiceWaitingListForFinanceDivision";
		var bClickable = true;
	...
	function executeClickEvent(Id)
	 ...
	 window.location="referral?method=generateInvoicePageForFinanceDivision&opdId="+Id;
	 }
