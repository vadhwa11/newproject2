...
function checkd(){
var SDate = document.agendaRegister.<%= FROM_DATE%>.value;
var EDate = document.agendaRegister.<%= TO_DATE %>.value;
...
<FORM name="agendaRegister" action="" method=post>
<h6>Agenda Register</h6>
<DIV class="Clear"></DIV>

<DIV class="blockFrame"><Label><span>*</span> Agenda From
Date</Label> <input type="text" name="<%=FROM_DATE%>" class="calDate" value=""
	readonly="readonly" MAXLENGTH="30" validate="Pick a from date,date,yes" />
<img src="/hms/jsp/images/cal.gif" width="16" height="16" border="0"
	onClick="setdate('<%=currentDate%>',document.agendaRegister.<%= FROM_DATE%>,event);"
	class="calender" /> <LABEl><span>*</span> Agenda To Date</LABEL> <input
	type="text" name="<%=TO_DATE%>" value="" class="calDate"
	readonly="readonly" validate="Pick a to date,date,yes" MAXLENGTH="30" />
<img src="/hms/jsp/images/cal.gif" width="16" height="16" border="0"
	onClick="setdate('<%=currentDate%>',document.agendaRegister.<%= TO_DATE%>,event);"
	class="calender" /></DIV>
<div class="division"></div>
<div class="bottom"><input type="button" class=button value="Ok"
	name="print"
	onclick="submitForm('agendaRegister','/hms/hms/agendaReport?method=printAgendaRegister','checkd()');" />
