<%-- 
    ...
    * File Name           : resultOfAppealMedicalboardPrint.jsp 
    * Tables Used         : 
    * Description         : 
...
<h6>Print Result Of Appeal Medical Board Entry</h6>
<div class="Clear"></div>

<div class="blockFrame">
<form name="resultOfAppealMedicalboardPrint1" action="" method="post">
...
<label>Entry No</label> <input id="searchField1" type="text"
	...
	onclick="setdate('',document.resultOfAppealMedicalboardPrint1.<%=ENTRY_DATE%>,event)" ; />
...
<input tabindex="1" type="button" name="Search"
	onclick="submitForm('resultOfAppealMedicalboardPrint1','resultOfAppealMedicalboardSearch?method=searchResultOfAppealMedicalboardSearch');"
...
<%
   ...
   %>
<form name="resultOfAppealMedicalboardPrint" method="post" action="">
<script type="text/javascript">
...
<div class="bottom"><input name="<%=FLAG_FOR_PRINT%>"
	type="hidden" value="y" tabindex="1" /> <input type="hidden"
	name="<%=STATUS %>" value="" /> <input type="hidden"
	name="<%= COMMON_ID%>" value="" /> <label>Changed By</label> <label
...
%>
formName = "resultOfAppealMedicalboardPrint"
start = 0
