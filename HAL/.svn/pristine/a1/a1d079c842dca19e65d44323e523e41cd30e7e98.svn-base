...
<input type="button" name="Submit" class="button"
	onclick="if(checkBlankSearch()){submitForm('patientSearch','/hms/hms/mediClaim?method=showPatientDetailsCardicClaim');}"
	value="Search"  accesskey="a" /></div>
</form>
<div class="Clear"></div>
...
<form name="searchCardicClaim" method="post" action=""><script
	type="text/javascript">
	formFields = [
			[0, "hinId", "id"], [1,"servNo"], [2,"hin"], [3,"patName"], [4,"rank"], [5,"sPersonName"]];
	 statusTd = 5;
</script></form>
