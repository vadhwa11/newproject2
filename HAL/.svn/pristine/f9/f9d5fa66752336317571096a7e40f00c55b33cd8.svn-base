...
<input type="button" name="add" id="addbutton" value="Print" class="button" onClick="submitForm('searchMedicalExam','referral?method=generateReferralExcelReport');" accesskey="a" tabindex=1 />
