...
<form name="monthWiseImmunizationReport" method="post" action="">

<div class="titleBg">
<h2>Month wise Immunization Report</h2>
</div>
...
<div class="Clear"></div> 
<input type="button" name="OK" value="OK" class="button" onClick="submitForm('monthWiseImmunizationReport','fwc?method=showMonthWiseImmunizationReport');" />
