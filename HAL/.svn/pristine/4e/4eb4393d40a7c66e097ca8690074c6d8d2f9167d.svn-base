...
%>
<div class="titleBg"><h2>NIP Drug Master</h2></div>
<div id="searcharea">
<div id="searchbar">
...
<input	type="hidden" name="colName" value="nomenclature"/>
                    <input type="button" name="search" value="Search" class="button"   onclick="submitForm('search','pharmacy?method=searchItemNIP','checkSearch')" tabindex=1  />
                    ...
                    <input type="hidden" name="add" onclick="submitForm('search','pharmacy?method=generatePVMSExcel');" accesskey="r"  tabindex=1  value="Export To Excel" class="buttonBig">
 		            ...
 		            <%--- Report Button   --%>  
 		            <input type="hidden" name="<%=JASPER_FILE_NAME%>" value="Mas_item_list_NIP"> 
...
{
%> <h4><a href="pharmacy?method=showItemNIPJsp">Show All Records</a></h4> <%
 	}
 	}
...
statusTd = 21;
	  ...
	  <input type="hidden" name="<%=JSP_NAME %>" value = "itemNIP">
      <div class="Clear"></div>	
...
<input type="text" id="pvmsNo" name="<%= CODE%>" value=""   validate="Mat. Code,string,yes"  onblur="checkPvmsForAlreadyExistNIP();"  MAXLENGTH="20" tabindex=1 />
...
<div class="division"></div>
	...
	<input type="button" name="add" id="addbutton" value="Add"	class="button" onclick="submitForm('item','pharmacy?method=addItemNIP','ValidateTemp')" accesskey="a" tabindex=1 style="display: inline" />
<input	type="button" name="edit" id="editbutton" value="Update"	style="display: none" class="button" onclick="submitForm('item','pharmacy?method=editItemNIP&flag='+this.value,'ValidateTemp')"	accesskey="u" tabindex=1 />
	
	<input type="button" name="Delete" id="deletebutton" value="Activate" class="button" onClick="submitForm('item','pharmacy?method=deleteItemNIP&flag='+this.value)" accesskey="d" tabindex=1/>		
		<input type="reset" name="Reset" id="reset"	value="Reset" class="button" onclick="submitFormForButton('item','pharmacy?method=showItemNIPJsp)" accesskey="d"	tabindex=1 accesskey="r" />
