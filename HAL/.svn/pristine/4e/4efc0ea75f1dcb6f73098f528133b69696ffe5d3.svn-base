...
/**
 * This is an object that contains data related to the hr_mas_leave_type_mediator table.
...
public abstract class BaseHrMasLeaveTypeMediator  implements Serializable {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof jkt.hms.masters.business.HrMasLeaveTypeMediator)) return false;
		else {
			jkt.hms.masters.business.HrMasLeaveTypeMediator hrMasLeaveTypeMediator = (jkt.hms.masters.business.HrMasLeaveTypeMediator) obj;
			if (null == this.getId() || null == hrMasLeaveTypeMediator.getId()) return false;
			else return (this.getId().equals(hrMasLeaveTypeMediator.getId()));
		}
	}
