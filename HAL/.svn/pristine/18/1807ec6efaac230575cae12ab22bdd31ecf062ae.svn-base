...
<h6>Marriage Accomodation Register</h6>
...
<label><span>*</span>Category</label> <input type="radio" class="radio"
	name="<%=CATEGORY_NAME %>" value="o" checked="checked" /> <label
	class="valueNoWidth">Officers</label> <input type="radio" class="radio"
	name="<%=CATEGORY_NAME %>" value="a" /> <label class="valueNoWidth">Airmen</label>
</div>
<div class="Clear"></div>
<div class="bottom"><input type="button" name="OK" value="OK"
	class="button"
	onClick="submitForm('accomReg','accom?method=generateMarriageAccomRegister','validateFromToDate');" />
