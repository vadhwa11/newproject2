...
<script>
	...
	function showReport()
	{
		if (TenderSingleQuotationForm.<%=TENDER_NO%>.value=="" || TenderSingleQuotationForm.<%=TENDER_SUPPLIER_GROUP_ID %>.value=="")
		{
		alert('Pl. Check Your Inputs (Tender No & Group)');
		return;
		}
	
		TenderSingleQuotationForm.method="post";
		submitForm('TenderSingleQuotationForm','tender?method=generateTenderSingleQuotationReport');
	}
	function onChangeTender()
	{
		//TenderSingleQuotationForm.<%=TENDER_SUPPLIER_GROUP_ID%>.options.length=1;
		TenderSingleQuotationForm.method="post";
		submitForm('TenderSingleQuotationForm','tender?method=showSingleQuotationJsp&groupId='+TenderSingleQuotationForm.<%=TENDER_SUPPLIER_GROUP_ID%>.value);
	}
</script>

<form name="TenderSingleQuotationForm"><input type="hidden"
...
<h6>Tender - Single Quotation</h6>
<div class="Clear"></div>

<div class="blockTitle">Tender - Single Quotation</div>
<div class="blockTitleCurve"></div>
<div class="Clear"></div>
<div class="blockFrame"><label class="large">Group</label> <select
...
<label class="large">Received Single Quotation </label> <input
	type="radio" name="rsq" value="1" class="radio" checked="checked" /> <label
	class="large">Resultant Single Quotation </label> <input type="radio"
	name="rsq" value="2" class="radio" />
<div class="Clear"></div>
</div>
<div class="Clear"></div>
