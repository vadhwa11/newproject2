...
<div class="Clear"></div>
<form name="medicalExaminationBoardSearch1" action="" method="post">
<h6>Medical Examination Board Search</h6>
...
<input tabindex="1" type="button" name="Search" id="searchField"
	onclick="submitForm('medicalExaminationBoardSearch1','medicalExaminationBoard?method=searchMedicalExaminationBoardSearch','checkSearchCriteria1');"
...
data_arr[<%= counter%>][4]=""
<%}%>
<%if(masMedicalExaminationReportOnEntry.getServiceNo()!=null){%>
data_arr[<%= counter%>][5] = "<%= masMedicalExaminationReportOnEntry.getServiceNo()%>"
<%}else{%>
data_arr[<%= counter%>][5] = ""
<%}%>
...
%>
formName = "medicalExaminationBoardSearch1"
