...
<form name="finalDischargeCancel" action="" method="post">
<%
...
<input type="button" name="Search" id="addbutton"
	onclick="submitForm('finalDischargeCancel','/hms/hms/adt?method=showFinalDischargeList');"
...
<form name="finalDischargecancel" method="post" action="">
...
{ %> <input type="button" name="discharge" id="dischargeButt"
	value="Cancel Discharge" class="buttonBig"
	onClick="submitForm('finalDischargecancel','adt?method=cancelDischargePatient','validateRadio');"
	accesskey="a" tabindex="1" /> <% }%> <script type="text/javascript">
</script></form>
<div class="Clear"></div>
</div>
