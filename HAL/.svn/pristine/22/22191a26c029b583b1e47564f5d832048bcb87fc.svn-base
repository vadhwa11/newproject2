...
<input  type="text"  id="indentDate" name="indentDate"   value="<%out.print(Date); %>"  readonly/>


<label>StockTaking No. </label>
	
<input	type="text" name="indentNo" value="<%=StockTakingNo%>" readonly="readonly"  tabindex=1  readonly/>

<label>Submitted By </label>
	
<input	type="text" name="poNo" value="<%=SubmittedBy%>" readonly="readonly" tabindex=1  readonly/>

<div class="clear"></div>

<label>Approved By </label>
	
<input	type="text" name="poNo" value="<%=ApprovedBy%>" readonly="readonly" tabindex=1  readonly/>

<label>Reason for Stock Taking</label>
<textarea  name="remarks" MAXLENGTH="490" validate="Remarks,metachar,no" style="width: 250px; height: 50px;"><% out.print(Reason); %></textarea>
...
<td><input type="text" name="remarks<%out.print(detailsList.getId()); %>" MAXLENGTH="399" id="remarks<%out.print(detailsList.getId()); %>" validate="Remarks,metachar,no" value="<%=detailsList.getRemarks()%>" size="15" style="width: 200px; height: 40px;"/></td>
...
<input type="button" name="add2" id="addbutton" value="Back To List" class="button" onClick="submitForm('ApprovalOfStockTaking','/hms/hms/stores?method=listofStockTacking&selectedAppId=A1780');"  tabindex=1 />
