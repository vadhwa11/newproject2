...
<form name="messageForBoardOfSurvey" method="post">
...
-->
<input type="button" name="No" value="Back" class="button"	onclick="submitForm('messageForBoardOfSurvey','/hms/hms/neStores?method=showBoardofSurveyJsp');" />
<div class="clear"></div>
<div class="division"></div>
</form>