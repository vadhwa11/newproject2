...
<div>
<!--<input	name="investigationTemplate" type="button"	value="Previous Visits" tabindex="1" class="buttonBig2" onClick="submitForm('medicalBoardExaminationReleaseDischargePA','opd?method=showPatientPreviousVisitForViewScreen&visitId=<%=visit.getId()%>&visitNo=<%=visit.getVisitNo()%>&<%=HIN_ID%>=<%=visit.getHin().getId()%>&token=<%=visit.getTokenNo()%>');"" />
<input	name="investigationTemplate" type="button"	value="Previous Medical Exams" tabindex="1" class="buttonBig2" onClick="submitForm('medicalBoardExaminationReleaseDischargePA','medicalExam?method=getPrevMedExamFromHIC&serviceNo=<%=visit.getHin().getServiceNo() %>');"" />
<input	name="investigationTemplate" type="button"	value="Previous Medical Boards" tabindex="1" class="buttonBig2" onClick="submitForm('medicalBoardExaminationReleaseDischargePA','medicalExam?method=getPrevMedBoardFromHIC&visitId=<%=visit.getId()%>&visitNo=<%=visit.getVisitNo()%>&<%=HIN_ID%>=<%=visit.getHin().getId()%>&serviceNo=<%=visit.getHin().getServiceNo() %>');"" />
<input	name="investigationTemplate" type="button"	value="Previous Hospitalizations" tabindex="1" class="buttonBig2" onClick="submitForm('medicalBoardExaminationReleaseDischargePA','opd?method=showPatientPreviousVisitForHospitality&visitId=<%=visit.getId()%>&visitNo=<%=visit.getVisitNo()%>&<%=HIN_ID%>=<%=visit.getHin().getId()%>');"" />
-->
...
<form name="medicalBoardExaminationReleaseDischargePA" action="" method="post">
<!--Block One Starts-->
...
<input tabindex="1" type="text" class="auto" size="50"  maxlength="20" readonly="readonly" id="" name="<%=PLACE %>" value="<%=medExamObj.getPlace() %>"
	onKeyUp="limitText(this,20);"  />

 <% }else{%>
<input tabindex="1" type="text" class="auto" size="50" maxlength="20" readonly="readonly" id="" name="<%=PLACE %>"
	onKeyUp="limitText(this,20);"  />
...
<input	tabindex="1" class="auto" size="15" name="<%=DATE_DISCHARGE %>" readonly="readonly"   value="<%=HMSUtil.convertDateToStringWithoutTime(medExamObj.getDateDischarge())%>"
	validate="DOB,date,no" maxlength="10"
	onKeyUp="mask(this.value,this,'2,5','/');" />

 <% }else{%>
<input	tabindex="1" name="<%=DATE_DISCHARGE %>"
	validate="DOB,date,no" maxlength="10" value="<%=date %>"  class="date" readonly="readonly"
	onKeyUp="mask(this.value,this,'2,5','/');" />
...
{
%>
<td width="10%"><input tabindex="1" readonly="readonly" type="text" size="11"	name="<%=FROM+inc1 %>" maxlength="10" value="<%=HMSUtil.convertDateToStringWithoutTime(setMedicalExam.getAddressfrom()) %>"/></td>
<% }else{
%>
<td width="10%"><input tabindex="1" readonly="readonly" type="text"	size="11" name="<%=FROM+inc1 %>" maxlength="10" />
<% }%>
</td>
<% if(setMedicalExam.getAddressto()!=null ){%>
<td width="10%"><input tabindex="1" readonly="readonly" type="text"	size="11" name="<%=TO+inc1 %>" maxlength="10" value="<%=HMSUtil.convertDateToStringWithoutTime(setMedicalExam.getAddressto()) %>"/></td>
<% }else{%>
<td width="10%"><input tabindex="1" readonly="readonly" type="text"	size="11" name="<%=TO+inc1 %>" maxlength="10" />
</td>
<% }%>
...
<td width="10%">
<input tabindex="1" type="text" readonly="readonly"	size="11" name="<%=FROM+inc1 %>" maxlength="10" />
</td>
<td width="10%"><input tabindex="1" type="text" readonly="readonly" size="11"	name="<%=TO+inc1 %>" maxlength="10" />
</td>
<td width="10%"><input tabindex="1" readonly="readonly" type="text"	name="<%=PLACE+inc1 %>" maxlength="10" /></td>
<td width="10%"><input tabindex="1" readonly="readonly" type="text"	name="<%=P_NO+inc1 %>" maxlength="10" /></td>
...
<!--Block Four Ends-->
<div class="clear paddingTop15"></div>
<h4> Any previous Service Details in Army/AF/Navy<a href="javascript:animatedcollapse.toggle('slide2')"></a></h4>
<div class="clear"></div>
<div id="slide2">
<div class="Block">
...
<input	tabindex="1" name="<%=PARTICULAR_DATE+inc11 %>" readonly="readonly" size="11"  value="<%=HMSUtil.convertDateToStringWithoutTime(setMedicalExam.getParticulardate())%>"
	...
	onKeyUp="mask(this.value,this,'2,5','/');" />
  <% }else{%>
<input	tabindex="1" name="<%=PARTICULAR_DATE+inc11 %>"   readonly="readonly" size="11"	validate="DOB,date,no" maxlength="10" id="particulardate" value="<%=date %>"
	onKeyUp="mask(this.value,this,'2,5','/');" />
 <% }%>
 </td>
...
<input type="text"	tabindex="1" name="<%=APPROXIMATE_DATE+inc11 %>"  readonly="readonly" id="approximatedate" size="11" value="<%=HMSUtil.convertDateToStringWithoutTime(setMedicalExam.getApproximatedate1())%>"	validate="DOB,String,no" maxlength="30"
	 />
  <% }else{%>
<input  type="text"	tabindex="1" name="<%=APPROXIMATE_DATE+inc11 %>" readonly="readonly" id="approximatedate" size="11"	validate="DOB,String,no" maxlength="30" />
 <% }%>
  </td>
...
<input type="text"	tabindex="1" name="<%=APPROXIMATE_DATE2+inc11 %>" readonly="readonly" id="<%=APPROXIMATE_DATE2+inc11 %>" size="11" value="<%=HMSUtil.convertDateToStringWithoutTime(setMedicalExam.getApproximatedate2())%>"	validate="DOB,String,no" maxlength="30"	 />
<%}else{ %>
<input type="text"	tabindex="1" name="<%=APPROXIMATE_DATE2+inc11 %>" readonly="readonly" id="<%=APPROXIMATE_DATE2+inc11 %>" size="11" value=""	validate="DOB,String,no" maxlength="30"	 />
...
<input	tabindex="1" name="<%=PARTICULAR_DATE+inc11 %>"   readonly="readonly"	validate="DOB,date,no" maxlength="10" id="particulardate" value="<%=date %>"
	onKeyUp="mask(this.value,this,'2,5','/');" size="11" />
...
<input	tabindex="1" type="text"  name="<%=CONDITION_OF_GUMS %>" value="<%=medExamObj.getConditionOfGums() %>"
	class="" onchange="return CheckAlpha(event);" readonly="readonly" id="txtAlpha" maxlength="2" validate="Condition Of Gums,Alphabetic,Yes" />
...
<table width="50%" cellspacing="0" cellpadding="0" border="0">
		...
		<th>FW</th>
			...
			<input tabindex="1" type="text"  maxlength="20" readonly="readonly"  id="hrfw" class="auto" size="10" name="<%=HEARING_R_F_W %>" value="<%=medExamObj.getEarHearingRfw()   %>" onkeyup="isNumber1(this)" maxlength="6" onblur="checkForWiegth(this.value,id);" />
			<%}else{ %>
			<input tabindex="1" type="text" value="600" maxlength="20" readonly="readonly"  id="hrfw" class="auto" size="10" name="<%=HEARING_R_F_W %>" onkeyup="isNumber1(this)"	maxlength="6" onblur="checkForWiegth(this.value,id);" />
			<%} %>
			cm
		...
		<td>
			...
			<input tabindex="1" type="text"  maxlength="20" readonly="readonly" class="auto" size="10" id="hlfw" value="<%=medExamObj.getEarHearingLfw()  %>" name="<%=HEARING_L_F_W%>" onkeyup="isNumber1(this)" maxlength="6" onblur="checkForWiegth(this.value,id);" />
			<%}else{ %>
			<input tabindex="1" type="text" value="600" maxlength="20" readonly="readonly" class="auto" size="10" id="hlfw" name="<%=HEARING_L_F_W %>" onkeyup="isNumber1(this)"	maxlength="6" onblur="checkForWiegth(this.value,id);" />
			<%} %>
			cm
		...
		<td>
			...
			<input tabindex="1" type="text"  readonly="readonly" id="bothfw"	class="auto" name="<%=HEARING_BOTH_FW %>" value="<%= medExamObj.getEarHearingBothFw() %>" onkeyup="isNumber1(this)" maxlength="6" onblur="checkForWiegth(this.value,id);" size="10"/>
			<%}else{ %>
			<input tabindex="1" type="text" value="600" readonly="readonly" id="bothfw"	class="auto" name="<%=HEARING_BOTH_FW %>" onkeyup="isNumber1(this)" maxlength="6" onblur="checkForWiegth(this.value,id);" size="10"/>
			<%} %>
			cm
		...
		<td>
			<% if(medExamObj.getHearingRcv() != null){ %>
 			<input tabindex="1" type="text" maxlength="20" readonly="readonly" size="10" class="auto"  id="hrcv" name="<%=HEARING_R_C_V %>" value="<%= medExamObj.getHearingRcv() %>" onkeyup="isNumber1(this)" maxlength="6" onblur="checkForWiegth(this.value,id);" />
			<%}else{ %>
	 		<input tabindex="1" type="text" value="600" maxlength="20" readonly="readonly"size="10" class="auto"  id="hrcv" name="<%=HEARING_R_C_V %>" onkeyup="isNumber1(this)"	maxlength="6" onblur="checkForWiegth(this.value,id);" />
			<%} %>cm
		</td>
		<td>
 				<% if(medExamObj.getHearingLcv() != null){ %>
	  			<input tabindex="1" type="text" maxlength="20" readonly="readonly" size="10" class="auto" id="hlcv" name="<%=HEARING_L_C_V %>" value="<%= medExamObj.getHearingLcv() %>" onkeyup="isNumber1(this)" maxlength="6" onblur="checkForWiegth(this.value,id);" />
	  			<%}else{ %>
	    		<input tabindex="1" type="text" value="600" maxlength="20" readonly="readonly" size="10" class="auto" id="hlcv" name="<%=HEARING_L_C_V %>" onkeyup="isNumber1(this)" maxlength="6" onblur="checkForWiegth(this.value,id);" />
	  			<%} %>cm
		...
		<td>
	  		...
	  		<input tabindex="1" type="text" maxlength="20" readonly="readonly" id="bothcv" class="auto"  size="10" name="<%=HEARING_BOTH_CV %>" value="<%= medExamObj.getHearingBothCv()  %>" onkeyup="isNumber1(this)" maxlength="6" onblur="checkForWiegth(this.value,id);" />
			<%}else{ %>
 			<input tabindex="1" type="text" value="600" maxlength="20" readonly="readonly" id="bothcv" class="auto" size="10" name="<%=HEARING_BOTH_CV %>" onkeyup="isNumber1(this)" maxlength="6" onblur="checkForWiegth(this.value,id);" />
			<%} %>
			cm
	...
	<tr>
			...
			<%-- <script>
				<%
					if(medExamObj.getTympanicL()!= null){
						System.out.println("Tm l===="+medExamObj.getTympanicL());
				%>
		...
		<%-- 		<script>
					...
					if(medExamObj.getTympanicR()!= null){
						System.out.println("Tm R===="+medExamObj.getTympanicR());
					%>
		...
		<td>
	  		...
	  		<input tabindex="1" type="text" class="auto" size="20" readonly="readonly" name="<%=MOBILITYL %>" maxlength="100"  value="<%= medExamObj.getMobilityL()  %>"  />
			<%}else{ %>
 			<input tabindex="1" type="text" value="Normal" class="auto" size="20" readonly="readonly" name="<%=MOBILITYL %>"  maxlength="100"  />
			<%} %>
		...
		<td>
	  			...
	  			<input tabindex="1" type="text" class="auto" size="20" readonly="readonly" name="<%=MOBILITYR %>" maxlength="100"  value="<%= medExamObj.getMobilityR()  %>"  />
				<%}else{ %>
 				<input tabindex="1" type="text" value="Normal" class="auto" size="20" readonly="readonly" name="<%=MOBILITYR %>"  maxlength="100"  />
...
<label>Audiometry Record</label>
	  ...
	  <input tabindex="1" type="text" maxlength="10" readonly="readonly" id="bothcv" name="<%=AUDIOMETRY_RECORD %>" value="<%= medExamObj.getAudiometryRecord()  %>" class="auto" size="19" />
<%}else{ %>
 <input tabindex="1" type="text"   id="bothcv" readonly="readonly" name="<%=AUDIOMETRY_RECORD %>"  maxlength="10"  class="auto" size="19"/>
<%} %>
...
<input tabindex="1" type="text" maxlength="20" readonly="readonly" class="calDate" readonly="readonly " value="<%=HMSUtil.convertDateToStringWithoutTime(medExamObj.getLastConfinementDate()) %>"	name="<%=DATE_OF_LASTCONFINEMENT %>" maxlength="10" onKeyUp="mask(this.value,this,'2,5','/');" validate="Dental Date,date,no" />
   <% }else{%>
<input tabindex="1" type="text" maxlength="20"  readonly="readonly" class="calDate" readonly="readonly "	name="<%=DATE_OF_LASTCONFINEMENT %>" maxlength="10" onKeyUp="mask(this.value,this,'2,5','/');" validate="Dental Date,date,no" />
 <% }%>
...
<input tabindex="1" type="text"  onkeyup="chkLength(this,100);"  id="remarks" readonly="readonly"	name="<%=MEDICIN_REMARKS %>" class="Auto" size="20" maxlength="100" value="<%=medExamObj.getRemarks() %>"/>
   <% }else{%>
<input tabindex="1" type="text"  onkeyup="chkLength(this,100);" id="remarks" readonly="readonly"	name="<%=MEDICIN_REMARKS %>" class="Auto" size="20" maxlength="100" value=""/>
 <% }%>
...
<input tabindex="1" type="text" id="paRemarks" value="<%=medExamObj.getPerAuthRemarks()  %>" name="paRemarks" value="" size="20" maxlength="100" />
<% }else{%>
...
<%
  if(medExamObj.getPaAFRORemarks()!=null){
  		%>
  		 <div class="clear paddingTop15"></div>
<h4>Rejection Remarks By Perusing II(AIR HQ/AFRO)</h4>
<div class="clear"></div>
<div class="Block">
<label >Final Observation</label>
<% if(medExamObj.getPaAFROFinalObservation()!=null){%>
<input tabindex="1" type="text" name="paAFROFinalObservation" readonly="readonly" value="<%=medExamObj.getPaAFROFinalObservation() %>" size="20" maxlength="100" />
<% }else{%>
<input tabindex="1" type="text" name="paAFROFinalObservation" readonly="readonly" size="20" maxlength="100" />
<% }%>
<label>Remark</label>
<textarea cols="20" rows="2" tabindex="1" maxlength="100" name="paAFRORemarks" tabindex="1" readonly="readonly" onkeyup="chkLength(this,99);"
 onpaste="return checkOnPaste(this)"	oninput="return checkMaxLengthMoz(this)"	onKeyDown="return checkMaxLength(this)" ><%=medExamObj.getPaAFRORemarks() %></textarea>

<label >Signed By</label>
<% if(medExamObj.getPaAFROSignedBy()!=null){%>
<input tabindex="1" type="text" name="paAFROSignedBy" value="<%=medExamObj.getPaAFROSignedBy() %>" size="20" maxlength="100" readonly="readonly" />
<% }else{%>
<input tabindex="1" type="text" name="paAFROSignedBy" value="" size="20" maxlength="100" readonly="readonly" />
...
<input tabindex="1" name="Button"	type="button" class="button" value="VALIDATE"	onClick="submitForm('medicalBoardExaminationReleaseDischargePA','medicalExam?method=validateMedExamPersusingAuthority');" />
<input tabindex="1" name="Button"	type="button" class="button" value="REJECT"	onClick="if(checkRemarksPA()){submitForm('medicalBoardExaminationReleaseDischargePA','medicalExam?method=rejectMedExamPA');}" />
  ...
  function showHideInvestigationTemplateCombo(valueOfTemplate){
		...
		if(checkTemplateId(valueOfTemplate)){
		  	...
		  	document.getElementById("copyPrevInvestigationTemplateDiv").style.display='none';
				...
				submitProtoAjaxWithDivName('medicalBoardExaminationReleaseDischargePA','/hms/hms/opd?method=showGridForInvestigation','gridview');
...
function jsViewFileUploadWindowGynaecology()
{
 ...
 function copyPrevInvestigationTempate(visitNo,hinId){
	    ...
	    submitProtoAjaxWithDivName('medicalBoardExaminationReleaseDischargePA','/hms/hms/opd?method=getPatientPreviousInvestigationForCopy&&visitNo='+visitNo+'&hinId='+hinId,'gridview');
}
 function getListForTreatment(val){
	 	if(val=='investigationDiv'){
			submitProtoAjaxWithDivName('medicalBoardExaminationReleaseDischargePA','/hms/hms/opd?method=getListForTreatment&flag=investigation',val);
		}else if(val=='treatmentDiv'){
			submitProtoAjaxWithDivName('medicalBoardExaminationReleaseDischargePA','/hms/hms/opd?method=getListForTreatment&flag=treatment',val);
		}
	...
	function submitdata()
	{
        ...
        if(charge=="")
        {
         ...
         return false;
        	...
        	submitForm('medicalBoardExaminationReleaseDischargePA','medicalExam?method=addMedicalExaminationBoardAnnual');
        }
