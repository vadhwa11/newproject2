...
<label class="valueLarge"> <%=cardiologyDepartmentDetails.getTmtReport() %></label>


<div class="Clear"></div>

<label class="common">Echo cardiology</label> <label class="common"></label>
<label class="valueLarge"> <%=cardiologyDepartmentDetails.getEchoCardiology() %></label>


<div class="Clear"></div>

<label class="common">Holter</label> <label class="common"></label> <label
	class="valueLarge"><%=cardiologyDepartmentDetails.getHolter() %></label>


<div class="Clear"></div>

<label class="common">Cardiac Cathetization Data</label> <label
	class="common"></label> <label class="valueLarge"><%=cardiologyDepartmentDetails.getCardiacCathetizationData() %></label>


<div class="Clear"></div>

<label class="common">Remarks</label> <label class="common"></label> <label
	class="valueLarge"><%=cardiologyDepartmentDetails.getRemarks() %></label>
