...
<h2 align="left" class="style1">Department Indent</h2>
		...
		<table width="20%" align="right" border="0" cellpadding="0"
			...
			<tr>
				...
				<td width="9%" background="/hms/jsp/images/toolbuttBack.gif"><input
					type="button" name="Reset" value="Reset" class="toolbutton"></td>
				<td width="2%" background="/hms/jsp/images/toolbuttBack.gif"></td>
...
<div id="testDiv" size="height:500px;"><input type="hidden"
	...
	value="<%=internalIndentId%>" id="hdb" /> <%if(internalIndentId==0){ %>
<label class="bodytextB_blue"><font id="error"></font> Demand
No: </label> <input type="text" name="<%=DEMAND_NO %>" value="<%=maxDemandNo%>"
...
<span class="bodytextB_blue">To Store:</span> <select
	...
	<%
				...
				}else{ %> <label class="bodytextB_blue"><font id="error"></font>
Demand No: </label> <input type="text" name="<%=DEMAND_NO %>"
	value="<%=demandNo%>" readonly="readonly" class="textbox_size20"
...
<input type="button" name="sss" align="right" class="button"
	value="Display Last Demand No."
	onclick="showLastDemandNo('departmentIndentGrid')" /> Page No:<%=pageNo%>
