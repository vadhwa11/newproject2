...
%>
		...
		<select name="<%=HIN_ID%>" validate="Hin No,metachar,yes" id="hinId" onblur="if(this.value!=''){submitProtoAjax('admissionByHin','/hms/hms/adt?method=searchPatintForAdmAjax');}" tabindex="1">
		...
		<% 
	     	...
	     	{ 
				...
				%>
		<option value="<%=obj[0]%>"><%=(String)obj[2]+" "+(obj[3]!=null?(String)obj[3]:"")+" "+(obj[4]!=null?(String)obj[4]:"")+"("+(String)obj[5]+")"%></option>
		<% } 
			} 
