...
<script type="text/javascript"
	...
	<form name="medicalBoardForm44Interme" action="" method="post">
...
<div class="titleBg">
<h2>AFMSF - 44 (Interme Category)</h2>
</div>
...
<input type="button" name="Submit11" id="addbutton" onclick="submitForm('medicalBoardForm44Interme','/hms/hms/medicalBoard?method=submitMedicalExamForm44Interme');" value="Submit" class="button" accesskey="a" />
