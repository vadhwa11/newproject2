...
<!-- <script src="/hms/jsp/js/jquery.js" type="text/javascript"></script> -->
...
<input type="hidden" name="supplyType"  id="supplyType" value="U">
...
Date</label> <input type="text" class="date" name="<%=INVOICE_DATE%>" 
	id="invoiceDate" value="<%=currentDate %>"  MAXLENGTH="10" onkeyup="mask(this.value,this,'2,5','/');" tabindex=1 onblur="validateExpDate(this,'invoiceDate');" />
...
window.onload = function(){ submitProtoAjaxforGrid('grnGrid','/hms/hms/stores?method=responseGridForList'); }
