...
/**
 * This is an object that contains data related to the store_loan_out_m table.
 * Do not modify this class because it will be overwritten if the configuration file
 * related to this class is modified.
 *
 * @hibernate.class
 *  table="store_loan_out_m"
 */

public abstract class BaseStoreLoanOutM  implements Serializable {

	public static String REF = "StoreLoanOutM";
	 ...
	 */
	public BaseStoreLoanOutM (java.lang.Integer id) {
		this.setId(id);
		initialize();
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof jkt.hms.masters.business.StoreLoanOutM)) return false;
		else {
			jkt.hms.masters.business.StoreLoanOutM storeLoanOutM = (jkt.hms.masters.business.StoreLoanOutM) obj;
			if (null == this.getId() || null == storeLoanOutM.getId()) return false;
			else return (this.getId().equals(storeLoanOutM.getId()));
		}
	}
