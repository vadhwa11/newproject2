...
<%
	...
	System.out.print("------------------------ In Jsp searchStoreMmfDepartmentMList "+searchStoreMmfDepartmentMList.size());
	
	
	if(map.get("gridIndentMList")!=null)
		gridIndentMList=(List) map.get("gridIndentMList");
	System.out.print("------------------------ In Jsp gridIndentMList "+gridIndentMList.size());
	
	if(map.get("gridIndentTList")!=null)
		gridIndentTList=(List) map.get("gridIndentTList");
	System.out.print("------------------------ In Jsp gridIndentTList "+gridIndentTList.size());
...
<div id="testDiv" size="height:500px;"><input type="hidden"
	...
	name="<%=NO_DETAIL_RECORDS%>" value="<%=noDetailRecords%>" /> <br />
