...
/**
 * This is an object that contains data related to the hr_employee_balance table.
...
public abstract class BaseHrEmployeeBalance  implements Serializable {

	public static String REF = "HrEmployeeBalance";
	 ...
	 */
	public BaseHrEmployeeBalance (java.lang.Integer id) {
		this.setId(id);
		initialize();
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof jkt.hms.masters.business.HrEmployeeBalance)) return false;
		else {
			jkt.hms.masters.business.HrEmployeeBalance hrEmployeeBalance = (jkt.hms.masters.business.HrEmployeeBalance) obj;
			if (null == this.getId() || null == hrEmployeeBalance.getId()) return false;
			else return (this.getId().equals(hrEmployeeBalance.getId()));
		}
	}
